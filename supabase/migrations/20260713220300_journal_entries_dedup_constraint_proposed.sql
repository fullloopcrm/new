-- Adopted from legacy hand-run migration: 2026_07_13_journal_entries_dedup_constraint_PROPOSED.sql
-- Original commit date (git first-add): 2026-07-13T18:03:00-04:00
...
-- Postgres 2026-07-30: applying this file after the lockdown restores the
-- attack. SAFE ALTERNATIVES that fix the same double-post race WITHOUT
-- touching the RPC's grants or redefining the function: prefer
-- `20260711174933_unique_journal_entries.sql` or
