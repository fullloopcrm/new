...
const TENANT_TABLES = new Set([
  ...
  'import_batches','import_rows','inventory_items','invoice_activity','invoices','jefe_tasks',
  ...
  'property_changes','prospects','push_subscriptions','quote_activity','quote_budgets','quote_templates',
  ...
  'travel_time_cache','unmatched_payments','vendor_items','vendors','verification_codes','waitlist','website_visits',
