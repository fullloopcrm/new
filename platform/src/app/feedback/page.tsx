        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <a href="sms:+18445667276" className="block text-sm py-1 hover:text-white transition-colors">Text Us: 844.Loop.CRM</a>
              <a href="tel:+18445667276" className="block text-sm py-1 hover:text-white transition-colors">Call Us: 844.Loop.CRM</a>
