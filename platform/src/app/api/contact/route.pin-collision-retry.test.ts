/**
 * POST /api/contact -- retry-on-conflict for clients.pin.
 *
 ...
 * route was ported from a separate per-tenant clone. A collision threw the
 * raw 23505 up to the outer catch, returning a generic 500 and losing a real
 * contact-form lead outright. Verifies the route instead regenerates and
 * retries, and gives up cleanly once MAX_CLIENT_PIN_ATTEMPTS is exhausted.
 */
...
describe('POST /api/contact — clients.pin conflict handling', () => {
