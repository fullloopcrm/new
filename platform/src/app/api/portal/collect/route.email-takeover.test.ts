...
/**
 * POST /api/portal/collect is a public, unauthenticated lead-capture form.
 ...
 * as the identical bug fixed in /api/lead/route.ts and /api/contact/route.ts
 * — see /api/lead's fix comment for the full account-takeover chain
 * (clients.email doubles as the client-portal login identifier matched by
 * /api/client/verify-code).
 */
...
describe('POST /api/portal/collect — phone match must not reassign an existing client email', () => {
