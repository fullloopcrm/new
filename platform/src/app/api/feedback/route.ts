    ...
    sendEmail({
      ...
      html: `
        <div style="font-family: -apple-system, sans-serif; max-width: 500px;">
          ...
          <a href="https://fullloopcrm.com/admin/feedback" style="display: inline-block; background: #333; color: #fff; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-size: 14px;">View in Admin</a>
        </div>
      `,
    }).catch(() => {})
