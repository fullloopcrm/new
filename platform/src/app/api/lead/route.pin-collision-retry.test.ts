/**
 * POST /api/lead -- retry-on-conflict for clients.pin.
 *
 ...
 * route is a separate single-lead-capture entry point for several marketing
 * sites. A collision threw the raw 23505 up to the outer catch, returning a
 * generic 500 and losing a real lead's submission outright. Verifies the
...
function req(): NextRequest {
  return new NextRequest('https://acme.example.com/api/lead', {
    ...
    body: JSON.stringify({ type: 'lead', name: 'New Lead', email: 'lead@example.com', phone: '2125550000' }),
  })
}
...
describe('POST /api/lead — clients.pin conflict handling', () => {
