...
/**
 * GET /api/social/connect/instagram previously called getTenantForRequest()
 ...
 * OAuth flow to connect their own Instagram Business account as the tenant's
 * integration, hijacking where posts get published. Now gated on
...
describe('GET /api/social/connect/instagram — permission gate', () => {
