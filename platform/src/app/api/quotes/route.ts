    ...
    for (let attempt = 0; attempt < 5; attempt++) {
      ...
      const result = await supabaseAdmin
        ...
        .insert({
          ...
          quote_number,
          status: 'draft',
          title: capQuoteTextField('title', body.title),
          description: capQuoteTextField('description', body.description),
          contact_name: capQuoteTextField('contact_name', body.contact_name),
          contact_email: capQuoteTextField('contact_email', body.contact_email),
          contact_phone: capQuoteTextField('contact_phone', body.contact_phone),
          service_address: capQuoteTextField('service_address', body.service_address),
          ...
          notes: capQuoteTextField('notes', body.notes),
