...
beforeEach(() => {
  // The admin summary (and recurring-expiration check, which rides along with
  // it) now only runs at 8am ET — pin the clock so this test is deterministic
  // regardless of real wall-clock time when the suite runs.
  // 2026-07-22T12:00:00Z = 8am EDT.
  vi.useFakeTimers()
