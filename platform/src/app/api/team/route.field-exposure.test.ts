/**
 * GET /api/team selected '*' from team_members and is gated only by
 ...
 * route.rbac.test.ts) intentionally ignores its select column-list argument,
 * so this asserts directly on what was passed to select().
 */
...
describe('GET /api/team — field-exposure allowlist', () => {
  beforeEach(() => {
    vi.resetModules()
    fromMock.mockClear()
