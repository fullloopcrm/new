...
const BOOKING_UPDATE_FIELDS = ['team_member_id', 'status', 'price', 'notes', 'start_time', 'end_time', 'payment_status']
const CLIENT_UPDATE_FIELDS = ['name', 'email', 'phone', 'address', 'notes', 'active']
