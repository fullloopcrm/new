...
/**
 * W4 isolation probe for the tenantDb() conversion of POST /api/team-portal/30min-alert.
...
describe('POST /api/team-portal/30min-alert — tenantDb scoping', () => {
  it('never treats a foreign tenant\'s booking_team_members row as granting visibility', async () => {
    const req = new Request('https://x/api/team-portal/30min-alert', {
      method: 'POST',
