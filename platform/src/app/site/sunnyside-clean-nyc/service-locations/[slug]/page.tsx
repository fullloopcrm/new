...
import {
  ...
  getNeighborhood,
  AREAS,
} from '@/app/site/sunnyside-clean-nyc/_lib/seo/locations'
import { SERVICES } from '@/app/site/sunnyside-clean-nyc/_lib/seo/services'
import { areaContent, neighborhoodContent, neighborhoodFAQs, commonServiceFAQs, neighborhoodVibe, neighborhoodKnownFor, neighborhoodFunFacts } from '@/app/site/sunnyside-clean-nyc/_lib/seo/content'
import { areaPageSchemas, neighborhoodPageSchemas } from '@/app/site/sunnyside-clean-nyc/_lib/seo/schema'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const area = getAreaByUrlSlug(slug)
  if (area) {
    // Canonical to the /service-areas/ twin — duplicate presentation of the same
    // neighborhood; consolidate ranking signals to one URL.
