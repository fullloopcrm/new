...
import { breadcrumbSchema, localBusinessSchema, faqSchema } from '@/app/site/sunnyside-clean-nyc/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: 'Get Paid for Cleaning Referrals | Earn 10% Commission | Sunnyside Clean NYC',
  ...
  alternates: { canonical: 'https://www.cleaningservicesunnysideny.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
  openGraph: {
    title: 'Get Paid for Cleaning Referrals | Sunnyside Clean NYC',
    description: 'Earn 10% commission every time someone you refer books a cleaning. Recurring income, fast payouts.',
    url: 'https://www.cleaningservicesunnysideny.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Referral Program', url: 'https://www.cleaningservicesunnysideny.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
        ]),
      ...
      <section className="bg-[#1E2A4A] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-300 text-lg max-w-2xl leading-relaxed">
            Earn 10% commission every time someone you refer books a cleaning with Sunnyside Clean NYC. No limit on referrals. Recurring income for as long as they stay a customer.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Send your link to anyone who needs cleaning in NYC. They book using your link.</p>
                </div>
              </div>
              <div className="flex gap-5">
      ...
      <section className="bg-[#A8F0DC] py-20">
        <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h2 className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#1E2A4A] tracking-wide">Start Earning Today</h2>
            <p className="text-[#1E2A4A]/70 text-lg mt-2">Sign up above and start sharing your referral link.</p>
          </div>
          <a href="sms:2122028400" className="inline-block bg-[#1E2A4A] text-white px-8 py-4 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors whitespace-nowrap">
            Text (212) 202-8400
          </a>
        </div>
      </section>
