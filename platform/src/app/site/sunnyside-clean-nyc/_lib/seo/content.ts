...
const richContentMap: Record<string, ServiceRichContent> = {
  'deep-cleaning': {
    ...
    educationSections: [
      ...
      },
      {
        ...
        body: [
          'We charge by the hour — $59/hr with your supplies, $69/hr when we bring everything. The total cost depends on how long the job takes.',
    ...
    faqs: [
      ...
      { question: 'How much does a deep cleaning cost in NYC?', answer: 'Deep cleaning costs $59–$69/hr depending on who provides supplies. A typical studio deep clean runs $196–$260 (4–5 hours). A 2-bedroom is usually $260–$390 (4–6 hours). A 3-bedroom can be $325–$520 (5–8 hours). We charge by the hour so you only pay for the time your space actually needs.' },
  ...
  'regular-cleaning': {
    ...
    nycTips: [
      ...
      { title: 'Provide your own supplies to save ~21%', detail: 'At $59/hr vs $69/hr, providing your own vacuum, mop, and basic cleaning products saves you $32+ per 2-hour visit. Over a year of weekly cleanings, that\'s $1,600+ in savings.' },
    ...
    educationSections: [
      ...
      },
      {
        ...
        body: [
          'Regular cleaning starts at $59/hr when you provide supplies or $69/hr when we bring everything. A typical 2-hour regular clean for a 1-bedroom costs just $98 with your supplies.',
    ...
    faqs: [
      ...
      { question: 'How much does regular apartment cleaning cost in NYC?', answer: 'Regular cleaning is $59/hr with your supplies or $69/hr when we bring everything. A typical 1-bedroom takes 2 hours ($98–$130). A 2-bedroom takes 2.5–3 hours ($122–$195). Weekly clients see the lowest per-visit costs.' },
  ...
  'bi-weekly-cleaning': {
    ...
    faqs: [
      { question: 'How much does bi-weekly cleaning cost in NYC?', answer: 'Bi-weekly cleaning is $59/hr with your supplies or $69/hr when we bring everything. A 1-bedroom typically costs $122–$162 per visit (2.5 hours). A 2-bedroom runs $147–$195 (3 hours). You pay for time worked — no flat-rate markups.' },
  ...
  'monthly-cleaning': {
    ...
    faqs: [
      { question: 'How much does monthly cleaning cost in NYC?', answer: 'Monthly cleaning is $59/hr with your supplies or $69/hr when we bring everything. A 1-bedroom typically costs $147–$195 (3–4 hours). A 2-bedroom runs $171–$260 (3.5–5 hours). Monthly cleans take longer than weekly because there\'s more buildup to address.' },
  ...
  'same-day-cleaning': {
    ...
    pricingNote: 'Same-day cleaning is $89/hr flat. A focused 2-hour clean is $200. A thorough 3–4 hour apartment clean is $300–$400. For non-urgent needs, scheduling 2+ days ahead at $59–$69/hr saves 35–50%.',
    faqs: [
  ...
  'airbnb-cleaning': {
    ...
    educationSections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Our turnover service costs $59–$69/hr — a 1-bedroom turnover at 1.5–2 hours runs $89–$158. A 2-bedroom takes 2–2.5 hours at $118–$198.',
    ...
    faqs: [
      { question: 'How much does Airbnb turnover cleaning cost?', answer: 'Turnover cleaning is $59/hr with supplies on-site or $69/hr when we bring everything. A studio runs $89–$118 (1.5 hours). A 1-bedroom is $89–$158 (1.5–2 hours). A 2-bedroom is $118–$237 (2–3 hours). Most hosts set their Airbnb cleaning fee to match.' },
  ...
  'office-cleaning': {
    ...
    pricingNote: 'Office cleaning costs $59–$69/hr depending on supply arrangement. A small office (under 1,000 sqft) takes 2 hours ($98–$130/visit). A mid-size office (1,000–2,500 sqft) takes 3–4 hours ($147–$260). Larger spaces are quoted based on scope. Weekly clients get the most value.',
    faqs: [
      { question: 'How much does office cleaning cost in NYC?', answer: 'Office cleaning is $59/hr with your supplies or $69/hr when we bring everything. A small office (under 1,000 sqft) costs $98–$130 per visit. A mid-size office (1,000–2,500 sqft) runs $147–$260. Weekly service offers the best per-visit value.' },
