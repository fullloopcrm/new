...
import { getNeighborhoodsByArea } from '@/app/site/sunnyside-clean-nyc/_lib/seo/locations'
...
const description = 'Contact Sunnyside Clean NYC for a free cleaning quote. Text or call (212) 202-9030, or book online. Service from $59/hr across Manhattan, Brooklyn & Queens. 5.0★ Google.'
...
const contactFaqs = [
  ...
  { question: 'Do I need to call to book, or can I text?', answer: 'Texting is our preferred method — it\'s faster for both of us. You can also call or book online at cleaningservicesunnysideny.com.' },
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-2xl p-8 text-center hover:border-[#A8F0DC] hover:shadow-lg transition-all">
              ...
              <a href="/book/new" className="inline-block mt-5 bg-[#1E2A4A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                Self Booking $10 OFF
              </a>
            </div>
          </div>
