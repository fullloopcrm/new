...
export const metadata: Metadata = {
  title: 'Privacy Policy | Sunnyside Clean NYC',
  description: 'Sunnyside Clean NYC privacy policy — how we protect your data. We never sell or share your information. NYC cleaning from $59/hr. (212) 202-8400',
  alternates: { canonical: 'https://www.cleaningservicesunnysideny.com/privacy-policy' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Privacy Policy', url: 'https://www.cleaningservicesunnysideny.com/privacy-policy' },
      ])} />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about this privacy policy? Contact us at <a href="mailto:hi@thenycmaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thenycmaid.com</a> or text <a href="sms:2122028400" className="text-[#1E2A4A] underline underline-offset-2">(212) 202-8400</a>.
            </p>
