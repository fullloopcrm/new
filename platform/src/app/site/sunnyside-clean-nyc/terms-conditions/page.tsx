...
import { breadcrumbSchema } from '@/app/site/sunnyside-clean-nyc/_lib/seo/schema'
import JsonLd from '@/components/marketing/JsonLd'
import Breadcrumbs from '@/components/marketing/Breadcrumbs'

export const metadata: Metadata = {
  title: 'Terms & Conditions | Sunnyside Clean NYC',
  description: 'Terms & conditions for Sunnyside Clean NYC — cancellation policy, payment terms, scheduling & service agreement. Cleaning from $59/hr. (212) 202-8400',
  alternates: { canonical: 'https://www.cleaningservicesunnysideny.com/terms-conditions' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Terms & Conditions', url: 'https://www.cleaningservicesunnysideny.com/terms-conditions' },
      ])} />
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-200/60 mt-3">Service agreement for Sunnyside Clean NYC</p>
        </div>
      </section>
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              By booking a cleaning service with Sunnyside Clean NYC, you agree to the following terms and conditions. We reserve the right to update these terms at any time. Continued use of our services constitutes acceptance of any changes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                'Sunnyside Clean NYC carries full general liability insurance and bonding.',
