...
import ContactForm from "@/app/site/the-baltimore-exterminator/_components/ContactForm";
import CTAGroup from "@/app/site/the-baltimore-exterminator/_components/CTAGroup";
import { PHONE, SITE_URL, getBreadcrumbSchema } from "@/app/site/the-baltimore-exterminator/_lib/seo";
import { getAllServices, getAllNeighborhoods } from "@/app/site/the-baltimore-exterminator/_lib/data";

export const metadata: Metadata = {
  title: "Free Pest Control Quote Baltimore | No-Obligation Exterminator Estimate",
  description:
    "Request a no-obligation pest control quote from licensed Baltimore exterminators. Includes on-site inspection, written treatment plan, and upfront pricing. Cockroaches, bed bugs, rats, mice, termites & more. Same-day service available across the entire Baltimore metro area, and the surrounding suburbs. Text us.",
  keywords:
    "pest control quote Baltimore, exterminator estimate, pest control inspection, cockroach extermination quote, bed bug treatment estimate, rat control quote, exterminator inspection Baltimore",
  openGraph: {
    title: "Free Pest Control Quote Baltimore | No-Obligation Exterminator Estimate",
    description:
      "Pest control quote from licensed Baltimore exterminators. Inspection, upfront pricing, same-day service. Text us.",
...
export default function QuoteRequestPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How much does pest control cost in Baltimore?",
        acceptedAnswer: {
          "@type": "Answer",
    ...
    <div className="text-white">
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10">
            ...
            <p className="mt-4 text-lg text-zinc-300">
              The Baltimore Exterminator serves the entire Baltimore metro area, Howard County, Long
              Island, and Anne Arundel County County. Whether you are dealing with{" "}
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-zinc-700 bg-[#1A1A1A] p-6">
              ...
              <p className="mt-2 text-sm text-zinc-300">
                ...
                We cover all of Baltimore, Howard County, Baltimore County, and Anne Arundel County County.
              </p>
            </div>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-zinc-400">
            Fill out the form below and a licensed Baltimore exterminator will contact you
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-zinc-300">
            Many Baltimore residents and business owners attempt to handle pest problems
          ...
          <div className="mt-10 space-y-8">
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                control quote from The Baltimore Exterminator. The inspection is included in the $199/hr rate. The
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-zinc-300">
            At The Baltimore Exterminator, we believe in complete pricing transparency.
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-zinc-300">
            ...
            ranges for our most popular exterminator services in the Baltimore metro area.
          ...
          <p className="mt-8 text-zinc-400">
            These are estimated ranges based on typical Baltimore pest control jobs.
          ...
          <div className="mt-6">
            <p className="text-zinc-400">
              ...
              to see everything our Baltimore exterminators can treat.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { name: "Maria T.", area: "Roland Park", text: "I texted them about a cockroach problem in my apartment and within 10 minutes I had a response. The exterminator came the next morning, did a thorough inspection, and gave me a clear quote with no pressure. Treatment started that same day. Pest control pricing was very fair — much less than I expected." },
              { name: "David R.", area: "Fells Point", text: "After finding bed bug bites, I panicked and called three different exterminators. The Baltimore Exterminator was the only one who offered an inspection before quoting. Their heat treatment quote was competitive and they explained every step of the process. Truly professional pest control service." },
              { name: "Jennifer K.", area: "Towson", text: "We needed a termite inspection for our home purchase. The exterminator was incredibly thorough — spent over an hour inspecting the foundation, crawl space, and all wood contact areas. The detailed report helped us negotiate with the seller. Highly recommend their pest control team." },
              { name: "Marcus L.", area: "Highlandtown", text: "Restaurant owner here. Getting a pest control quote from The Baltimore Exterminator was refreshingly straightforward. They walked through my entire kitchen, identified potential problem areas, and put together a maintenance plan that keeps us DOH-compliant. No surprises on the bill, ever." },
              { name: "Sarah W.", area: "Canton", text: "Mice in my rowhome basement were driving me crazy. I submitted a quote request online at midnight and had a response by 8am. The exterminator came that afternoon, found where they were getting in, sealed everything up, and set traps. Problem solved within a week. $199/hr was a great deal." },
              { name: "Tom H.", area: "Catonsville", text: "Raccoons in our attic were keeping the whole family up at night. The wildlife control specialist they sent was knowledgeable and humane. The quote was transparent and they explained exactly what the removal process involved. Excellent pest control company — we use them for annual maintenance now." },
            ].map((review) => (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                Many pest control companies in Baltimore provide vague estimates over the phone, then surprise customers with higher prices once the technician arrives. At The Baltimore Exterminator, we believe in complete transparency. Our quote process starts with a thorough on-site inspection by a state-licensed exterminator who identifies the exact pest species, assesses the severity of the infestation, locates entry points and nesting sites, and evaluates property-specific factors that affect treatment. Only then do we provide a detailed written quote that includes the treatment plan, products to be used, number of visits, preparation requirements, safety precautions, and total cost. No hidden fees. No surprise charges. No pressure to buy services you don&apos;t need.
              </p>
              <p>
