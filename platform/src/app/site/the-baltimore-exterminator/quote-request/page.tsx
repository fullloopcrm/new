        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { name: "Marcus L.", area: "Astoria", text: "Restaurant owner here. Getting a pest control quote from The Baltimore Exterminator was refreshingly straightforward. They walked through my entire kitchen, identified potential problem areas, and put together a maintenance plan that keeps us DOH-compliant. No surprises on the bill, ever." },
