    ...
    <div className="text-white">
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-3xl text-zinc-400">
            Every {nameLower} service from The Baltimore Exterminator includes a comprehensive treatment
            package performed by a licensed pest control technician. Here is what you get when you
            book {nameLower} with us across the entire Baltimore metro area.
          </p>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-3xl text-zinc-400">
            ...
            in Baltimore, Howard County, Baltimore County, and Anne Arundel County County. Each area has unique pest
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-3xl text-zinc-400">
            Common questions our licensed exterminators receive about {nameLower} in Baltimore,
        ...
        <section className="bg-[#0A0A0A] py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-2 max-w-3xl text-sm text-zinc-400">
              Dealing with other {service.category.toLowerCase()} pests? Our licensed Baltimore exterminators also
      ...
      {crossCategoryServices.length > 0 && (
        <section className="bg-[#2A2A2A] py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-2 max-w-3xl text-sm text-zinc-400">
              The Baltimore Exterminator offers 30+ professional pest control and extermination services beyond
