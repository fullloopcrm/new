...
import { PHONE, SITE_NAME, EMAIL, ADDRESS } from "@/app/site/the-baltimore-exterminator/_lib/seo";
import { getCategories, getRegions } from "@/app/site/the-baltimore-exterminator/_lib/data";
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <span className="text-xl font-bold text-white">
              The<span className="text-green-500">Baltimore</span>Exterminator
            </span>
            <p className="mt-3 text-sm leading-6 text-zinc-500">
              Professional pest control and extermination services across the entire Baltimore metro area. Licensed, insured, and trusted
