...
import { PHONE } from "@/app/site/the-baltimore-exterminator/_lib/seo";
...
const defaults: Record<CTAVariant, { title: string; subtitle: string }> = {
  ...
  preFaq: {
    title: "Licensed. Insured. Trusted by Thousands of Baltimore Properties.",
    ...
    return (
      <div className="mt-8">
        <div className="mb-5 space-y-1.5 text-sm text-zinc-400">
          ...
          <p>&#10003; <strong className="text-zinc-200">Licensed &amp; insured</strong> Maryland Department of Agriculture exterminators</p>
        </div>
