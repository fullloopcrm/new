...
import { track as localTrack, getSessionId } from "@/app/site/the-baltimore-exterminator/_lib/tracker";
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div>
          ...
          <select id="app-license" name="license" required className={selectClass}>
            ...
            <option value="nys-dec-7a">Yes — Maryland Department of Agriculture Category 7A</option>
            <option value="nys-dec-other">Yes — other state certification</option>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Your pest control experience, certifications, what kind of role you're looking for, and why you want to join The Baltimore Exterminator..."
        />
      </div>
