...
import { getAllServices, getServicesByCategory } from "@/app/site/the-baltimore-exterminator/_lib/data";
...
export const metadata: Metadata = {
  title:
    "Pest Control Pricing Baltimore | Exterminator Costs at $199/hr | No Hidden Fees",
  description:
    "See transparent pest control pricing and exterminator rates for the entire Baltimore metro area. Cockroach extermination from $150, bed bug treatment from $300, rat control from $200. Self-book online & save $20. Inspections, upfront written quotes, no hidden fees. Licensed & insured.",
  keywords:
    "pest control pricing Baltimore, exterminator cost Baltimore, how much does exterminator cost, bed bug treatment cost Baltimore, cockroach extermination price, rat exterminator cost, termite treatment pricing, commercial pest control pricing",
  openGraph: {
    title: "Pest Control Pricing Baltimore | Exterminator Costs at $199/hr | No Hidden Fees",
    description:
      "Transparent pest control pricing for Baltimore. Cockroach treatment from $150, bed bugs from $300, rats from $200. Self-book online & save $20. Inspections, no hidden fees.",
...
const pricingFaqs = [
  {
    ...
    a: "We charge one flat rate: $199/hr, 1-hour minimum, no matter the pest type, severity, property size, or treatment method — residential or commercial. Every pest control engagement at The Baltimore Exterminator begins with an inspection and a written estimate, so you always know exactly what you will pay before any work begins.",
  },
  {
  ...
  },
  {
    ...
    a: "In most cases, standard homeowner's insurance policies do not cover pest control or extermination costs, because pest infestations are generally classified as a maintenance issue rather than sudden damage. However, some commercial insurance policies include coverage for pest-related structural damage, particularly from termites and wood-destroying insects. In Baltimore rental apartments, landlords are legally required to provide and pay for pest control under the Baltimore Housing Maintenance Code. If you are a renter dealing with a pest problem, your landlord is typically responsible for the cost of extermination. The Baltimore Exterminator can provide documentation to support insurance claims or landlord reimbursement requests.",
  },
  {
    q: "What is included in the price of a pest control treatment?",
    a: "Every pest control treatment from The Baltimore Exterminator includes a comprehensive package: a thorough property inspection to identify pest species and entry points, a customized treatment plan using EPA-approved products, the complete treatment application performed by a licensed exterminator, at least one follow-up inspection within two to four weeks to verify results, re-treatment at no additional charge if needed, detailed prevention recommendations, and our satisfaction guarantee. If pests return between scheduled treatments, we come back and treat again at no extra cost. When comparing exterminator pricing, make sure you are comparing total packages, not just the headline number.",
  },
  {
    ...
    <div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-zinc-300">
              ...
              , we believe every homeowner and business owner in Baltimore
              ...
              <Link
                ...
                className="text-green-400 hover:text-green-300"
              >
                Baltimore, NJ, Baltimore County &amp; Anne Arundel County
              </Link>
            ...
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              ...
              confident that our pricing delivers the best value in the Baltimore metro
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: "Our pest control pricing includes a satisfaction guarantee that we take extremely seriously. If pests return between your scheduled treatments, we come back and re-treat your property at absolutely no additional charge. This is not a marketing gimmick or a promise with fine-print exceptions. It is our standard operating procedure on every residential and commercial pest control engagement. We stand behind every dollar you spend with us because our business depends on delivering lasting results, not on collecting fees for repeated ineffective treatments. Check our customer reviews to see how this guarantee works in practice across hundreds of Baltimore properties.",
              },
            ].map((item) => (
              <div
                key={item.title}
          ...
          <p className="mt-10 max-w-4xl text-zinc-300 leading-7">
            ...
            Baltimore homeowners and businesses. Nobody budgets for a{" "}
            <Link
              href="/bed-bug-treatment"
              className="text-green-400 hover:text-green-300"
            >
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            ...
            ranges for the entire Baltimore metro area, including Baltimore, Baltimore,
            Baltimore, the Baltimore, Baltimore, Northern Howard County, Baltimore County,
            and Anne Arundel County County. These ranges represent typical pricing for
                ...
                <div key={category}>
                  ...
                  <p className="mb-6 text-sm text-zinc-400">
                    {category === "Common Pests" &&
                      "The most frequently encountered pest control needs across Baltimore apartments, homes, and businesses. These pests thrive in the city's dense urban environment and require professional exterminator treatment for lasting elimination."}
                    {category === "Rodents" &&
                      "Rodent extermination and control services for rats, mice, and preventive rodent proofing. Baltimore's rodent population is one of the largest in the world, making professional exterminator intervention essential for effective control."}
                    {category === "Wood-Destroying Insects" &&
                      "Specialized pest control for termites and carpenter ants that can cause significant structural damage to Baltimore brownstones, townhouses, and commercial buildings if left untreated."}
                    ...
                    {category === "Commercial Services" &&
                      "Comprehensive commercial pest control and restaurant pest management programs designed for Baltimore businesses. Includes DOH-compliant documentation and flexible scheduling around business operations."}
                    {category === "General Services" &&
                      "Broad-spectrum pest control and emergency exterminator services for residential and commercial properties across the Baltimore metro area."}
                  </p>
          ...
          <p className="mt-12 text-sm text-zinc-500 max-w-3xl">
            * All prices are estimates based on typical pest control jobs in the
            Baltimore metro area. Actual exterminator costs depend on property size,
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            ...
            decisions when choosing an exterminator. Baltimore pest control costs are
            ...
            will pay for exterminator service in the Baltimore metro area:
          </p>
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            ...
            exterminator service for your situation. The Baltimore Exterminator serves
            ...
            clients across the entire Baltimore metro area, including all five
            neighborhoods, Northern Howard County, Baltimore County, and Anne Arundel County County.
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-zinc-700 bg-zinc-800/50 p-8">
              ...
              <div className="mt-6 space-y-4 text-sm leading-6 text-zinc-300">
                ...
                <p>
                  Baltimore apartments, brownstones, townhouses, and single-family
            ...
            <div className="rounded-xl border border-green-700 bg-zinc-800/50 p-8">
              ...
              <div className="mt-6 space-y-4 text-sm leading-6 text-zinc-300">
                ...
                <p>
                  ...
                  service to maintain Baltimore Department of Health compliance. Retail
          ...
          <div className="mt-10 max-w-4xl space-y-4 text-zinc-300 leading-7">
            <p>
              ...
              comprehensive documentation that satisfies Baltimore Department of Health
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            ...
            <div className="relative flex flex-col rounded-xl border-2 border-green-600 bg-zinc-800/50 p-8">
              ...
              <p className="mt-1 text-sm text-zinc-400">
                Ideal for most Baltimore apartments &amp; homes
              </p>
              <p className="mt-4 text-3xl font-extrabold text-green-500">
                $199/hr
                <span className="text-lg font-normal text-zinc-400">
          ...
          <div className="mt-10 max-w-4xl space-y-4 text-zinc-300 leading-7">
            <p>
              Pest control maintenance plans save Baltimore property owners an average
            ...
            <p>
              ...
              operationally essential. The Baltimore Department of Health requires
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            ...
            getting for your money. At The Baltimore Exterminator, every pest control
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2">
            {[
              ...
              },
              {
                ...
                desc: "Our licensed pest control technicians apply EPA-approved products using targeted methods that maximize effectiveness while minimizing exposure to your family, pets, employees, and the environment. We follow Integrated Pest Management (IPM) principles, combining chemical treatments with mechanical exclusion, sanitation recommendations, and habitat modification for long-lasting results. Every exterminator on our team holds Maryland Department of Agriculture Commercial Pesticide Applicator certifications, and wildlife control operators hold additional state Nuisance Wildlife Control licenses. You are getting trained, certified professionals on every job.",
              },
              {
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold sm:text-4xl">
            ...
            <span className="text-green-500">Pricing in Baltimore</span>
          </h2>
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            ...
            exterminator now, not next Tuesday. That is why The Baltimore Exterminator
            offers{" "}
            <Link
          ...
          <div className="mt-10 max-w-3xl rounded-xl border border-zinc-700 bg-zinc-800/50 p-8">
            ...
            <p className="mt-6 text-sm leading-6 text-zinc-400">
              ...
              hours within Baltimore and 3 to 6 hours across our full{" "}
              <Link
                href="/areas"
                className="text-green-400 hover:text-green-300"
              >
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            ...
            Baltimore property owner, which is why we offer a variety of payment
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-zinc-700 bg-zinc-800/50 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-400">
                In Baltimore, landlords are legally required to provide pest control
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-5 text-zinc-300 leading-7">
            <p>
              ...
              price is a mistake we see Baltimore property owners make repeatedly, and
            ...
            <p>
              ...
              We hear this story from new customers every single week. The Baltimore
            ...
            <ul className="space-y-3 pl-4">
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  Every exterminator on our team holds Maryland Department of Agriculture Commercial
                  Pesticide Applicator certifications. Wildlife operators hold
                  additional state Nuisance Wildlife Control licenses. You are
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  to see this guarantee in action across hundreds of Baltimore
                  properties.
                </span>
              </li>
              <li className="flex items-start gap-3">
            ...
            <p>
              ...
              choosing an exterminator in Baltimore. Visit our{" "}
              <Link
                href="/about"
                className="text-green-400 hover:text-green-300"
              >
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            We know that pest control costs are a common concern for Baltimore
          ...
          <p className="mt-10 max-w-4xl text-zinc-300 leading-7">
            ...
            <Link
              ...
              className="text-green-400 hover:text-green-300"
            >
              the entire Baltimore metro area, Northern Howard County, Baltimore County, and
