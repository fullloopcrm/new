...
import "./globals.css";
import Header from "@/app/site/the-baltimore-exterminator/_components/Header";
import Footer from "@/app/site/the-baltimore-exterminator/_components/Footer";
import Tracker from "@/app/site/the-baltimore-exterminator/_components/Tracker";
import { getOrganizationSchema, getWebsiteSchema, SITE_URL } from "@/app/site/the-baltimore-exterminator/_lib/seo";
...
export const metadata: Metadata = {
  title: {
    default: "The Baltimore Exterminator | Pest Control $199/hr | Self-Book & Save $20",
    template: "%s | The Baltimore Exterminator",
  },
  description:
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    siteName: "The Baltimore Exterminator",
  },
  twitter: {
    card: "summary_large_image",
    title: "The Baltimore Exterminator | Baltimore Pest Control | Self-Book & Save $20",
    description:
  ...
  return (
    <html lang="en">
      ...
      <body className={`${inter.variable} font-sans antialiased bg-[#0A0A0A] text-white`}>
        ...
        <ConsentBanner />
        <ClientErrorMonitor slug="the-baltimore-exterminator" />
        <TenantAnalyticsScript slug="the-baltimore-exterminator" />
      </body>
    </html>
  );
}
