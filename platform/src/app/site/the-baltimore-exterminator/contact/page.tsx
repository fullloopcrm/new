...
import { PHONE, EMAIL, ADDRESS, SITE_URL, getBreadcrumbSchema, getLocalBusinessSchemaGlobal } from "@/app/site/the-baltimore-exterminator/_lib/seo";
import { getAllServices, getAllNeighborhoods } from "@/app/site/the-baltimore-exterminator/_lib/data";

export const metadata: Metadata = {
  title: "Contact Baltimore Exterminator | Self-Book & Save $20",
  description:
    "Contact The Baltimore Exterminator for a pest control inspection and quote. Self-book online & save $20. Same-day exterminator service across the entire Baltimore metro area, and the surrounding suburbs. Licensed, insured, flat-rate pricing at $199/hr. We respond within minutes.",
  keywords:
    "contact exterminator Baltimore, book pest control online Baltimore, text exterminator, Baltimore pest control, book exterminator appointment, pest control near me, emergency exterminator contact",
  openGraph: {
    title: "Contact Baltimore Exterminator | Self-Book & Save $20",
    description:
      "Contact The Baltimore Exterminator. Self-book online & save $20. Inspection, same-day service, flat-rate pricing at $199/hr.",
...
export default function ContactPage() {
  ...
  const contactFaqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How quickly does The Baltimore Exterminator respond to contact requests?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "What is the fastest way to contact a pest control exterminator in Baltimore?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Does The Baltimore Exterminator offer pest control inspections?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. Every new client receives a no-obligation pest control inspection. Our licensed exterminator will assess your property, identify the pest species, determine the severity of the infestation, and provide an upfront quote with pricing $199/hr.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "What areas does The Baltimore Exterminator serve?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "We provide pest control and exterminator services across the entire Baltimore metro area (Baltimore City and Baltimore County), plus Howard County, Baltimore County, and Anne Arundel County County.",
        },
      },
    ],
  };
  ...
  return (
    <div className="text-white">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: safeJsonLd(contactFaqSchema) }} />
      ...
      <section className="bg-green-700 pb-20 pt-8">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-10 text-sm font-semibold uppercase tracking-[0.2em] text-green-200/80">
            Baltimore Pest Control Experts &middot; Licensed &amp; Insured &middot; Same-Day Service
          </p>
          <h1 className="mt-3 text-4xl font-extrabold tracking-tight sm:text-5xl">
            Contact Your{" "}
            <span className="text-green-200">Baltimore Exterminator</span> Today
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-green-100">
            ...
            preventive service &mdash; we&apos;re here. Inspections. Upfront pricing.
            No call centers, no runaround. When you contact The Baltimore Exterminator,
            you reach a licensed pest control professional who knows Baltimore
            inside and out.
          </p>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-green-100">
            ...
            before we even arrive. With pest control pricing $199/hr and
            same-day exterminator service available across the entire Baltimore metro area, there
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-green-100">
            ...
            and every other type of property in Baltimore, Howard County, Baltimore County, and
            Anne Arundel County. No matter the pest &mdash;{" "}
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            >
              ...
              <p className="mt-2 text-sm text-zinc-400">
                ...
                property. We&apos;ll provide an inspection and upfront quote.
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
            How to Reach Your Baltimore Exterminator
          </h2>
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            the ways you can get in touch with The Baltimore Exterminator, ranked by
            response speed.
          </p>
          ...
          <div className="mt-12 space-y-10">
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-300">
                  ...
                  schedule your pest control inspection. Text messages are monitored
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-green-400">Self-Book &mdash; Save $20</h3>
                <p className="mt-2 text-zinc-300">
                  ...
                  &mdash; and you save $20 off your quote for doing it. Tell us your
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-300">
                  ...
                  proposal before your inspection.
                </p>
              </div>
            </div>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            From the moment you reach out to The Baltimore Exterminator, our process is
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-300">
                  ...
                  exterminator appointments are available for most of Baltimore, and we offer
                  ...
                  Pest control pricing is a flat $199/hr, and we will provide your
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-300">
                  ...
                  Baltimore exterminator clients have their pest problem resolved in a single
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            with an active infestation that poses a health or safety risk, The Baltimore
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            clients ask most often about contacting The Baltimore Exterminator and
            scheduling service.
          </p>
          ...
          <div className="mt-12 space-y-8">
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                fastest in the Baltimore exterminator industry.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                situations across Baltimore, Howard County, Baltimore County, and Anne Arundel County. If
                ...
                is $199/hr with no extra charge for same-day scheduling.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                $199/hr depending on the service.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                especially for food service businesses facing Baltimore DOH regulations.
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                thousands of Baltimore properties.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                across the entire Baltimore metro area. Building-wide pest control contracts include
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            The Baltimore Exterminator provides professional pest control and exterminator
            services across a wide geographic area covering Baltimore and the
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 md:grid-cols-4">
            {["Baltimore", "Baltimore", "Baltimore", "Baltimore", "Baltimore", "Howard County", "Baltimore County", "Anne Arundel County"].map(
              (region) => (
          ...
          <p className="mt-8 text-zinc-300">
            ...
            <Link href="/cockroach-extermination" className="text-green-400 hover:text-green-300">
              cockroach exterminator in Baltimore
            </Link>, a{" "}
            <Link href="/bed-bug-treatment" className="text-green-400 hover:text-green-300">
              bed bug treatment in Baltimore
            </Link>, a{" "}
            <Link href="/rat-extermination" className="text-green-400 hover:text-green-300">
              rat exterminator in Baltimore
            </Link>, or{" "}
            <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">
              termite treatment in Anne Arundel County
            </Link>{" "}
      ...
      {/* ───────── WHY Baltimore TRUSTS US ───────── */}
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
            Why Baltimore Property Owners Trust <span className="text-green-500">The Baltimore Exterminator</span>
          </h2>
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                Choosing the right pest control company is one of the most important decisions a property owner or tenant can make. The wrong exterminator wastes your time and money with ineffective treatments that allow infestations to grow worse. At The Baltimore Exterminator, we&apos;ve built our reputation on doing the job right the first time — with licensed technicians, EPA-approved products, transparent pricing at a flat $199/hr, and a satisfaction guarantee that means we come back at no charge if pests return between treatments.
              </p>
              <p>
                Every exterminator on our team holds an active Maryland Department of Agriculture Commercial Pesticide Applicator license and undergoes continuous training in the latest pest control techniques, product innovations, and safety protocols. Our wildlife control specialists carry additional Maryland Department of Agriculture Nuisance Wildlife Control licenses for <Link href="/raccoon-removal" className="text-green-400 hover:text-green-300">raccoon removal</Link>, <Link href="/squirrel-removal" className="text-green-400 hover:text-green-300">squirrel removal</Link>, <Link href="/pigeon-control" className="text-green-400 hover:text-green-300">pigeon control</Link>, and <Link href="/bat-removal" className="text-green-400 hover:text-green-300">bat removal</Link>. We maintain comprehensive general liability insurance on every job and provide documentation upon request for property managers, co-op boards, and commercial tenants.
              </p>
            </div>
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                Our pest control services cover the full spectrum of urban and suburban pest challenges — from <Link href="/cockroach-extermination" className="text-green-400 hover:text-green-300">cockroach extermination</Link> in Baltimore high-rises to <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">termite treatment</Link> for Baltimore County homes to <Link href="/restaurant-pest-control" className="text-green-400 hover:text-green-300">restaurant pest control</Link> for Baltimore&apos;s thousands of food service establishments. Whether you&apos;re dealing with a minor ant problem or a major rat infestation, our exterminators bring the expertise and equipment to resolve it completely.
              </p>
              <p>
                We&apos;re proud to maintain a 4.9-star rating across thousands of completed pest control jobs. Read our <Link href="/reviews" className="text-green-400 hover:text-green-300">customer reviews</Link> to see what real Baltimore homeowners, tenants, and business operators say about working with us. Check our <Link href="/pricing" className="text-green-400 hover:text-green-300">transparent pricing page</Link> to see what every service costs. And when you&apos;re ready, <a href={`sms:${phonePlain}`} className="text-green-400 hover:text-green-300">text us</a> — it&apos;s the fastest way to get a response. We typically reply within minutes during business hours. Your pest problem ends here.
              </p>
            </div>
          </div>
        </div>
