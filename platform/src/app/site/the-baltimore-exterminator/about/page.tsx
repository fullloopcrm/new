...
import { getAllServices, getAllNeighborhoods, getRegions } from "@/app/site/the-baltimore-exterminator/_lib/data";
...
import { PHONE, SITE_URL, EMAIL, ADDRESS, getBreadcrumbSchema, getLocalBusinessSchemaGlobal } from "@/app/site/the-baltimore-exterminator/_lib/seo";

export const metadata: Metadata = {
  title: "About The Baltimore Exterminator | Licensed & Insured Baltimore Pest Control Company",
  description:
    "Learn about The Baltimore Exterminator providing licensed, insured pest control and extermination across the entire Baltimore metro area, and the surrounding suburbs. 30+ services, 280+ neighborhoods, flat-rate pricing at $199/hr. Meet our team, our approach, and why thousands of Baltimore residents trust us. Text us.",
  keywords:
    "about Baltimore exterminator, Baltimore pest control company, licensed exterminator Baltimore, insured pest control, Consortium Baltimore, pest control team Baltimore",
  openGraph: {
    title: "About The Baltimore Exterminator | Licensed & Insured Baltimore Pest Control Company",
    description:
      "Licensed, insured pest control across Baltimore. 30+ services, 280+ neighborhoods, flat-rate pricing at $199/hr. Text us.",
    url: `${SITE_URL}/about`,
  },
  alternates: {
    ...
    <div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-3xl">
            ...
            <h1 className="mt-3 text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl">
              Baltimore&apos;s Pests Don&apos;t Stand
              <br />
              <span className="text-[#EFF70A]">a Chance.</span>
            </h1>
            <p className="mt-6 text-lg leading-8 text-zinc-300">
              The Baltimore Exterminator is a{" "}
              <a
              ...
              in Baltimore, NJ, Baltimore County &amp; Anne Arundel County.
            </p>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              ...
              Whether you own a brownstone in Baltimore, manage a high-rise in Baltimore, or run a restaurant in Baltimore, our exterminator team
              is ready to protect your property with affordable, professional pest control at a flat $199/hr.
            </p>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              We believe that every Baltimore resident deserves to live and work in a pest-free environment. That is why we have built the most comprehensive
              pest control network in the Baltimore metro area, the entire Baltimore metro area and surrounding suburbs.
              ...
              space, The Baltimore Exterminator is the name you can trust to eliminate them quickly, safely, and permanently.
            </p>
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              The Baltimore Exterminator was founded with a simple but powerful mission: to provide affordable, professional pest control
              to every home and business in the Baltimore metropolitan area. We recognized that too many property owners were
            ...
            <p>
              ...
              company, The Baltimore Exterminator benefits from a deep bench of service industry expertise. Consortium Baltimore has spent years
              building and operating service businesses across the Baltimore metro area, and that experience informs everything we do
              ...
              The Baltimore Exterminator, you will speak with a real person, get a straightforward quote, and have a licensed pest control
              technician at your door &mdash; often the same day.
            </p>
            <p>
              What started as a small team of dedicated exterminators serving Baltimore and Baltimore has grown into the most comprehensive
              pest control network in the Baltimore metro area. Today, we provide{" "}
              ...
              the entire Baltimore metro area and surrounding suburbs. We have assembled a roster of
              highly trained, licensed exterminators who specialize in every type of urban pest &mdash; from cockroaches, bed bugs,
              and rodents to termites, wildlife, and commercial-grade infestations. Every member of our pest control team is Maryland Department of Agriculture
            ...
            <p>
              ...
              business, and we are proud of the trust that the Baltimore community has placed in our pest control company.
            </p>
            <p>
              Looking ahead, our mission remains the same: to be the most trusted, most affordable, and most effective pest control
              provider in the Baltimore metro area. We are continually investing in new training, new technology, and new service
              areas to ensure that no matter where you are in the Baltimore metro region, a licensed exterminator from The Baltimore Exterminator
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: "Licensed & Certified", desc: "Every technician holds Maryland Certified Pesticide Applicator licenses. Wildlife operators hold additional state Nuisance Wildlife Control licenses." },
          ...
          <div className="mt-16 max-w-4xl space-y-8 text-lg leading-8 text-zinc-300">
            <div>
              ...
              <p>
                ...
                owners. Every exterminator on our team holds a valid Maryland Department of Agriculture Certified
                ...
                biology, and environmental regulations. Our wildlife control specialists carry additional state Nuisance Wildlife Control Operator
                permits, authorizing them to handle raccoons, squirrels, opossums, and other wildlife that frequently invade Baltimore properties.
                ...
                and continuing education credits. When you hire The Baltimore Exterminator, you are hiring a pest control company that takes licensing
            ...
            <div>
              ...
              <p>
                ...
                a single accident could leave you responsible for costly repairs or medical bills. The Baltimore Exterminator carries comprehensive
            ...
            <div>
              ...
              <p>
                ...
                never discussed. At The Baltimore Exterminator, we do things differently. Every pest control job begins with an inspection, during
            ...
            <div>
              ...
              <p>
                ...
                &mdash; these situations demand immediate attention. The Baltimore Exterminator offers same-day and after-hours emergency pest control
                ...
                including the entire Baltimore metro area, Northern Howard County, Baltimore County, and Anne Arundel County.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                EPA-approved and applied according to strict manufacturer guidelines and Maryland state regulations. We employ targeted
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              The backbone of The Baltimore Exterminator is our team of licensed, experienced pest control professionals. Every exterminator
              on our roster has been carefully vetted, trained, and certified to handle the full spectrum of pest challenges that Baltimore
              City properties face. Our hiring process goes beyond simply checking for a valid Maryland Department of Agriculture Commercial Pesticide Applicator license.
            ...
            <p>
              ...
              continuous learning ensures that when a Baltimore Exterminator technician arrives at your property, they bring the most current
            ...
            <p>
              ...
              and{" "}
              <Link href="/mouse-extermination" className="text-green-400 hover:text-green-300">mouse extermination</Link>{" "}
              with a focus on exclusion and long-term prevention, not just trapping. And our wildlife specialists hold state Nuisance Wildlife
              Control Operator licenses, enabling them to legally and humanely remove raccoons, squirrels, birds, and other wildlife from
              residential and commercial properties throughout the Baltimore metro area.
            </p>
            <p>
              For our{" "}
              <Link href="/commercial-pest-control" className="text-green-400 hover:text-green-300">commercial pest control</Link>{" "}
              ...
              program, in particular, is designed to meet the stringent requirements of Baltimore Department of Health inspections, helping restaurant
            ...
            <p>
              ...
              to learn about current opportunities. The Baltimore Exterminator offers competitive compensation, ongoing professional development,
              and the chance to be part of the most comprehensive pest control network in the Baltimore metro area.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              At The Baltimore Exterminator, we follow an Integrated Pest Management (IPM) methodology that represents the gold standard
            ...
            <p>
              ...
              in the first place. At The Baltimore Exterminator, we take a different approach. Our exterminators are trained to identify
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              ...
              property is located within the Baltimore metro area, a licensed exterminator from The Baltimore Exterminator can reach you quickly,
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              ...
              corporate office tower. Every property owner in the Baltimore metro area deserves professional pest control, and we are
            ...
            <p>
              ...
              especially for families and small business owners already dealing with Baltimore&apos;s cost of living. That is why
            ...
            <p>
              ...
              the impersonal, in-and-out approach that characterizes too many pest control companies in the Baltimore market.
            </p>
            <p>
              ...
              prevention, or anything related to keeping your Baltimore property pest-free, do not hesitate to reach out to{" "}
              <a href={`sms:${phonePlain}`} className="text-green-400 hover:text-green-300">us</a>{" "}
              or{" "}
              <a href={`mailto:${EMAIL}`} className="text-green-400 hover:text-green-300">{EMAIL}</a>.
            </p>
