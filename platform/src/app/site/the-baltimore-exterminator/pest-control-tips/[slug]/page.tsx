...
import { getAllTips, getTipBySlug } from "@/app/site/the-baltimore-exterminator/_data/tips";
import {
  PHONE,
  SITE_URL,
  SITE_NAME,
      ...
      <section className="bg-[#0A0A0A] pb-12 pt-8">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex items-center gap-4 text-sm text-zinc-500">
            <span>By <strong className="text-zinc-300">The Baltimore Exterminator Team</strong></span>
            <span>&bull;</span>
            <span>State Licensed Pest Control Technicians</span>
          </div>
        </div>
      </section>
