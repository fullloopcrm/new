...
import { getJobDates } from "@/app/site/the-baltimore-exterminator/_lib/jobDates";
...
export default async function NeighborhoodCareersPage({ params }: PageProps) {
  ...
  const jobPostingSchema = {
    ...
    description: `Licensed pest control technician / exterminator serving ${location}. Perform residential and commercial pest control throughout ${neighborhood.name} and nearby ${neighborhood.region} neighborhoods — inspections and EPA-approved treatments for cockroaches, bed bugs, mice, rats, ants, and termites common to ${neighborhood.name} properties. Full-time, $45,000–$85,000/yr, benefits, and state certification training sponsorship. Join ${SITE_NAME}.`,
    datePosted,
    validThrough,
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            ...
            <p>
              ...
              Baltimore pest issues like cockroach infestations in apartment buildings,
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: `Exterminators who excel in ${neighborhood.name} have clear advancement opportunities to lead exterminator, field supervisor, and management roles within The Baltimore Exterminator's ${neighborhood.region} operation.`,
              },
              {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            <p>
              ...
              {neighborhood.name} with {SITE_NAME}, you will need a Maryland Department of Agriculture
            ...
            <p>
              ...
              {neighborhood.name}, a Maryland Department of Agriculture Nuisance Wildlife Control Operator
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            to see all available exterminator jobs across the Baltimore metro area.
          </p>
          ...
          <div className="mt-12 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            ...
            <p>
              ...
              professionals in the Baltimore metro area. Our dispatchers work with
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            ...
            <p>
              ...
              of the strongest and most stable job markets in the entire Baltimore
