...
import { PHONE, SITE_URL, SITE_NAME, getBreadcrumbSchema, getFAQPageSchema, getLocalBusinessSchemaGlobal } from "@/app/site/the-baltimore-exterminator/_lib/seo";

export const metadata: Metadata = {
  title: "Book Baltimore Exterminator Today | Save $20 Booking Online",
  description:
    "Book a licensed Baltimore exterminator online and save $20 — the fastest way to get service. Same-day and next-day pest control appointments across the entire Baltimore metro area, and the surrounding suburbs. We respond within 10-30 minutes, schedule as soon as tomorrow, and your certified technician arrives on time within a 1-hour window. Inspection, upfront flat-rate pricing at $199/hr.",
  keywords:
    "book exterminator Baltimore, schedule pest control appointment, same-day exterminator Baltimore, next-day pest control, book bed bug treatment, schedule cockroach extermination, Baltimore pest control appointment, emergency exterminator booking, hire exterminator today",
  openGraph: {
    title: "Book Baltimore Exterminator Today | Save $20 Booking Online",
    description:
      "Book a licensed Baltimore exterminator online and save $20. We respond in 10-30 min, schedule next-day appointments, and your technician arrives on time within a 1-hour window.",
...
const faqs = [
  ...
  {
    q: "How much does it cost to book an exterminator in Baltimore?",
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-zinc-300">
              Schedule a licensed exterminator for your home or business in Baltimore, Howard County,
              Baltimore County, or Anne Arundel County. Fill out the booking form below and our pest control team
          ...
          <div className="mt-10 rounded-xl border border-zinc-800 bg-[#141414] p-6 sm:p-8">
            ...
            <p className="mb-6 text-sm text-zinc-400">
              Tell us about your pest problem and we&apos;ll match you with a certified Baltimore pest control
      ...
      <section className="bg-[#2A2A2A] py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-zinc-400">
            ...
            hire a licensed Baltimore exterminator through The Baltimore Exterminator.
          </p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              ...
              <p className="mt-1 text-sm text-zinc-400">
                ...
                pest control technician to your location. We serve 280+ neighborhoods across the entire Baltimore metro area &mdash; the closer we can match you, the sooner
      ...
      <section className="bg-[#2A2A2A] py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-zinc-400">
            ...
            The Baltimore Exterminator &mdash; from response times and scheduling to pricing
      ...
      <section className="bg-[#0A0A0A] py-16">
        <div className="mx-auto max-w-xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold sm:text-3xl">
            Ready to Book Your{" "}
            <span className="text-green-400">Baltimore Exterminator</span>?
          </h2>
