/**
 * Rich sitemap for wepayyoujunkremoval.com (slug we-pay-you-junk).
 *
 ...
 * /site/we-pay-you-junk/sitemap.xml; middleware rewrites the apex /sitemap.xml
...
const STATIC_PATHS: TowStaticPath[] = [
  ...
  { path: '/apply-for-junk-removal-job', priority: 0.7, changeFrequency: 'weekly' },
  { path: '/blog', priority: 0.6, changeFrequency: 'weekly' },
  { path: '/book-junk-removal-service-today', priority: 0.9, changeFrequency: 'weekly' },
  { path: '/careers', priority: 0.7, changeFrequency: 'weekly' },
  { path: '/commercial', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/contact-we-pay-you-junk-removal-today', priority: 0.6, changeFrequency: 'monthly' },
