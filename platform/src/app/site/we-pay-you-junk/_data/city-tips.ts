  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          `Preparation is the difference between a $200 junk removal and a $600 one. The more organized you are before our ${cityName} crew arrives, the faster they work — and since you're paying starting at $200/hr, faster means cheaper. Here's how ${cityName} residents can prepare for a smooth, cost-effective cleanout.`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Despite these challenges, ${cityName} residents consistently save 25-40% compared to traditional flat-rate junk removal. The combination of our starting at $200/hr rate (vs. $300-$800 flat fees from competitors) and the 50% Resale Credit (when applicable) on valuable items makes our service the clear winner in the ${cityName} market — challenges and all.`,
        ],
      },
      {
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          `We Pay You Junk Removal exists because this model is fundamentally unfair to ${cityName} residents. We charge a transparent hourly rate — $200/hr for a 1-person crew, $300/hr for a 2-person crew, plus $100/hr for each additional person, same-day available. You watch the clock, there is nothing to estimate or manipulate. We appraise your valuable items in front of you with real comparable sales data. And we credit you 50% (when applicable) of what they are worth. The same items that other ${cityName} companies profit from — we split the value with you. No trick, no fine print, no catch.`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `With our service in ${cityName}, a 1-person crew picks up furniture in under an hour for $200. If that furniture has $400 in resale value, you get $200 credit — your net cost is zero, and we might pay you. Traditional furniture removal in ${cityName} costs $150-$300 per piece with zero return. The economics are not even close.`,
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `We Pay You in ${cityName}: $200-$300/hr depending on crew size. Dump fees included. 50% resale credit (when applicable) on valuable items. A 2-hour job at $300/hr ($600) with $300 in resale credits = you pay $300. Same stuff, same volume, different model. Your savings: $100-$600 depending on the job. And on big cleanouts, you might walk away with a check.`,
        ],
      },
      {
