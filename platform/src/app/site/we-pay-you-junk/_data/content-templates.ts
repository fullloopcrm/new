...
export function statePageContent(stateName: string, stateAbbr: string, cities: { name: string; slug: string }[]) {
  ...
  return {
    ...
    metaDescription: `Professional junk removal in ${cities.length}+ cities across ${stateName}. starting at $200/hr with dump fees included. We credit you 50% (when applicable) of resale value (when applicable) on items worth something. Same-day available.`,
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          `The process is simple no matter where you are in ${stateName}. Call us at ${PHONE} and describe what you need removed. We'll confirm pricing based on the volume and type of items. You pick your crew size — 1-person at $200/hr, 2-person at $300/hr, or emergency same-day at +$100/hr per additional person — and we schedule a time that works for you. Same-day appointments are available in most ${stateAbbr} cities when you call before noon. We operate 7AM-8PM daily, 7 days a week including weekends and holidays.`,
      ...
      },
      {
        ...
        paragraphs: [
          `Our pricing is the same across all ${cities.length} cities in ${stateName}: $200/hr for a 1-person crew, $300/hr for a 2-person crew, and +$100/hr per additional person for emergency same-day. Dump fees, transfer station costs, and disposal charges are all included (an industry first). There are no hidden fees, no volume-based pricing, and no surge pricing. The rate you're quoted is the rate you pay.`,
          `The 1-person crew at $200/hr is ideal for small jobs — a few pieces of furniture, some electronics, a light cleanout, or single-item pickups like a mattress or refrigerator. Most 1-person jobs in ${stateName} take 1-2 hours. The 2-person crew at $300/hr is our most popular option for ${stateName} customers — it handles full garage cleanouts, basement clearing, furniture removal, appliance hauling, estate work, and anything heavy. Most 2-person jobs take 1.5-3 hours. Emergency same-day at +$100/hr per additional person guarantees arrival within 2 hours for last-minute deadlines.`,
...
export function cityPageContent(cityName: string, stateName: string, stateAbbr: string, stateSlug: string, otherCities: { name: string; slug: string }[]) {
  ...
  return {
    ...
    metaDescription: `Professional junk removal in ${cityName}, ${stateAbbr}. starting at $200/hr with dump fees included. We credit you 50% (when applicable) of resale value (when applicable). Same-day available. Call ${PHONE}.`,
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Step 2: Pick your crew — 1-person crew at $200/hr for small jobs, 2-person crew at $300/hr for most residential work, or emergency same-day at +$100/hr per additional person for urgent deadlines. Schedule a time that works for you. Same-day slots are available in ${cityName} for calls placed before noon. We offer 2-hour arrival windows so you're not stuck waiting all day.`,
      ...
      },
      {
        ...
        paragraphs: [
          `Pricing in ${cityName} is straightforward: $200/hr for 1-person crew, $300/hr for 2-person crew, +$100/hr per additional person emergency same-day. All dump fees included (an industry first). All valuable items credited at 50% resale value (when applicable). No hidden fees, no volume pricing, no minimum charges, no contracts.`,
          ...
          `For smaller jobs in ${cityName} — a single item pickup, a few boxes, light furniture — a 1-person crew at $200/hr usually handles it in under an hour, putting your total at $100 before any credits. For full cleanouts and heavy items, the 2-person crew at $300/hr is our most popular option. For large-scale projects — full estate clearing, warehouse jobs, multi-day office cleanouts — the 2-person crew offers the best value per hour of work completed.`,
        ],
      },
      {
...
export function cityServicePageContent(cityName: string, stateName: string, stateAbbr: string, service: Service) {
  ...
  return {
    ...
    metaDescription: `${service.title} in ${cityName}, ${stateAbbr}. starting at $200/hr, dump fees included. 50% Resale Credit (when applicable) on valuable items. Same-day available. Call ${PHONE}.`,
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Step 2 — Choose Your Crew: Pick the crew size that fits your ${svcLower} job. Our crew handles light ${svcLower} work — a few items, small spaces, simple access. Our crew starting at $200/hr is our most popular for ${svcLower} in ${cityName} — it handles most residential jobs efficiently with one person loading while the other sorts and appraises. Our crew starting at $200/hr tackles large ${svcLower} projects fast — full property clears, heavy items, and time-sensitive work.`,
      ...
      },
      {
        ...
        paragraphs: [
          `${service.title} pricing in ${cityName} follows our standard transparent structure: $200/hr for 1-person crew, $300/hr for 2-person crew, +$100/hr per additional person emergency same-day. All dump fees, disposal costs, and transfer station fees are included (an industry first). All items with resale value are credited to you at 50% of fair market value (when applicable). There are no hidden charges, minimums, or volume-based fees.`,
