...
import { CUSTOMER_TYPES } from "@/app/site/we-pay-you-junk/_data/customer-types";
...
import { customerCityContent } from "@/app/site/we-pay-you-junk/_data/customer-content";
...
export async function generateMetadata({ params }: { params: Promise<{ type: string; state: string; city: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `${ct.name} junk removal in ${result.city.name}, ${result.state.abbreviation}. ${ct.description} Starting at $200/hr.`,
