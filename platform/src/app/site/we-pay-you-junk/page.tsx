...
import {
  ...
  TOP_CITIES,
  STATES,
} from "@/app/site/we-pay-you-junk/_data/content";
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mx-auto mt-8 max-w-3xl space-y-5 text-base leading-relaxed text-slate-700">
            ...
            <p>
              <strong>Our People:</strong> Your local crew is an independent operator partner who runs junk removal in your area under the We Pay You Junk Removal brand (see our <Link href="/careers" className="text-teal-600 underline">partner opportunities</Link> or <Link href="/apply-for-junk-removal-job" className="text-teal-600 underline">apply today</Link>). Partners bring their own truck and own their territory, so they have real skin in the game — they show up on time, appraise fairly, and treat every job like the business it is. When you see the same faces on repeat jobs, you know they know what they&apos;re doing.
            </p>
            <p>
