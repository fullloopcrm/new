...
import { SERVICE_ZONES } from '@/app/site/wash-and-fold-hoboken/_lib/service-zones'
import dynamic from 'next/dynamic'
const CoverageMap = dynamic(() => import('@/app/site/wash-and-fold-hoboken/_components/CoverageMap'), { ssr: false })
