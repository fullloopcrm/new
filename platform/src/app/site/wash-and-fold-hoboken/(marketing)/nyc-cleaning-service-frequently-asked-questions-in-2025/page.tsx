...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, howToBookSchema, breadcrumbSchema, faqSchema } from '@/app/site/wash-and-fold-hoboken/_lib/seo/schema'
...
const schedulingFAQs = [
  { question: 'How do I book a cleaning?', answer: 'Text or call (212) 202-8400. We typically schedule within 24–48 hours. Same-day availability for urgent requests.' },
...
const pageDescription = 'Answers to 24 common questions about The NYC Maid — pricing ($59–$100/hr), what\'s included, scheduling, insurance, service areas, and more. Serving Manhattan, Brooklyn, Queens, Long Island & NJ. (212) 202-8400'
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-blue-200/80 text-lg max-w-2xl leading-relaxed mb-10">
            Everything you need to know about pricing, services, scheduling, and how we work — answered by our team. Can&apos;t find your question? Call <a href="tel:6464900130" className="text-[#A8F0DC] underline underline-offset-2">(646) 490-0130</a>.
          </p>
