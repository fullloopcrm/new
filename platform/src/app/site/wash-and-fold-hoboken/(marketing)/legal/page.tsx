      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 text-sm">
            Questions? Contact us at <a href="mailto:hi@thenycmaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thenycmaid.com</a> or text/call <a href="tel:6464900130" className="text-[#1E2A4A] underline underline-offset-2">(646) 490-0130</a>.
          </p>
        </div>
      </div>
    </>
