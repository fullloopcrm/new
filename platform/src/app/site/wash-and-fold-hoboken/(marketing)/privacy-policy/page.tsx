...
import { breadcrumbSchema } from '@/app/site/wash-and-fold-hoboken/_lib/seo/schema'
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about this privacy policy? Contact us at <a href="mailto:hi@thenycmaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thenycmaid.com</a> or text/call <a href="tel:6464900130" className="text-[#1E2A4A] underline underline-offset-2">(646) 490-0130</a>.
            </p>
