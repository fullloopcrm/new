...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `https://www.thepennsylvaniamaid.com/available-nyc-maid-jobs/${n.slug}` },
    openGraph: {
      title: `Cleaning Jobs in ${n.name} | The Pennsylvania Maid`,
      description,
      url: `https://www.thepennsylvaniamaid.com/available-nyc-maid-jobs/${n.slug}`,
    },
  }
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: `Jobs in ${n.name}`, url: `https://www.thepennsylvaniamaid.com/available-nyc-maid-jobs/${n.slug}` },
        ]),
        jobSchema,
      ]} />
