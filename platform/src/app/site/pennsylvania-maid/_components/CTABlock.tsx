      ...
      <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
        <div>
          ...
          <p className="text-[#1E2A4A]/70 text-lg mt-2">
            {subtitle || 'Book online in under a minute — trusted by Pennsylvania residents.'}
          </p>
          <div className="flex items-center gap-3 mt-3">
            ...
            <Link href="https://g.page/r/CSX9IqciUG9SEAE/review" className="text-[#1E2A4A] text-sm font-semibold underline underline-offset-2 hover:opacity-80">Write a Review</Link>
          </div>
        </div>
        <div className="flex flex-col sm:flex-row items-center gap-3 flex-shrink-0">
          <Link href="/book/new" className="bg-[#1E2A4A] text-white px-8 py-3.5 rounded-md font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
            Self Booking $10 OFF
          </Link>
          <a href="sms:2153984500" className="border-2 border-[#1E2A4A] text-[#1E2A4A] px-8 py-3.5 rounded-md font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A] hover:text-white transition-colors">
            Text 215.398.4500
          </a>
        </div>
      </div>
