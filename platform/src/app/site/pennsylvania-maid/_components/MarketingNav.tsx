        ...
        <div className="bg-[#1E2A4A] text-gray-300 text-xs">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center lg:justify-between h-9">
            <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] tracking-widest uppercase">
              ...
              <Link href="/service-areas-served-by-the-nyc-maid" className="hover:text-white transition-colors font-semibold text-white/80 hidden sm:inline">PA</Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[72px]">
            <Link href="/" className="flex-shrink-0">
              <span className="font-[family-name:var(--font-bebas)] text-2xl sm:text-3xl text-[#1E2A4A] tracking-wide">The Pennsylvania Maid</span>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-2">
              <a href="sms:2153984500" className="inline-block bg-[#1E2A4A] text-white px-3.5 py-2 rounded-md font-bold text-xs tracking-wide uppercase hover:bg-[#1E2A4A]/90 transition-colors whitespace-nowrap">
                Text 215.398.4500
              </a>
            ...
            <div className="lg:hidden flex items-center gap-2">
              <a href="sms:2153984500" className="bg-[#1E2A4A] text-white px-3 py-2 rounded-md font-bold text-xs tracking-widest uppercase">
                Text
              </a>
        ...
        <div className={`absolute top-0 left-0 h-full w-[85%] max-w-sm bg-[#1E2A4A] transform transition-transform duration-300 ease-out ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="bg-white flex items-center justify-between px-5 py-4">
            <Link href="/" onClick={closeMenu}>
              <span className="font-[family-name:var(--font-bebas)] text-xl text-[#1E2A4A] tracking-wide">The Pennsylvania Maid</span>
            </Link>
          ...
          <div className="overflow-y-auto h-[calc(100%-72px)] px-5 py-6">
            <div className="space-y-1">
              ...
              <div className="border-t border-white/10 mt-4 pt-6 space-y-3 text-center">
                ...
                <a href="sms:2153984500" className="block bg-[#1E2A4A] text-white py-3 rounded-lg font-bold text-sm tracking-widest uppercase border border-white/20">Text 215.398.4500</a>
              </div>
            </div>
          </div>
        </div>
