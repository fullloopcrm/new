...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, howToBookSchema, breadcrumbSchema, faqSchema, areaItemListSchema } from '@/app/site/pennsylvania-maid/_lib/seo/schema'
...
const areaFAQs = [
  { question: 'What areas does The Pennsylvania Maid serve?', answer: `We serve ${totalNeighborhoods}+ neighborhoods across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island (Nassau and western Suffolk), Westchester County, and Northern New Jersey (Hudson and close-in Bergen). Same rates and same quality everywhere.` },
  ...
  { question: 'Do you serve areas outside of these neighborhoods?', answer: 'We may. If you don\'t see your neighborhood listed, text (215) 398-4500 and we\'ll let you know. We\'re always expanding.' },
...
const pageUrl = 'https://www.thepennsylvaniamaid.com/service-areas-served-by-the-nyc-maid'
const pageTitle = `Service Areas — ${totalNeighborhoods}+ Neighborhoods in NYC, Long Island, Westchester & NJ | The Pennsylvania Maid`
const pageDescription = `The Pennsylvania Maid serves ${totalNeighborhoods}+ neighborhoods across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. Same rates everywhere — $59/hr. Find professional cleaning in your neighborhood. (215) 398-4500`
