...
import { BLOG_POSTS } from '@/app/site/pennsylvania-maid/_lib/seo/blog-data'
...
export const metadata: Metadata = {
  title: 'Blog | Pennsylvania Cleaning Tips & News | The Pennsylvania Maid',
  description: 'The Pennsylvania Maid blog — cleaning tips, guides & news for Pennsylvania residents. Apartment care, eco-friendly products & pro advice. Service from $59/hr. (215) 398-4500',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/pennsylvania-maid-service-blog' },
  openGraph: {
    title: 'Blog | The Pennsylvania Maid',
    description: 'Expert cleaning tips and guides for Pennsylvania residents.',
    url: 'https://www.thepennsylvaniamaid.com/pennsylvania-maid-service-blog',
  },
  twitter: {
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <h1 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl lg:text-6xl text-white tracking-wide mb-4">The Pennsylvania Maid Blog</h1>
          <p className="text-white/60 text-lg max-w-3xl mx-auto">Real cleaning advice from people who do this every day — no fluff, no stock photos, just what actually works in Pennsylvania apartments.</p>
        </div>
      </section>

      <div className="max-w-7xl mx-auto px-4 py-12">
        <Breadcrumbs items={[{ name: 'Blog', href: '/pennsylvania-maid-service-blog' }]} />

        {/* Featured post */}
        <Link href={`/pennsylvania-maid-service-blog/${featured.slug}`} className="group block border border-gray-200 rounded-xl p-8 md:p-10 mb-12 hover:border-[#A8F0DC] hover:shadow-lg transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {rest.map(post => (
            <Link key={post.slug} href={`/pennsylvania-maid-service-blog/${post.slug}`} className="group border border-gray-200 rounded-xl p-6 hover:border-[#A8F0DC] hover:shadow-lg transition-all">
        ...
        <div className="text-center">
          <p className="text-gray-600">
            Looking for practical how-tos? Check out our <Link href="/pennsylvania-maid-and-cleaning-tips-and-advice-by-the-pennsylvania-maid" className="text-[#1E2A4A] font-semibold hover:underline">100 cleaning tips</Link> page.
          </p>
        </div>
      </div>
