...
export const metadata: Metadata = {
  title: 'Refund Policy | The Pennsylvania Maid',
  description: 'The Pennsylvania Maid refund policy — no money upfront, pay only after cleaning is complete. No deposits. Service from $59/hr. (215) 398-4500',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/refund-policy' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Refund Policy', url: 'https://www.thepennsylvaniamaid.com/refund-policy' },
      ])} />
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <div className="bg-[#F5FBF8] border border-[#A8F0DC]/30 rounded-xl p-6">
              ...
              <p className="text-gray-600 leading-relaxed mb-3">
                Payment is collected approximately 30 minutes before the cleaner finishes. If payment is not received, the cleaner will wait and the wait time is billable. Time is billed in 30-minute increments. Because we never take your money in advance, there is nothing to refund.
              </p>
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions? Contact us at <a href="mailto:hi@thepennsylvaniamaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thepennsylvaniamaid.com</a> or text <a href="sms:2153984500" className="text-[#1E2A4A] underline underline-offset-2">(215) 398-4500</a>.
            </p>
            <p className="text-gray-500 text-sm mt-4">
