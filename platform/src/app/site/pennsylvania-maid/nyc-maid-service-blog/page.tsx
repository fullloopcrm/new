...
export const metadata: Metadata = {
  title: 'Blog | NYC Cleaning Tips & News | The Pennsylvania Maid',
  description: 'The Pennsylvania Maid blog — cleaning tips, guides & news for NYC residents. Apartment care, eco-friendly products & pro advice. Service from $59/hr. (215) 398-4500',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/nyc-maid-service-blog' },
  openGraph: {
    title: 'Blog | The Pennsylvania Maid',
    description: 'Expert cleaning tips and guides for NYC residents.',
    url: 'https://www.thepennsylvaniamaid.com/nyc-maid-service-blog',
  },
  twitter: {
