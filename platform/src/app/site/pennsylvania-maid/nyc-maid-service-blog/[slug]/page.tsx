...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://www.thepennsylvaniamaid.com/nyc-maid-service-blog/${post.slug}` },
    openGraph: {
      title: post.title,
      description: post.excerpt,
      url: `https://www.thepennsylvaniamaid.com/nyc-maid-service-blog/${post.slug}`,
      type: 'article',
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://www.thepennsylvaniamaid.com/nyc-maid-service-blog/${post.slug}`,
    },
    url: `https://www.thepennsylvaniamaid.com/nyc-maid-service-blog/${post.slug}`,
  }
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Blog', url: 'https://www.thepennsylvaniamaid.com/nyc-maid-service-blog' },
          { name: post.title, url: `https://www.thepennsylvaniamaid.com/nyc-maid-service-blog/${post.slug}` },
        ]),
        articleSchema,
      ]} />
