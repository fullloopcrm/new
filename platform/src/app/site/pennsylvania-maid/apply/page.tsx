      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center max-w-sm">
            ...
            <p className="text-gray-500 text-sm mt-4">Questions? / ¿Preguntas? (215) 398-4500</p>
          </div>
        </div>
      </div>
    )
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          <div>
            <label className="flex items-center gap-3 px-3 py-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Required for Long Island, Pennsylvania, Pennsylvania, and some outer borough areas</p>
                <p className="text-xs text-gray-500">Requerido para Long Island, Pennsylvania, Pennsylvania, y algunas áreas exteriores</p>
                <p className="text-xs text-green-600 font-medium mt-1">+$5/hr bonus for car-required locations (Pennsylvania, Long Island, Pennsylvania, NJ) / +$5/hr bonificación para ubicaciones que requieren auto</p>
              </div>
            </label>
          </div>
          ...
          <div className="my-5 p-4 border border-gray-200 rounded-lg bg-gray-50">
            <label className="flex items-start gap-3 cursor-pointer text-[13px] leading-relaxed text-gray-600">
              ...
              />
              <span>
                By checking this box, I consent to receive transactional text messages from <strong>The Pennsylvania Maid</strong> for appointment confirmations, reminders, and customer support. Reply STOP to opt out. Reply HELP for help. Msg frequency may vary. Msg &amp; data rates may apply.
                <br /><br />
                Al marcar esta casilla, doy mi consentimiento para recibir mensajes de texto de <strong>The Pennsylvania Maid</strong> para confirmaciones de citas, recordatorios y atención al cliente. Responda STOP para cancelar. Responda HELP para ayuda.
                <br /><br />
                <a href="https://www.thepennsylvaniamaid.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#1E2A4A] hover:underline">Privacy Policy</a> | <a href="https://www.thepennsylvaniamaid.com/terms-conditions" target="_blank" rel="noopener noreferrer" className="text-[#1E2A4A] hover:underline">Terms &amp; Conditions</a>
              </span>
            </label>
          </div>
          ...
          <p className="text-xs text-gray-400 text-center">
            Questions? / ¿Preguntas? (215) 398-4500
          </p>
        </form>
      </div>
    </div>
