...
const trustFAQs = [
  ...
  { question: 'What areas do you serve?', answer: 'We serve Philadelphia — Center City, Old City, Fishtown, Manayunk, Chestnut Hill, University City, and South Philadelphia. Same rates everywhere.' },
...
const pageDescription = 'Answers to 24 common questions about The Pennsylvania Maid — pricing ($59–$89/hr) plus 20% off weekly recurring, what\'s included, scheduling, insurance, service areas, and more. Serving Pennsylvania & NJ. (215) 398-4500'
...
export default function FAQPage() {
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16">
          ...
          <Link href="/service-areas-served-by-the-pennsylvania-maid" className="group border border-gray-200 rounded-xl p-6 hover:border-[#A8F0DC] transition-all">
            ...
            <p className="text-gray-500 text-sm">Pennsylvania &amp; NJ</p>
          </Link>
      ...
      <CTABlock title="Ready to Book Your Cleaning?" subtitle="Text us — trusted by New Yorkers across Pennsylvania." />
    </>
  )
}
