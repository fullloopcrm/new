...
const pageUrl = 'https://www.thepennsylvaniamaid.com/nyc-cleaning-service-frequently-asked-questions-in-2025'
const pageTitle = 'NYC Cleaning Service FAQ — Pricing, Services & Scheduling | The Pennsylvania Maid'
const pageDescription = 'Answers to 24 common questions about The Pennsylvania Maid — pricing ($59–$89/hr) plus 20% off weekly recurring, what\'s included, scheduling, insurance, service areas, and more. Serving Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. (215) 398-4500'
