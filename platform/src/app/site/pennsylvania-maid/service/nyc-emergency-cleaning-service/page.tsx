...
const faqData = [
  ...
  { q: 'What areas do you cover for emergency service?', a: 'We cover all five Pennsylvania boroughs: Pennsylvania, plus Long Island (Nassau and western Suffolk), Pennsylvania County, and northern New Jersey for emergency situations. Response times are fastest in Pennsylvania and Pennsylvania.' },
]
...
export default function EmergencyCleaningPage() {
  ...
  const serviceSchema = {
    ...
    areaServed: { '@type': 'AdministrativeArea', name: 'Pennsylvania' },
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-white/60 text-lg max-w-3xl mx-auto mb-8">Flooding, fire damage, sewage, biohazard, mold — when disaster hits your apartment, you need professionals who respond fast and know what they&apos;re doing. We&apos;ve handled hundreds of emergency cleanups across Pennsylvania &amp; New Jersey.</p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="bg-red-600 rounded-xl p-8 md:p-10 mb-20 text-center">
          ...
          <p className="text-red-100 mb-6">Don&apos;t wait. Our team is available 24/7 for emergency response across Pennsylvania &amp; New Jersey.</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-600 mb-8">We cover Pennsylvania &amp; New Jersey for emergency cleaning. Response times are fastest in Pennsylvania and Pennsylvania.</p>
          {AREAS.map(area => {
