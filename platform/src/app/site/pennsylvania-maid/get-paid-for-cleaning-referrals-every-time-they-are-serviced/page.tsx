...
import { breadcrumbSchema, localBusinessSchema, faqSchema } from '@/app/site/pennsylvania-maid/_lib/seo/schema'
...
import ReferralFAQSection from '@/app/site/pennsylvania-maid/_components/ReferralFAQSection'
import ReferralCTABlock from '@/app/site/pennsylvania-maid/_components/ReferralCTABlock'
import ReferralPageBody from '@/app/site/pennsylvania-maid/_components/ReferralPageBody'

export const metadata: Metadata = {
  title: 'Get Paid for Cleaning Referrals | Earn 10% Commission | The Pennsylvania Maid',
  description: 'Earn 10% commission every time your referral books a cleaning (from $59/hr). Recurring income, fast payouts via Stripe. (215) 398-4500',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
  openGraph: {
    title: 'Get Paid for Cleaning Referrals | The Pennsylvania Maid',
    description: 'Earn 10% commission every time someone you refer books a cleaning. Recurring income, fast payouts.',
    url: 'https://www.thepennsylvaniamaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced',
  },
}
...
const referralFAQs = [
  ...
  { question: 'How do I get paid?', answer: 'We pay commissions via Stripe after each completed cleaning.' },
...
const referralFAQsBilingual = [
  ...
  { question: 'How do I get paid?', questionEs: '¿Cómo me pagan?', answer: 'We pay commissions via Stripe after each completed cleaning.', answerEs: 'Pagamos las comisiones por Stripe después de cada limpieza completada.' },
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Referral Program', url: 'https://www.thepennsylvaniamaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
        ]),
