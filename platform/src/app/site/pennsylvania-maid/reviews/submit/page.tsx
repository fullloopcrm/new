...
import { localBusinessSchema, breadcrumbSchema } from '@/app/site/pennsylvania-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: 'Leave a Review | The Pennsylvania Maid',
  description: 'Share your experience with The Pennsylvania Maid. Your honest feedback helps other New Yorkers find trusted, reliable cleaning services.',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/reviews/submit' },
  openGraph: {
    title: 'Leave a Review | The Pennsylvania Maid',
    description: 'Share your experience with The Pennsylvania Maid cleaning service.',
    url: 'https://www.thepennsylvaniamaid.com/reviews/submit',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Leave a Review', url: 'https://www.thepennsylvaniamaid.com/reviews/submit' },
        ]),
      ]} />
