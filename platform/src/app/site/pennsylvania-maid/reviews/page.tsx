...
import { breadcrumbSchema, localBusinessSchema, reviewSchemas, reviewsPageSchema, videoReviewsSchemas } from '@/app/site/pennsylvania-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: 'Pennsylvania Maid Service Reviews | 5-Star Verified Client Reviews',
  description: 'See why Pennsylvania residents trust our background-checked, insured cleaners. From $59/hr, no contracts.',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/reviews' },
  openGraph: {
    title: 'Pennsylvania Maid Service Reviews | 5-Star Verified Client Reviews',
    description: 'See reviews from across Pennsylvania.',
    url: 'https://www.thepennsylvaniamaid.com/reviews',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Reviews', url: 'https://www.thepennsylvaniamaid.com/reviews' },
        ]),
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-blue-200/80 text-lg max-w-2xl leading-relaxed">
            Don&rsquo;t take our word for it &mdash; hear directly from the families and professionals across Pennsylvania who trust us to clean their homes every week. These are verified reviews from real <Link href="/services/apartment-cleaning-service-in-pennsylvania" className="text-white underline underline-offset-2">apartment cleaning</Link>, <Link href="/services/deep-cleaning-service-in-pennsylvania" className="text-white underline underline-offset-2">deep cleaning</Link>, and <Link href="/services/weekly-maid-service-in-pennsylvania" className="text-white underline underline-offset-2">weekly maid service</Link> clients. No fake reviews, no cherry-picking &mdash; just honest feedback from people who chose us and keep coming back.
          </p>
        </div>
      </section>
