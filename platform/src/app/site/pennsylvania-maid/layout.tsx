...
import MarketingNav from '@/app/site/pennsylvania-maid/_components/MarketingNav'
import MarketingFooter from '@/app/site/pennsylvania-maid/_components/MarketingFooter'
import ReferralBanner from '@/app/site/pennsylvania-maid/_components/ReferralBanner'
...
export const metadata = {
  title: {
    default: 'The Pennsylvania Maid — Professional Cleaning Services in Pennsylvania From $59/hr',
  },
}
...
export default function MarketingLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${bebasNeue.variable} ${inter.variable} font-[family-name:var(--font-inter)]`}>
      ...
      <MarketingFooter />
      <TenantAnalyticsScript slug="pennsylvania-maid" />
      <ClientErrorMonitor slug="pennsylvania-maid" />
