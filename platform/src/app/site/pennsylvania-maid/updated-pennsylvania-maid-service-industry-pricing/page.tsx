...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, pricingOffersSchema, howToBookSchema, breadcrumbSchema, faqSchema } from '@/app/site/pennsylvania-maid/_lib/seo/schema'
...
const description = 'Transparent hourly cleaning rates across Pennsylvania & NJ. $59/hr your supplies (10% off weekly, 5% biweekly/monthly), $69/hr we bring everything (20% off weekly, 10% biweekly/monthly), $89/hr same-day. No hidden fees. 5.0★ Rated. (215) 398-4500'
...
const pricingFaqs = [
  ...
  { question: 'Do you offer free estimates?', answer: 'Yes. Text (215) 398-4500 with your address, home size, and service type and we\'ll provide a custom quote within minutes. No obligation, no pressure.' },
  ...
  { question: 'Can I get a quote without booking?', answer: 'Absolutely. Text (215) 398-4500 with your apartment details and we\'ll send a quote. No commitment required. Most quotes are delivered within 15 minutes.' },
]
  ...
  return (
    <>
      <JsonLd data={[
        organizationSchema(),
        webSiteSchema(),
        webPageSchema({ url, name: title, description, breadcrumb: [{ name: 'Home', url: 'https://www.thepennsylvaniamaid.com' }, { name: 'Pricing', url }] }),
        localBusinessSchema(),
        pricingOffersSchema(),
        howToBookSchema(),
        breadcrumbSchema([{ name: 'Home', url: 'https://www.thepennsylvaniamaid.com' }, { name: 'Pricing', url }]),
          ...
          <div className="max-w-5xl mx-auto px-4 py-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:2153984500" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-[#A8F0DC] rounded-2xl p-7 text-center relative">
                ...
                <a href="sms:2153984500" className="block mt-6 bg-[#1E2A4A] text-white px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:2153984500" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text — same-day</a>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { n: '01', t: 'Text Us', d: 'Reach us at (215) 398-4500 with your address, home size, and what type of cleaning you need.' },
