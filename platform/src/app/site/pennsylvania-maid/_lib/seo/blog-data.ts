...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    sections: [
      ...
      { heading: 'The Short Answer', paragraphs: ['Most professional cleaning in Pennsylvania runs between $59 and $89 per hour, depending on the service and who\'s doing it. A standard <a href="/services/apartment-cleaning-service-in-nyc">apartment cleaning</a> for a 1-bedroom typically takes 2–3 hours. So you\'re looking at roughly $118–$237 for a basic clean. Recurring clients save more depending on their tier: $69/hr (we supply) gets 20% off weekly or 10% off biweekly/monthly; $59/hr (you supply) gets 10% off weekly or 5% off biweekly/monthly.', '<a href="/services/deep-cleaning-service-in-nyc">Deep cleaning</a> costs more — usually 1.5x to 2x the standard rate — because it includes things like inside the oven, behind the fridge, scrubbing grout, and all those spots you pretend don\'t exist.'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Or Just Book a Deep Clean', paragraphs: ['Look, if you have the time and energy for three weeks of cleaning, more power to you. Most people don\'t. That\'s genuinely why <a href="/services/deep-cleaning-service-in-nyc">deep cleaning services</a> exist. One 4–5 hour session and your apartment is spring-ready. We serve <a href="/service-areas-served-by-the-nyc-maid">hundreds of neighborhoods</a> across Pennsylvania.'] },
    ],
  },
  {
