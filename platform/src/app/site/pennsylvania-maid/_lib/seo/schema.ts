...
export function videoReviewsSchemas() {
  const videos = [
    { id: 'review-1', title: 'NYC Cleaning Client Review — Manhattan Apartment', description: 'Real client testimonial from a verified NYC apartment cleaning booked with The Pennsylvania Maid.' },
    { id: 'review-2', title: 'NYC Cleaning Client Review — Brooklyn Home', description: 'Brooklyn client shares their honest experience with professional deep cleaning from The Pennsylvania Maid.' },
