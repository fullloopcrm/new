...
export function homepageContent() {
  return {
    ...
    metaDescription: 'Pennsylvania\'s top-rated maid service from $59/hr. House cleaning across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. Licensed, insured. 5.0★ Rated. (215) 398-4500',
...
const areaIntros: Record<string, string[]> = {
  ...
  queens: [
    'Queens is Pennsylvania\'s most diverse borough, and our cleaning team serves every neighborhood with reliable, thorough service.',
...
export function serviceContent(service: Service) {
  return {
    ...
    metaDescription: `Professional ${service.name.toLowerCase()} across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. ${service.features.slice(0, 2).join(', ')} & more. ${service.priceRange}. 5.0★ Rated. (215) 398-4500`,
...
export function commonServiceFAQs(service: Service): { question: string; answer: string }[] {
  return [
    ...
    { question: 'Do you have a referral program?', answer: 'Yes. Refer a friend and earn money every time they book a cleaning — not just the first time. Visit thepennsylvaniamaid.com/referral or text us for details. It\'s one of the most generous referral programs in NYC cleaning.' },
  ]
}
