...
export const metadata: Metadata = {
  title: 'Do Not Share Policy | The Pennsylvania Maid',
  description: 'The Pennsylvania Maid does not sell, share, or distribute your personal information. Your data stays with us. Pennsylvania cleaning from $59/hr. (215) 398-4500',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/do-not-share-policy' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Do Not Share Policy', url: 'https://www.thepennsylvaniamaid.com/do-not-share-policy' },
      ])} />
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-xl p-5 mt-4 space-y-2">
              <p className="text-gray-600 text-sm">Email us at <a href="mailto:hi@thepennsylvaniamaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thepennsylvaniamaid.com</a> with the subject &ldquo;Do Not Share&rdquo;</p>
              <p className="text-gray-600 text-sm">Or text <a href="sms:2153984500" className="text-[#1E2A4A] underline underline-offset-2">(215) 398-4500</a></p>
            </div>
