...
import { breadcrumbSchema, localBusinessSchema, serviceItemListSchema } from '@/app/site/pennsylvania-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: { absolute: 'Pennsylvania Cleaning Services — Deep Clean, Maid Service, Move-In/Out & More | The Pennsylvania Maid' },
  description: 'All cleaning services by The Pennsylvania Maid from $59/hr. Deep cleaning, weekly maid service, move-in/out, post-construction, Airbnb, same-day. Pennsylvania, Pennsylvania, Pennsylvania, the Pennsylvania, Pennsylvania, Long Island, Pennsylvania & NJ.',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/pennsylvania-maid-service-services-offered-by-the-pennsylvania-maid' },
  openGraph: {
    title: 'Pennsylvania Cleaning Services — Deep Clean, Maid Service & More | The Pennsylvania Maid',
    description: 'Professional cleaning services from $59/hr across Pennsylvania, Pennsylvania, Pennsylvania, the Pennsylvania, Pennsylvania, Long Island, Pennsylvania & NJ. Licensed, insured, 5-star rated.',
    url: 'https://www.thepennsylvaniamaid.com/pennsylvania-maid-service-services-offered-by-the-pennsylvania-maid',
  },
}
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            <a href="sms:2153984500" className="text-blue-200/70 font-medium text-lg py-4 hover:text-white transition-colors underline underline-offset-4">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <Breadcrumbs items={[{ name: 'Services', href: '/pennsylvania-maid-service-services-offered-by-the-pennsylvania-maid' }]} />
      </div>
      ...
      <section className="py-20 bg-[#A8F0DC]">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <Link href="/updated-pennsylvania-maid-service-industry-pricing" className="inline-block bg-[#1E2A4A] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-xs font-semibold text-gray-400 tracking-[0.2em] uppercase mb-3">Why New Yorkers Choose The Pennsylvania Maid</h2>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <a href="sms:2153984500" className="inline-block text-[#1E2A4A] font-semibold py-3.5 hover:underline underline-offset-4">
                Text us for questions
              </a>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <Link href="/service-areas-served-by-the-pennsylvania-maid" className="inline-block bg-[#1E2A4A] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
            Browse All Service Areas &rarr;
          </Link>
        </div>
      </section>

      <CTABlock title="Book Any Cleaning Service Today" subtitle="Text us — trusted by New Yorkers across Pennsylvania, Pennsylvania, Pennsylvania, the Pennsylvania, Pennsylvania, Long Island, Pennsylvania & New Jersey." />
    </>
  )
}
