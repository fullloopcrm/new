...
export const metadata: Metadata = {
  title: { absolute: 'NYC Cleaning Services — Deep Clean, Maid Service, Move-In/Out & More | The Pennsylvania Maid' },
  description: 'All cleaning services by The Pennsylvania Maid from $59/hr. Deep cleaning, weekly maid service, move-in/out, post-construction, Airbnb, same-day. Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ.',
  alternates: { canonical: 'https://www.thepennsylvaniamaid.com/nyc-maid-service-services-offered-by-the-nyc-maid' },
  openGraph: {
    title: 'NYC Cleaning Services — Deep Clean, Maid Service & More | The Pennsylvania Maid',
    ...
    url: 'https://www.thepennsylvaniamaid.com/nyc-maid-service-services-offered-by-the-nyc-maid',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Services', url: 'https://www.thepennsylvaniamaid.com/nyc-maid-service-services-offered-by-the-nyc-maid' },
        ]),
      ]} />
