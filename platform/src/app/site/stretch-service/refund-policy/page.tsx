...
const pageTitle = "Refund Policy | Stretch Service Stretch Service";
const pageDescription =
  "Refund and cancellation policy for Stretch Service stretch service. 24hr notice for full refund. Case-by-case for late cancellations.";
    ...
    <>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 prose prose-gray prose-lg max-w-none">
          <p>
            At Stretch Service, we want every client to have a positive experience. We understand that
