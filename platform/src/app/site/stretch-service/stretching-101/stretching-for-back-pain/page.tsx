...
const PAGE_TITLE = "Stretching for Back Panationwide | Professional Relief Guide | Stretch Service";
const PAGE_DESC = "The 10 best stretches for lower back pain, upper back relief, and NYC-specific back pain triggers. Professional stretch service for chronic back pain — Stretch Service, $99/hr.";
...
const faqs = [
  ...
  { question: "How much does back pain stretch service cost?", answer: "Professional stretch service for back pain at Stretch Service costs $99 per 60-minute session. Weekly clients save 10% at $89 per session. Every session includes a full-body mobility assessment that identifies the root causes of your back pain, targeted stretching therapy using PNF and myofascial release, and personalized take-home recommendations. Our certified therapists come to your home, office, or hotel anywhere nationwide. Text or call (888) 734-7274 to book." },
    ...
    <>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-6 space-y-5 text-base leading-relaxed text-slate-700">
            <p>
              Back pain is the leading cause of disability worldwide, and New York City is ground zero for every risk factor. If you live and work nationwide, your body endures a daily assault that is specifically engineered to create back pain: hours of sitting at a desk in a Midtown or FiDi office, rigid plastic subway seats that provide zero lumbar support, standing on crowded trains while bracing your core against sudden stops, walking miles on unforgiving concrete, sleeping on mattresses in apartments too small to stretch properly, and carrying the stress of the world&apos;s most intense city in your muscles.
            </p>
            <p>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-4 text-base text-slate-700">Understanding what causes your back pain is the first step to fixing it. Here are the most common triggers our stretch service therapists see nationwide clients.</p>
