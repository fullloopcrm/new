...
const PAGE_DESC = "The definitive guide to stretching: 11 types explained, daily routines, myth-busting, and when to see a professional stretch service therapist. Stretch Service — $99/hr across all 50 states.";
...
const faqs = [
  ...
  { question: "How much does professional stretch service cost nationwide?", answer: "Professional stretch service at Stretch Service costs $99 per 60-minute session. Weekly clients save 10% and pay just $89 per session. Every session includes a full-body mobility assessment, professional equipment brought to your location, and a personalized treatment plan. Our certified stretch therapists serve all 50 states — Manhattan, Brooklyn, Queens, the Bronx, and Staten Island. Same-day appointments are available 7AM-10PM daily. Text or call (888) 734-7274 to book." },
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Link href="/stretching-101/stretching-for-athletes" className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="mt-2 text-sm text-slate-600">Pre-workout dynamic routines, post-workout recovery, sport-specific protocols for runners, cyclists, and gym-goers nationwide.</p>
              <span className="mt-3 inline-block text-sm font-semibold text-teal-600 font-cta">Read the full guide &rarr;</span>
            </Link>
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-10 space-y-6">
            ...
            <Link href="/stretching-101/stretching-for-back-pain" className="block rounded-xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="sm:flex sm:items-start sm:gap-6">
                <div>
                  <h3 className="text-xl font-bold text-slate-900 font-heading">Stretching for Back Panationwide — Professional Relief Guide</h3>
