...
import { services, getServiceUrl, cities, SITE_URL, SITE_SMS_LINK, SITE_PHONE } from "@/app/site/stretch-service/_lib/siteData";
...
export const metadata: Metadata = {
  title: "Stretch Service | All 11 Types | $99/hr Nationwide Mobile",
  description: "Professional mobile stretch service nationwide. 11 types including assisted, PNF, myofascial release & more. $99/hr, 10% off weekly. Same-day available 7AM-10PM.",
...
export default function ServicesPage() {
  return (
    <>
      <JsonLd data={webPageSchema("All Stretch Services — Nationwide Mobile", "All professional stretching services offered by Stretch Service nationwide.", `${SITE_URL}/services`)} />
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-20">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-teal-200 font-cta">11 Professional Stretch Types | $99/hr | 900+ Cities</p>
          <h1 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl font-heading">
            Nationwide Mobile Stretch Service
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/80">
            {services.length} professional stretching techniques delivered to your home, office, hotel, or any location by certified stretch therapists. {cities.length}+ cities across all 50 states.
          </p>
        </div>
      </section>
