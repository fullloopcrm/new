...
const pageTitle = "Terms & Conditions | Stretch Service Stretch Service";
const pageDescription =
  "Terms and conditions for Stretch Service mobile stretch service. Booking, cancellation, payment, and service policies. $99/hr, 24hr cancellation notice.";
    ...
    <>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 prose prose-gray prose-lg max-w-none">
          <p>
            Welcome to Stretch Service. By booking, purchasing, or using any of our services, you agree to
            be bound by the following terms and conditions. Please read them carefully.
          </p>

          <h2 className="font-heading">1. Services</h2>
          <p>
            Stretch Service provides professional mobile assisted stretching services throughout New York
          ...
          <ul>
            ...
            <li>
              Stretch Service therapists are certified stretch professionals but are not medical doctors,
          ...
          <p>
            To the fullest extent permitted by law, Stretch Service, its owners, employees, and
          ...
          <p>
            Stretch Service provides mobile services at your chosen location. You are responsible for
          ...
          <p>
            All content on the Stretch Service website, including text, images, logos, graphics, and
            design, is the property of Stretch Service and is protected by copyright and trademark laws.
          ...
          <p>
            Stretch Service reserves the right to update or modify these terms at any time. Changes will
