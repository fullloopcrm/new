...
const pageDescription =
  "Expert stretching tips, wellness advice, and stretch service guides from Stretch Service. Learn about PNF stretching, recovery, mobility & more.";
...
const placeholderArticles = [
  ...
  {
    title: "The Best Parks nationwide for Outdoor Stretching",
    excerpt:
