...
import { PHONE, PHONE_HREF, SMS_HREF, TOP_CITIES } from "@/app/site/nycroadsideemergencyassistance/_data/content";
      ...
      <nav className="transition-all duration-300" style={{ backgroundColor: "#b91c1c" }}>
        <div className="flex items-center justify-between px-3 sm:px-4 py-4">
          <Link href="/" className="flex items-center gap-1 shrink min-w-0">
            <span className="text-sm sm:text-lg lg:text-xl font-bold tracking-wider sm:tracking-widest text-white font-heading whitespace-nowrap">NYC ROADSIDE</span>
            <span className="text-sm sm:text-lg lg:text-xl font-bold tracking-wider sm:tracking-widest text-yellow-200 font-heading whitespace-nowrap">EMERGENCY ASSISTANCE</span>
          </Link>
          ...
          <div className="hidden lg:flex justify-end">
            <Link href="/book-towing-service-today">
              <span className="inline-flex items-center gap-2 rounded-lg bg-yellow-400 px-4 py-2 text-[15px] font-bold text-slate-900 transition-colors hover:bg-yellow-300 font-cta shadow-md">
                Book Online — Save $25
              </span>
            </Link>
          </div>
        ...
        <div className="lg:hidden bg-slate-900 border-t border-slate-700/60 px-4 py-6 space-y-4">
          ...
          <div className="mt-4 space-y-3">
            <Link href="/book-towing-service-today" onClick={() => setMobileOpen(false)} className="block">
              <span className="block w-full rounded-lg bg-yellow-400 px-6 py-3 text-center text-base font-bold text-slate-900 font-cta shadow-md">Book Online — Save $25</span>
            </Link>
            <a href={SMS_HREF} className="block">
              <span className="block w-full rounded-lg bg-white px-6 py-3 text-center text-base font-semibold text-teal-700 font-cta">Text {PHONE}</span>
            </a>
            <a href={PHONE_HREF} className="block">
              <span className="block w-full rounded-lg border-2 border-white/40 px-6 py-3 text-center text-base font-semibold text-white font-cta">Call {PHONE}</span>
            </a>
          </div>
        </div>
      )}
