...
export interface ServiceTipsContent {
  ...
  donts: string[];
  /** Cost paragraph — rate description + what affects total hours. Use token links where useful. */
  cost: string;
...
export const SERVICE_TIPS: Record<string, Tips> = {
  ...
  "light-duty-towing": {
    ...
    rightNow: [
      ...
      "Tell dispatch the drop destination — home, shop, dealer, or impound. We quote estimated total hours based on the route — same $149 / hour for every minute on the clock, no per-mile, no per-block.",
    ...
    cost:
      "Every service we run uses the same {link:/pricing|hourly rate}: $149 per hour, 1-hour minimum, billed in half-hour increments after. Book online and your first hour is $124 instead of $149. Most intra-borough tows finish inside the first hour. Longer routes, multi-borough drops, or scenes that need winching simply add more time at the same rate. No NYC surcharge, no after-hours markup, no hidden fees.",
    causes: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. Out-of-borough and out-of-state runs use the same $149 / hour rate, quoted as estimated total hours per destination up front. See {link:/services/long-distance-towing|long distance towing}.",
      },
      {
  ...
  "motorcycle-towing": {
    ...
    cost:
      "Motorcycle transport runs the same $149 / hour rate as every other service we provide. 1-hour minimum, half-hour increments after. Scooters are the same rate. Heavy touring bikes (GoldWings, K1600s) may need a heavy-duty flatbed if the combined weight exceeds standard chock ratings — dispatch will tell you on the call. Book online and save $25 on the first hour. For ongoing event or track-day transport, commercial accounts get volume pricing.",
    causes: [
  ...
  "heavy-duty-towing": {
    ...
    cost:
      "Heavy-duty work uses the same $149 / hour rate as every other call, quoted as estimated total hours up front because the work runs multi-hour. Vehicle weight, distance, and recovery complexity add hours, not premium rates. A straightforward NYC heavy-duty tow typically lands in the 2–4 hour range. Book online and your first hour is $124. For fleet customers, {link:/services/fleet-towing|fleet accounts} get priority dispatch and net-30 billing. See {link:/pricing|pricing}.",
    causes: [
  ...
  "flatbed-towing": {
    ...
    cost:
      "Flatbed runs the same $149 / hour rate — see {link:/pricing|full pricing}. Required equipment, not an upsell — if your car is AWD, EV, or low-clearance, this is the correct service. Book online and your first hour is $124. For cross-state moves, {link:/services/long-distance-towing|long distance towing} quotes total estimated hours up front. Exotic and six-figure vehicles may route to {link:/services/luxury-exotic-towing|luxury and exotic} for elevated cargo insurance.",
    causes: [
  ...
  "long-distance-towing": {
    intro:
      "Long distance means flatbed — the only safe way to move a vehicle more than about 20 miles. Upstate, Jersey, Connecticut, PA, Boston, DC corridor. Same $149 / hour rate as every other call, quoted as estimated total hours per destination up front — you know the total before we load. Book online and your first hour is $124. For in-city transfers, {link:/services/flatbed-towing|flatbed towing} is the right service; for moves involving classics or exotics, route to {link:/services/classic-antique-car-transport|classic transport} or {link:/services/luxury-exotic-towing|luxury transport} for the right equipment.",
    rightNow: [
      ...
      "Confirm payment method before loading — estimated total quoted at the $149 / hour rate, full amount due at drop (or 50% up front on runs over 300 miles).",
    ],
    dos: [
  ...
  "roadside-assistance": {
    ...
    cost:
      "Roadside calls — {link:/services/jump-start|jump}, {link:/services/flat-tire-change|tire}, {link:/services/lockout-service|lockout}, {link:/services/gas-delivery|gas}, {link:/services/winch-out-recovery|winch-out} — all run our single $149 / hour rate with a 1-hour minimum. Most finish well inside that hour. Book online and your first hour is $124. Fuel delivered is billed at cost plus a small handling fee. If the fix turns into a longer tow, the hour you've already paid for credits against the total. See {link:/pricing|full pricing}.",
    causes: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "The driver assesses on scene. If it's a tow, the hour you've already paid for credits against the total. If it's a simple add-on (replace a cable terminal, swap a fuse), additional time at the same $149 / hour rate is quoted before doing it.",
      },
    ],
  },
  ...
  "jump-start": {
    ...
    cost:
      "Jump-start runs our $149 / hour rate, 1-hour minimum (book online for $124). Arrival 20-30 min typical. Includes the jump plus battery load test and alternator voltage check — most calls finish in 20 minutes. If the battery needs replacement, {link:/services/battery-replacement|battery replacement} is quoted on scene — common group sizes in stock on every truck. If the alternator is bad and a jump won't hold, we tow to a shop — the hour you've already paid for credits against the total. See {link:/pricing|full pricing}.",
    causes: [
  ...
  "battery-replacement": {
    ...
    cost:
      "Battery replacement is the $149 / hour service rate (1-hour minimum, $124 first hour when you book online) plus the battery itself at retail price. Standard group sizes run $150-$250 for a quality battery; European AGM or EFB run $250-$400. BCM registration on German makes is included — no upcharge. Old battery goes with us for recycling. See {link:/pricing|full pricing}. If scan-tool diagnosis reveals an alternator issue, the hour credits toward a tow via {link:/services/jump-start|jump-start service escalation}.",
    causes: [
  ...
  "gas-delivery": {
    ...
    cost:
      "Gas delivery uses our standard $149 / hour rate (1-hour minimum, $124 first hour when you book online) plus fuel at cost plus a small handling fee. Standard delivery is 2 gallons, usually under $15 in fuel cost. Up to 5 gallons available on request. Most calls finish in 20 minutes. See {link:/pricing|full pricing}. If the vehicle won't restart — fuel pump damage from running dry is possible — the hour you've already paid for credits toward a {link:/services/roadside-assistance|roadside diagnosis} or tow.",
    causes: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Could be the pump heat-soaked from running dry. We diagnose on scene. If it escalates to a tow, the hour you've already paid for credits against the total.",
      },
      {
  ...
  "flat-tire-change": {
    ...
    cost:
      "Tire change runs our $149 / hour rate, 1-hour minimum ($124 first hour when you book online). Plug-and-patch on scene is included when damage is in the tread. Most calls finish in 25 minutes. If you have no spare, we tow to a tire shop at the same hourly rate. See {link:/pricing|pricing}. If the damage is a sidewall tear, a bent rim, or multiple tires affected (common after a pothole strike), {link:/services/flatbed-towing|flatbed} is the right call.",
    causes: [
  ...
  "lockout-service": {
    ...
    rightNow: [
      ...
      "Have payment ready — $149 / hour, 1-hour minimum, $124 first hour online. Most cars unlocked in under 10 minutes.",
    ],
    dos: [
    ...
    cost:
      "$149 / hour, 1-hour minimum — $124 first hour when you book online. Most lockouts finish in under 10 minutes. See {link:/pricing|pricing}. If the keys are lost entirely (not just locked inside) and you need new keys programmed, that's a dealer or locksmith scope. We can {link:/services/flatbed-towing|flatbed you to the dealer} at the same hourly rate if needed. If the vehicle is an exotic or has anti-theft coding that requires dealer-only access, we tell you before sending.",
    causes: [
  ...
  "winch-out-recovery": {
    ...
    cost:
      "Winch-out is the same $149 / hour rate as every other call, 1-hour minimum ($124 first hour when you book online). Difficulty factors: depth, angle, drivetrain, and whether a second truck is needed — these add hours, not premium rates. Deep snow recovery: see {link:/services/winter-snow-extraction|winter snow extraction}. Severe ditch recoveries are quoted in estimated hours before dispatch. See {link:/pricing|pricing}. If the vehicle can't drive after extraction (bent control arm, flat tire, bent rim), we can {link:/services/flatbed-towing|flatbed it to a shop} at the same hourly rate.",
    causes: [
  ...
  "ev-tesla-towing": {
    ...
    cost:
      "EV transport runs our $149 / hour rate — same as every other service. 1-hour minimum, $124 first hour when you book online. For damaged or brick-level EVs that need skates and extended loading time, additional time at the same rate is quoted in advance. See {link:/pricing|full pricing}. Authorized service center transport — Tesla Service, Rivian Service, Lucid Service — is the standard destination. Manufacturer roadside coverage (Tesla Roadside, etc.) reimburses most tows; we can bill them directly in many cases.",
    causes: [
  ...
  "boat-trailer-towing": {
    ...
    cost:
      "Boat and trailer towing uses our standard $149 / hour rate, quoted as estimated total hours up front because the variables (weight, axles, damage) push the time materially. Basic trailer tow (empty trailer, intact) typically fits the 1-hour minimum. Loaded boat trailers, multi-axle utility trailers, or trailers with damage that requires winching run longer. Book online and save $25 on the first hour. For {link:/services/heavy-duty-towing|heavy-duty trailer recovery}, expect multiple hours at $149 / hour, all quoted before dispatch. Flat tires only? {link:/services/flat-tire-change|Roadside tire service} runs the same rate.",
    causes: [
  ...
  "rv-motorhome-towing": {
    ...
    cost:
      "RV recovery is the same $149 / hour rate as every other service, quoted as estimated total hours up front because the work is multi-hour. Variables: class (A, B, or C), length, weight, recovery complexity, and destination distance — these add hours, not premium rates. Typical NYC-area Class A recovery runs 4–7 hours; Class C runs 2–5 hours; Class B (camper vans) lands in the {link:/services/heavy-duty-towing|heavy-duty} range, 2–4 hours. Compare to {link:/pricing|standard pricing}. Book online and save $25 on the first hour. {link:/services/fleet-towing|Rental fleet accounts} get priority dispatch.",
    causes: [
  ...
  "mobile-mechanic-on-site-repairs": {
    ...
    cost:
      "Mobile mechanic service runs our single $149 / hour rate, 1-hour minimum ($124 first hour when you book online) — labor included. Parts at retail. Common parts stocked: batteries, fuses, relays, hose clamps, coolant, brake fluid, washer fluid, belts. For bigger repairs, additional hours at the same rate are quoted before starting. If the diagnosis reveals a tow-needed issue, the hour you've already paid for credits toward a {link:/services/flatbed-towing|flatbed} or appropriate tow. See {link:/pricing|pricing}.",
    causes: [
  ...
  "emergency-247-towing": {
    intro:
      "24/7 means 24/7 — overnight, holidays, snowstorms, same $149 / hour rate. The only surcharge is when a job genuinely costs more to execute (heavy-duty in a blizzard, out-of-state at 3 AM), and dispatch tells you before we start. For life-safety scenes (active travel lane, bridge or tunnel deck), call 911 first. For urgent-but-not-emergency breakdowns, see {link:/services/roadside-assistance|roadside assistance}.",
    rightNow: [
    ...
    cost:
      "24/7 calls run at our single {link:/pricing|hourly rate} — $149 / hour for every service, 1-hour minimum, $124 first hour when you book online. No overnight or holiday surcharge. The only higher-cost scenarios are inherently complex jobs (heavy-duty in bad conditions, long-distance in the middle of the night) — those still bill at $149 / hour, but with more estimated hours quoted up front. See also {link:/services/accident-recovery|accident recovery} and {link:/services/heavy-duty-towing|heavy-duty}.",
    causes: [
...
export function getNeighborhoodTips(
  ...
  const archTips: Record<NeighborhoodArchetype, string[]> = {
    ...
    "outer-residential": [
      `In ${cityName}, destinations to shops or dealers may be outside the borough — confirm the estimated hours cover the route.`,
