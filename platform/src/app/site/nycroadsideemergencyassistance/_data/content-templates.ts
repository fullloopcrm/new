...
export function statePageContent(stateName: string, stateAbbr: string, cities: { name: string; slug: string }[]) {
  ...
  return {
    title: `${stateName} Tow Truck Near Me — $149/hr, $25 Off Online, No Catches. 24/7 ${stateName}, NYC.`,
    metaDescription: `${stateName} tow truck service at one rate: $149/hour, $25 off online ($124 first hour). No NYC surcharge, no after-hours markup, no hidden fees. 24/7 dispatch across ${cities.length}+ ${stateName} neighborhoods. 20–40 min arrival. Call ${PHONE}.`,
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          `One rate for every service: $149 / hour, 1-hour minimum, billed in half-hour increments after. Book online and save $25 — your first hour is $124 instead of $149. Same rate at 3 AM as at 3 PM. No NYC surcharge, no after-hours markup, no storage fees on same-day drops. If scope shifts on scene, we tell you before we proceed — never after.`,
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          `Light-duty tow in ${stateName}: $149 / hour, 1-hour minimum, half-hour increments after. Book online and your first hour is $124. Covers cars, sedans, compact SUVs, and anything under about 10,000 lbs gross weight. Wheel-lift trucks handle these — they fit in tighter spaces than full flatbeds.`,
          `Flatbed tow: same $149 / hour rate. Required for AWD and 4WD vehicles, EVs, low-clearance sports and luxury cars, motorcycles, and any tow going more than roughly 20 miles. Book online and your first hour is $124. If you are not sure whether your car needs flatbed, tell dispatch the year/make/model — we know the answer for every common vehicle on the road.`,
          ...
          `Roadside (jump-start, flat-tire change, lockout, gas delivery, winch-out): same $149 / hour rate, 1-hour minimum. Most roadside calls finish well inside the first hour. Book online and pay $124 for the first hour. Any fuel delivered is billed at cost plus a small handling fee on top of the service rate.`,
...
export function cityPageContent(cityName: string, stateName: string, stateAbbr: string, stateSlug: string, otherCities: { name: string; slug: string }[]) {
  ...
  return {
    title: `${cityName} Tow Truck Near Me — $149/hr, $25 Off Online, No Catches. 24/7 ${cityName}, ${stateName}.`,
    metaDescription: `${cityName} tow truck at one rate: $149/hour, $25 off online ($124 first hour). No NYC surcharge, no after-hours markup, no hidden fees. 24/7 dispatch covering ${cityName}, ${stateName}. 20–40 min arrival. Call ${PHONE}.`,
    heroSubtitle: `24/7 Towing & Roadside in ${cityName}`,
    sections: [
      {
        heading: `Towing & Roadside in ${cityName}, ${stateName}`,
        paragraphs: [
          `Broken down in ${cityName}? NYC Roadside Emergency Assistance has trucks staged in ${stateName} and runs 24/7, with typical arrivals of 20–40 minutes. We handle every common NYC roadside situation — dead batteries on cold mornings, flats from the endless pothole lottery, keys locked in cars, cars that ran out of gas between stations, cars stuck in snow or a loading-zone curb cut, and the full range of tow situations from a quick shop transfer to a full collision recovery.`,
          ...
          `One rate for every service: $149 / hour, 1-hour minimum, billed in half-hour increments after. Book online and save $25 — your first hour is $124. No NYC surcharge, no storage fees on same-day drops, no after-hours markup. If the job complexity shifts, we tell you the new estimated hours before we execute.`,
      ...
      },
      {
        ...
        paragraphs: [
          `Light-duty tow from ${cityName}: $149 / hour, 1-hour minimum. Most intra-borough tows from ${cityName} finish inside the first hour. Book online and your first hour is $124.`,
          `Flatbed tow from ${cityName}: same $149 / hour rate. If your vehicle is AWD, 4WD, an EV, or a low-clearance sports/luxury car, flatbed is mandatory — dragging drive wheels destroys the drivetrain and low bumpers scrape off on wheel-lift. Motorcycles also go flatbed. Book online and save $25 on the first hour.`,
          `Roadside (jump, tire, lockout, gas, winch-out): $149 / hour, 1-hour minimum. Most calls finish in 20–40 minutes. Book online and pay $124 for the first hour. Any delivered fuel is billed at cost plus a small handling fee on top of the service rate.`,
...
export function cityServicePageContent(cityName: string, stateName: string, stateAbbr: string, service: Service) {
  ...
  return {
    title: `${service.title} ${cityName}, ${stateName} — $149/hr, $25 Off Online, No Catches.`,
    metaDescription: `${service.title} in ${cityName}, ${stateName} at one rate: $149/hour, $25 off online ($124 first hour). No NYC surcharge, no after-hours markup. 24/7 dispatch, 20–40 min arrival, licensed. Call ${PHONE}.`,
    heroSubtitle: `${service.title} in ${cityName} — 24/7`,
    sections: [
      {
        heading: `${service.title} in ${cityName}, ${stateName}`,
        paragraphs: [
          `Need ${svcLower} in ${cityName}? NYC Roadside Emergency Assistance runs this job 24 hours a day, with trucks staged in ${stateName} and typical arrival times of 20–40 minutes. Flat-rate pricing quoted on the phone before we dispatch. No NYC surcharge, no storage fees on same-day drops, no bait-and-switch.`,
      ...
      },
      {
        ...
        paragraphs: [
          `${service.title} pricing in ${cityName} is the same as every other service we run: $149 / hour, 1-hour minimum, billed in half-hour increments after that. Book online and save $25 — your first hour is $124. No NYC surcharge, no after-hours markup, no storage fees on same-day drops.`,
          ...
          `To give you a sense of real numbers: a typical light-duty tow within ${cityName} to a local shop fits inside the 1-hour minimum — $124 online, $149 by phone. A flatbed tow from ${cityName} to a specialty shop a few miles away runs about 1–1.5 hours. A roadside ${svcLower} call almost always finishes inside the first hour.`,
        ],
      },
      {
      ...
      {
        heading: `Why Choose NYC Roadside Emergency Assistance for ${service.title} in ${cityName}`,
        paragraphs: [
