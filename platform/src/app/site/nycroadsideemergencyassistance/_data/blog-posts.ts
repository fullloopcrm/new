...
const ORIGINAL_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Every service we run uses the same rate: $149 / hour, 1-hour minimum, billed in half-hour increments after. Book online and your first hour is $124. If the vehicle requires flatbed and we show up with a wheel-lift, that's on us and we'll bring the right truck — no extra charge for our mistake.",
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "Jump-start: $149 / hour, 1-hour minimum — $124 first hour online. Most calls resolve in under 30 minutes (inside the minimum). On-scene battery replacement adds the battery itself at retail; the labor is already inside the hour.",
    ],
  },
  {
    ...
    content: [
      ...
      "Tire change: $149 / hour, 1-hour minimum — $124 first hour online. Plug/patch service runs in the same hour. Tow to a tire shop if you don't have a spare: same hourly rate, time added based on distance.",
  ...
  },
  {
    ...
    content: [
      ...
      "EV tows use the same $149 / hour rate as every other call, 1-hour minimum. Book online and pay $124 for the first hour. Long-distance tows to out-of-state specialty shops available on request (Tesla service centers in NJ, Rivian in NJ and CT) — quoted as estimated total hours up front.",
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "Rate structure: $149 / hour for every service, 1-hour minimum. Book online and pay $124 for the first hour. Long-distance motorcycle transport quoted as estimated total hours up front. Enclosed transport adds time on the schedule but the rate stays the same.",
  ...
  },
  {
    ...
    content: [
      ...
      "Standard lockout: $149 / hour, 1-hour minimum — $124 first hour online. On-scene time typically 5–20 minutes (inside the minimum). If we arrive and the situation genuinely requires dealer intervention (rare), we don't charge — you pay only when we actually solve the problem.",
    ],
  },
  {
    ...
    content: [
      ...
      "Our rate: $149 / hour for every service, 1-hour minimum, $124 first hour when you book online. Most NYC breakdowns resolve well inside one hour — meaning the typical call lands at the 1-hour minimum. If you call us 2–3 times a year and book online each time, you pay roughly $448–$672. If you call 5+ times a year, a fleet account with us beats AAA retail overage pricing.",
      "The coverage comparison: AAA covers most of what we do — jump, tire, lockout, gas, short tows. But AAA's service caps matter. Some memberships limit tows to 3–5 miles from the breakdown location. If your breakdown is 7 miles from your preferred shop, you pay retail on the overage. Our hourly rate has no mileage cap — same $149 / hour regardless of distance, with longer routes simply taking more time on the clock.",
...
export const BLOG_POSTS: BlogPost[] = [...ORIGINAL_POSTS, ...TIPS_100];