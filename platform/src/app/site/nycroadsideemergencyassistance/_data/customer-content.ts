...
export function customerCityContent(ct: CustomerType, cityName: string, stateName: string, stateAbbr: string) {
  return [
    ...
    `NYC Roadside Emergency Assistance operation in ${cityName}: NYC DCWP licensed, full commercial auto, garage liability, and on-hook insurance. W-2 driver employees who train on every common vehicle platform. Flat-rate pricing. Photos at scene and drop. Receipts emailed within minutes. Call ${PHONE}.`,
