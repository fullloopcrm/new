...
const SERVICE_FAQS: Record<string, ServiceFAQ[]> = {
  ...
  "mobile-mechanic-on-site-repairs": [
    ...
    },
    {
      ...
      a: "Usually yes, significantly. Shop rates in NYC run $125-200+ per hour labor, plus shop fees, plus the time you lose for the visit. Curbside repair is our standard $149 / hour rate (1-hour minimum, $124 first hour online), parts at retail. For a simple sensor swap that takes 20 minutes, you're often saving the shop-visit time and most of the labor cost.",
    },
    {
  ...
  "impound-recovery": [
    ...
    },
    {
      ...
      a: "Yes. We retrieve from the pound and deliver to any address in the five boroughs — home, work, shop, storage facility. Same $149 / hour rate as every other service. Delivery outside the boroughs is available — additional hours quoted in advance based on the route.",
    },
    {
