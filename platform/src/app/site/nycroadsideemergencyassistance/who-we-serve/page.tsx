...
export const metadata: Metadata = {
  title: "Who We Serve — $149/hr, $25 Off Online, No Catches. NYC Tow For Every Driver.",
  description: `NYC towing and roadside service for ${CUSTOMER_TYPES.length} customer types at one transparent rate: $149/hour, $25 off online ($124 first hour). No NYC surcharge, no after-hours markup. Stranded drivers, fleets, insurance, body shops, property managers, EV owners, commercial trucking, and more.`,
