...
import { FAQ } from "@/app/site/nycroadsideemergencyassistance/_data/content";
import { JsonLd, breadcrumbSchema, faqPageSchema } from "@/app/site/nycroadsideemergencyassistance/_lib/schema";

export const metadata: Metadata = {
  title: "NYC Tow FAQ — $149/hr, $25 Off Online, No Catches Explained.",
  description: "Common questions about NYC towing and roadside service. One rate: $149/hour, $25 off online ($124 first hour). No NYC surcharge, no after-hours markup, no hidden fees. Pricing, flatbed vs wheel-lift, AWD/EV, impound recovery, fleet accounts, insurance billing.",
...
const LEFT_FAQS = [
  ...
  { q: "How does your pricing work?", a: <>One rate for every service: $149 per hour, 1-hour minimum, billed in half-hour increments after. Book online and your first hour is $124 instead of $149. No NYC surcharge, no after-hours markup, no hidden fees. See full <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">pricing breakdown</Link>.</> },
  ...
  { q: "What if I just need a jump or a tire change?", a: <>Same $149 / hour rate with a 1-hour minimum ($124 first hour when you book online). Most roadside calls finish in 15–30 minutes — well inside the hour. Dispatch routes the nearest truck, typical arrival 20–40 minutes. If the job escalates to a tow, the hour you&apos;ve already paid for credits against the total. See <Link href="/services/roadside-assistance" className="text-teal-700 font-semibold hover:underline">roadside details</Link>.</> },
  ...
  { q: "How does the hourly rate work after the first hour?", a: <>First hour is the minimum at $149 / hour ($124 first hour online). After that, billed in half-hour increments at the same rate — $124.50 per half hour. Estimated total hours are quoted before dispatch so you know the number before we move.</> },
