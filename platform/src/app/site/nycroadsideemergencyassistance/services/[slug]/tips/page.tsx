...
import { PHONE } from "@/app/site/nycroadsideemergencyassistance/_data/content";
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `${service.title} in NYC — complete guide. Emergency 101, common causes, flat-rate pricing, do's and don'ts, and NYC-specific FAQs from NYC Roadside Emergency Assistance dispatch team.`,
      ...
      <JsonLd
        schema={[
          ...
          howToSchema({
            ...
            description: `${service.title} step-by-step protocol from NYC Roadside Emergency Assistance dispatch team.`,
          ...
          articleSchema({
            ...
            author: "NYC Roadside Emergency Assistance Dispatch",
          }),
          faqPageSchema(
            tips.faq.map((f) => ({
              question: f.q,
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            What to do right now, what it costs, why it happens, and how we handle the call — straight from NYC Roadside Emergency Assistance dispatch team.
          </p>
