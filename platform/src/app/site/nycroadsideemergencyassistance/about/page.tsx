...
export const metadata: Metadata = {
  title: "About — $149/hr, $25 Off Online, No Catches. Licensed Local NYC Tow Operator.",
  description: "Licensed NYC DCWP tow operator running 24/7 across all five boroughs. One rate: $149/hour, $25 off when you book online ($124 first hour). No NYC surcharge, no after-hours markup. W-2 drivers, full insurance. The local operator national networks subcontract to.",
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl font-heading">
            About <span className="gradient-text">NYC Roadside Emergency Assistance</span> — Licensed 24/7 Tow Operator
          </h1>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-teal-400 hover:shadow-md text-center">
              <p className="text-3xl font-bold text-teal-700 font-heading">$124</p>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="relative mx-auto mt-8 aspect-[16/7] max-w-4xl overflow-hidden rounded-2xl shadow-lg">
            {(() => { const _photo = getPhoto("_about"); return (<Image src={_photo.url} alt={_photo.alt} fill sizes="(max-width: 1024px) 100vw, 1024px" className="object-cover" priority={false} />); })()}
          </div>
          <div className="mx-auto mt-8 max-w-3xl space-y-5 text-center text-base leading-relaxed text-slate-700">
