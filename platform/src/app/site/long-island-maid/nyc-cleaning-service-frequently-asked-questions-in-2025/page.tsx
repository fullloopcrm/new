...
const pageUrl = 'https://www.thelongislandmaid.com/nyc-cleaning-service-frequently-asked-questions-in-2025'
const pageTitle = 'NYC Cleaning Service FAQ — Pricing, Services & Scheduling | The Long Island Maid'
const pageDescription = 'Answers to 24 common questions about The Long Island Maid — pricing ($59–$89/hr) plus 20% off weekly recurring, what\'s included, scheduling, insurance, service areas, and more. Serving Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. (516) 202-5900'
