...
const pageUrl = 'https://www.thelongislandmaid.com/available-nyc-maid-jobs'
const pageTitle = 'Cleaning Jobs NYC, Long Island, Westchester & NJ — Starting $30/hr + Bonuses, Open 24/7 | Trabajo de Limpieza'
const pageDescription = 'Hiring cleaners across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ! Starting $30/hr + bonus programs. Stripe in <30 min. 100% tips. Open 24/7. English & Spanish | Contratando — desde $30/hr + bonos, propinas 100% tuyas. (516) 202-5900'
