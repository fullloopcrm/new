...
import { breadcrumbSchema, localBusinessSchema, serviceItemListSchema } from '@/app/site/long-island-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  ...
  description: 'All cleaning services by The Long Island Maid from $59/hr. Deep cleaning, weekly maid service, move-in/out, post-construction, Airbnb, same-day. Long Island & NJ.',
  ...
  openGraph: {
    ...
    description: 'Professional cleaning services from $59/hr across Long Island & NJ. Licensed, insured, 5-star rated.',
    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-xs font-semibold text-gray-400 tracking-[0.2em] uppercase mb-3">Why New Yorkers Choose The Long Island Maid</h2>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Our cleaners serve all of Long Island — same rates, same quality, no travel fees. <Link href="/reviews" className="text-[#1E2A4A] underline underline-offset-2">Read our reviews</Link> to see what clients say.
            </p>
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <a href="sms:5162025900" className="inline-block text-[#1E2A4A] font-semibold py-3.5 hover:underline underline-offset-4">
                Text us for questions
              </a>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mb-8">
            Every service listed above is available across our entire Long Island service area. Same rates, same quality, everywhere we serve.
          </p>
      ...
      <CTABlock title="Book Any Cleaning Service Today" subtitle="Text us — trusted by New Yorkers across Long Island." />
    </>
  )
}
