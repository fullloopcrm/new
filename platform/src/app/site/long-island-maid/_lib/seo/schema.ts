...
const BUSINESS = {
  ...
  legalName: 'The Long Island Maid Cleaning Service LLC',
  url: 'https://www.thelongislandmaid.com',
  phone: '+1-516-202-5900',
  phoneDisplay: '(516) 202-5900',
  email: 'hi@thelongislandmaid.com',
  logo: 'https://www.thelongislandmaid.com/icon-512.png',
  image: 'https://www.thelongislandmaid.com/icon-512.png',
  priceRange: '$$',
  currenciesAccepted: 'USD',
  paymentAccepted: 'Cash, Credit Card, Debit Card, Apple Pay, Cash App',
  description: 'Professional house cleaning services across Long Island. Deep cleaning, regular apartment cleaning, move-in/move-out, post-construction cleanup, weekly maid service, same-day cleaning, Airbnb turnover, and office cleaning. Licensed, insured, and background-checked cleaners.',
  slogan: "Long Island's Trusted Cleaning Service",
  knowsLanguage: ['en', 'es'],
...
const logoObj = {
  ...
  width: 512,
  height: 512,
  caption: 'The Long Island Maid Logo',
}
...
const fullAreaServed = [
  { '@type': 'AdministrativeArea' as const, name: 'Long Island' },
]

const serviceAreaObj = {
  '@type': 'GeoCircle' as const,
  geoMidpoint: { '@type': 'GeoCoordinates' as const, latitude: 40.7370, longitude: -73.5594 },
  geoRadius: '80000',
}
...
export function webSiteSchema() {
  return {
    ...
    potentialAction: {
      ...
      target: {
        '@type': 'EntryPoint',
        urlTemplate: `${BUSINESS.url}/service-areas-served-by-the-long-island-maid?q={search_term_string}`,
      },
...
export function localBusinessSchema(neighborhood?: Neighborhood, area?: Area) {
  ...
  return {
    ...
    hasMap: 'https://maps.google.com/?q=The+Long+Island+Maid+Garden+City+NY',
    areaServed,
      ...
      itemListElement: [
        {
          ...
          itemListElement: [
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Deep Cleaning', url: `${BUSINESS.url}/services/deep-cleaning-service-in-long-island` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Regular Apartment Cleaning', url: `${BUSINESS.url}/services/apartment-cleaning-service-in-long-island` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Weekly Maid Service', url: `${BUSINESS.url}/services/weekly-maid-service-in-long-island` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Bi-Weekly Cleaning', url: `${BUSINESS.url}/services/bi-weekly-cleaning-service-in-long-island` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Monthly Cleaning', url: `${BUSINESS.url}/services/monthly-cleaning-service-in-long-island` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Move-In/Move-Out Cleaning', url: `${BUSINESS.url}/services/move-in-move-out-cleaning-service-in-long-island` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Post-Construction Cleanup', url: `${BUSINESS.url}/services/post-construction-cleanup-service-in-long-island` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Same-Day Cleaning', url: `${BUSINESS.url}/services/same-day-cleaning-service-in-long-island` } },
          ],
        },
        {
          '@type': 'OfferCatalog',
          ...
          itemListElement: [
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Office Cleaning', url: `${BUSINESS.url}/services/office-cleaning-service-in-long-island` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Airbnb & Short-Term Rental Cleaning', url: `${BUSINESS.url}/services/airbnb-cleaning-in-long-island` } },
          ],
        },
      ],
    },
    ...
    potentialAction: [
      {
        ...
        target: {
          '@type': 'EntryPoint',
          urlTemplate: `${BUSINESS.url}/contact-the-long-island-maid-service-today`,
...
export function serviceSchema(service: Service, neighborhood?: Neighborhood, area?: Area) {
  const location = neighborhood ? `${neighborhood.name}, ${area?.name || ''}` : 'Long Island'
...
export function reviewSchemas(reviews?: ReviewSchemaInput[]) {
  ...
  return r.map(review => ({
    ...
    publisher: { '@type': 'Organization', name: 'The Long Island Maid' },
  }))
}
...
export function siteNavigationSchema() {
  return {
    ...
    hasPart: [
      { '@type': 'WebPage', name: 'Contact', url: `${BUSINESS.url}/contact-the-long-island-maid-service-today`, position: 1 },
      { '@type': 'WebPage', name: 'Services', url: `${BUSINESS.url}/long-island-maid-service-services-offered-by-the-long-island-maid`, position: 2 },
      { '@type': 'WebPage', name: 'Pricing', url: `${BUSINESS.url}/updated-long-island-maid-service-industry-pricing`, position: 3 },
      { '@type': 'WebPage', name: 'Service Areas', url: `${BUSINESS.url}/service-areas-served-by-the-long-island-maid`, position: 4 },
      { '@type': 'WebPage', name: 'Reviews', url: `${BUSINESS.url}/reviews`, position: 5 },
      { '@type': 'WebPage', name: 'Now Hiring Cleaners', url: `${BUSINESS.url}/available-long-island-maid-jobs`, position: 6 },
      { '@type': 'WebPage', name: 'Contact', url: `${BUSINESS.url}/contact-the-long-island-maid-service-today`, position: 7 },
      { '@type': 'WebPage', name: 'FAQ', url: `${BUSINESS.url}/long-island-cleaning-service-frequently-asked-questions-in-2025`, position: 8 },
      { '@type': 'WebPage', name: 'About', url: `${BUSINESS.url}/about-the-long-island-maid-service-company`, position: 9 },
      { '@type': 'WebPage', name: 'Blog & Tips', url: `${BUSINESS.url}/long-island-maid-service-blog`, position: 10 },
    ],
  }
}
...
export function howToBookSchema() {
  return {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: 'How to Book a Cleaning Service with The Long Island Maid',
    ...
    step: [
      {
        '@type': 'HowToStep',
        name: 'Contact Us',
        text: 'Text (516) 202-5900 to schedule your cleaning.',
        url: `${BUSINESS.url}/contact-the-long-island-maid-service-today`,
        position: 1,
      },
      {
        '@type': 'HowToStep',
...
export function serviceItemListSchema() {
  return {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'Cleaning Services Offered by The Long Island Maid',
    description: 'Complete list of professional cleaning services available across Long Island.',
...
export function areaItemListSchema() {
  return {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'Service Areas Covered by The Long Island Maid',
    description: 'We serve Long Island and the surrounding area.',
...
export function professionalServiceSchema(service: Service, neighborhood?: Neighborhood, area?: Area) {
  ...
  return {
    ...
    name: `${service.name}${neighborhood ? ` in ${neighborhood.name}` : ''} - The Long Island Maid`,
    description: service.description,
...
export function homepageSchemas() {
  ...
  return [
    ...
    webPageSchema({
      url,
      name: 'Long Island Maid Service & House Cleaning From $59/hr | 5-Star Rated | The Long Island Maid',
      description: BUSINESS.description,
      type: 'WebPage',
...
export function areaPageSchemas(area: Area) {
  ...
  const title = `${area.name} Maid Service & House Cleaning From $59/hr | The Long Island Maid`
...
export function neighborhoodPageSchemas(neighborhood: Neighborhood, area: Area) {
  ...
  const title = `${neighborhood.name} Maid Service & House Cleaning From $59/hr | The Long Island Maid`
...
export function neighborhoodServicePageSchemas(neighborhood: Neighborhood, service: Service, area: Area) {
  ...
  const title = `${service.name} in ${neighborhood.name}, ${area.name} From $59/hr | The Long Island Maid`
...
export function servicePageSchemas(service: Service) {
  ...
  const description = `Professional ${service.name.toLowerCase()} across Long Island. ${service.features.slice(0, 3).join(', ')} & more. From ${service.priceRange.split('–')[0]}. 5.0★ Rated. ${BUSINESS.phoneDisplay}`
  return [
    organizationSchema(),
    webSiteSchema(),
    webPageSchema({
      ...
      breadcrumb: [
        { name: 'Home', url: BUSINESS.url },
        { name: 'Services', url: `${BUSINESS.url}/long-island-maid-service-services-offered-by-the-long-island-maid` },
        { name: service.name, url },
      ],
    }),
    localBusinessSchema(),
