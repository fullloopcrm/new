...
export const metadata: Metadata = {
  title: 'Blog | NYC Cleaning Tips & News | The Long Island Maid',
  description: 'The Long Island Maid blog — cleaning tips, guides & news for NYC residents. Apartment care, eco-friendly products & pro advice. Service from $59/hr. (516) 202-5900',
  alternates: { canonical: 'https://www.thelongislandmaid.com/nyc-maid-service-blog' },
  openGraph: {
    title: 'Blog | The Long Island Maid',
    description: 'Expert cleaning tips and guides for NYC residents.',
    url: 'https://www.thelongislandmaid.com/nyc-maid-service-blog',
  },
  twitter: {
