      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center max-w-sm">
            ...
            <p className="text-gray-500 text-sm mt-4">Questions? (516) 202-5900</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto p-4 pt-6">
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          {/* Location */}
          <div>
            <label className="block text-sm font-medium text-[#1E2A4A] mb-1">Your Location (Long Island area) *</label>
            <input
              type="text"
              required
              value={form.location}
          ...
          <p className="text-xs text-gray-400 text-center">Questions? (516) 202-5900</p>
        </form>
      </div>
    </div>
  )
