    ...
    return (
      <div className="min-h-screen bg-white flex flex-col">
        <div className="bg-[#1E2A4A] px-6 py-4">
          <h1 className="text-white text-xl font-bold">The Long Island Maid</h1>
        </div>
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center max-w-sm">
            ...
            <p className="text-gray-500 text-sm mt-4">Questions? / ¿Preguntas? (516) 202-5900</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="max-w-lg mx-auto p-4 pt-6">
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">We&apos;re looking for reliable, detail-oriented cleaners in Long Island.</p>
            <p className="text-gray-500 text-sm">Buscamos limpiadores confiables y detallistas en Long Island.</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-[#1E2A4A] mb-1">Preferred Language / Idioma / Язык *</label>
            <select
              required
              value={form.preferred_language}
              onChange={(e) => setForm({ ...form, preferred_language: e.target.value })}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg text-[#1E2A4A] text-base bg-white"
            >
          ...
          <div>
            <label className="flex items-center gap-3 px-3 py-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Required for Long Island, Long Island, Long Island, and some outer borough areas</p>
                <p className="text-xs text-gray-500">Requerido para Long Island, Long Island, Long Island, y algunas áreas exteriores</p>
                <p className="text-xs text-green-600 font-medium mt-1">+$5/hr bonus for car-required locations (Long Island, Long Island, Long Island, NJ) / +$5/hr bonificación para ubicaciones que requieren auto</p>
              </div>
            </label>
          </div>
          ...
          <div>
            <div>
              <label className="block text-sm font-medium text-[#1E2A4A] mb-2">Do you bring your own cleaning supplies &amp; equipment? / ¿Trae sus propios suministros y equipo de limpieza? *</label>
              <div className="grid grid-cols-2 gap-3">
                <label className={`flex items-center gap-3 px-3 py-3 border rounded-lg cursor-pointer ${!form.labor_only ? 'border-[#1E2A4A] bg-blue-50' : 'border-gray-200 hover:bg-gray-50'}`}>
                  <input
                    type="radio"
                    name="supplies"
                  ...
                  />
                  <div>
                    <span className="text-sm font-medium text-[#1E2A4A]">Yes / Sí</span>
                ...
                <label className={`flex items-center gap-3 px-3 py-3 border rounded-lg cursor-pointer ${form.labor_only ? 'border-[#1E2A4A] bg-blue-50' : 'border-gray-200 hover:bg-gray-50'}`}>
                  ...
                  />
                  <div>
                    <span className="text-sm font-medium text-[#1E2A4A]">No — labor only / Solo mano de obra</span>
          ...
          <div className="my-5 p-4 border border-gray-200 rounded-lg bg-gray-50">
            <label className="flex items-start gap-3 cursor-pointer text-[13px] leading-relaxed text-gray-600">
              ...
              />
              <span>
                By checking this box, I consent to receive transactional text messages from <strong>The Long Island Maid</strong> for appointment confirmations, reminders, and customer support. Reply STOP to opt out. Reply HELP for help. Msg frequency may vary. Msg &amp; data rates may apply.
                <br /><br />
                Al marcar esta casilla, doy mi consentimiento para recibir mensajes de texto de <strong>The Long Island Maid</strong> para confirmaciones de citas, recordatorios y atención al cliente. Responda STOP para cancelar. Responda HELP para ayuda.
                <br /><br />
                <a href="https://www.thelongislandmaid.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#1E2A4A] hover:underline">Privacy Policy</a> | <a href="https://www.thelongislandmaid.com/terms-conditions" target="_blank" rel="noopener noreferrer" className="text-[#1E2A4A] hover:underline">Terms &amp; Conditions</a>
              </span>
            </label>
          </div>
          ...
          <p className="text-xs text-gray-400 text-center">
            Questions? / ¿Preguntas? (516) 202-5900
          </p>
        </form>
      </div>
    </div>
