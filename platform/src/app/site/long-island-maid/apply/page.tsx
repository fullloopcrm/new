          ...
          <div>
            <label className="flex items-center gap-3 px-3 py-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Required for Long Island, and some outer borough areas</p>
                <p className="text-xs text-gray-500">Requerido para Long Island, y algunas áreas exteriores</p>
                <p className="text-xs text-green-600 font-medium mt-1">+$5/hr bonus for car-required locations (Long Island, NJ) / +$5/hr bonificación para ubicaciones que requieren auto</p>
              </div>
            </label>
          </div>
