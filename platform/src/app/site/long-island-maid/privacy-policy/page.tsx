...
export const metadata: Metadata = {
  title: 'Privacy Policy | The Long Island Maid',
  description: 'The Long Island Maid privacy policy — how we protect your data. We never sell or share your information. Long Island cleaning from $59/hr. (516) 202-5900',
  alternates: { canonical: 'https://www.thelongislandmaid.com/privacy-policy' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Privacy Policy', url: 'https://www.thelongislandmaid.com/privacy-policy' },
      ])} />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about this privacy policy? Contact us at <a href="mailto:hi@thelongislandmaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thelongislandmaid.com</a> or text <a href="sms:5162025900" className="text-[#1E2A4A] underline underline-offset-2">(516) 202-5900</a>.
            </p>
