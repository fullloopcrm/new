...
const process = [
  { step: '1', title: 'Text Us', description: 'Text (516) 202-5900 and describe the situation. We\'ll ask what happened, when it happened, and the scope of damage. Be honest about severity — it helps us send the right team with the right equipment.' },
...
export default function EmergencyCleaningPage() {
  ...
  const serviceSchema = {
    ...
    availableChannel: {
      '@type': 'ServiceChannel',
      servicePhone: { '@type': 'ContactPoint', telephone: '+15162025900', contactType: 'customer service', availableLanguage: ['English', 'Spanish'] },
    },
    hoursAvailable: {
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="sms:5162025900" className="text-white font-semibold text-lg hover:underline underline-offset-4">
