...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `${service.name} in NYC From ${service.priceRange.split('–')[0]} | 5-Star Rated | The Long Island Maid`
  const description = `Professional ${service.name.toLowerCase()} across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. ${service.features.slice(0, 2).join(', ')} & more. From ${service.priceRange.split('–')[0]}. 5.0★ Rated. (516) 202-5900`
