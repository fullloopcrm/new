...
const serviceLinks = [
  ...
  { name: 'Regular Apartment Cleaning', href: '/services/apartment-cleaning-service-in-long-island' },
  { name: 'Weekly Service', href: '/services/weekly-maid-service-in-long-island' },
  { name: 'Bi-Weekly Cleaning', href: '/services/bi-weekly-cleaning-service-in-long-island' },
  ...
  { name: 'All Services', href: '/long-island-maid-service-services-offered-by-the-long-island-maid' },
]

const moreLinks = [
  { name: 'About', href: '/about-the-long-island-maid-service-company' },
  { name: 'FAQ', href: '/long-island-cleaning-service-frequently-asked-questions-in-2025' },
  { name: 'Careers — Administrator', href: '/careers/administrator' },
  { name: 'Careers — Cleaning Jobs', href: '/available-long-island-maid-jobs' },
  { name: 'Careers — Sales Partner', href: '/careers/commission-sales-partner' },
  { name: 'Locations', href: '/service-areas-served-by-the-long-island-maid' },
        ...
        <div className="bg-[#1E2A4A] text-gray-300 text-xs">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center lg:justify-between h-9">
            <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] tracking-widest uppercase">
              ...
              <Link href="/service-areas-served-by-the-long-island-maid" className="hover:text-white transition-colors font-semibold text-white/80 hidden sm:inline">LI</Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[72px]">
            <Link href="/" className="flex-shrink-0">
              <span className="font-[family-name:var(--font-bebas)] text-2xl sm:text-3xl text-[#1E2A4A] tracking-wide">The Long Island Maid</span>
            </Link>
            ...
            <nav className="hidden lg:flex items-center justify-center flex-1 gap-8 mx-8">
              ...
              <Link href="/updated-long-island-maid-service-industry-pricing" className="text-[#1E2A4A] hover:text-[#1E2A4A]/70 font-medium text-[15px] tracking-wide">Pricing</Link>
            ...
            <div className="hidden lg:flex items-center gap-2">
              <a href="sms:5162025900" className="inline-block bg-[#1E2A4A] text-white px-3.5 py-2 rounded-md font-bold text-xs tracking-wide uppercase hover:bg-[#1E2A4A]/90 transition-colors whitespace-nowrap">
                Text 516.202.5900
              </a>
            ...
            <div className="lg:hidden flex items-center gap-2">
              <a href="sms:5162025900" className="bg-[#1E2A4A] text-white px-3 py-2 rounded-md font-bold text-xs tracking-widest uppercase">
                Text
              </a>
        ...
        <div className={`absolute top-0 left-0 h-full w-[85%] max-w-sm bg-[#1E2A4A] transform transition-transform duration-300 ease-out ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="bg-white flex items-center justify-between px-5 py-4">
            <Link href="/" onClick={closeMenu}>
              <span className="font-[family-name:var(--font-bebas)] text-xl text-[#1E2A4A] tracking-wide">The Long Island Maid</span>
            </Link>
          ...
          <div className="overflow-y-auto h-[calc(100%-72px)] px-5 py-6">
            <div className="space-y-1">
              ...
              <Link href="/updated-long-island-maid-service-industry-pricing" onClick={closeMenu} className="block py-3 text-white font-medium text-lg">Pricing</Link>
              ...
              <div className="border-t border-white/10 mt-4 pt-6 space-y-3 text-center">
                ...
                <a href="sms:5162025900" className="block bg-[#1E2A4A] text-white py-3 rounded-lg font-bold text-sm tracking-widest uppercase border border-white/20">Text 516.202.5900</a>
              </div>
            </div>
          </div>
        </div>
