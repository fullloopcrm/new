...
import {
  ...
  ALL_NEIGHBORHOODS,
  AREAS,
} from '@/app/site/long-island-maid/_lib/seo/locations'
import { SERVICES } from '@/app/site/long-island-maid/_lib/seo/services'
import { areaContent, neighborhoodContent, neighborhoodFAQs, commonServiceFAQs, neighborhoodVibe, neighborhoodKnownFor, neighborhoodFunFacts } from '@/app/site/long-island-maid/_lib/seo/content'
import { areaPageSchemas, neighborhoodPageSchemas, faqSchema } from '@/app/site/long-island-maid/_lib/seo/schema'
...
import NearbyNeighborhoods from '@/app/site/long-island-maid/_components/NearbyNeighborhoods'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (area) {
    ...
    const url = `https://www.thelongislandmaid.com/${slug}`
    const title = `${area.name} Maid Service & House Cleaning From $59/hr | The Long Island Maid`
    const description = `Professional house cleaning in ${area.name} from $59/hr. Deep cleaning, weekly maid service, move-in/out & more. Licensed, insured, 5.0★ Rated. (516) 202-5900`
    return {
  ...
  if (neighborhood) {
    ...
    const description = `Professional cleaning in ${neighborhood.name}, ${neighborhoodArea.name}. Serving ${neighborhood.housing_types.slice(0, 2).join(', ')} near ${neighborhood.landmarks[0]}. From $59/hr. 5.0★ Rated. (516) 202-5900`
    return {
      title: { absolute: title },
      description,
      alternates: { canonical: url },
      ...
      <>
        ...
        <section className="bg-white">
          <figure className="relative aspect-[21/9] w-full overflow-hidden max-h-[520px]">
            ...
            />
            <figcaption className="sr-only">{areaPhoto.caption} — {area.name} cleaning service by The Long Island Maid</figcaption>
          </figure>
        </section>
        ...
        <section className="py-20 bg-[#1E2A4A]">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { n: '01', t: 'Text Us', d: `Reach us at (516) 202-5900 with your ${area.name} address, preferred date, and any special requests.` },
      ...
      <>
        ...
        <section className="bg-white border-b border-gray-100 pt-14 md:pt-20 pb-0">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <a href="sms:5162025900" className="text-[#1E2A4A] font-semibold py-4 hover:underline underline-offset-4">
        ...
        <section className="bg-white">
          <figure className="relative aspect-[21/9] w-full overflow-hidden max-h-[520px]">
            <Image
              ...
              className="object-cover"
            />
            <figcaption className="sr-only">{neighborhoodPhoto.caption} — {neighborhood.name}, {neighborhoodArea.name} cleaning service by The Long Island Maid</figcaption>
          </figure>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <a href="sms:5162025900" className="text-[#1E2A4A] font-semibold hover:underline underline-offset-4">
                    Text us for questions
                  </a>
                </div>
              </div>
        ...
        <section className="py-20 bg-[#1E2A4A]">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { n: '01', t: 'Text Us', d: `Reach us at (516) 202-5900 with your ${neighborhood.name} address, preferred date, and any special requests.` },
                { n: '02', t: 'We Confirm', d: 'We match you with a background-checked, insured cleaner and lock in your appointment — usually within the hour.' },
                { n: '03', t: 'Pay After', d: 'Your cleaner arrives on time, does the work, and you pay only after the cleaning is complete. No deposits ever.' },
              ].map(s => (
                <div key={s.n} className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
