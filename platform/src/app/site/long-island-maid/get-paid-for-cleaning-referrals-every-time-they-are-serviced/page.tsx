...
import { breadcrumbSchema, localBusinessSchema, faqSchema } from '@/app/site/long-island-maid/_lib/seo/schema'
...
import ReferralFAQSection from '@/app/site/long-island-maid/_components/ReferralFAQSection'
import ReferralCTABlock from '@/app/site/long-island-maid/_components/ReferralCTABlock'
import ReferralPageBody from '@/app/site/long-island-maid/_components/ReferralPageBody'

export const metadata: Metadata = {
  title: 'Get Paid for Cleaning Referrals | Earn 10% Commission | The Long Island Maid',
  description: 'Earn 10% commission every time your referral books a cleaning (from $59/hr). Recurring income, fast payouts via Stripe. (516) 202-5900',
  alternates: { canonical: 'https://www.thelongislandmaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
  openGraph: {
    title: 'Get Paid for Cleaning Referrals | The Long Island Maid',
    description: 'Earn 10% commission every time someone you refer books a cleaning. Recurring income, fast payouts.',
    url: 'https://www.thelongislandmaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Referral Program', url: 'https://www.thelongislandmaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
        ]),
