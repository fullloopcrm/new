...
import { organizationSchema, webSiteSchema, webPageSchema, breadcrumbSchema, faqSchema } from '@/app/site/long-island-maid/_lib/seo/schema'
...
const pageUrl = 'https://www.thelongislandmaid.com/careers/operations-coordinator'
const pageTitle = 'Part-Time Operations Admin — 10% Per Job, ~$40/hr Last Month | The Long Island Maid'
const pageDescription = 'The Long Island Maid is hiring a part-time operations coordinator. Earn 10% of every completed job — paid per job via Stripe. Last month 10% averaged out to about $40/hr. Own the calendar, cleaners, and collections. Aiming for 100 services/week. Apply now.'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    images: [{ url: 'https://www.thelongislandmaid.com/icon-512.png', width: 512, height: 512, alt: 'Part-Time Operations Admin — The Long Island Maid — Now Hiring' }],
...
function coordinatorJobPostingSchema() {
  ...
  return {
    ...
    datePosted,
    validThrough,
    description: `<h2>Part-Time Operations Admin — The Long Island Maid — Remote</h2>
<p>The Long Island Maid is hiring a <strong>part-time operations coordinator</strong> to own the calendar, the cleaners, and the collections. You earn <strong>10% of every completed and paid job</strong> — paid per job via Stripe within minutes of completion, same as the cleaners. No base salary. No hourly rate. You earn when the business earns.</p>
...
<h3>How to Apply</h3>
<p>Submit your application at <a href="https://www.thelongislandmaid.com/apply/operations-coordinator">thelongislandmaid.com/apply/operations-coordinator</a>. Include a photo and a 60-second selfie video introduction. If bilingual, speak in both English and Spanish.</p>`,
    ...
    hiringOrganization: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://www.thelongislandmaid.com/icon-512.png',
        width: 512,
        height: 512,
      },
      telephone: '+1-516-202-5900',
    ...
    identifier: {
      '@type': 'PropertyValue',
      name: 'The Long Island Maid',
      value: 'long-island-maid-ops-coordinator-2026',
    },
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Go to thelongislandmaid.com/apply/operations-coordinator. Fill out the short form, upload a photo of yourself and a 60-second selfie video. If you\'re bilingual, speak in both English and Spanish in the video. We review applications within 48 hours.',
  },
]
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            <a href="sms:5162025900" data-track="coord-hero-text" className="text-blue-200/70 font-medium text-lg py-4 hover:text-white transition-colors underline underline-offset-4">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <section className="bg-[#A8F0DC] rounded-2xl p-8 md:p-12 text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="sms:5162025900" data-track="coord-bottom-text" className="text-[#1E2A4A]/60 font-medium text-sm hover:text-[#1E2A4A] transition-colors underline underline-offset-4">
              Text us for questions
            </a>
          </div>
        </section>
