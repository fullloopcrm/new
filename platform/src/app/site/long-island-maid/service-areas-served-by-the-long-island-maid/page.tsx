...
const pageUrl = 'https://www.thelongislandmaid.com/service-areas-served-by-the-long-island-maid'
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <Breadcrumbs items={[{ name: 'Service Area', href: '/service-areas-served-by-the-long-island-maid' }]} />
