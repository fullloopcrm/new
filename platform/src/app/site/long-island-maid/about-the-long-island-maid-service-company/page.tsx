...
import { getNeighborhoodsByArea, ALL_NEIGHBORHOODS } from '@/app/site/long-island-maid/_lib/seo/locations'
...
const aboutFaqs = [
  { question: 'How long has The Long Island Maid been in business?', answer: 'Since 2018. We started serving Long Island and have expanded to Long Island. We\'ve completed thousands of cleanings and maintain a 5.0-star rating with 50+ verified reviews.' },
  ...
  { question: 'How many neighborhoods do you serve?', answer: `We serve ${ALL_NEIGHBORHOODS.length}+ neighborhoods across Long Island. Same rates everywhere — no travel surcharges.` },
  ...
  return (
    <>
      <JsonLd data={[
        organizationSchema(),
        webSiteSchema(),
        webPageSchema({ url, name: title, description, type: 'AboutPage', breadcrumb: [{ name: 'Home', url: 'https://www.thelongislandmaid.com' }, { name: 'About', url }] }),
        localBusinessSchema(),
        howToBookSchema(),
        breadcrumbSchema([{ name: 'Home', url: 'https://www.thelongislandmaid.com' }, { name: 'About', url }]),
        faqSchema(aboutFaqs),
      ]} />
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-200/60 text-lg max-w-2xl mx-auto leading-relaxed">
            The Long Island Maid has been keeping New York homes clean since 2018. No gimmicks, no corporate nonsense — just honest, dependable cleaning from people who care.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            <div className="lg:col-span-3">
              ...
              <div className="space-y-5 text-gray-600 leading-relaxed">
                <p>
                  We started The Long Island Maid in 2018 because we were frustrated with the cleaning industry in New York. Prices were inflated, quality was inconsistent, and companies treated cleaners and clients like numbers. We knew there had to be a better way.
                </p>
                <p>
                ...
                <p>
                  That approach has earned us a perfect 5.0-star rating with 50+ verified client reviews, thousands of completed cleanings, and a client base that includes homes across Garden City, Great Neck, and the surrounding towns. Many of our clients have been with us for years — and they stay because we deliver the same quality every single visit.
                </p>
                <p>
                  Today we serve {ALL_NEIGHBORHOODS.length}+ neighborhoods across Long Island. Our team is bilingual (English and Spanish), background-checked, licensed, and insured. Our pricing is straightforward — $59/hr with your supplies (recurring: 10% off weekly, 5% off biweekly/monthly), $69/hr when we bring everything (recurring: 20% off weekly, 10% off biweekly/monthly), $89/hr for same-day emergency service.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-to-b from-[#1E2A4A] to-[#243352]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-white tracking-wide text-center mb-4">The Long Island Maid Difference</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#1E2A4A] tracking-wide text-center mb-12">About The Long Island Maid</p>
