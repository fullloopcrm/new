...
import MarketingNav from '@/app/site/long-island-maid/_components/MarketingNav'
import MarketingFooter from '@/app/site/long-island-maid/_components/MarketingFooter'
import ReferralBanner from '@/app/site/long-island-maid/_components/ReferralBanner'
...
export const metadata = {
  title: {
    default: 'The Long Island Maid — Professional Cleaning Services in Long Island From $59/hr',
  },
}
...
export default function MarketingLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${bebasNeue.variable} ${inter.variable} font-[family-name:var(--font-inter)]`}>
      ...
      <MarketingFooter />
      <TenantAnalyticsScript slug="long-island-maid" />
      <ClientErrorMonitor slug="long-island-maid" />
