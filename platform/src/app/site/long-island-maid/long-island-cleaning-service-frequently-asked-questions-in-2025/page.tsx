...
const schedulingFAQs = [
  { question: 'How do I book a cleaning?', answer: 'Text (516) 202-5900. We typically schedule within 24–48 hours. Same-day availability for urgent requests.' },
  ...
  { question: 'Do you offer same-day cleaning?', answer: 'Yes. Text (516) 202-5900 and we\'ll dispatch a professional cleaner within hours. Same-day service is $89/hr.' },
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="font-[family-name:var(--font-bebas)] text-4xl md:text-6xl lg:text-7xl text-white tracking-wide leading-[0.95] mb-6">
            Frequently Asked Questions About Long Island House Cleaning Services
          </h1>
          <p className="text-blue-200/80 text-lg max-w-2xl leading-relaxed mb-10">
            Everything you need to know about pricing, services, scheduling, and how we work — answered by our team. Can&apos;t find your question? Text <a href="sms:5162025900" className="text-[#A8F0DC] underline underline-offset-2">(516) 202-5900</a>.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <Breadcrumbs items={[{ name: 'FAQ', href: '/long-island-cleaning-service-frequently-asked-questions-in-2025' }]} />
        ...
        <div className="bg-[#A8F0DC] rounded-2xl p-8 md:p-12 mb-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/updated-long-island-maid-service-industry-pricing" className="inline-block mt-6 text-[#1E2A4A] font-semibold underline underline-offset-4 hover:no-underline">
        ...
        <div className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] rounded-2xl p-8 md:p-12 text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <a href="sms:5162025900" className="bg-[#A8F0DC] text-[#1E2A4A] px-10 py-4 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
              Sales &amp; Customer Service: (516) 202-5900
            </a>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16">
          <Link href="/long-island-maid-service-services-offered-by-the-long-island-maid" className="group border border-gray-200 rounded-xl p-6 hover:border-[#A8F0DC] transition-all">
