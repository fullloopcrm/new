...
export const metadata: Metadata = {
  title: 'Refund Policy | The Long Island Maid',
  description: 'The Long Island Maid refund policy — no money upfront, pay only after cleaning is complete. No deposits. Service from $59/hr. (516) 202-5900',
  alternates: { canonical: 'https://www.thelongislandmaid.com/refund-policy' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Refund Policy', url: 'https://www.thelongislandmaid.com/refund-policy' },
      ])} />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions? Contact us at <a href="mailto:hi@thelongislandmaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thelongislandmaid.com</a> or text <a href="sms:5162025900" className="text-[#1E2A4A] underline underline-offset-2">(516) 202-5900</a>.
            </p>
            <p className="text-gray-500 text-sm mt-4">
