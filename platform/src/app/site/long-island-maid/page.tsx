...
import { homepageContent } from '@/app/site/long-island-maid/_lib/seo/content'
import { homepageSchemas, faqSchema, videoReviewsSchemas } from '@/app/site/long-island-maid/_lib/seo/schema'
import { pickLifestylePhoto } from '@/app/site/long-island-maid/_lib/seo/photos'
import JsonLd from '@/app/site/long-island-maid/_components/JsonLd'
import ServiceGrid from '@/app/site/long-island-maid/_components/ServiceGrid'
import TrustBadges from '@/app/site/long-island-maid/_components/TrustBadges'
import CTABlock from '@/app/site/long-island-maid/_components/CTABlock'
import FAQSection from '@/app/site/long-island-maid/_components/FAQSection'
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.thelongislandmaid.com' },
  openGraph: {
    title: content.title,
    description: content.metaDescription,
    url: 'https://www.thelongislandmaid.com',
...
const homepageFAQs = [
  // Pricing & Booking
  { question: 'How much does house cleaning cost in Long Island?', answer: `Our house cleaning services start at $59/hour when you provide supplies (recurring: 10% off weekly, 5% off biweekly/monthly), or $69/hour when we bring everything (recurring: 20% off weekly, 10% off biweekly/monthly). Same-day and emergency service is $89/hour. Final cost depends on home size and service type.` },
  ...
  { question: 'How do I book a cleaning?', answer: 'Text (516) 202-5900. We typically schedule within 24-48 hours, with same-day availability for urgent requests.' },
  ...
  { question: 'Do you clean offices and commercial spaces?', answer: 'Yes. We offer office cleaning for small to mid-size commercial spaces across the Long Island area. Contact us for a custom quote.' },
  ...
  // Areas & Coverage
  { question: 'What areas do you serve?', answer: 'We serve Long Island and the surrounding area. Same rates everywhere — no travel fees.' },
  ...
  { question: 'How long have you been in business?', answer: 'The Long Island Maid is proud to bring the same standard of professional, background-checked house cleaning to Long Island.' },
  ...
  { question: 'How do I contact you?', answer: 'Text (516) 202-5900, or email hi@thelongislandmaid.com. Texting is the fastest way to reach us.' },
]
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] pt-12 md:pt-16 pb-14 md:pb-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            ...
            <a href="sms:5162025900" className="inline-flex items-center gap-2 bg-white/10 border border-white/30 text-white px-8 py-4 rounded-lg font-bold text-base tracking-widest uppercase hover:bg-white/20 transition-colors">
              Text (516) 202-5900
            </a>
      ...
      <section className="bg-white">
        <figure className="relative aspect-[21/9] w-full overflow-hidden max-h-[560px]">
          <Image
            ...
            alt={`${homepagePhoto.alt} — The Long Island Maid`}
            fill
            priority
            sizes="100vw"
            className="object-cover"
          />
          <figcaption className="sr-only">{homepagePhoto.caption} — Long Island Maid service homepage</figcaption>
        </figure>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            {/* Left — story */}
            <div>
              <p className="text-xs font-semibold text-gray-400 tracking-[0.25em] uppercase mb-3">Long Island&apos;s Trusted Home Cleaning Company</p>
              <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#1E2A4A] tracking-wide leading-tight mb-4">Welcome to The Long Island Maid</h2>
              ...
              <p className="text-gray-600 leading-relaxed mb-5">
                Whether it&apos;s a <Link href="/services/weekly-maid-service-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">weekly cleaning</Link> for your apartment, a <Link href="/services/deep-cleaning-service-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">deep clean</Link> before guests arrive, or a <Link href="/services/move-in-move-out-cleaning-service-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">move-out clean</Link> — we handle it all with care, attention to detail, and genuine pride in what we do.
              </p>
              <p className="text-gray-600 leading-relaxed mb-5">
                We serve <Link href="/service-areas-served-by-the-long-island-maid" className="text-[#1E2A4A] underline underline-offset-2">Long Island</Link>. Every cleaner is background-checked, insured, and paid fairly. We don&apos;t cut corners — on your home or on our people.
              </p>
              <p className="text-gray-600 leading-relaxed mb-5">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <a href="sms:5162025900" className="inline-block bg-[#1E2A4A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                  Text (516) 202-5900
                </a>
                <Link href="/about-the-long-island-maid-service-company" className="text-[#1E2A4A] font-semibold hover:underline underline-offset-4">
                  Learn more &rarr;
                </Link>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-[#F5FBF8] border border-[#A8F0DC]/30 rounded-2xl p-8">
                <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-5">The Long Island Maid at a Glance</h3>
      ...
      <section className="py-20 bg-[#A8F0DC]">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xs font-semibold text-[#1E2A4A]/50 tracking-[0.25em] uppercase mb-3 text-center">Long Island Maid Service Pricing Explained — Hourly Rates, Average Costs &amp; What to Expect</p>
          <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#1E2A4A] tracking-wide text-center mb-4">How Much Does House Cleaning Cost in Long Island?</h2>
          <p className="text-[#1E2A4A]/70 text-center max-w-3xl mx-auto mb-14">
            We keep it simple: flat hourly rates, no hidden fees, no contracts. Choose the option that fits your situation. Every tier includes the same professional, <Link href="/about-the-long-island-maid-service-company" className="text-[#1E2A4A] font-semibold underline underline-offset-2">background-checked cleaners</Link> — the only difference is who brings the supplies. See our full <Link href="/updated-long-island-maid-service-industry-pricing" className="text-[#1E2A4A] font-semibold underline underline-offset-2">pricing page</Link> for more details.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-16 items-start">
            ...
            <div className="bg-[#1E2A4A] rounded-2xl p-8 pt-10 relative flex flex-col lg:-my-4 shadow-xl">
              ...
              <ul className="space-y-2 mb-6">
                {[
                  'Most Long Island renters — no storage needed for bulky supplies',
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col">
              ...
              <div className="w-10 h-[2px] bg-[#A8F0DC] mt-4 mb-5" />
              <p className="text-gray-600 text-sm leading-relaxed mb-5">
                Need a cleaner today? We dispatch a professional to your door within hours. Includes all supplies and equipment — <Link href="/services/same-day-cleaning-service-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">same-day cleaning</Link> when you need it most.
              </p>
              <p className="text-xs font-semibold text-gray-400 tracking-[0.15em] uppercase mb-3">Best For</p>
              <ul className="space-y-2 mb-6">
                {[
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-5">Long Island Cleaning Cost Tips — How to Get the Best Value</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-5">What Affects the Cost of House Cleaning in Long Island?</h3>
              <ul className="space-y-4">
                {[
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center">
            <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-2">How Long Island Maid Pricing Compares to the Industry</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto mb-8">
              ...
              <div className="bg-[#F5FBF8] border border-[#A8F0DC]/30 rounded-xl p-4">
                <p className="text-xs text-[#A8F0DC] font-semibold tracking-wide uppercase mb-1">The Long Island Maid</p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="sms:5162025900" className="inline-block bg-[#1E2A4A] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                Text (516) 202-5900
              </a>
              <Link href="/updated-long-island-maid-service-industry-pricing" className="text-[#1E2A4A] font-semibold hover:underline underline-offset-4 text-sm">
                View pricing &rarr;
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-[#1E2A4A] to-[#243352]">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xs font-semibold text-[#A8F0DC]/70 tracking-[0.25em] uppercase mb-3 text-center">Professional Long Island House Cleaning Services</p>
          <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-white tracking-wide text-center mb-4">Deep Cleaning, Regular Maid Service &amp; More in Long Island</h2>
          <p className="text-blue-200/60 text-center max-w-3xl mx-auto mb-14">
            From <Link href="/services/weekly-maid-service-in-long-island" className="text-[#A8F0DC] underline underline-offset-2">weekly maid service</Link> and <Link href="/services/deep-cleaning-service-in-long-island" className="text-[#A8F0DC] underline underline-offset-2">deep cleaning</Link> to <Link href="/services/move-in-move-out-cleaning-service-in-long-island" className="text-[#A8F0DC] underline underline-offset-2">move-in/move-out cleaning</Link>, <Link href="/services/post-construction-cleanup-service-in-long-island" className="text-[#A8F0DC] underline underline-offset-2">post-renovation cleanup</Link>, and <Link href="/services/same-day-cleaning-service-in-long-island" className="text-[#A8F0DC] underline underline-offset-2">same-day emergency cleaning</Link> — we handle every type of residential cleaning across Long Island. All cleaners are background-checked, licensed, and insured.
          </p>
          <ServiceGrid />
          <div className="text-center mt-10">
            <Link href="/long-island-maid-service-services-offered-by-the-long-island-maid" className="text-[#A8F0DC] font-semibold hover:underline underline-offset-4">Browse All Cleaning Services &rarr;</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#1E2A4A] tracking-wide leading-tight mb-6">Why Long Island Trusts The Long Island Maid</h2>
            <div className="w-12 h-[2px] bg-[#A8F0DC] mb-6" />
            <p className="text-gray-600 text-lg leading-relaxed mb-4">
              We provide personalized, hourly <Link href="/updated-long-island-maid-service-industry-pricing" className="text-[#1E2A4A] underline underline-offset-2">cleaning service pricing</Link> for each unique space — ensuring high-quality cleaning tailored to your needs. No contracts, no hidden fees, no surprises.
            </p>
            <p className="text-gray-600 leading-relaxed mb-6">
              Every cleaner on our team is fully background-checked and insured. Whether you need a <Link href="/services/apartment-cleaning-service-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">regular apartment cleaning</Link>, a <Link href="/services/deep-cleaning-service-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">deep clean</Link>, or <Link href="/services/airbnb-cleaning-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">Airbnb turnover cleaning</Link> — we&apos;ve got you covered. <Link href="/about-the-long-island-maid-service-company" className="text-[#1E2A4A] underline underline-offset-2">Learn more about our company</Link>.
            </p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xs font-semibold text-gray-400 tracking-[0.25em] uppercase mb-3 text-center">What Makes The Long Island Maid Different From Other Cleaning Services</p>
          <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#1E2A4A] tracking-wide text-center mb-4">Why Clients Choose The Long Island Maid Over Every Other Cleaning Company</h2>
          <p className="text-gray-500 text-center max-w-3xl mx-auto mb-14">
            No money upfront — you pay only after your cleaning is complete. Flat <Link href="/updated-long-island-maid-service-industry-pricing" className="text-[#1E2A4A] underline underline-offset-2">hourly pricing</Link> with no surprise fees. Experienced, professional cleaners — not random gig workers. <Link href="/services/weekly-maid-service-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">Weekly</Link> and <Link href="/services/bi-weekly-cleaning-service-in-long-island" className="text-[#1E2A4A] underline underline-offset-2">bi-weekly recurring service</Link> available. No contracts — stay because you&apos;re happy.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <Link href="/available-long-island-maid-jobs" className="text-[#1E2A4A] font-semibold text-sm hover:underline underline-offset-4">Join Our Cleaning Team &rarr;</Link>
          </div>
          <div>
            <p className="text-xs font-semibold text-gray-400 tracking-[0.2em] uppercase mb-3">The Ideal Long Island Maid Service Client</p>
      ...
      <section className="py-16 bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#1E2A4A] tracking-wide mb-4">Proudly Serving Long Island</h2>

          <p className="text-gray-500 max-w-2xl mx-auto">Same flat hourly rate, same background-checked cleaners, no travel fees — anywhere in our Long Island service area. Text us your address and we&apos;ll confirm coverage.</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mb-8">
            Refer friends, family, or neighbors to The Long Island Maid and earn 10% recurring commission on every cleaning they book — not just the first. Paid via Stripe after each completed visit. No limit on referrals, no cap on earnings.
          </p>
      ...
      {/* FAQ */}
      <FAQSection faqs={homepageFAQs} title="Long Island House Cleaning Service — Frequently Asked Questions &amp; Answers" columns={2} />
