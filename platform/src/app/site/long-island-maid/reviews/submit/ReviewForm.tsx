    ...
    <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-2xl overflow-hidden mt-8">
      ...
      <div className="px-6 md:px-8 py-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-gray-900 font-semibold text-lg">The Long Island Maid</h2>
            <p className="text-gray-400 text-sm">Verified Business &middot; Long Island Since 2018</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 md:px-8 py-8 space-y-6">
        ...
        <p className="text-xs text-gray-400 text-center">
          By submitting, you confirm this review is based on a real experience with The Long Island Maid.
        </p>
      </div>
    </form>
  )
