...
import { localBusinessSchema, breadcrumbSchema } from '@/app/site/long-island-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: 'Leave a Review | The Long Island Maid',
  description: 'Share your experience with The Long Island Maid. Your honest feedback helps other New Yorkers find trusted, reliable cleaning services.',
  alternates: { canonical: 'https://www.thelongislandmaid.com/reviews/submit' },
  openGraph: {
    title: 'Leave a Review | The Long Island Maid',
    description: 'Share your experience with The Long Island Maid cleaning service.',
    url: 'https://www.thelongislandmaid.com/reviews/submit',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Leave a Review', url: 'https://www.thelongislandmaid.com/reviews/submit' },
        ]),
      ]} />
