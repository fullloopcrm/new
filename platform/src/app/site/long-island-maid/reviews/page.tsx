...
import { breadcrumbSchema, localBusinessSchema, reviewSchemas, reviewsPageSchema, videoReviewsSchemas } from '@/app/site/long-island-maid/_lib/seo/schema'
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Reviews', url: 'https://www.thelongislandmaid.com/reviews' },
        ]),
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-blue-200/80 text-lg max-w-2xl leading-relaxed">
            Don&rsquo;t take our word for it &mdash; hear directly from the families and professionals across Long Island who trust us to clean their homes every week. These are verified reviews from real <Link href="/services/apartment-cleaning-service-in-long-island" className="text-white underline underline-offset-2">apartment cleaning</Link>, <Link href="/services/deep-cleaning-service-in-long-island" className="text-white underline underline-offset-2">deep cleaning</Link>, and <Link href="/services/weekly-maid-service-in-long-island" className="text-white underline underline-offset-2">weekly maid service</Link> clients. No fake reviews, no cherry-picking &mdash; just honest feedback from people who chose us and keep coming back.
          </p>
        </div>
      </section>
