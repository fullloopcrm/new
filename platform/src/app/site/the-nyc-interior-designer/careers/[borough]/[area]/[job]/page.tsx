...
import {
  ...
  PHONE_HREF,
  EMAIL,
} from "@/app/site/the-nyc-interior-designer/_lib/siteData";
import { findJobBySlug, jobs } from "@/app/site/the-nyc-interior-designer/_lib/jobs";
...
export default async function JobPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchemaData).replace(/</g, '\\u003c') }} />
