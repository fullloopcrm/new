/**
 * Rich sitemap for thenycinteriordesigner.com (slug the-nyc-interior-designer).
 *
 ...
 *   + /areas/[borough]/[area]/[service] (money-page grid: 152 areas × 37
 *   services ≈ 5.6k) + /blog/[slug] + /careers/[borough] + /careers/[borough]/
 *   [area] + /careers/[borough]/[area]/[job] (152 areas × 8 jobs ≈ 1.2k).
 * Total ≈ 7.2k URLs — well under the 50k per-sitemap limit — all indexable, so
 * included in full. URL shapes come from the site's own URL helpers so no slug
 * drifts or 404s. Served at /site/the-nyc-interior-designer/sitemap.xml;
...
const STATIC_PAGES: Array<{ path: string; priority: number; changeFrequency: Freq }> = [
  ...
  { path: '/get-a-free-consultation', priority: 0.9, changeFrequency: 'weekly' },
  { path: '/interior-design-101', priority: 0.7, changeFrequency: 'monthly' },
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Borough hubs: /areas/[borough] + /careers/[borough]
