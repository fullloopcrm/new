      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mt-4 text-base leading-relaxed text-slate-600">
            ...
            <Link href="/get-a-free-consultation" className="font-semibold text-blue-700 hover:text-blue-800 underline">
      ...
      <section className="bg-section-alt py-16">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
            ...
            <Link href="/get-a-free-consultation" className="text-sm font-semibold text-blue-700 hover:text-blue-800 font-cta">
              Free Consultation
            </Link>
          </div>
        </div>
