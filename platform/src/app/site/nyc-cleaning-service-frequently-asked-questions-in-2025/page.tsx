...
const pricingFAQs = [
  ...
  { question: 'Do you charge a flat rate or hourly?', answer: 'We charge by the hour. The rate is the same regardless of service type or neighborhood — $59/hr with your supplies, $75/hr when we bring everything, $100/hr for same-day emergency service. No hidden fees, no surge pricing.' },
...
const schedulingFAQs = [
  { question: 'How do I book a cleaning?', answer: 'Text (212) 202-9030. We typically schedule within 24–48 hours. Same-day availability for urgent requests.' },
  ...
  { question: 'Do you offer same-day cleaning?', answer: 'Yes. Text (212) 202-9030 and we\'ll dispatch a professional cleaner within hours. Same-day service is $100/hr.' },
  ...
  { question: 'What hours do you operate?', answer: 'Office hours are Monday through Saturday 7am to 7pm. Sales and booking inquiries are available 24/7 — text (212) 202-9030 anytime.' },
]
...
const trustFAQs = [
  ...
  { question: 'Do you bring your own supplies?', answer: 'It\'s your choice. At $59/hr you provide the supplies. At $75/hr we bring everything — professional-grade cleaning products and all equipment needed. $100/hr for same-day emergency service, we bring everything.' },
...
const pageDescription = 'Answers to 24 common questions about The NYC Maid — pricing ($59–$100/hr), what\'s included, scheduling, insurance, service areas, and more. Serving Manhattan, Brooklyn, Queens, Long Island & NJ. (212) 202-9030'
...
export default function FAQPage() {
  ...
  return (
    <>
      ...
      <CTABlock title="Ready to Book Your Cleaning?" subtitle="Text us — trusted by New Yorkers across Manhattan, Brooklyn, Queens, Long Island & New Jersey." />
    </>
  )
}
