...
export default async function NeighborhoodCategoryPage({ params }: { params: Promise<{ borough: string; slug: string; category: string }> }) {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: safeJsonLd(ncFaqLd) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: safeJsonLd(ncSpeakLd) }} />
