...
import { getNeighborhoodsByArea, ALL_NEIGHBORHOODS } from '@/app/site/connecticut-maid/_lib/seo/locations'
...
const url = 'https://www.theconnecticutmaid.com/about-the-connecticut-maid-service-company'
const title = 'About The Connecticut Maid | Affordable, Reliable Connecticut Cleaning Since 2018'
const description = 'The Connecticut Maid is Connecticut\'s most trusted cleaning service — affordable rates from $59/hr, reliable background-checked cleaners, and consistent quality since 2018. Serving 150+ neighborhoods. 5.0★ Rated. (203) 491-5600'
...
const aboutFaqs = [
  { question: 'How long has The Connecticut Maid been in business?', answer: 'Since 2018. We started serving Connecticut and have expanded to Connecticut. We\'ve completed thousands of cleanings and maintain a 5.0-star rating with 50+ verified reviews.' },
  ...
  { question: 'How do you keep prices so affordable?', answer: 'We keep overhead low — no storefront, no middle-management layer, no expensive marketing budgets. We pass those savings to you. Our cleaners earn competitive pay while you get rates well below the Connecticut average.' },
  { question: 'What makes you different from other cleaning companies?', answer: 'Three things: consistency (same cleaner every visit for recurring clients), affordability ($59/hr is among the lowest rates in Connecticut for licensed, insured service), and reliability (we show up on time, every time, and we don\'t cancel).' },
  { question: 'How many neighborhoods do you serve?', answer: `We serve ${ALL_NEIGHBORHOODS.length}+ neighborhoods across Connecticut. Same rates everywhere — no travel surcharges.` },
  ...
  return (
    <>
      <JsonLd data={[
        organizationSchema(),
        webSiteSchema(),
        webPageSchema({ url, name: title, description, type: 'AboutPage', breadcrumb: [{ name: 'Home', url: 'https://www.theconnecticutmaid.com' }, { name: 'About', url }] }),
        localBusinessSchema(),
        howToBookSchema(),
        breadcrumbSchema([{ name: 'Home', url: 'https://www.theconnecticutmaid.com' }, { name: 'About', url }]),
        faqSchema(aboutFaqs),
      ]} />
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-200/60 text-lg max-w-2xl mx-auto leading-relaxed">
            The Connecticut Maid has been keeping Connecticut homes clean since 2018. No gimmicks, no corporate nonsense — just honest, dependable cleaning from people who care.
          </p>
        </div>
      </section>

      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs items={[{ name: 'About', href: '/about-the-connecticut-maid-service-company' }]} />
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            <div className="lg:col-span-3">
              ...
              <div className="space-y-5 text-gray-600 leading-relaxed">
                <p>
                  We started The Connecticut Maid in 2018 because we were frustrated with the cleaning industry. Prices were inflated, quality was inconsistent, and companies treated cleaners and clients like numbers. We knew there had to be a better way.
                </p>
                <p>
                ...
                <p>
                  That approach has earned us a perfect 5.0-star rating with 50+ verified client reviews, thousands of completed cleanings, and a client base that includes homes across Norwalk, Stamford, and the surrounding towns. Many of our clients have been with us for years — and they stay because we deliver the same quality every single visit.
                </p>
                <p>
                  Today we serve {ALL_NEIGHBORHOODS.length}+ neighborhoods across Connecticut. Our team is bilingual (English and Spanish), background-checked, licensed, and insured. Our pricing is straightforward — $59/hr with your supplies (recurring: 10% off weekly, 5% off biweekly/monthly), $69/hr when we bring everything (recurring: 20% off weekly, 10% off biweekly/monthly), $89/hr for same-day emergency service.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Truly Affordable', detail: 'Our rates start at $59/hr — well below the Connecticut average for licensed, insured cleaning. No surge pricing, no hidden fees, no travel charges. Connecticut to Long Island, same rate.' },
      ...
      <section className="py-16 bg-gradient-to-b from-[#1E2A4A] to-[#243352]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-white tracking-wide text-center mb-4">The Connecticut Maid Difference</p>
      ...
      <section className="py-12 bg-[#A8F0DC]">
        <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-start gap-6">
          ...
          <div>
            ...
            <Link href="/available-connecticut-maid-jobs" className="inline-block mt-3 text-[#1E2A4A] font-semibold text-sm underline underline-offset-4">See open positions &rarr;</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#1E2A4A] tracking-wide text-center mb-12">About The Connecticut Maid</p>
