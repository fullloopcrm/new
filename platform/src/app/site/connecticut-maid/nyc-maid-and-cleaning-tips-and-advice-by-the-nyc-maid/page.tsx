...
export const metadata: Metadata = {
  title: 'The 100 Best Cleaning Tips for NYC Apartments | The Connecticut Maid',
  description: 'The definitive list — 100 expert cleaning tips for NYC apartments from professional cleaners. Kitchen, bathroom, floors, pets & more. From $59/hr. (203) 491-5600',
  alternates: { canonical: 'https://www.theconnecticutmaid.com/nyc-maid-and-cleaning-tips-and-advice-by-the-nyc-maid' },
  openGraph: {
    ...
    url: 'https://www.theconnecticutmaid.com/nyc-maid-and-cleaning-tips-and-advice-by-the-nyc-maid',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: '100 Cleaning Tips', url: 'https://www.theconnecticutmaid.com/nyc-maid-and-cleaning-tips-and-advice-by-the-nyc-maid' },
        ]),
        faqSchema,
        howToSchema,
      ]} />
