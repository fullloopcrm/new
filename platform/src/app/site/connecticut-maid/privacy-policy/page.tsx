  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Privacy Policy', url: 'https://www.theconnecticutmaid.com/privacy-policy' },
      ])} />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about this privacy policy? Contact us at <a href="mailto:hi@theconnecticutmaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@theconnecticutmaid.com</a> or text <a href="sms:2034915600" className="text-[#1E2A4A] underline underline-offset-2">(203) 491-5600</a>.
            </p>
