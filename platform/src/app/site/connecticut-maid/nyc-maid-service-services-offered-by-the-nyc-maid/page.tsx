...
import { breadcrumbSchema, localBusinessSchema, serviceItemListSchema } from '@/app/site/connecticut-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: { absolute: 'Connecticut Cleaning Services — Deep Clean, Maid Service, Move-In/Out & More | The Connecticut Maid' },
  description: 'All cleaning services by The Connecticut Maid from $59/hr. Deep cleaning, weekly maid service, move-in/out, post-construction, Airbnb, same-day. Connecticut, Connecticut, Connecticut, the Connecticut, Connecticut, Long Island, Connecticut & NJ.',
  alternates: { canonical: 'https://www.theconnecticutmaid.com/connecticut-maid-service-services-offered-by-the-connecticut-maid' },
  openGraph: {
    title: 'Connecticut Cleaning Services — Deep Clean, Maid Service & More | The Connecticut Maid',
    description: 'Professional cleaning services from $59/hr across Connecticut, Connecticut, Connecticut, the Connecticut, Connecticut, Long Island, Connecticut & NJ. Licensed, insured, 5-star rated.',
    url: 'https://www.theconnecticutmaid.com/connecticut-maid-service-services-offered-by-the-connecticut-maid',
  },
}
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            <a href="sms:2034915600" className="text-blue-200/70 font-medium text-lg py-4 hover:text-white transition-colors underline underline-offset-4">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <Breadcrumbs items={[{ name: 'Services', href: '/connecticut-maid-service-services-offered-by-the-connecticut-maid' }]} />
      </div>
      ...
      <section className="py-20 bg-[#A8F0DC]">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <Link href="/updated-connecticut-maid-service-industry-pricing" className="inline-block bg-[#1E2A4A] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-xs font-semibold text-gray-400 tracking-[0.2em] uppercase mb-3">Why New Yorkers Choose The Connecticut Maid</h2>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <a href="sms:2034915600" className="inline-block text-[#1E2A4A] font-semibold py-3.5 hover:underline underline-offset-4">
                Text us for questions
              </a>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <Link href="/service-areas-served-by-the-connecticut-maid" className="inline-block bg-[#1E2A4A] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
            Browse All Service Areas &rarr;
          </Link>
        </div>
      </section>

      <CTABlock title="Book Any Cleaning Service Today" subtitle="Text us — trusted by New Yorkers across Connecticut, Connecticut, Connecticut, the Connecticut, Connecticut, Long Island, Connecticut & New Jersey." />
    </>
  )
}
