...
export const metadata: Metadata = {
  title: { absolute: 'NYC Cleaning Services — Deep Clean, Maid Service, Move-In/Out & More | The Connecticut Maid' },
  description: 'All cleaning services by The Connecticut Maid from $59/hr. Deep cleaning, weekly maid service, move-in/out, post-construction, Airbnb, same-day. Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ.',
  alternates: { canonical: 'https://www.theconnecticutmaid.com/nyc-maid-service-services-offered-by-the-nyc-maid' },
  openGraph: {
    title: 'NYC Cleaning Services — Deep Clean, Maid Service & More | The Connecticut Maid',
    ...
    url: 'https://www.theconnecticutmaid.com/nyc-maid-service-services-offered-by-the-nyc-maid',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Services', url: 'https://www.theconnecticutmaid.com/nyc-maid-service-services-offered-by-the-nyc-maid' },
        ]),
      ]} />
