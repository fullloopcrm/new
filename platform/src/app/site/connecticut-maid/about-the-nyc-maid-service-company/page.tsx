...
const aboutFaqs = [
  { question: 'How long has The Connecticut Maid been in business?', answer: 'Since 2018. We started serving Connecticut and have expanded to Connecticut, Connecticut, the Connecticut, Connecticut, Long Island, Connecticut, and New Jersey. We\'ve completed thousands of cleanings and maintain a 5.0-star rating with 50+ verified reviews.' },
  ...
  { question: 'How many neighborhoods do you serve?', answer: `We serve ${ALL_NEIGHBORHOODS.length}+ neighborhoods across Connecticut, Connecticut, Connecticut, the Connecticut, Connecticut, Long Island, Connecticut, and New Jersey. Same rates everywhere — no travel surcharges.` },
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-200/60 text-lg max-w-2xl mx-auto leading-relaxed">
            The Connecticut Maid has been keeping New York homes clean since 2018. No gimmicks, no corporate nonsense — just honest, dependable cleaning from people who care.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            <div className="lg:col-span-3">
              ...
              <div className="space-y-5 text-gray-600 leading-relaxed">
                <p>
                  We started The Connecticut Maid in 2018 because we were frustrated with the cleaning industry in New York. Prices were inflated, quality was inconsistent, and companies treated cleaners and clients like numbers. We knew there had to be a better way.
                </p>
                <p>
