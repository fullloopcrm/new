...
import { BLOG_POSTS, getBlogPost, getAllBlogSlugs } from '@/app/site/connecticut-maid/_lib/seo/blog-data'
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${post.title} | The Connecticut Maid`,
    description: post.metaDescription,
    alternates: { canonical: `https://www.theconnecticutmaid.com/connecticut-maid-service-blog/${post.slug}` },
    openGraph: {
      title: post.title,
      description: post.excerpt,
      url: `https://www.theconnecticutmaid.com/connecticut-maid-service-blog/${post.slug}`,
      type: 'article',
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const blogPhotoUrl = `https://www.theconnecticutmaid.com${blogPhoto.src}`
  ...
  const articleSchema = {
    ...
    author: { '@type': 'Organization', name: 'The Connecticut Maid', url: 'https://www.theconnecticutmaid.com' },
    publisher: {
      '@type': 'Organization',
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://www.theconnecticutmaid.com/connecticut-maid-service-blog/${post.slug}`,
    },
    url: `https://www.theconnecticutmaid.com/connecticut-maid-service-blog/${post.slug}`,
  }
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: post.title, url: `https://www.theconnecticutmaid.com/connecticut-maid-service-blog/${post.slug}` },
        ]),
        articleSchema,
      ]} />
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        <Breadcrumbs items={[
          { name: 'Blog', href: '/connecticut-maid-service-blog' },
          { name: post.title, href: `/connecticut-maid-service-blog/${post.slug}` },
        ]} />
        ...
        <div className="border border-gray-200 rounded-xl p-6 my-12">
          ...
          <div className="flex items-center justify-between">
            <p className="text-gray-500 text-sm">— Desiree Marie, Connecticut</p>
        ...
        {related.length > 0 && (
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {related.map(r => (
                <Link key={r.slug} href={`/connecticut-maid-service-blog/${r.slug}`} className="group border border-gray-200 rounded-xl p-6 hover:border-[#A8F0DC] hover:shadow-lg transition-all">
