  ...
  return (
    <footer className="bg-[#1E2A4A] text-gray-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-8">
        <h2 className="font-[family-name:var(--font-bebas)] text-white text-3xl md:text-4xl tracking-wide text-center mb-2">The Connecticut Maid</h2>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-500">&copy; {new Date().getFullYear()} The Connecticut Maid &middot; Sales &amp; Customer Service: <a href="sms:2034915600" className="text-[#A8F0DC]/70 hover:text-[#A8F0DC]">(203) 491-5600</a> &middot; NYC Web Design by{' '}<a href="https://www.consortiumnyc.com/" target="_blank" rel="noopener noreferrer" className="text-[#A8F0DC] font-semibold hover:text-white underline underline-offset-2 decoration-[#A8F0DC]/50">Consortium NYC</a></p>
        </div>
      </div>
