import ReferralSignupForm from '@/app/site/connecticut-maid/_components/ReferralSignupForm'

const en = {
  heroTitle: 'Get Paid for Cleaning Referrals',
  heroBody: 'Earn 10% commission every time someone you refer books a cleaning with The Connecticut Maid. No limit on referrals. Recurring income for as long as they stay a customer.',
  benefits: [
...
const es = {
  ...
  heroBody: 'Gana 10% de comisión cada vez que alguien que refieras reserve una limpieza con The Connecticut Maid. Sin límite de referidos. Ingresos recurrentes mientras sigan siendo clientes.',
  benefits: [
        ...
        <div className="mb-16">
          <div className="aspect-video rounded-xl overflow-hidden border border-gray-200">
            <iframe
              ...
              title="The Connecticut Maid Referral Program"
