...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, howToBookSchema, breadcrumbSchema } from '@/app/site/connecticut-maid/_lib/seo/schema'
...
const careerFAQs = [
  ...
  { question: 'Do I need a car?', questionEs: '¿Necesito carro?', answer: 'Yes — a car is strongly preferred. Jobs are spread across Fairfield County, and most areas are not well served by public transit.', answerEs: 'Sí — se prefiere carro. Los trabajos están repartidos por Fairfield County.' },
  ...
  { question: 'How do I apply?', questionEs: '¿Cómo aplico?', answer: 'Apply online at theconnecticutmaid.com/apply or text (203) 491-5600. We review applications within 24–48 hours and get you working fast.', answerEs: 'Aplica en theconnecticutmaid.com/apply o envía un texto al (203) 491-5600. Revisamos en 24–48 horas.' },
]
...
function jobPostingSchema(region: string, locations: string) {
  ...
  return {
    ...
    description: `Now hiring experienced house cleaners in ${locations}. Starting at $30/hr paid via Stripe within 30 minutes of every completed job. Bonus programs available for retention, client satisfaction, and five-star reviews. Flexible schedule. Open 24/7. You provide your own cleaning supplies and equipment. Background check required. Apply at theconnecticutmaid.com/apply or text (203) 491-5600. Bilingual workplace (English/Spanish). 100% of tips are yours.`,
    identifier: {
      '@type': 'PropertyValue',
      name: 'The Connecticut Maid',
      value: `connecticut-maid-cleaner-${regionSlug}`,
    },
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-white/60 text-sm">Connecticut</p>
            <span className="text-white/30">·</span>
          ...
          <h1 className="font-[family-name:var(--font-bebas)] text-4xl md:text-6xl lg:text-7xl text-white tracking-wide leading-[0.95] mb-6">
            Join The Connecticut Maid — Starting at $30/hr, Bonus Programs Available
          </h1>
          <p className="text-blue-200/80 text-lg max-w-2xl leading-relaxed mb-3">
            We&apos;re hiring experienced cleaners across Connecticut. You bring your own supplies and equipment — we bring a steady stream of clients, a flexible schedule, and starting at $30/hr paid via Stripe within 30 minutes of every completed job. Bonus programs let top performers earn even more.
          </p>
          <p className="text-blue-200/50 max-w-2xl leading-relaxed mb-4 italic">
            Contratando limpiadores experimentados en Connecticut. Tú traes tus suministros — nosotros traemos clientes estables, horario flexible, y desde $30/hr pagado por Stripe en menos de 30 minutos. Programas de bonos disponibles.
          </p>
          <p className="text-blue-200/80 text-lg max-w-2xl leading-relaxed mb-3">
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-6 text-center">
            ...
            <div>
              ...
              <p className="text-[#1E2A4A]/60 text-sm font-medium">Connecticut</p>
            </div>
          </div>
        </div>
      </section>
