...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `https://www.theconnecticutmaid.com/available-nyc-maid-jobs/${n.slug}` },
    openGraph: {
      title: `Cleaning Jobs in ${n.name} | The Connecticut Maid`,
      description,
      url: `https://www.theconnecticutmaid.com/available-nyc-maid-jobs/${n.slug}`,
    },
  }
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: `Jobs in ${n.name}`, url: `https://www.theconnecticutmaid.com/available-nyc-maid-jobs/${n.slug}` },
        ]),
        jobSchema,
      ]} />
