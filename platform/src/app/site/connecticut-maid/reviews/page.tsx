...
export const metadata: Metadata = {
  ...
  description: 'See why Connecticut residents trust our background-checked, insured cleaners. From $59/hr, no contracts.',
  alternates: { canonical: 'https://www.theconnecticutmaid.com/reviews' },
  openGraph: {
    title: 'Connecticut Maid Service Reviews | 5-Star Verified Client Reviews',
    description: 'See reviews from across Connecticut.',
