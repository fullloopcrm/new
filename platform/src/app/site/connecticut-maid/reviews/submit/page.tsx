...
import { localBusinessSchema, breadcrumbSchema } from '@/app/site/connecticut-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: 'Leave a Review | The Connecticut Maid',
  description: 'Share your experience with The Connecticut Maid. Your honest feedback helps other New Yorkers find trusted, reliable cleaning services.',
  alternates: { canonical: 'https://www.theconnecticutmaid.com/reviews/submit' },
  openGraph: {
    title: 'Leave a Review | The Connecticut Maid',
    description: 'Share your experience with The Connecticut Maid cleaning service.',
    url: 'https://www.theconnecticutmaid.com/reviews/submit',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Leave a Review', url: 'https://www.theconnecticutmaid.com/reviews/submit' },
        ]),
      ]} />
