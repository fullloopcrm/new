...
const url = 'https://www.theconnecticutmaid.com/contact-the-connecticut-maid-service-today'
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs items={[{ name: 'Contact', href: '/contact-the-connecticut-maid-service-today' }]} />
      </div>
