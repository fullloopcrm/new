...
export const metadata: Metadata = {
  ...
  description: 'All cleaning services by The Connecticut Maid from $59/hr. Deep cleaning, weekly maid service, move-in/out, post-construction, Airbnb, same-day. Connecticut & NJ.',
  ...
  openGraph: {
    ...
    description: 'Professional cleaning services from $59/hr across Connecticut & NJ. Licensed, insured, 5-star rated.',
...
export default function ServicesIndexPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Our cleaners serve all of Connecticut — same rates, same quality, no travel fees. <Link href="/reviews" className="text-[#1E2A4A] underline underline-offset-2">Read our reviews</Link> to see what clients say.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mb-8">
            Every service listed above is available across our entire Connecticut service area. Same rates, same quality, everywhere we serve.
          </p>
      ...
      <CTABlock title="Book Any Cleaning Service Today" subtitle="Text us — trusted by New Yorkers across Connecticut." />
    </>
  )
}
