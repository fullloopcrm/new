...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const description = `Commission sales jobs in ${n.name}, NYC. 1099 sales rep role — sign clients or referrers and earn 10% recurring on every cleaning, paid daily via Stripe. No cap. Apply: (203) 491-5600`
  return {
    title,
    description,
