...
const pageDescription = 'The Connecticut Maid is a brand-new market launch backed by the same team and platform behind The Connecticut Maid. We’re hiring an Administrator with a real long-term path to becoming CEO. Compensation based on experience. Remote, anywhere in the US.'
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            This is a real entrepreneurial opportunity — for someone who wants to jump in and be completely all-in on a startup, not manage a stable, slow-moving company. The Connecticut Maid is a brand-new market launch, backed by the same team and platform behind The Connecticut Maid, one of Connecticut’s highest-rated cleaning companies. Whoever takes this role isn’t signing up to manage an established operation — you’re getting in on the ground floor and building it.
          </p>
          <p className="text-gray-600 leading-relaxed mb-3">
