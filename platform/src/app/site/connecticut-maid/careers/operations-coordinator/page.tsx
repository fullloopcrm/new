...
const pageUrl = 'https://www.theconnecticutmaid.com/careers/operations-coordinator'
const pageTitle = 'Part-Time Operations Admin — 10% Per Job, ~$40/hr Last Month | The Connecticut Maid'
const pageDescription = 'The Connecticut Maid is hiring a part-time operations coordinator. Earn 10% of every completed job — paid per job via Stripe. Last month 10% averaged out to about $40/hr. Own the calendar, cleaners, and collections. Aiming for 100 services/week. Apply now.'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    images: [{ url: 'https://www.theconnecticutmaid.com/icon-512.png', width: 512, height: 512, alt: 'Part-Time Operations Admin — The Connecticut Maid — Now Hiring' }],
  ...
  twitter: {
    ...
    title: pageTitle,
    description: pageDescription,
    images: ['https://www.theconnecticutmaid.com/icon-512.png'],
  },
  keywords: 'part time operations coordinator, part time coordinator remote, part time dispatcher, part time customer service, second job from home, side job remote, work from phone job, cleaning service coordinator, scheduling coordinator part time, payment coordinator, virtual coordinator, remote coordinator Connecticut, part time work from home, easy second job, side gig remote, operations coordinator cleaning company, bilingual coordinator, part time job Connecticut, part time job New Jersey, part time job Long Island, remote part time job, work from home part time, dispatcher part time, service coordinator part time, 10 percent commission job, per job pay, pay per job coordinator',
  other: {
    'geo.region': 'US-CT',
...
function coordinatorJobPostingSchema() {
  ...
  return {
    ...
    datePosted,
    validThrough,
    description: `<h2>Part-Time Operations Admin — The Connecticut Maid — Remote</h2>
<p>The Connecticut Maid is hiring a <strong>part-time operations coordinator</strong> to own the calendar, the cleaners, and the collections. You earn <strong>10% of every completed and paid job</strong> — paid per job via Stripe within minutes of completion, same as the cleaners. No base salary. No hourly rate. You earn when the business earns.</p>
...
<h3>How to Apply</h3>
<p>Submit your application at <a href="https://www.theconnecticutmaid.com/apply/operations-coordinator">theconnecticutmaid.com/apply/operations-coordinator</a>. Include a photo and a 60-second selfie video introduction. If bilingual, speak in both English and Spanish.</p>`,
    ...
    hiringOrganization: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://www.theconnecticutmaid.com/icon-512.png',
        width: 512,
        height: 512,
      },
      telephone: '+1-203-491-5600',
      email: 'hi@theconnecticutmaid.com',
      foundingDate: '2018',
      numberOfEmployees: {
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Go to theconnecticutmaid.com/apply/operations-coordinator. Fill out the short form, upload a photo of yourself and a 60-second selfie video. If you\'re bilingual, speak in both English and Spanish in the video. We review applications within 48 hours.',
  },
]
  ...
  return (
    <>
      <JsonLd data={[
        ...
        webPageSchema({
          ...
          breadcrumb: [
            ...
            { name: 'Careers', url: 'https://www.theconnecticutmaid.com/available-connecticut-maid-jobs' },
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-blue-200/80 text-lg max-w-3xl leading-relaxed mb-3">
            The Connecticut Maid &mdash; Connecticut | Long Island | New Jersey
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            <a href="sms:2034915600" data-track="coord-hero-text" className="text-blue-200/70 font-medium text-lg py-4 hover:text-white transition-colors underline underline-offset-4">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <Breadcrumbs items={[
          { name: 'Careers', href: '/available-connecticut-maid-jobs' },
        ...
        <section className="bg-[#A8F0DC] rounded-2xl p-8 md:p-12 text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="sms:2034915600" data-track="coord-bottom-text" className="text-[#1E2A4A]/60 font-medium text-sm hover:text-[#1E2A4A] transition-colors underline underline-offset-4">
              Text us for questions
            </a>
          </div>
        </section>
