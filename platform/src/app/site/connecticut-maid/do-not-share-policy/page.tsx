  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Do Not Share Policy', url: 'https://www.theconnecticutmaid.com/do-not-share-policy' },
      ])} />
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-xl p-5 mt-4 space-y-2">
              <p className="text-gray-600 text-sm">Email us at <a href="mailto:hi@theconnecticutmaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@theconnecticutmaid.com</a> with the subject &ldquo;Do Not Share&rdquo;</p>
              <p className="text-gray-600 text-sm">Or text <a href="sms:2034915600" className="text-[#1E2A4A] underline underline-offset-2">(203) 491-5600</a></p>
            </div>
