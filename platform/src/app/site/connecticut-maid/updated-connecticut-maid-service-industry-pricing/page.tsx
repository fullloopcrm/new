...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, pricingOffersSchema, howToBookSchema, breadcrumbSchema, faqSchema } from '@/app/site/connecticut-maid/_lib/seo/schema'
...
const pricingFaqs = [
  { question: 'How much does house cleaning cost in Connecticut?', answer: 'Our rates are $59/hr when you provide supplies (recurring: 10% off weekly, 5% off biweekly/monthly), $69/hr when we bring everything (recurring: 20% off weekly, 10% off biweekly/monthly), and $89/hr for same-day emergency service. A typical Connecticut apartment cleaning costs $98–$414 depending on size and service type. We provide a custom quote based on your specific needs.' },
  ...
  { question: 'Do you charge extra for travel or different neighborhoods?', answer: 'No. Every neighborhood we serve — from Connecticut to Connecticut to Long Island — gets the same flat hourly rate. No travel surcharges, no surge pricing, no zone fees.' },
  ...
  { question: 'How much does a deep cleaning cost?', answer: 'Deep cleaning typically costs $196–$414 for a standard Connecticut apartment. Studios run $196–$245, 1-bedrooms $245–$325, and 2-3 bedrooms $325–$414+. The exact price depends on square footage, condition, and whether you want us to bring supplies.' },
  ...
  { question: 'Do you offer free estimates?', answer: 'Yes. Text (203) 491-5600 with your address, home size, and service type and we\'ll provide a custom quote within minutes. No obligation, no pressure.' },
  ...
  { question: 'Can I get a quote without booking?', answer: 'Absolutely. Text (203) 491-5600 with your apartment details and we\'ll send a quote. No commitment required. Most quotes are delivered within 15 minutes.' },
]
  ...
  return (
    <>
      <JsonLd data={[
        organizationSchema(),
        webSiteSchema(),
        webPageSchema({ url, name: title, description, breadcrumb: [{ name: 'Home', url: 'https://www.theconnecticutmaid.com' }, { name: 'Pricing', url }] }),
        localBusinessSchema(),
        pricingOffersSchema(),
        howToBookSchema(),
        breadcrumbSchema([{ name: 'Home', url: 'https://www.theconnecticutmaid.com' }, { name: 'Pricing', url }]),
          ...
          <div className="max-w-5xl mx-auto px-4 py-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:2034915600" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-[#A8F0DC] rounded-2xl p-7 text-center relative">
                ...
                <a href="sms:2034915600" className="block mt-6 bg-[#1E2A4A] text-white px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:2034915600" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text — same-day</a>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs items={[{ name: 'Pricing', href: '/updated-connecticut-maid-service-industry-pricing' }]} />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Same Rate Everywhere', detail: 'Connecticut to Long Island — same price' },
            ].map(g => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { n: '01', t: 'Text Us', d: 'Reach us at (203) 491-5600 with your address, home size, and what type of cleaning you need.' },
