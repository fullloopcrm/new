...
import { SERVICES, getServiceByUrlSlug } from '@/app/site/connecticut-maid/_lib/seo/services'
...
import { serviceContent, serviceFAQs, getServiceRichContent, commonServiceFAQs } from '@/app/site/connecticut-maid/_lib/seo/content'
import { servicePageSchemas, faqSchema } from '@/app/site/connecticut-maid/_lib/seo/schema'
import { pickPhotoByCategory, type PhotoCategory } from '@/app/site/connecticut-maid/_lib/seo/photos'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const url = `https://www.theconnecticutmaid.com/services/${slug}`
  const title = `${service.name} From ${service.priceRange.split('–')[0]} | 5-Star Rated | The Connecticut Maid`
  const description = `Professional ${service.name.toLowerCase()} across Connecticut. ${service.features.slice(0, 2).join(', ')} & more. From ${service.priceRange.split('–')[0]}. 5.0★ Rated.`
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
            <div className="lg:col-span-3">
              ...
              <h1 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl lg:text-6xl text-white tracking-wide leading-[0.95] mb-5">
                {rich?.heroH1 || `${service.name} in Connecticut — Professional & Affordable`}
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4">
                ...
                <a href="sms:2034915600" className="bg-white/10 border border-white/30 text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-white/20 transition-colors">
                  Text 203.491.5600
                </a>
              </div>
            </div>
      ...
      <section className="bg-white">
        <figure className="relative aspect-[21/9] w-full overflow-hidden max-h-[520px]">
          <Image
            ...
            alt={`${servicePhoto.alt} — ${service.name} in Connecticut`}
            fill
            priority
            sizes="100vw"
            className="object-cover"
          />
          <figcaption className="sr-only">{servicePhoto.caption} — {service.name} by The Connecticut Maid</figcaption>
        </figure>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-2 lg:sticky lg:top-28">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-3">
                  ...
                  <a href="sms:2034915600" className="bg-[#1E2A4A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                    Text 203.491.5600
                  </a>
                </div>
              </div>
      ...
      {rich && rich.nycTips.length > 0 && (
        <section className="py-16 bg-gradient-to-b from-[#1E2A4A] to-[#243352]">
          <div className="max-w-5xl mx-auto px-4">
            ...
            <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-white tracking-wide text-center mb-12">{rich?.tipsTitle || `Connecticut ${service.name} Tips From Local Pros`}</p>
        ...
        <section className="py-12 bg-[#A8F0DC]">
          <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-start gap-6">
            ...
            <div>
              ...
              <Link href="/updated-connecticut-maid-service-industry-pricing" className="inline-block mt-3 text-[#1E2A4A] font-semibold text-sm underline underline-offset-4">Full pricing details &rarr;</Link>
            </div>
          </div>
        </section>
      )}
      ...
      <section className="py-20 bg-[#1E2A4A]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { n: '01', t: 'Self-Book', d: 'Book online with your address, preferred date, and any special requests — takes about 2 minutes.' },
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#1E2A4A] tracking-wide text-center mb-4">{service.name} Across Connecticut</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-xs font-semibold text-gray-400 tracking-[0.25em] uppercase mb-3 text-center">More Connecticut Cleaning Services</h2>
          ...
          <div className="text-center mt-10">
            <Link href="/connecticut-maid-service-services-offered-by-the-connecticut-maid" className="inline-block bg-[#A8F0DC] text-[#1E2A4A] px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
      ...
      <CTABlock title={`Book ${service.name} Today`} subtitle="Text us — background-checked, insured cleaners serving Connecticut." />
    </>
  )
}
