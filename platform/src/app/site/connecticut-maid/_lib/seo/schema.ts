...
const BUSINESS = {
  ...
  legalName: 'The Connecticut Maid Cleaning Service LLC',
  url: 'https://www.theconnecticutmaid.com',
  phone: '+1-203-491-5600',
  phoneDisplay: '(203) 491-5600',
...
const logoObj = {
  ...
  width: 512,
  height: 512,
  caption: 'The Connecticut Maid Logo',
}
...
export function reviewSchemas(reviews?: ReviewSchemaInput[]) {
  ...
  return r.map(review => ({
    ...
    publisher: { '@type': 'Organization', name: 'The Connecticut Maid' },
  }))
}
...
export function howToBookSchema() {
  return {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: 'How to Book a Cleaning Service with The Connecticut Maid',
...
export function professionalServiceSchema(service: Service, neighborhood?: Neighborhood, area?: Area) {
  ...
  return {
    ...
    name: `${service.name}${neighborhood ? ` in ${neighborhood.name}` : ''} - The Connecticut Maid`,
    description: service.description,
...
export function homepageSchemas() {
  ...
  return [
    ...
    webPageSchema({
      url,
      name: 'Connecticut Maid Service & House Cleaning From $59/hr | 5-Star Rated | The Connecticut Maid',
      description: BUSINESS.description,
      type: 'WebPage',
