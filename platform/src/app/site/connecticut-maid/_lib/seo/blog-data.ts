...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Or Just Book a Deep Clean', paragraphs: ['Look, if you have the time and energy for three weeks of cleaning, more power to you. Most people don\'t. That\'s genuinely why <a href="/services/deep-cleaning-service-in-nyc">deep cleaning services</a> exist. One 4–5 hour session and your apartment is spring-ready. We serve <a href="/service-areas-served-by-the-nyc-maid">hundreds of neighborhoods</a> across Connecticut, Connecticut, Connecticut, the Connecticut, Connecticut, Long Island, Connecticut, and New Jersey.'] },
    ],
  },
  {
