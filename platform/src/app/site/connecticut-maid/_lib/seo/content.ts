...
const introTemplates = [
  (n: Neighborhood) => `Looking for a reliable cleaning service in ${n.name}? The Connecticut Maid has been trusted by ${n.name} residents for years, delivering spotless results in ${n.housing_types[0]}, ${n.housing_types[1]}, and more.`,
...
export function neighborhoodContent(neighborhood: Neighborhood, area: Area) {
  ...
  return {
    title: `${h1} | ${area.name}`,
    metaDescription: `Professional cleaning in ${neighborhood.name}, ${area.name} from $59/hr. Serving ${neighborhood.housing_types.slice(0, 2).join(', ')} near ${neighborhood.landmarks[0]}. 5.0★ Rated. (203) 491-5600`,
    h1,
    intro,
  }
}
...
const knownForTemplates = [
  (n: Neighborhood) => [`Home to ${n.landmarks[0]}`, `Known for its beautiful ${n.housing_types[0]}`, `A neighborhood of ${n.housing_types[1]} and local character`, `Walking distance to ${n.landmarks[1] || n.landmarks[0]}`, `One of Connecticut's most sought-after areas for families and professionals`],
...
const serviceIntroTemplates = [
  ...
  (n: Neighborhood, s: Service) => `${n.name} residents trust The Connecticut Maid for expert ${s.name.toLowerCase()}. We understand the unique ${n.cleaning_challenges[0]} and ${n.cleaning_challenges[1]} that come with cleaning homes in this area.`,
...
export function neighborhoodServiceContent(neighborhood: Neighborhood, service: Service, area: Area) {
  ...
  return {
    title: `${h1} | ${area.name}`,
    metaDescription: `${service.name} in ${neighborhood.name}, ${area.name}. ${service.features.slice(0, 2).join(', ')} & more. ${service.priceRange}. 5.0★ Rated. (203) 491-5600`,
    h1,
    intro,
    whyUs: [
...
const richContentMap: Record<string, ServiceRichContent> = {
  'deep-cleaning': {
    heroH1: 'Connecticut Deep Cleaning Service — The Reset Your Apartment Needs',
    roomsTitle: 'What Gets Deep Cleaned in Every Connecticut Apartment',
    tipsTitle: 'Connecticut Deep Cleaning — Insider Tips From Local Pros',
    heroSubtitle: 'The most thorough cleaning your Connecticut apartment has ever had. We get into every corner, behind every appliance, and inside every cabinet — so your home feels brand new.',
    whatIs: {
      ...
      body: [
        ...
        'Most Connecticut apartments need a deep clean before transitioning to a recurring maintenance schedule. If it\'s been more than a month since your last professional cleaning — or if you\'ve never had one — a deep clean is where to start.',
    ...
    whenToBook: {
      ...
      items: [
        ...
        'Seasonal deep clean — most Connecticut apartments benefit from a deep clean every 3-6 months',
    ...
    nycTips: [
      { title: 'Pre-war apartments need extra attention', detail: 'Older Connecticut buildings have crown molding, intricate baseboards, original hardwood, and radiators that collect decades of dust. Our cleaners are experienced with these details and know how to clean them without damage.' },
    ...
    educationSections: [
      {
        heading: 'How Long Does a Deep Cleaning Take in Connecticut?',
        body: [
    ...
    faqs: [
      ...
      { question: 'How much does a deep cleaning cost in Connecticut?', answer: 'Deep cleaning costs $59–$69/hr depending on who provides supplies, or $89/hr for same-day emergency service. A typical studio deep clean runs $196–$260 (4–5 hours). A 2-bedroom is usually $260–$390 (4–6 hours). A 3-bedroom can be $325–$520 (5–8 hours). We charge by the hour so you only pay for the time your space actually needs.' },
  ...
  'regular-cleaning': {
    heroH1: 'Connecticut Apartment Cleaning — Consistent, Reliable, Affordable',
    tipsTitle: 'Smart Apartment Cleaning Tips for Connecticut Residents',
    ...
    whatIs: {
      ...
      body: [
        ...
        'Most Connecticut apartment dwellers book regular cleaning on a weekly or bi-weekly schedule. Weekly clients see the best results — their homes stay in great shape with minimal effort.',
      ],
    },
    whenToBook: {
    ...
    nycTips: [
      { title: 'Weekly is the sweet spot for most Connecticut apartments', detail: 'Connecticut apartments accumulate dust, allergens, and kitchen grime faster than suburban homes due to density, HVAC systems, and street-level particles. Weekly cleaning prevents buildup so every clean is fast and efficient.' },
    ...
    educationSections: [
      ...
      {
        heading: 'What Does Regular Cleaning Cost in Connecticut?',
        body: [
          ...
          'Compare that to one-time deep cleans at $250–$400 each. Recurring regular service is the most cost-effective way to keep your Connecticut apartment clean.',
        ],
      },
    ],
    pricingNote: 'Regular cleaning typically costs $98–$260 per visit. A weekly 2-hour clean at $59/hr is just $118/visit — the most affordable way to maintain a spotless Connecticut apartment.',
    faqs: [
      ...
      { question: 'How often should I schedule regular cleaning?', answer: 'Weekly is ideal for most Connecticut apartments. Bi-weekly works well for singles or couples with low-traffic homes. Monthly is suitable for very tidy households that want occasional professional maintenance.' },
  ...
  'weekly-cleaning': {
    heroH1: 'Connecticut Weekly Maid Service — Never Come Home to a Mess Again',
    tipsTitle: 'Weekly Cleaning Secrets From Connecticut\'s Top-Rated Maids',
    ...
    whatIs: {
      ...
      body: [
        ...
        'Weekly clients get priority scheduling, the same cleaner every visit, and the lowest effective hourly rate at $59/hr with your supplies. It\'s the most popular service for busy Connecticut professionals and families.',
      ],
    },
    whenToBook: {
  ...
  'move-in-move-out-cleaning': {
    heroH1: 'Connecticut Move-In/Move-Out Cleaning — Protect Your Deposit',
    tipsTitle: 'Connecticut Moving Day Cleaning — What Every Renter Should Know',
    ...
    nycTips: [
      ...
      { title: 'Ask your landlord what they expect', detail: 'Some Connecticut landlords have specific cleaning requirements for move-out. Ask beforehand so we can make sure everything on their checklist is covered.' },
    ],
    educationSections: [
      {
        heading: 'Move-Out Cleaning — Protect Your Security Deposit',
        body: [
          'Connecticut security deposits are typically one month\'s rent — that\'s $2,000–$5,000+ you could lose if the apartment isn\'t returned in acceptable condition. A professional move-out clean costs $260–$520 and virtually guarantees you get your full deposit back.',
  ...
  'bi-weekly-cleaning': {
    heroH1: 'Connecticut Bi-Weekly Cleaning — Spotless Every Two Weeks, Half the Cost',
    tipsTitle: 'Bi-Weekly Cleaning Tips for Connecticut Apartment Dwellers',
    ...
    whatIs: {
      ...
      body: [
        'Bi-weekly cleaning is the most popular schedule for Connecticut couples, small apartments, and professionals who keep a relatively tidy home between visits. Your cleaner arrives every 14 days and performs a thorough cleaning of the entire apartment — kitchen, bathrooms, all surfaces, floors, and more.',
    ...
    nycTips: [
      ...
      { title: 'Consider upgrading to weekly during summer', detail: 'Connecticut summers bring more dust, allergens, and AC use. Many bi-weekly clients temporarily switch to weekly June–September, then drop back to bi-weekly in the fall. We make schedule changes easy.' },
  ...
  'monthly-cleaning': {
    heroH1: 'Connecticut Monthly Cleaning Service — A Professional Reset Every 30 Days',
    tipsTitle: 'Monthly Cleaning Strategies for Connecticut Homes & Apartments',
  ...
  'post-renovation-cleaning': {
    heroH1: 'Connecticut Post-Construction Cleanup — Make Your Renovation Livable',
    roomsTitle: 'What Gets Cleaned After a Connecticut Apartment Renovation',
    tipsTitle: 'Post-Renovation Cleanup Tips for Connecticut Co-ops & Condos',
    ...
    nycTips: [
      ...
      { title: 'Connecticut co-op and condo boards may require it', detail: 'Many Connecticut buildings require professional post-construction cleaning and sign-off before issuing a completion certificate. Ask your building manager about requirements — we can provide proof of service if needed.' },
    ...
    faqs: [
      ...
      { question: 'Is post-construction cleaning required by Connecticut buildings?', answer: 'Many Connecticut co-op and condo boards require professional cleaning before issuing a construction completion certificate or releasing your alteration deposit. Check with your building management — we can provide a receipt and proof of service.' },
    ],
  },

  'same-day-cleaning': {
    heroH1: 'Same-Day Cleaning in Connecticut — A Pro at Your Door in Hours',
    tipsTitle: 'Last-Minute Connecticut Cleaning — How to Get It Done Today',
    ...
    whenToBook: {
      ...
      items: [
        'Unexpected guests arriving tonight — parents, in-laws, friends passing through Connecticut',
    ...
    nycTips: [
      { title: 'Text us early for best availability', detail: 'Same-day requests sent before 10am have the best chance of afternoon availability. After noon, same-day availability drops significantly. Text (203) 491-5600 as early as possible for the best shot at a same-day slot.' },
    ...
    faqs: [
      ...
      { question: 'How do I book same-day service?', answer: 'Text (203) 491-5600 as early in the day as possible. Text is fastest — we\'ll confirm availability and estimated arrival time within minutes. Morning requests before 10am have the best availability for afternoon service.' },
    ],
  },

  'airbnb-cleaning': {
    heroH1: 'Connecticut Airbnb & Short-Term Rental Cleaning — 5-Star Turnovers Guaranteed',
    tipsTitle: 'Airbnb Hosting Tips From Connecticut\'s Go-To Turnover Cleaners',
    ...
    educationSections: [
      ...
      },
      {
        ...
        body: [
          'Most Connecticut Airbnb hosts charge a $75–$150 cleaning fee to guests, which covers (or partially covers) the turnover cost.',
  ...
  'office-cleaning': {
    heroH1: 'Connecticut Office Cleaning — Keep Your Workspace Healthy & Professional',
    tipsTitle: 'Office Cleaning Best Practices for Connecticut Businesses',
    ...
    whatIs: {
      ...
      subheading: 'Office cleaning is a commercial cleaning service designed for small offices, co-working spaces, medical practices, and professional suites across Connecticut.',
      body: [
    ...
    nycTips: [
      { title: 'Schedule cleaning after business hours', detail: 'Most Connecticut offices get cleaned between 6–9pm or 6–8am. Off-hours cleaning means zero disruption to your team and no cleaners navigating around occupied desks. We\'ll work around your schedule.' },
      ...
      { title: 'Ask about green cleaning products', detail: 'Many Connecticut offices prefer eco-friendly cleaning products, especially in close-quarters spaces. We can use plant-based, low-VOC products that are effective without the chemical smell. Just request it when booking.' },
    ],
    educationSections: [
      {
        ...
        body: [
          ...
          'Most Connecticut offices with 5+ employees benefit from at least weekly professional cleaning. The cost is modest relative to rent and the impact on team morale and health.',
        ],
      },
      {
...
export function neighborhoodFAQs(neighborhood: Neighborhood, area: Area): { question: string; answer: string }[] {
  return [
    ...
    },
    {
      ...
      answer: `You can book online through our website, text us at (203) 491-5600. We typically can schedule within 24-48 hours, with same-day availability for urgent requests.`,
    },
    {
...
export function commonServiceFAQs(service: Service): { question: string; answer: string }[] {
  return [
    ...
    { question: 'Are you licensed and insured?', answer: 'Yes. The Connecticut Maid is a fully licensed cleaning company with general liability insurance and bonding. Every cleaner is covered while working in your home. We can provide proof of insurance upon request.' },
    ...
    { question: 'Do you offer gift certificates?', answer: 'Yes — cleaning makes a great gift. Text us at (203) 491-5600 to purchase a gift certificate in any amount. We\'ll send a digital certificate that the recipient can redeem for any service.' },
    ...
    { question: 'Do you have a referral program?', answer: 'Yes. Refer a friend and earn money every time they book a cleaning — not just the first time. Visit theconnecticutmaid.com/referral or text us for details. It\'s one of the most generous referral programs in Connecticut cleaning.' },
  ]
}
