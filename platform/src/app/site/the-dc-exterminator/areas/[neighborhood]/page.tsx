...
export default async function NeighborhoodHubPage({ params }: PageProps) {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: `Yes. All our technicians serving ${neighborhood.name} hold DOEE Commercial Pesticide Applicator licenses and are fully insured. Wildlife operators hold additional DEC licenses.`,
    },
  ];
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-3xl text-zinc-400">
            ...
            pricing, and treatment by a licensed DC pest control technician.
          </p>
