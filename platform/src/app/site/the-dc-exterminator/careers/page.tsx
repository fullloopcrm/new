...
import { getAllNeighborhoods, getNeighborhoodsByRegion } from "@/app/site/the-dc-exterminator/_lib/data";
import { PHONE, SITE_URL, SITE_NAME, EMAIL } from "@/app/site/the-dc-exterminator/_lib/seo";
import { getBreadcrumbSchema } from "@/app/site/the-dc-exterminator/_lib/seo";
import CareersCTA from "@/app/site/the-dc-exterminator/_components/CareersCTA";
import JobApplicationForm from "@/app/site/the-dc-exterminator/_components/JobApplicationForm";

export const metadata: Metadata = {
  title:
    "Exterminator Jobs DC | Now Hiring Pest Control Technicians | $45K-$95K+",
  description:
    "Now hiring licensed exterminators, pest control technicians, wildlife control specialists, and commercial account managers across DC, Northern Virginia & Suburban Maryland. $45K-$95K+ pay, full benefits, paid training, company vehicle. Join DC's fastest-growing pest control team. Text us to apply.",
  keywords:
    "exterminator jobs DC, pest control technician jobs, hiring exterminators DC, pest control careers, wildlife control jobs DC, commercial pest control jobs, exterminator salary DC",
  openGraph: {
    title:
      "Exterminator Jobs DC | Now Hiring Pest Control Technicians | $45K-$95K+",
    description:
      "Now hiring pest control pros across DC. $45K-$95K+ pay, full benefits, paid training, company vehicle. Text us to apply.",
...
const positions = [
  ...
  },
  {
    ...
    description:
      "Pest Control Technicians are the backbone of The DC Exterminator's field operations. In this role, you will perform residential and commercial pest control treatments across DC, DC, DC, the DC, DC, Northern Virginia, and Suburban Maryland. Your daily work includes conducting pest inspections, applying EPA-approved treatments for cockroaches, bed bugs, mice, rats, ants, termites, spiders, and other common DC pests, documenting findings and treatment details, and communicating with customers about prevention strategies. You will be trained in the latest extermination techniques, Integrated Pest Management methods, and safety protocols to deliver lasting results for our residential and commercial pest control customers. This is an outstanding opportunity for someone who wants to build a long-term career in the pest control and extermination industry with one of DC's fastest-growing pest control companies.",
    requirements: [
      "DOEE Pesticide Applicator certification (or willingness to obtain within 90 days of hire with company support)",
      ...
      "Comfortable working in DC apartment buildings, commercial kitchens, basements, crawl spaces, and rooftops",
      "Valid driver's license preferred but not required for DC-based walking routes",
  ...
  },
  {
    ...
    description:
      "Our Wildlife Control Specialists handle the unique challenges of urban wildlife management in Washington, D.C. and the surrounding metro area. You will specialize in the humane removal, exclusion, and prevention of raccoons, squirrels, opossums, birds, bats, groundhogs, and other wildlife species that invade residential and commercial properties throughout our service territory. This pest control career requires deep expertise in animal behavior, structural exclusion techniques, habitat modification, one-way door installation, and full compliance with DOEE wildlife regulations. You will also coordinate with our pest control technicians on projects that involve both wildlife and traditional pest issues, such as properties dealing with both raccoons and rodent infestations simultaneously. Wildlife Control Specialists at The DC Exterminator gain exposure to an extraordinary variety of wildlife scenarios unique to the Washington, D.C. urban environment.",
    requirements: [
      "DOEE Nuisance Wildlife Control Operator (NWCO) license required",
      "DOEE Pesticide Applicator license preferred for integrated pest management situations",
      "2+ years of wildlife control, animal control, or related pest management experience",
      "Thorough knowledge of DC and NYS wildlife regulations, seasons, and humane removal protocols",
  ...
  },
  {
    ...
    description:
      "The Commercial Account Manager is responsible for building, maintaining, and expanding relationships with commercial pest control clients across Washington, D.C., Northern Virginia and Suburban Maryland. You will manage pest control contracts for restaurants, hotels, office buildings, warehouses, retail stores, healthcare facilities, food processing plants, and property management companies. This role combines consultative sales expertise with deep knowledge of commercial pest control requirements, health department regulations, and industry-specific extermination protocols. You will conduct facility assessments, develop customized pest management proposals, coordinate service schedules with our exterminator teams, ensure client satisfaction and contract renewals, and identify upsell opportunities for additional pest control services. Top-performing Commercial Account Managers at The DC Exterminator regularly earn well above the base salary range through our generous commission structure.",
    requirements: [
      ...
      "Strong understanding of commercial pest control needs, DC DOH regulations, and industry compliance standards",
      "Proven track record of meeting or exceeding sales targets and maintaining high client retention rates",
      "Excellent presentation, negotiation, and relationship-building skills",
      "Familiarity with DC's restaurant, hospitality, healthcare, and property management industries",
      "DOEE Pesticide Applicator certification a plus (not required but training available)",
  ...
  },
  {
    ...
    requirements: [
      ...
      "Knowledge of DC geography, quadrants, and neighborhoods a strong plus",
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-4xl">
            ...
            <p className="mt-6 text-lg leading-8 text-zinc-300">
              ...
              managers, and customer service professionals across the DC metro
              area. We serve{" "}
              <Link
                href="/areas"
              ...
              in Washington, D.C., Northern Virginia and Suburban Maryland &mdash;
            ...
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              ...
              companies in the DC metro area, we offer competitive pay ranging
              ...
              control services that DC-area residents depend on every single day.
            </p>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              The pest control industry in Washington, D.C. offers stability,
              ...
              of choice for pest control professionals in the DC metro area.
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            from other pest control employers in Washington, D.C. and the
            ...
            {[
              {
                ...
                desc: "Every new exterminator and pest control technician receives comprehensive hands-on training in IPM protocols, EPA-approved treatment methods, equipment operation, safety procedures, and customer service excellence. We pair new hires with experienced lead exterminators for field training across diverse DC pest control scenarios including bed bug heat treatments, cockroach gel bait applications, rodent exclusion work, and termite barrier installations. Our training program is designed to turn good technicians into great exterminators.",
              },
              {
                title: "Competitive Pay & Bonuses",
                desc: "We offer some of the most competitive wages in the DC pest control industry. Our exterminators earn base salaries ranging from $45,000 to $95,000+ depending on role and experience, plus performance bonuses, overtime pay at time-and-a-half, and employee referral bonuses of $500 or more. Commercial account managers earn uncapped commissions on top of their base salary. We believe that exceptional pest control work deserves exceptional compensation.",
              },
              {
                title: "Career Growth Opportunities",
                desc: "Many of our lead exterminators and operations managers started as entry-level pest control technicians. We promote from within whenever possible and provide clear advancement paths from technician to lead exterminator, field supervisor, branch manager, and regional director. Customer service representatives can advance into dispatching, operations coordination, or transition to field roles with our full licensing support. Your ceiling at The DC Exterminator is as high as your ambition.",
              },
              {
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            exterminator positions across our service areas in DC, Northern
            Virginia, and Suburban Maryland. All positions include paid training, full
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            most comprehensive pest control training programs in the DC metro
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2">
            <div className="rounded-xl border border-zinc-700 bg-zinc-800/50 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-400">
                ...
                common DC pests (cockroaches, bed bugs, rats, mice, ants,
                ...
                are experienced lead exterminators who bring real-world DC pest
            ...
            <div className="rounded-xl border border-zinc-700 bg-zinc-800/50 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-400">
                ...
                exterminators on real pest control jobs across DC
                neighborhoods. From DC high-rises to DC
                rowhouses, DC single-family homes to DC apartment
            ...
            <div className="rounded-xl border border-zinc-700 bg-zinc-800/50 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-400">
                We provide full support for obtaining your DOEE Commercial
                ...
                {SITE_NAME} apart from competitors in the DC pest control
                market.
              </p>
            </div>
            <div className="rounded-xl border border-zinc-700 bg-zinc-800/50 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-400">
                ...
                training sessions at our DC office, send team members to
                ...
                at the forefront of the DC pest control industry.
              </p>
            </div>
          </div>
          ...
          <p className="mt-10 text-lg text-zinc-300">
            ...
            exterminators working in Washington, D.C. today. Many of our graduates
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            in the DC area provide. When you work as an exterminator or pest
          ...
          <p className="mt-10 text-lg text-zinc-300">
            ...
            among the highest in the DC pest control industry because we
            ...
            routes across DC, a wildlife control specialist
            handling complex removal jobs in Suburban Maryland, or a customer service
            representative scheduling appointments for customers across the entire
            Washington, D.C. metro area, you will receive the same high-quality benefits and
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-zinc-400">
                ...
                DC office. For experienced exterminators and pest control
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            DC metro area. Browse exterminator careers by neighborhood to find
          ...
          <p className="mt-12 text-lg text-zinc-300">
            ...
            over {totalNeighborhoods} neighborhoods across DC, Northern
            Virginia, and Suburban Maryland, and there may be a pest control position
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold sm:text-4xl">
            ...
            <span className="text-green-500">DC Pest Control</span>
          </h2>
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            <p>
              The pest control industry in Washington, D.C. is one of the most
              ...
              in America, DC will always need skilled exterminators and pest
              control professionals. Rats, mice, cockroaches, bed bugs,
              termites, ants, spiders, and urban wildlife are permanent fixtures
              of the Washington, D.C. landscape, and the demand for professional
            ...
            <p>
              ...
              exterminators work in every type of property across the District
            ...
            <p>
              ...
              control workers nationwide, and the DC metro area consistently
              ...
              control technicians in Washington, D.C. exceed national averages by
            ...
            <p>
              ...
              career opportunity. Washington, D.C. needs great exterminators
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-zinc-400">
              Fill out the form below to apply for a pest control position with The DC Exterminator.
