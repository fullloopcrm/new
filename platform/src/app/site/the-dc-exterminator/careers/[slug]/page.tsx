...
import { getJobDates } from "@/app/site/the-dc-exterminator/_lib/jobDates";
  ...
  const jobPostingSchema = {
    ...
    jobLocation: {
      ...
      address: {
        ...
        addressRegion: neighborhood.region === "Northern Virginia" ? "VA" : neighborhood.region === "Suburban Maryland" ? "MD" : "DC",
        addressCountry: "US",
      },
    },
    baseSalary: {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            ...
            <p>
              ...
              DC pest issues like cockroach infestations in apartment buildings,
            ...
            <p>
              ...
              heat treatment in a {neighborhood.name} rowhouse or execute a
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: `Exterminators who excel in ${neighborhood.name} have clear advancement opportunities to lead exterminator, field supervisor, and management roles within The DC Exterminator's ${neighborhood.region} operation.`,
              },
              {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            <p>
              ...
              {neighborhood.name} with {SITE_NAME}, you will need a DOEE
            ...
            <p>
              ...
              {neighborhood.name}, a DOEE Nuisance Wildlife Control Operator
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            to see all available exterminator jobs across the DC metro area.
          </p>
          ...
          <div className="mt-12 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            ...
            <p>
              ...
              professionals in the DC metro area. Our dispatchers work with
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            ...
            <p>
              ...
              of the strongest and most stable job markets in the entire DC
