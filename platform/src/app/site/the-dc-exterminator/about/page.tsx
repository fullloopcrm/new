...
import { getAllServices, getAllNeighborhoods, getRegions } from "@/app/site/the-dc-exterminator/_lib/data";
...
import { PHONE, SITE_URL, EMAIL, ADDRESS, getBreadcrumbSchema, getLocalBusinessSchemaGlobal } from "@/app/site/the-dc-exterminator/_lib/seo";

export const metadata: Metadata = {
  title: "About The DC Exterminator | Licensed & Insured DC Pest Control Company",
  description:
    "Learn about The DC Exterminator, a Consortium DC company providing licensed, insured pest control and extermination across DC, Northern Virginia & Suburban Maryland. 30+ services, 280+ neighborhoods, flat-rate pricing at $199/hr. Meet our team, our approach, and why thousands of DC-area residents trust us. Text us.",
  keywords:
    "about DC exterminator, DC pest control company, licensed exterminator DC, insured pest control, Consortium DC, pest control team DC",
  openGraph: {
    title: "About The DC Exterminator | Licensed & Insured DC Pest Control Company",
    description:
      "Licensed, insured pest control across DC. 30+ services, 280+ neighborhoods, flat-rate pricing at $199/hr. Text us.",
    url: `${SITE_URL}/about`,
  },
  alternates: {
    ...
    <div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-zinc-300">
              ...
              in DC, Northern Virginia &amp; Suburban Maryland.
            </p>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              ...
              Whether you own a rowhouse in DC, manage a high-rise in DC, or run a restaurant in DC, our exterminator team
              is ready to protect your property with affordable, professional pest control at a flat $199/hr.
            </p>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              We believe that everyone in the DC metro area deserves to live and work in a pest-free environment. That is why we have built the most comprehensive
              pest control network in the DC metro area, covering all Washington, D.C. area, Northern Virginia and Suburban Maryland.
              ...
              space, The DC Exterminator is the name you can trust to eliminate them quickly, safely, and permanently.
            </p>
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              The DC Exterminator was founded with a simple but powerful mission: to provide affordable, professional pest control
              to every home and business in the Washington, D.C. metropolitan area. We recognized that too many property owners were
              ...
              <Link href="/pricing" className="text-green-400 hover:text-green-300">pricing at a flat $199/hr</Link>{" "}
            ...
            <p>
              ...
              company, The DC Exterminator benefits from a deep bench of service industry expertise. Consortium DC has spent years
              building and operating service businesses across major metro areas, and that experience informs everything we do
              ...
              The DC Exterminator, you will speak with a real person, get a straightforward quote, and have a licensed pest control
              technician at your door &mdash; often the same day.
            </p>
            <p>
              What started as a small team of dedicated exterminators serving DC and DC has grown into the most comprehensive
              pest control network in the DC metro area. Today, we provide{" "}
              ...
              spanning all Washington, D.C. area, Northern Virginia and Suburban Maryland. We have assembled a roster of
              highly trained, licensed exterminators who specialize in every type of urban pest &mdash; from cockroaches, bed bugs,
              and rodents to termites, wildlife, and commercial-grade infestations. Every member of our pest control team is DOEE
            ...
            <p>
              ...
              business, and we are proud of the trust that the DC community has placed in our pest control company.
            </p>
            <p>
              Looking ahead, our mission remains the same: to be the most trusted, most affordable, and most effective pest control
              provider in the Washington, D.C. metro area. We are continually investing in new training, new technology, and new service
              areas to ensure that no matter where you are in the DC metro region, a licensed exterminator from The DC Exterminator
              is just a text message away. If you have a pest problem, we want to be the first and last exterminator you
              ever need. Text{" "}
              <a href={`sms:${phonePlain}`} className="text-green-400 hover:text-green-300">us</a> anytime, or{" "}
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: "Licensed & Certified", desc: "Every technician holds DOEE Commercial Pesticide Applicator licenses. Wildlife operators hold additional DOEE Nuisance Wildlife Control licenses." },
              ...
              { title: "Upfront Pricing", desc: "Inspections. Written quotes before any work begins. No hidden fees, no surprises, no upselling." },
          ...
          <div className="mt-16 max-w-4xl space-y-8 text-lg leading-8 text-zinc-300">
            <div>
              ...
              <p>
                ...
                owners. Every exterminator on our team holds a valid DC Department of Energy and Environment (DOEE) Commercial
                ...
                biology, and environmental regulations. Our wildlife control specialists carry additional DOEE Nuisance Wildlife Control Operator
                permits, authorizing them to handle raccoons, squirrels, opossums, and other wildlife that frequently invade DC properties.
                ...
                and continuing education credits. When you hire The DC Exterminator, you are hiring a pest control company that takes licensing
                and professional standards as seriously as you do. You can verify our credentials at any time by contacting{" "}
            ...
            <div>
              ...
              <p>
                ...
                a single accident could leave you responsible for costly repairs or medical bills. The DC Exterminator carries comprehensive
            ...
            <div>
              ...
              <p>
                ...
                never discussed. At The DC Exterminator, we do things differently. Every pest control job begins with an inspection, during
                ...
                openly, with services at a flat $199/hr, because we believe informed customers are happy customers. No hidden fees, no
            ...
            <div>
              ...
              <p>
                ...
                &mdash; these situations demand immediate attention. The DC Exterminator offers same-day and after-hours emergency pest control
                service for exactly these kinds of urgent situations. When you text{" "}
                ...
                including DC, Northern Virginia and Suburban Maryland.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                EPA-approved and applied according to strict manufacturer guidelines and DC regulations. We employ targeted
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              The backbone of The DC Exterminator is our team of licensed, experienced pest control professionals. Every exterminator
              on our roster has been carefully vetted, trained, and certified to handle the full spectrum of pest challenges that DC-area
              properties face. Our hiring process goes beyond simply checking for a valid DOEE Commercial Pesticide Applicator license.
            ...
            <p>
              ...
              continuous learning ensures that when a DC Exterminator technician arrives at your property, they bring the most current
            ...
            <p>
              ...
              and{" "}
              <Link href="/mouse-extermination" className="text-green-400 hover:text-green-300">mouse extermination</Link>{" "}
              with a focus on exclusion and long-term prevention, not just trapping. And our wildlife specialists hold DOEE Nuisance Wildlife
              Control Operator licenses, enabling them to legally and humanely remove raccoons, squirrels, birds, and other wildlife from
              residential and commercial properties throughout the DC metro area.
            </p>
            <p>
              For our{" "}
              <Link href="/commercial-pest-control" className="text-green-400 hover:text-green-300">commercial pest control</Link>{" "}
              ...
              program, in particular, is designed to meet the stringent requirements of DC Department of Health inspections, helping restaurant
            ...
            <p>
              ...
              to learn about current opportunities. The DC Exterminator offers competitive compensation, ongoing professional development,
              and the chance to be part of the most comprehensive pest control network in the Washington, D.C. metro area.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              At The DC Exterminator, we follow an Integrated Pest Management (IPM) methodology that represents the gold standard
            ...
            <p>
              ...
              in the first place. At The DC Exterminator, we take a different approach. Our exterminators are trained to identify
      ...
      <section className="bg-[#2A2A2A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              The DC Exterminator provides professional pest control and extermination services across three distinct regions
              in the Washington, D.C. metropolitan area &mdash; the District itself, Northern Virginia, and Suburban Maryland.
              In total, our exterminators serve{" "}
              <Link href="/areas" className="text-green-400 hover:text-green-300">{totalNeighborhoods}+ neighborhoods</Link>,
              making us one of the most geographically comprehensive pest control providers in the region. No matter where your
              property is located within the DC metro area, a licensed exterminator from The DC Exterminator can reach you quickly,
              often providing same-day service for emergency pest situations.
            </p>
            <p>
              Each region in our service area presents unique pest control challenges. The District&apos;s dense rowhouse and
              mid-rise environment creates ideal conditions for cockroach infestations and rodent activity in shared walls and
              utility chases. The mix of historic rowhouses, converted commercial buildings, and newer high-rise development
              requires flexible treatment strategies that account for varying construction types and pest entry points. As the
              seat of the federal government, DC draws residents and workers from every background, and demands exterminators
              who can communicate effectively and adapt to the wide range of building styles found across the city. DC&apos;s
              age and density present significant rodent control challenges, particularly in older residential buildings and
              near parks and waterways. Our Northern Virginia and Suburban Maryland service areas bring a more suburban
              character &mdash; wildlife concerns like raccoons and squirrels, alongside the standard urban pest issues.
            </p>
            <p>
              Beyond the District, our Northern Virginia pest control team serves communities across Arlington, Alexandria,
              Falls Church, and Fairfax County, providing the same licensed, insured, professional extermination services that
              DC residents rely on. Our Northern Virginia exterminators also cover Reston, McLean, and Tysons, where{" "}
              <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">termite treatment</Link>{" "}
              is a particularly important service for homeowners with wood-frame construction. And our Suburban Maryland team
              brings comprehensive pest control to communities from Bethesda to Silver Spring and beyond, handling everything
              from residential pest prevention to{" "}
              <Link href="/commercial-pest-control" className="text-green-400 hover:text-green-300">commercial pest control</Link>{" "}
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-lg leading-8 text-zinc-300">
            <p>
              Washington, D.C. is a proudly diverse city, and The DC Exterminator is proud to serve every corner of it.
              From the tight-knit communities of Anacostia and Petworth to the bustling commercial corridors of U Street and
              Downtown DC, our pest control services reach residents and business owners of every background, in every type of
              property, across every neighborhood. We treat every home and every business with the same level of professionalism,
              respect, and care &mdash; whether it is a rent-controlled apartment, a luxury condo, a family-owned corner store, or a
              corporate office tower. Every property owner in the DC metro area deserves professional pest control, and we are
            ...
            <p>
              ...
              especially for families and small business owners already dealing with the DC area&apos;s high cost of living. That is why
            ...
            <p>
              ...
              the impersonal, in-and-out approach that characterizes too many pest control companies in the DC market.
            </p>
            <p>
              ...
              prevention, or anything related to keeping your DC property pest-free, do not hesitate to reach out to{" "}
              <a href={`sms:${phonePlain}`} className="text-green-400 hover:text-green-300">us</a>{" "}
              or{" "}
              <a href={`mailto:${EMAIL}`} className="text-green-400 hover:text-green-300">{EMAIL}</a>.
            </p>
