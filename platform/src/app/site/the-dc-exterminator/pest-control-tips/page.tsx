...
import { getAllTips, getTipCategories } from "@/app/site/the-dc-exterminator/_data/tips";
import {
  PHONE,
  SITE_URL,
  SITE_NAME,
...
export const metadata: Metadata = {
  title: "DC Pest Control Tips & Guide | Expert Advice from Licensed Exterminators",
  description:
    "Free expert pest control tips from licensed DC exterminators. Cockroach prevention, bed bug detection, mouse-proofing, tenant rights, seasonal guides & more. Real advice that actually works — not generic fluff.",
  keywords:
    "pest control tips DC, cockroach prevention tips, bed bug detection, mouse proof apartment, DC tenant rights pest control, seasonal pest prevention, DIY pest control, natural pest control, restaurant pest control DC",
  openGraph: {
    title: "DC Pest Control Tips & Expert Guide | The DC Exterminator",
    description:
      "Free expert pest control tips from licensed DC exterminators. Real, actionable advice for cockroach prevention, bed bug detection, mouse-proofing, tenant rights, and more.",
  ...
  const masterFaqs = [
    {
      ...
      a: "Yes. Every tip, guide, and recommendation on this page comes from our team of DOEE-licensed pest control technicians with years of hands-on experience in DC apartments, homes, and commercial properties. We see thousands of pest situations every year — this is what actually works.",
    },
    {
    ...
    {
      q: "Is natural pest control effective in DC apartments?",
    ...
    {
      q: "Can my landlord charge me for pest control in DC?",
      a: "No. Under the DC Housing Maintenance Code, your landlord is legally required to provide pest control and keep your apartment free of vermin at no additional cost to you. Read our complete DC tenant rights guide for details on how to enforce this right, file complaints, and take action if your landlord refuses.",
    },
    {
      q: "What's the most important thing I can do to prevent pests in my DC apartment?",
      a: "Three things make the biggest impact: (1) Fix every water leak — pests need water more than food, (2) Seal entry points around pipes under sinks with copper mesh and caulk, and (3) Store all food in sealed hard containers. Do these three things consistently and you'll prevent 80% of common DC pest problems.",
    },
  ];
    ...
    <div className="text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd({
            ...
            "@type": "CollectionPage",
            name: "DC Pest Control Tips & Expert Guide",
            description:
              "Comprehensive pest control knowledge base from licensed DC exterminators. Expert tips, DIY guides, prevention strategies, and tenant rights information.",
            url: `${SITE_URL}/pest-control-tips`,
            publisher: {
              "@type": "Organization",
              name: SITE_NAME,
      ...
      <section className="bg-[#0A0A0A] pb-16 pt-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-green-500">
            Free Expert Knowledge &middot; From Licensed DC Exterminators
          </p>
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-300">
            Real pest control advice from exterminators who work inside DC apartments every single day. Not the generic &quot;keep your kitchen clean&quot; stuff you&apos;ve already read 50 times. Actual, specific, experience-tested tips that help you prevent, identify, and deal with every pest that calls Washington, D.C. home.
          </p>
      ...
      <section className="border-y border-zinc-800 bg-zinc-900/80 py-5">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-8 px-4 text-center text-sm text-zinc-400 sm:px-6 lg:px-8">
          ...
          <span className="hidden text-zinc-700 sm:inline">&bull;</span>
          <span><strong className="text-white">DC-Specific</strong> Advice</span>
          <span className="hidden text-zinc-700 sm:inline">&bull;</span>
      ...
      {/* ── THE BIG PICTURE: WHAT EVERY DC RESIDENT NEEDS TO KNOW ── */}
      <section className="bg-[#0A0A0A] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-green-500">Start Here</p>
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            The <span className="text-green-500">Honest Truth</span> About Pest Control in DC
          </h2>
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                Living in Washington, D.C. means sharing space with pests. It&apos;s not a question of IF, it&apos;s a question of WHEN. The dense housing, aging infrastructure, massive food industry, and constant movement of people and goods make DC one of the most pest-challenged environments in North America.
              </p>
              <p>
            ...
            <div className="space-y-5 text-zinc-300 leading-7">
              ...
              <p>
                These guides are written by technicians who are inside DC apartments every single day. Not content writers in another state Googling &quot;pest control tips.&quot; When we say &quot;the most common cockroach entry point in DC apartments is the gap around kitchen sink pipes,&quot; we know that because we see it 10 times a week, not because we read it somewhere.
              </p>
              <p>
                <strong className="text-white">The three pillars of DC pest prevention:</strong>
              </p>
              ...
              <p className="text-sm text-zinc-400">
                Do these three things consistently and you&apos;ll prevent 80% of common DC pest problems. The guides below show you exactly how.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border-y border-red-500/30 bg-[#2a0e0e] px-4 py-5 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl items-start gap-3">
          ...
          <p className="text-sm leading-6 text-zinc-300">
            <strong className="text-white">Bookmark this page.</strong> We add new guides regularly based on the questions DC residents ask us most. Every guide is written by the same licensed exterminators who treat {">"}25,000 DC properties per year. This is the free advice we give our friends and family.
          </p>
        </div>
      </div>
      ...
      <section className="bg-[#0A0A0A] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            10 Rules of <span className="text-green-500">DC Pest Prevention</span>
          </h2>
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            If you read nothing else on this entire page, read these ten rules. Follow them and you&apos;ll have fewer pest problems than 90% of DC apartments.
          </p>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            {[
              ...
              },
              {
                ...
                detail: "The gap around pipes under your kitchen and bathroom sinks is the #1 pest entry point in DC apartments. Copper mesh + caulk. Five minutes. Done.",
              },
              {
                num: "03",
              ...
              },
              {
                ...
                detail: "Not when it's full. Daily. A bag of garbage sitting overnight in a warm DC apartment is an open invitation to every pest in your building.",
              },
              {
                num: "05",
              ...
              },
              {
                ...
                detail: "Text or email your landlord, not a phone call. You need a dated paper trail if you ever need to file a code enforcement complaint or go to DC Superior Court.",
              },
              {
                num: "10",
                rule: "Don't Wait",
      ...
      <div className="border-y border-red-500/30 bg-[#2a0e0e] px-4 py-5 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl items-start gap-3">
          ...
          <p className="text-sm leading-6 text-zinc-300">
            <strong className="text-white">German cockroaches are the fastest-reproducing common pest in DC.</strong> A single female produces an egg case every 28 days containing 30-48 eggs. In ideal conditions (your warm apartment), one cockroach can lead to 30,000 offspring in a year. That&apos;s why &quot;I&apos;ll deal with it later&quot; is the most expensive pest control decision you can make.
          </p>
        </div>
      </div>
      ...
      <section className="bg-[#2A2A2A] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            DC Pest <span className="text-green-500">Cheat Sheet</span>
          </h2>
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            Quick-hit guidance for the most common pest situations in DC. For the full deep-dive, click through to the relevant guide.
          </p>
            ...
            {[
              {
                ...
                link: "/pest-control-tips/how-to-identify-cockroaches-in-dc-apartment",
              },
              {
                pest: "Mice",
                ...
                link: "/pest-control-tips/how-to-mouse-proof-your-dc-apartment",
              },
              {
                pest: "Bed Bugs",
                ...
                link: "/pest-control-tips/bed-bug-signs-how-to-check-your-dc-apartment",
              },
              {
                pest: "Drain Flies",
                ...
                link: "/pest-control-tips/how-to-get-rid-of-drain-flies-in-dc-bathroom",
              },
              {
                pest: "Ants",
                ...
                link: "/pest-control-tips/what-attracts-cockroaches-to-dc-apartments",
              },
              {
                pest: "Rats (outdoor)",
                ...
                link: "/pest-control-tips/how-to-deal-with-rats-outside-your-dc-building",
              },
            ].map((item) => (
      ...
      <section className="bg-[#0A0A0A] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            Pest Control <span className="text-green-500">Myths</span> That Cost DC Residents Money
          </h2>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
                Advice from <span className="text-green-500">Real DC Exterminators</span>
              </h2>
              <p className="mt-4 text-zinc-300 leading-7">
                Every guide in this knowledge base is written by our team of DOEE-licensed pest control technicians who work inside DC apartments and commercial properties every day. We&apos;re not content writers Googling pest facts &mdash; we&apos;re the people pulling refrigerators away from walls, sealing pipe gaps with copper mesh, and placing gel bait in the exact crevices where cockroaches hide.
              </p>
              <p className="mt-4 text-zinc-300 leading-7">
                We&apos;ve treated over 25,000 DC properties. We know what works, what doesn&apos;t, and &mdash; most importantly &mdash; when DIY crosses the line into &quot;you really need to call someone.&quot; These guides reflect that experience honestly.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { stat: "DOEE", label: "Licensed & Insured" },
