...
import { SITE_URL, PHONE, getBreadcrumbSchema } from "@/app/site/the-dc-exterminator/_lib/seo";

export const metadata: Metadata = {
  title: "30+ DC Pest Control & Exterminator Services | Browse All Treatments",
  description:
    "Browse all 30+ professional pest control and exterminator services from The DC Exterminator. Cockroach extermination, bed bug treatment, rat control, mouse removal, termite treatment, wildlife removal, commercial pest control & more. Licensed & insured across DC, Northern Virginia & Suburban Maryland. Pricing at $199/hr. Text us.",
  keywords:
    "DC pest control services, exterminator services DC, cockroach extermination, bed bug treatment, rat exterminator, mouse exterminator, termite treatment, wildlife removal, commercial pest control, residential pest control DC",
  openGraph: {
    title: "30+ DC Pest Control & Exterminator Services | Browse All Treatments",
    description:
    ...
    <div className="text-white">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-zinc-300">
              The DC Exterminator offers {totalServices} professional pest control services covering every type
              of infestation you might encounter in the Washington, D.C. metro area. From cockroach extermination
              in DC apartments to rat control in DC restaurants, our licensed and insured
            ...
            <p className="mt-4 text-base leading-7 text-zinc-400">
              ...
              training, equipment, and experience to solve the problem fast. We serve all of Washington, D.C.
              plus Northern Virginia and Suburban Maryland — covering{" "}
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-zinc-300 leading-7">
            <p>
              Washington, D.C. presents a unique set of pest control challenges that no other American city
              ...
              in DC — they are a necessity.
            </p>

            <p>
              Many DC-area residents initially attempt DIY pest control using over-the-counter sprays, traps,
            ...
            <p>
              ...
              and ultimately failed treatment approach. Our pest control professionals hold DC
              DOEE commercial applicator licenses and complete ongoing continuing education
              every year to stay current with the latest integrated pest management techniques and
              product innovations. When you hire The DC Exterminator, you are getting science-backed
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-400 leading-7">
            Every pest control service from The DC Exterminator follows a proven, systematic process
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-4 space-y-4 text-zinc-300 leading-7">
                <p>
                  Residential pest control in Washington, D.C. requires an approach that prioritizes
                  safety, discretion, and minimal disruption to your daily life. Whether you live
                  in a historic rowhouse in Capitol Hill, a modern high-rise condo in Downtown DC,
                  a townhouse in Georgetown, or a single-family home in Suburban Maryland, our
                ...
                <p>
                  Our residential pest control services cover every common DC household pest including{" "}
            ...
            <div>
              ...
              <div className="mt-4 space-y-4 text-zinc-300 leading-7">
                ...
                <p>
                  ...
                  is specifically designed to meet DC Department of Health requirements, with
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-zinc-300 leading-7">
            <p>
              ...
              exists to handle. When you need an exterminator right now, The DC Exterminator answers
              the phone — day or night, weekdays, weekends, and holidays.
            </p>

            <p>
              Our emergency pest control response team is stationed across all Washington, D.C. area with
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 max-w-4xl space-y-6 text-zinc-300 leading-7">
            <p>
              The DC Exterminator provides professional pest control and exterminator services across
              the entire Washington, D.C. metro area. Our coverage spans {totalNeighborhoods}+ individual
              neighborhoods organized across 3 service regions: Washington, D.C., Northern Virginia,
              and Suburban Maryland. No matter
            ...
            <p>
              ...
              in Columbia Heights and Adams Morgan tend to have more severe cockroach and mouse
              infestations due to aging infrastructure and shared wall voids. Waterfront neighborhoods
              in Navy Yard and Southwest Waterfront experience elevated rodent pressure from
              proximity to shipping and industrial activity. Rowhouse-heavy neighborhoods like
              Capitol Hill, Petworth, and Bloomingdale frequently deal with carpenter ant and
              termite activity in their century-old wooden structural elements. New construction in
              areas like NoMa, Navy Yard, and Downtown DC attracts pests through
            ...
            <p>
              ...
              service footprint to ensure that everyone in the DC metro area has access to professional
