...
import { PHONE, EMAIL, ADDRESS, SITE_URL, getBreadcrumbSchema, getLocalBusinessSchemaGlobal } from "@/app/site/the-dc-exterminator/_lib/seo";
import { getAllServices, getAllNeighborhoods } from "@/app/site/the-dc-exterminator/_lib/data";

export const metadata: Metadata = {
  title: "Contact DC Exterminator | Self-Book & Save $20",
  description:
    "Contact The DC Exterminator for a pest control inspection and quote. Self-book online & save $20. Same-day exterminator service across DC, Northern Virginia & Suburban Maryland. Licensed, insured, flat-rate pricing at $199/hr. We respond within minutes.",
  keywords:
    "contact exterminator DC, book pest control online DC, text exterminator, DC pest control, book exterminator appointment, pest control near me, emergency exterminator contact",
  openGraph: {
    title: "Contact DC Exterminator | Self-Book & Save $20",
    description:
      "Contact The DC Exterminator. Self-book online & save $20. Inspection, same-day service, flat-rate pricing at $199/hr.",
...
export default function ContactPage() {
  ...
  const contactFaqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How quickly does The DC Exterminator respond to contact requests?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "What is the fastest way to contact a pest control exterminator in DC?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Does The DC Exterminator offer pest control inspections?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "What areas does The DC Exterminator serve?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "We provide pest control and exterminator services across all of Washington, D.C., plus Northern Virginia and Suburban Maryland.",
        },
      },
    ],
  };
    ...
    <div className="text-white">
      ...
      <section className="bg-green-700 pb-20 pt-8">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-10 text-sm font-semibold uppercase tracking-[0.2em] text-green-200/80">
            DC Pest Control Experts &middot; Licensed &amp; Insured &middot; Same-Day Service
          </p>
          <h1 className="mt-3 text-4xl font-extrabold tracking-tight sm:text-5xl">
            Contact Your{" "}
            <span className="text-green-200">DC Exterminator</span> Today
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-green-100">
            ...
            No call centers, no runaround. When you contact The DC Exterminator,
            you reach a licensed pest control professional who knows Washington, D.C.
            inside and out.
          </p>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-green-100">
            ...
            same-day exterminator service available across all Washington, D.C. area, there
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-green-100">
            ...
            and every other type of property in DC, Northern Virginia, and
            Suburban Maryland. No matter the pest &mdash;{" "}
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
            How to Reach Your DC Exterminator
          </h2>
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            the ways you can get in touch with The DC Exterminator, ranked by
            response speed.
          </p>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2">
            <div className="rounded-xl border border-zinc-700 bg-[#1A1A1A] p-8">
              ...
              <p className="mt-4 text-sm text-zinc-500">
                We&apos;re a mobile pest control team covering DC, Northern Virginia,
                and Suburban Maryland — we don&apos;t operate a walk-in storefront, so
                we recommend texting or booking online ahead of time so we can have
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            From the moment you reach out to The DC Exterminator, our process is
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-300">
                  ...
                  exterminator appointments are available for most of DC, and we offer
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-300">
                  ...
                  DC exterminator clients have their pest problem resolved in a single
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            with an active infestation that poses a health or safety risk, The DC
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            clients ask most often about contacting The DC Exterminator and
            scheduling service.
          </p>
          ...
          <div className="mt-12 space-y-8">
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                fastest in the DC exterminator industry.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                situations across DC, Northern Virginia, and Suburban Maryland. If
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                especially for food service businesses facing DC DOH regulations.
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                across all Washington, D.C. area. Building-wide pest control contracts include
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            The DC Exterminator provides professional pest control and exterminator
            services across a wide geographic area covering Washington, D.C. and the
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 md:grid-cols-4">
            {["Washington, D.C.", "Northern Virginia", "Suburban Maryland"].map(
              (region) => (
          ...
          <p className="mt-8 text-zinc-300">
            ...
            <Link href="/cockroach-extermination" className="text-green-400 hover:text-green-300">
              cockroach exterminator in DC
            </Link>, a{" "}
            <Link href="/bed-bug-treatment" className="text-green-400 hover:text-green-300">
              bed bug treatment in DC
            </Link>, a{" "}
            <Link href="/rat-extermination" className="text-green-400 hover:text-green-300">
              rat exterminator in DC
            </Link>, or{" "}
            <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">
              termite treatment in Suburban Maryland
            </Link>{" "}
