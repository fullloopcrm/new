...
import { PHONE, SITE_NAME, EMAIL, ADDRESS } from "@/app/site/the-dc-exterminator/_lib/seo";
import { getCategories, getRegions } from "@/app/site/the-dc-exterminator/_lib/data";
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <span className="text-xl font-bold text-white">
              The<span className="text-green-500">DC</span>Exterminator
            </span>
