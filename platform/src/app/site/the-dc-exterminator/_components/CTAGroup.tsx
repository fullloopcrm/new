...
import { PHONE } from "@/app/site/the-dc-exterminator/_lib/seo";
...
const defaults: Record<CTAVariant, { title: string; subtitle: string }> = {
  ...
  preFaq: {
    title: "Licensed. Insured. Trusted by Thousands of DC Properties.",
    ...
    return (
      <div className="mt-8">
        <div className="mb-5 space-y-1.5 text-sm text-zinc-400">
          ...
          <p>&#10003; <strong className="text-zinc-200">Licensed &amp; insured</strong> DOEE exterminators</p>
        </div>
