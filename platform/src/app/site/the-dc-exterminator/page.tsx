...
import {
  ...
  ADDRESS,
  getFAQPageSchema,
} from "@/app/site/the-dc-exterminator/_lib/seo";
import CTAGroup from "@/app/site/the-dc-exterminator/_components/CTAGroup";

export const metadata: Metadata = {
  title:
    "DC Pest Control & Exterminator Services | Licensed Exterminators | The DC Exterminator",
  description:
    "Professional pest control and exterminator services across DC, Northern Virginia & Suburban Maryland. Flat-rate pricing at $199/hr. Cockroaches, bed bugs, rats, mice, termites & more. Licensed & insured. Same-day service. Text us!",
  keywords:
    "DC pest control, DC exterminator, pest control DC, exterminator DC, bed bug treatment DC, cockroach extermination DC, rat exterminator DC, mouse exterminator, termite treatment, wildlife removal DC, commercial pest control, residential pest control",
  openGraph: {
    title: "DC Pest Control & Exterminator Services | The DC Exterminator",
    description:
      "Professional pest control and exterminator services across the DC metro area. Flat-rate pricing at $199/hr. 30+ services. 280+ neighborhoods. Text us!",
    url: SITE_URL,
    siteName: SITE_NAME,
    type: "website",
    locale: "en_US",
  ...
  const homeFaqs = [
    {
      ...
      a: "We charge one flat rate: $199/hr, 1-hour minimum, no matter the pest type, severity, or property size — residential or commercial. You're billed for actual time worked, never a worst-case flat quote. We always confirm the estimate with an inspection before any work begins — no hidden fees, no surprises.",
    },
    {
      q: "Do you offer same-day pest control and exterminator service?",
      a: "Yes. We offer same-day and emergency pest control service for urgent situations throughout DC, Northern Virginia, and Suburban Maryland. Whether it's a wasp nest near your front door, a rat sighting in your restaurant kitchen, or a bed bug discovery the night before guests arrive, our licensed exterminators can respond quickly. Text us and we'll dispatch a technician as soon as possible.",
    },
    {
    ...
    },
    {
      ...
      a: "We provide pest control and exterminator services for every property type — studio apartments, co-ops, condos, townhouses, rowhouses, single-family homes, restaurants, offices, retail stores, warehouses, and multi-unit residential buildings. Our licensed exterminators serve DC, Northern Virginia and Suburban Maryland.",
    },
    {
      q: "Are your exterminators licensed and insured?",
      a: "Every single one of our pest control technicians holds a DOEE Commercial Pesticide Applicator license and is fully insured. Our wildlife control operators carry additional DOEE Nuisance Wildlife Control licenses. We maintain full general liability coverage on every job we perform, and we're happy to provide proof of insurance upon request.",
    },
    {
      q: "What areas does The DC Exterminator serve?",
      a: `We provide pest control and exterminator services across ${totalNeighborhoods}+ neighborhoods spanning DC, DC, DC, the DC, DC, Northern Virginia, and Suburban Maryland. If you're anywhere in the DC metro area, we've got you covered. Check our service areas page for your specific neighborhood.`,
    },
    {
    ...
    <div className="text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd(getFAQPageSchema(homeFaqs)),
        }}
      />
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-zinc-300">
                ...
                in DC, Northern Virginia &amp; Suburban Maryland. DOEE licensed exterminators. Same-day pest control service available. Upfront pricing with no hidden fees.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="glow-border rounded-2xl bg-[#141414] px-6 py-8 text-center transition-all duration-300 hover:bg-[#1a1a1a]">
                ...
                <div className="mt-1 text-xs text-zinc-500">Fastest scheduling in DC. Period.</div>
              </div>
              <div className="glow-border rounded-2xl bg-[#141414] px-6 py-8 text-center transition-all duration-300 hover:bg-[#1a1a1a]">
                ...
                <div className="mt-2 text-sm font-semibold text-zinc-200">DC Loves Us</div>
              ...
              <div className="glow-border rounded-2xl bg-[#141414] px-6 py-8 text-center transition-all duration-300 hover:bg-[#1a1a1a]">
                ...
                <div className="mt-1 text-xs text-zinc-500">DC homes &amp; businesses cleared. Yours is next.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-y border-white/[0.06] bg-[#0D0D0D] py-6">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-8 px-4 text-center text-sm text-zinc-500 sm:px-6 lg:px-8">
          <span><strong className="text-zinc-200">DOEE Licensed</strong> Exterminators</span>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold sm:text-4xl">
            Washington, D.C.&apos;s Premier <span className="text-green-500">Pest Control</span> &amp; Exterminator Company
          </h2>
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                The DC Exterminator is a full-service pest control company serving the entire Washington, D.C. metropolitan area. Our team of licensed exterminators provides comprehensive pest control services to residential and commercial properties across the District, Northern Virginia, and Suburban Maryland. We specialize in eliminating every pest that thrives in the urban environment — from <Link href="/cockroach-extermination" className="text-green-400 hover:text-green-300">cockroaches</Link> and <Link href="/bed-bug-treatment" className="text-green-400 hover:text-green-300">bed bugs</Link> to <Link href="/rat-extermination" className="text-green-400 hover:text-green-300">rats</Link>, <Link href="/mouse-extermination" className="text-green-400 hover:text-green-300">mice</Link>, <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">termites</Link>, and <Link href="/general-pest-control" className="text-green-400 hover:text-green-300">general household pests</Link>.
              </p>
              <p>
                What sets our pest control company apart is our commitment to thorough, lasting results. Every job begins with a comprehensive inspection conducted by a DOEE-licensed exterminator who identifies not just the pest, but the source of the infestation and the conditions allowing it to persist. We then develop a customized treatment plan using EPA-approved products and industry-leading techniques — from targeted gel bait applications for <Link href="/cockroach-extermination" className="text-green-400 hover:text-green-300">cockroach control</Link> to whole-room heat treatment for <Link href="/bed-bug-treatment" className="text-green-400 hover:text-green-300">bed bug elimination</Link> to exclusion work for <Link href="/rodent-proofing" className="text-green-400 hover:text-green-300">rodent-proofing</Link>.
              </p>
              <p>
                We understand that pest problems in DC are uniquely challenging. Dense multi-unit housing means infestations can spread rapidly between apartments. The city&apos;s massive food service industry creates constant pest pressure on restaurants and commercial kitchens. Old building infrastructure provides endless entry points for rodents and insects. That&apos;s why our pest control approach addresses the root cause — not just the symptoms — with treatments designed for the realities of Washington, D.C. living. Whether you need <Link href="/emergency-pest-control" className="text-green-400 hover:text-green-300">emergency pest control</Link> for an active infestation or a <Link href="/commercial-pest-control" className="text-green-400 hover:text-green-300">commercial pest control maintenance plan</Link> to keep your business compliant, The DC Exterminator delivers results you can count on.
              </p>
            </div>
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
              ...
              <p>
                Every exterminator on our team holds active DOEE Commercial Pesticide Applicator certification and undergoes ongoing training in the latest pest control techniques and safety protocols. Our wildlife control specialists carry additional DOEE Nuisance Wildlife Control licenses for <Link href="/raccoon-removal" className="text-green-400 hover:text-green-300">raccoon removal</Link>, <Link href="/squirrel-removal" className="text-green-400 hover:text-green-300">squirrel removal</Link>, <Link href="/pigeon-control" className="text-green-400 hover:text-green-300">pigeon control</Link>, and <Link href="/bat-removal" className="text-green-400 hover:text-green-300">bat removal</Link>. We carry full general liability insurance on every job and are happy to provide documentation for property managers, co-op boards, and commercial tenants.
              </p>
              <p>
                Thousands of DC property owners, tenants, and business operators trust The DC Exterminator for reliable pest control. Check our <Link href="/reviews" className="text-green-400 hover:text-green-300">customer reviews</Link> to see why we maintain a 4.9-star rating across thousands of completed pest control jobs. Learn more <Link href="/about" className="text-green-400 hover:text-green-300">about our company</Link>, our commitment to excellence, and the Consortium DC team behind every pest control treatment we perform. Ready to get started? <Link href="/book/new" className="text-green-400 hover:text-green-300">Self-book online & save $20</Link> — the fastest way to get service — or <a href={`sms:${phonePlain}`} className="text-green-400 hover:text-green-300">text us</a>. We respond fast. With pest control pricing at a flat $199/hr, there&apos;s no reason to wait. Don&apos;t let a small pest problem become a major infestation. Contact The DC Exterminator today and let our licensed exterminators take care of the rest.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#111111] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            Why DC Chooses Our <span className="text-green-500">Pest Control</span> &amp; Exterminator Team
          </h2>
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            Choosing the right pest control company in Washington, D.C. is critical. The wrong exterminator wastes your time and money with ineffective treatments that let infestations grow worse. Here&apos;s what makes The DC Exterminator different from every other pest control company in the metro area.
          </p>
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                title: "Licensed & Insured Exterminators",
                desc: "All pest control technicians hold DOEE Commercial Pesticide Applicator licenses. Wildlife operators carry additional DEC Nuisance Wildlife Control certification. Full liability coverage on every single job — residential and commercial.",
              },
              {
                title: "Same-Day Pest Control Service",
                desc: "Emergency pest problems can't wait. Wasp nests, rat infestations, bed bug discoveries — we offer same-day exterminator service for urgent situations across DC, Northern Virginia and Suburban Maryland.",
              },
              {
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2">
            <div className="space-y-4 text-zinc-300 leading-7">
              <h3 className="text-xl font-semibold text-white">Comprehensive DC Pest Control Coverage</h3>
              <p>
                Most pest control companies in Washington, D.C. serve a limited area or specialize in only a few pest types. The DC Exterminator provides {totalServices} different pest control and exterminator services across {totalNeighborhoods}+ neighborhoods in {regions.length} regions. Whether you&apos;re dealing with <Link href="/cockroach-extermination" className="text-green-400 hover:text-green-300">cockroaches in a Shaw apartment</Link>, <Link href="/rat-extermination" className="text-green-400 hover:text-green-300">rats behind a U Street restaurant</Link>, <Link href="/bed-bug-treatment" className="text-green-400 hover:text-green-300">bed bugs in a Dupont Circle co-op</Link>, or <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">termites in a Suburban Maryland home</Link>, we have the expertise, the licensing, and the equipment to handle it.
              </p>
              <p>
                Our coverage extends well beyond the District. Our <Link href="/areas" className="text-green-400 hover:text-green-300">Northern Virginia pest control team</Link> covers communities from Arlington and Alexandria to Fairfax, Reston, and Tysons. And our Suburban Maryland exterminators serve Bethesda, Silver Spring, Rockville, and surrounding communities.
              </p>
            </div>
            <div className="space-y-4 text-zinc-300 leading-7">
              ...
              <p>
                Our <Link href="/pricing" className="text-green-400 hover:text-green-300">pest control pricing page</Link> breaks down the flat $199/hr rate that applies to every service we offer, from <Link href="/general-pest-control" className="text-green-400 hover:text-green-300">general pest control</Link> to specialized <Link href="/bed-bug-treatment" className="text-green-400 hover:text-green-300">bed bug heat treatment</Link> and <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">termite treatment programs</Link>, for both <Link href="/commercial-pest-control" className="text-green-400 hover:text-green-300">commercial pest control</Link> and residential properties.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border-y border-red-500/10 bg-[#1a0a0a] px-4 py-5 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl items-start gap-3">
          <span className="shrink-0 rounded-md bg-green-500/10 px-2 py-1 text-xs font-bold uppercase tracking-wider text-green-400">DC Insider</span>
          <p className="text-sm leading-6 text-zinc-300">
            <strong className="text-white">DC landlords are legally required to provide pest control.</strong> Under DC Housing Maintenance Code, your landlord must keep your apartment pest-free. If they&apos;re dragging their feet, you have rights. We work directly with building management to get the job done &mdash; and we document everything for your records.
          </p>
        </div>
      </div>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-4xl text-zinc-300 leading-7">
            The DC Exterminator offers {totalServices} professional pest control and extermination services organized across {Object.keys(servicesByCategory).length} categories. Every service is billed at a flat $199/hr, includes an inspection, EPA-approved treatments, and a satisfaction guarantee. Click any service below to see detailed information, pricing, FAQs, and coverage across all {totalNeighborhoods} neighborhoods we serve.
          </p>
              ...
              <div key={category}>
                ...
                <p className="mt-2 text-zinc-400">
                  {category === "Common Pests" &&
                    "The most frequently encountered pest problems across DC apartments, homes, and businesses. These pests thrive in the urban environment and require professional exterminator treatment for complete elimination."}
                  {category === "Rodents" &&
                    "DC's rodent population is one of the largest in the world. Professional rodent control combines trapping, baiting, and exclusion work to eliminate current infestations and prevent re-entry."}
                  ...
                  {category === "Wildlife Control" &&
                    "DC's urban wildlife — raccoons, squirrels, pigeons, and bats — can cause property damage and health hazards. Licensed wildlife control operators handle humane removal and exclusion."}
                  ...
                  {category === "Commercial Services" &&
                    "Specialized pest control programs designed for restaurants, food service, retail, offices, and commercial properties. DC DOH-compliant treatments with documentation for health inspections."}
      ...
      <div className="border-y border-red-500/10 bg-[#1a0a0a] px-4 py-5 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl items-start gap-3">
          <span className="shrink-0 rounded-full bg-green-500/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-green-400">Pro Tip</span>
          <p className="text-sm leading-6 text-zinc-300">
            <strong className="text-white">Moving into a new apartment?</strong> Request a pest inspection BEFORE you move your furniture in. It&apos;s 10x easier (and cheaper) to treat an empty unit. We offer pre-move-in inspections at the same flat $199/hr rate, and they only take about 30 minutes. You&apos;ll thank us later.
          </p>
        </div>
      </div>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            Understanding the <span className="text-green-500">DC Pest Problem</span>
          </h2>
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                Washington, D.C. has one of the most challenging pest environments in the United States. The combination of dense population, aging building infrastructure, an enormous food service industry, and a temperate coastal climate creates ideal conditions for virtually every urban pest species. According to the DC Department of Health, approximately 15% of DC households report seeing cockroaches in their homes, and rodent complaints have increased significantly in recent years across all Washington, D.C. area.
              </p>
              <p>
                <strong className="text-white">Cockroaches</strong> are the most common pest in DC apartments. German cockroaches — the smaller, light-brown species — infest kitchens and bathrooms, spreading through shared walls and plumbing in multi-unit buildings. A single female German cockroach can produce 30,000 offspring in a year. American cockroaches, the larger reddish-brown &quot;water bugs,&quot; invade basements, laundry rooms, and utility areas. Professional <Link href="/cockroach-extermination" className="text-green-400 hover:text-green-300">cockroach extermination</Link> using gel baits, IGR treatments, and crack-and-crevice applications is the only reliable way to eliminate established cockroach populations in DC buildings.
              </p>
              <p>
                <strong className="text-white">Bed bugs</strong> remain one of DC&apos;s most persistent pest problems. These blood-feeding insects spread through luggage, used furniture, and shared laundry facilities. Local bed bug disclosure requirements require landlords to disclose known bed bug infestation history to prospective tenants. Professional <Link href="/bed-bug-treatment" className="text-green-400 hover:text-green-300">bed bug treatment</Link> — particularly whole-room heat treatment that raises temperatures above 120°F — is the most effective elimination method. Chemical treatments using residual insecticides can supplement heat treatment for severe infestations.
              </p>
            </div>
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                <strong className="text-white">Rats and mice</strong> are an iconic — and serious — DC pest problem. The city&apos;s rat population is estimated in the millions, with Norway rats dominating at street level and in subway systems. Mayor Adams&apos; &quot;rat czar&quot; initiative and the expansion of containerized trash collection reflect how seriously the city takes rodent control. For individual properties, professional <Link href="/rat-extermination" className="text-green-400 hover:text-green-300">rat extermination</Link> and <Link href="/mouse-extermination" className="text-green-400 hover:text-green-300">mouse control</Link> combines strategic baiting, snap trapping, and — most importantly — <Link href="/rodent-proofing" className="text-green-400 hover:text-green-300">rodent exclusion work</Link> to seal entry points and prevent re-infestation.
              </p>
              <p>
                <strong className="text-white">Termites</strong> cause more property damage in the DC metro area than most people realize. Subterranean termites are the primary species, entering buildings through soil contact with foundations and causing structural damage that can cost thousands to repair. <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">Professional termite treatment</Link> uses liquid barrier treatments and bait station systems to protect properties. Annual termite inspections are recommended for all wood-frame structures, particularly in Northern Virginia and Suburban Maryland where soil conditions favor termite activity.
              </p>
              <p>
                <strong className="text-white">Wildlife</strong> in DC is more diverse than many residents expect. <Link href="/raccoon-removal" className="text-green-400 hover:text-green-300">Raccoons</Link> nest in attics and crawl spaces. <Link href="/squirrel-removal" className="text-green-400 hover:text-green-300">Squirrels</Link> chew through soffits and fascia to access warm interior spaces. <Link href="/pigeon-control" className="text-green-400 hover:text-green-300">Pigeons</Link> cause extensive property damage with their acidic droppings and nesting materials. <Link href="/bat-removal" className="text-green-400 hover:text-green-300">Bats</Link> — while ecologically beneficial — carry rabies risk and require licensed wildlife control for safe removal. All wildlife control in the District requires a DOEE Nuisance Wildlife Control license, which all our wildlife specialists hold.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#111111] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            From the heart of the District to the northern suburbs of Suburban Maryland, from the Potomac waterfront to the outer edges of Northern Virginia — our licensed exterminators provide professional pest control coverage across the entire DC metropolitan area. Every neighborhood we serve has a dedicated local service page with pest control information specific to that community.
          </p>
          ...
          <div className="mt-10 space-y-5 text-zinc-300 leading-7">
            <p>
              Each neighborhood we serve presents unique pest control challenges. <Link href="/areas/foggy-bottom" className="text-green-400 hover:text-green-300">Foggy Bottom</Link> high-rises deal with cockroach and rodent issues driven by restaurant density. <Link href="/areas/capitol-hill" className="text-green-400 hover:text-green-300">Capitol Hill</Link> and <Link href="/areas/petworth" className="text-green-400 hover:text-green-300">Petworth</Link> rowhouses face bed bug and mouse problems common in older multi-unit housing. <Link href="/areas/u-street" className="text-green-400 hover:text-green-300">U Street</Link> and <Link href="/areas/h-street" className="text-green-400 hover:text-green-300">H Street</Link> commercial corridors require specialized <Link href="/restaurant-pest-control" className="text-green-400 hover:text-green-300">restaurant pest control</Link> to maintain DC DOH compliance.
            </p>
            <p>
              Suburban communities across <Link href="/areas" className="text-green-400 hover:text-green-300">Northern Virginia</Link> and Suburban Maryland face different pest pressures — <Link href="/termite-treatment" className="text-green-400 hover:text-green-300">termite damage</Link> to wood-frame homes, <Link href="/tick-control" className="text-green-400 hover:text-green-300">tick control</Link> in wooded lots, <Link href="/mosquito-control" className="text-green-400 hover:text-green-300">mosquito control</Link> near standing water, and wildlife intrusions from <Link href="/raccoon-removal" className="text-green-400 hover:text-green-300">raccoons</Link> and <Link href="/squirrel-removal" className="text-green-400 hover:text-green-300">squirrels</Link>. Our exterminators understand these regional differences and tailor pest control treatments accordingly.
            </p>
          </div>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-green-500">DC&apos;s Most Wanted</p>
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            Common Pests in DC: <span className="text-green-500">Identification &amp; Treatment</span>
          </h2>
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            Think you know what&apos;s lurking in your walls? Here&apos;s your crash course on DC&apos;s most common pests &mdash; what they look like, why they love your building, and exactly how we eliminate them for good.
          </p>
      ...
      <section className="bg-[#111111] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            Seasonal <span className="text-green-500">Pest Control</span> Guide for DC
          </h2>
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            Every season in DC brings a different pest crew. Here&apos;s what&apos;s coming for your apartment next &mdash; and how to shut them down before they move in.
          </p>
          ...
          <p className="mt-8 text-zinc-300 leading-7">
            Year-round pest control maintenance plans are the most effective and cost-efficient approach for DC properties. Monthly or bi-monthly visits from a licensed exterminator ensure continuous protection against seasonal pest pressures. Our maintenance plans include scheduled inspections, preventive treatments, and unlimited callbacks between visits. <Link href="/pricing" className="text-green-400 hover:text-green-300">View our pest control pricing</Link> for maintenance plan options, or <Link href="/quote-request" className="text-green-400 hover:text-green-300">request a free quote</Link> tailored to your property.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            DC Pest Control <span className="text-green-500">Regulations &amp; Compliance</span>
          </h2>
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                Pest control in the District is regulated by the Department of Energy and Environment (DOEE). All commercial pesticide applications must be performed by or under the direct supervision of a DOEE-certified Commercial Pesticide Applicator. The DC Exterminator maintains full DOEE certification for all technicians, ensuring every treatment we perform meets District regulatory requirements.
              </p>
              <p>
                <strong className="text-white">Local pesticide notification requirements</strong> require pest control operators to provide tenants with written notification at least 48 hours before pesticide applications in residential buildings. The notice must include the target pest, the pesticide product name and EPA registration number, and any precautions to be taken. Our team handles all notification requirements as part of our service, ensuring full compliance for property managers and landlords.
              </p>
              <p>
                <strong className="text-white">Local bed bug disclosure requirements</strong> require building owners to disclose known bed bug infestation history for the previous year when providing a lease or rental agreement. Professional <Link href="/bed-bug-treatment" className="text-green-400 hover:text-green-300">bed bug treatment</Link> with documentation helps landlords and property managers maintain accurate records and demonstrate compliance with this requirement.
              </p>
            </div>
            <div className="space-y-5 text-zinc-300 leading-7">
              <p>
                <strong className="text-white">DC Department of Health</strong> requirements for food service establishments include strict pest control standards. Restaurants, bakeries, cafeterias, and food processing facilities must maintain pest-free conditions and may be required to produce pest control service records during DOH inspections. Our <Link href="/restaurant-pest-control" className="text-green-400 hover:text-green-300">restaurant pest control program</Link> provides all necessary documentation and is designed to meet DOH inspection requirements.
              </p>
              <p>
                <strong className="text-white">Integrated Pest Management (IPM)</strong> is required by law in all DC public housing, schools, and city-owned buildings. IPM emphasizes pest prevention through sanitation, exclusion, and habitat modification, with chemical treatments used only as a targeted last resort. The DC Exterminator follows IPM principles in all our work — residential and commercial — because it delivers the most effective, safest, and most sustainable pest control results.
              </p>
              <p>
                <strong className="text-white">Wildlife control</strong> in the District requires a separate DOEE Nuisance Wildlife Control license. All our wildlife control specialists — handling <Link href="/raccoon-removal" className="text-green-400 hover:text-green-300">raccoon removal</Link>, <Link href="/squirrel-removal" className="text-green-400 hover:text-green-300">squirrel removal</Link>, <Link href="/bat-removal" className="text-green-400 hover:text-green-300">bat exclusion</Link>, and <Link href="/pigeon-control" className="text-green-400 hover:text-green-300">pigeon control</Link> — hold current Nuisance Wildlife Control licenses and follow all DOEE guidelines for humane capture, exclusion, and relocation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            Get answers to the most common questions about pest control and exterminator services in the DC metro area. For more detailed information, visit our full <Link href="/faq" className="text-green-400 hover:text-green-300">FAQ page</Link>.
          </p>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            The DC Exterminator uses a science-based Integrated Pest Management (IPM) approach combined with the latest pest control technologies and EPA-approved products. Our treatment methods are selected based on the specific pest species, the severity of infestation, the property type, and the safety requirements of your household or business.
          </p>
      ...
      <section className="bg-[#111111] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            Pest Control for Every <span className="text-green-500">DC Property Type</span>
          </h2>
            ...
            {[
              {
                ...
                desc: "DC apartment pest control requires coordinated treatment strategies that account for shared walls, plumbing, and HVAC systems. Cockroaches, bed bugs, and mice commonly migrate between units through these shared infrastructure pathways. We work with property managers and co-op boards to develop building-wide pest control programs that treat the root cause — not just individual apartments. Our exterminators are experienced with pre-war walk-ups, post-war towers, luxury high-rises, DCHA public housing, and every building type in between.",
              },
              {
                type: "Rowhouses & Townhouses",
                desc: "DC's iconic rowhouses present unique pest control challenges. Original brick construction with settlement cracks provides entry points for rodents and insects. Basement-level kitchens are particularly vulnerable to cockroach and mouse infestations. Wood structural elements can attract termites and carpenter ants. Our exterminators understand rowhouse construction and develop treatment plans that protect these historic properties while eliminating pest problems at the source.",
              },
              {
                type: "Single-Family Homes",
                desc: "Homeowners across Northern Virginia and Suburban Maryland deal with a broader range of pest issues including termites, wildlife intrusions, lawn-damaging pests, and seasonal invaders. Our residential pest control programs for single-family homes include comprehensive interior and exterior treatments, perimeter barrier applications, attic and crawl space inspections, and foundation-level termite monitoring. We also provide rodent exclusion and wildlife-proofing services.",
              },
              {
                type: "Restaurants & Food Service",
                desc: "DC restaurants operate under strict Department of Health pest control standards. A single pest sighting during a DOH inspection can result in violations, fines, and public scoring penalties. Our restaurant pest control program provides DC DOH-compliant treatments on a regular schedule, complete documentation for inspections, and 24/7 emergency response. We service restaurants, bakeries, catering kitchens, food trucks, grocery stores, and every type of food service operation.",
              },
              {
                type: "Offices & Retail",
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-5 text-zinc-300 leading-7">
              ...
              <p>
                You should call a licensed exterminator immediately if you notice any of these signs in your DC property:
              </p>
              <ul className="list-inside list-disc space-y-2 text-sm text-zinc-400">
                ...
                <li><strong className="text-zinc-300">Commercial food service establishment</strong> — <Link href="/restaurant-pest-control" className="text-green-400 hover:text-green-300">restaurant pest control</Link> requires licensed professionals for DC DOH compliance</li>
              </ul>
              <p>
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">
            Contact <span className="text-green-500">The DC Exterminator</span>
          </h2>
          <p className="mt-4 max-w-3xl text-zinc-300 leading-7">
            Ready to get rid of pests for good? <Link href="/book/new" className="text-green-400 hover:text-green-300">Self-book online & save $20</Link> — it&apos;s the fastest way to get service. Prefer to text? We respond within minutes during business hours. You can also <Link href="/quote-request" className="text-green-400 hover:text-green-300">request a free quote online</Link> any time, day or night.
          </p>

          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl border border-green-500/30 bg-green-500/5 p-5">
              <h3 className="text-sm font-semibold uppercase text-green-500">Self-Book (Save $20)</h3>
              <Link href="/book/new" className="mt-2 block text-lg font-bold text-green-400 hover:text-green-300">
                Self-Book &rarr;
              </Link>
            </div>
          ...
          <div className="mt-10 space-y-5 text-zinc-300 leading-7">
            <h3 className="text-xl font-semibold text-white">Why Thousands of DC Properties Trust The DC Exterminator</h3>
            <p>
              Since our founding, The DC Exterminator has built a reputation as one of the most reliable pest control companies in the Washington, D.C. metropolitan area. Our success is built on a simple formula: hire the best licensed exterminators, invest in ongoing training, use the most effective products and techniques available, provide transparent pricing with no hidden fees, and stand behind every job with a satisfaction guarantee. We don&apos;t cut corners, we don&apos;t upsell unnecessary services, and we don&apos;t leave until the job is done right.
            </p>
            <p>
              Our pest control team handles everything from single-room <Link href="/ant-extermination" className="text-green-400 hover:text-green-300">ant treatments</Link> in studio apartments to building-wide <Link href="/cockroach-extermination" className="text-green-400 hover:text-green-300">cockroach extermination programs</Link> in 200-unit residential complexes. We provide <Link href="/commercial-pest-control" className="text-green-400 hover:text-green-300">commercial pest control</Link> for some of DC&apos;s busiest restaurants, retail stores, and office buildings. Our wildlife control specialists handle <Link href="/raccoon-removal" className="text-green-400 hover:text-green-300">raccoon removal</Link> in suburban Maryland attics and <Link href="/pigeon-control" className="text-green-400 hover:text-green-300">pigeon exclusion</Link> on DC high-rises. No pest problem is too small or too complex for our team.
            </p>
            <p>
              We&apos;re proud to serve the diverse communities across our {totalNeighborhoods}+ neighborhood service area. Whether you&apos;re in a <Link href="/areas/dupont-circle" className="text-green-400 hover:text-green-300">Dupont Circle</Link> luxury condo, a <Link href="/areas/anacostia" className="text-green-400 hover:text-green-300">Anacostia</Link> multi-family home, an <Link href="/areas/arlington" className="text-green-400 hover:text-green-300">Arlington</Link> rowhouse, or a <Link href="/areas/bethesda" className="text-green-400 hover:text-green-300">Bethesda</Link> colonial — we deliver the same professional pest control service, the same licensed expertise, and the same guaranteed results. Read our <Link href="/reviews" className="text-green-400 hover:text-green-300">customer reviews</Link> to see what our clients say about working with The DC Exterminator.
            </p>
          </div>
