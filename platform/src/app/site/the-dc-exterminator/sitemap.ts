/**
 * Per-tenant rich sitemap for thedcexterminator.com.
 *
 ...
 *
 * Served at /site/the-dc-exterminator/sitemap.xml (Next.js native). Middleware
 * must rewrite the apex /sitemap.xml to this path for the tenant host.
 */
import type { MetadataRoute } from 'next'
import servicesData from '@/app/site/the-dc-exterminator/_data/services.json'
import neighborhoodsData from '@/app/site/the-dc-exterminator/_data/neighborhoods.json'
import { tips } from '@/app/site/the-dc-exterminator/_data/tips'

const BASE = 'https://thedcexterminator.com'
