...
export const manhattanNeighborhoods: Neighborhood[] = [
  {
    ...
    vibe: "Small-town suburban pocket with deep community roots",
  },
  {
    name: "Inwood",
    slug: "inwood",
    ...
    vibe: "Nature-rich and culturally vibrant uptown retreat",
  },
  {
    name: "Fort George",
    slug: "fort-george",
    ...
    vibe: "Elevated residential area with historic character",
  },
  {
    ...
    vibe: "Energetic Dominican cultural heartbeat with stunning river views",
  },
  {
    name: "Hudson Heights",
    slug: "hudson-heights",
    ...
    vibe: "Peaceful pre-war enclave with panoramic river vistas",
  },
  {
    name: "West Harlem",
    slug: "west-harlem",
    ...
    vibe: "University-adjacent waterfront community in transition",
  },
  {
    ...
    vibe: "Historic brownstone beauty with academic energy",
  },
  {
    name: "Manhattanville",
    slug: "manhattanville",
    ...
    vibe: "Academic innovation meets industrial heritage",
  },
  {
    ...
    vibe: "Ivy League intellectual campus village",
  },
  {
    name: "Central Harlem",
    slug: "central-harlem",
    ...
    vibe: "Legendary cultural epicenter of Black excellence",
  },
  {
    name: "Harlem",
    slug: "harlem",
    ...
    vibe: "Soulful, historic, and culturally monumental",
  },
  {
    name: "Sugar Hill",
    slug: "sugar-hill",
    ...
    vibe: "Elegant Harlem Renaissance legacy with modern flair",
  },
  {
    name: "East Harlem",
    slug: "east-harlem",
    ...
    vibe: "Proud Latino heritage with explosive street art and energy",
  },
  {
    ...
    vibe: "Old-money elegance with world-class cultural institutions",
  },
  {
    name: "Lenox Hill",
    slug: "lenox-hill",
    ...
    vibe: "Polished medical and residential corridor",
  },
  {
    name: "Carnegie Hill",
    slug: "carnegie-hill",
    ...
    vibe: "Rarefied old-world elegance and family prestige",
  },
  {
    name: "Yorkville",
    slug: "yorkville",
    ...
    vibe: "Approachable Upper East Side living with European echoes",
  },
  {
    ...
    vibe: "Cultured, progressive, and family-friendly sophistication",
  },
  {
    ...
    vibe: "Diverse and evolving upper Manhattan neighborhood",
  },
  {
    name: "Lincoln Square",
    slug: "lincoln-square",
    ...
    vibe: "High-culture performing arts destination",
  },
  {
    ...
    vibe: "Grand crossroads of Midtown and the Upper West Side",
  },
  {
    name: "Sutton Place",
    slug: "sutton-place",
    ...
    vibe: "Ultra-private East River luxury enclave",
  },
  {
    ...
    vibe: "Iconic Art Deco grandeur and holiday magic",
  },
  {
    ...
    landmarks: [
      "47th Street Diamond Exchanges",
      "Diamond Dealers Club",
      "International Gem Tower",
    ],
    vibe: "Glittering high-stakes gem trading bazaar",
  },
  {
    ...
    vibe: "Electrifying showbiz spectacle and neon-lit nightlife",
  },
  {
    name: "Turtle Bay",
    slug: "turtle-bay",
    ...
    vibe: "Diplomatic elegance and brownstone tranquility",
  },
  {
    name: "Midtown East",
    slug: "midtown-east",
    ...
    vibe: "Power-suited corporate grandeur with architectural icons",
  },
  {
    name: "Midtown",
    slug: "midtown",
    ...
    vibe: "The quintessential bustling heart of New York City",
  },
  {
    name: "Tudor City",
    slug: "tudor-city",
    ...
    vibe: "Storybook Tudor enclave floating above Midtown",
  },
  {
    name: "Times Square",
    slug: "times-square",
    ...
    vibe: "Blinding neon spectacle and relentless energy",
  },
  {
    name: "Hudson Yards",
    slug: "hudson-yards",
    ...
    landmarks: ["The Vessel", "The Shed", "Edge Observation Deck"],
    vibe: "Gleaming mega-development pushing Manhattan westward",
  },
  {
    name: "Midtown West",
    slug: "midtown-west",
    ...
    vibe: "Transit-powered commercial hub transforming at warp speed",
  },
  {
    name: "Hell's Kitchen",
    slug: "hells-kitchen",
    ...
    vibe: "Gritty-turned-trendy dining and nightlife paradise",
  },
  {
    name: "Clinton",
    slug: "clinton",
    ...
    vibe: "Residential counterpart to Hell's Kitchen's nightlife",
  },
  {
    ...
    vibe: "Fashion industry heritage amid Midtown hustle",
  },
  {
    name: "Herald Square",
    slug: "herald-square",
    ...
    vibe: "Retail mecca and perpetual shopping frenzy",
  },
  {
    name: "Koreatown",
    slug: "koreatown",
    ...
    landmarks: [
      "Korea Way (32nd Street)",
      "Korean BBQ restaurants",
      "Spa Castle Premier",
    ],
    vibe: "24-hour Korean dining and nightlife concentrated intensity",
  },
  {
    name: "Murray Hill",
    slug: "murray-hill",
    ...
    vibe: "Young professional hangout with historic brownstone charm",
  },
  {
    name: "Kips Bay",
    slug: "kips-bay",
    ...
    vibe: "Low-key medical corridor with residential ease",
  },
  {
    name: "Rose Hill",
    slug: "rose-hill",
    ...
    landmarks: [
      "Curry Hill (Lexington Avenue)",
      "Baruch College",
      "69th Regiment Armory",
    ],
    vibe: "Hidden gem with South Asian culinary treasures",
  },
  {
    name: "NoMad",
    slug: "nomad",
    ...
    vibe: "Trendy hotel-bar-restaurant trifecta destination",
  },
  {
    ...
    landmarks: [
      "Peter Cooper Village Oval",
      "Stuyvesant Cove Park",
      "East River Greenway",
    ],
    vibe: "Sprawling mid-century residential campus on the river",
  },
  {
    ...
    landmarks: [
      ...
      "Stuyvesant Town Playground",
      "Stuyvesant Cove Park",
    ],
    vibe: "Village-within-a-city residential community",
  },
  {
    name: "Chelsea",
    slug: "chelsea",
    ...
    landmarks: ["The High Line", "Chelsea Market", "Chelsea Piers"],
    vibe: "Art-forward, LGBTQ+-friendly creative hub",
  },
  {
    ...
    vibe: "Tech-savvy foodies meet architectural icon",
  },
  {
    name: "Gramercy",
    slug: "gramercy",
    ...
    vibe: "Refined old-New York elegance and quiet prestige",
  },
  {
    name: "Gramercy Park",
    slug: "gramercy-park",
    ...
    vibe: "Key-holders-only exclusivity in a historic square",
  },
  {
    name: "Union Square",
    slug: "union-square",
    ...
    landmarks: [
      ...
      "Union Square Park",
      "Metronome Public Art Installation",
    ],
    vibe: "Activist energy and farmers market abundance",
  },
  {
    ...
    landmarks: [
      ...
      "The High Line (southern terminus)",
      "The Standard Hotel",
    ],
    vibe: "Cobblestone glamour from butcher shops to bottle service",
  },
  {
    name: "Alphabet City",
    slug: "alphabet-city",
    ...
    vibe: "Punk-rooted creative spirit with community garden soul",
  },
  {
    name: "East Village",
    slug: "east-village",
    ...
    landmarks: [
      "St. Mark's Place",
      "Tompkins Square Park",
      "The Fillmore East (historic site)",
    ],
    vibe: "Counterculture capital turned eclectic nightlife destination",
  },
  {
    ...
    vibe: "Bohemian legend and progressive cultural touchstone",
  },
  {
    name: "NoHo",
    slug: "noho",
    ...
    landmarks: [
      ...
      "The Public Theater (nearby)",
    ],
    vibe: "Compact cast-iron elegance with artistic pedigree",
  },
  {
    name: "Bowery",
    slug: "bowery",
    ...
    vibe: "Grit-to-glam transformation along Manhattan's oldest street",
  },
  {
    name: "West Village",
    slug: "west-village",
    ...
    vibe: "Romantic winding streets and literary cafe culture",
  },
  {
    ...
    vibe: "Immigrant heritage meets cutting-edge nightlife",
  },
  {
    name: "SoHo",
    slug: "soho",
    ...
    landmarks: [
      ...
      "The Drawing Center",
      "Dean & DeLuca (original location)",
    ],
    vibe: "Cast-iron architecture and world-class shopping runway",
  },
  {
    name: "Nolita",
    slug: "nolita",
    ...
    landmarks: [
      ...
      "Elizabeth Street boutiques",
      "Cafe Gitane",
    ],
    vibe: "Tiny, trendy, and impossibly chic boutique village",
  },
  {
    name: "Little Italy",
    slug: "little-italy",
    ...
    vibe: "Old-world Italian charm on a shrinking but spirited stage",
  },
  {
    name: "Chinatown",
    slug: "chinatown",
    ...
    vibe: "Pulsing, aromatic, and endlessly authentic Asian enclave",
  },
  {
    ...
    vibe: "Money, power, and Lower Manhattan's rebirth as a neighborhood",
  },
  {
    name: "Two Bridges",
    slug: "two-bridges",
    ...
    landmarks: [
      "Manhattan Bridge",
      "Brooklyn Bridge (nearby)",
      "Two Bridges Waterfront",
    ],
    vibe: "Bridge-framed waterfront community in rapid evolution",
  },
  {
    name: "TriBeCa",
    slug: "tribeca",
    ...
    vibe: "Celebrity loft living in converted warehouse luxury",
  },
  {
    name: "Civic Center",
    slug: "civic-center",
    ...
    vibe: "Government power center with monumental architecture",
  },
  {
    ...
    landmarks: [
      ...
      "Fulton Fish Market (historic site)",
    ],
    vibe: "Maritime heritage meets waterfront dining and nightlife",
  },
  {
    ...
    vibe: "Waterfront serenity with Statue of Liberty sunsets",
  },
  {
    name: "Hudson Square",
    slug: "hudson-square",
    ...
    vibe: "Publishing heritage turned tech industry powerhouse",
  },
  {
    ...
    vibe: "Aerial tramway island escape with haunting ruins",
  },
  {
    name: "Little Germany",
    slug: "little-germany",
    ...
    landmarks: [
      ...
      "German-American Shooting Society Building",
    ],
    vibe: "Faded German immigrant legacy with East Village spirit",
  },
  {
    ...
    vibe: "Tranquil historic park square with Quaker roots",
  },
  {
    ...
    landmarks: [
      "Waterside Plaza Esplanade",
      "Waterside School",
      "Asser Levy Recreation Center (nearby)",
    ],
    vibe: "Over-the-water residential enclave with skyline views",
  },
  {
    name: "Five Points",
    slug: "five-points",
    ...
    landmarks: [
      "Columbus Park",
      "Five Points intersection (historic site)",
      "Collect Pond Park",
    ],
    vibe: "Vanished infamous slum reborn as peaceful parkland",
  },
  {
    name: "Cooperative Village",
    slug: "cooperative-village",
    borough: "Manhattan",
    boroughSlug: "manhattan",
    description:
    ...
    landmarks: [
      ...
      "Hillman Housing",
      "East River Housing Cooperative",
    ],
    vibe: "Union-built cooperative community with lasting solidarity",
  },
  {
    name: "Radio Row",
    slug: "radio-row",
    ...
    vibe: "Lost electronics bazaar now honored by sacred memorial",
  },
  {
    ...
    vibe: "Car-free island playground with panoramic harbor views",
  },
  {
    ...
    vibe: "Urban sports and festival island getaway",
  },
  {
    name: "Ellis Island",
    slug: "ellis-island",
    ...
    vibe: "Sacred immigration landmark and American origin story",
  },
  {
    name: "Liberty Island",
    slug: "liberty-island",
    ...
    landmarks: [
      ...
      "Liberty Island Flagpole Plaza",
    ],
    vibe: "Monumental beacon of freedom and democracy",
  },
];
