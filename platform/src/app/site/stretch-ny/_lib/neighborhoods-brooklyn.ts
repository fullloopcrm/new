...
export const brooklynNeighborhoods: Neighborhood[] = [
  {
    name: "Bath Beach",
    slug: "bath-beach",
    borough: "Brooklyn",
    ...
    landmarks: ["Bath Beach Park", "Bensonhurst Park", "Gravesend Bay waterfront"],
    vibe: "Old-school Italian-American neighborhood with waterfront calm",
  },
  {
    name: "Bay Ridge",
    slug: "bay-ridge",
    ...
    landmarks: ["Verrazzano-Narrows Bridge", "Owl's Head Park", "Shore Road Park"],
    vibe: "Family-oriented with waterfront views and excellent dining",
  },
  {
    ...
    vibe: "Culturally rich brownstone neighborhood with creative energy",
  },
  {
    name: "Bensonhurst",
    slug: "bensonhurst",
    ...
    landmarks: ["18th Avenue shopping district", "Dyker Beach Park", "86th Street commercial strip"],
    vibe: "Multicultural hub with outstanding ethnic food and busy shopping streets",
  },
  {
    name: "Bergen Beach",
    slug: "bergen-beach",
    ...
    landmarks: ["Bergen Beach Park", "Paerdegat Basin", "Jamaica Bay shoreline"],
    vibe: "Suburban enclave with waterfront access and a quiet pace",
  },
  {
    name: "Georgetown",
    slug: "georgetown",
    ...
    landmarks: ["Paerdegat Basin Park", "Georgetown Playground", "Mill Basin inlet"],
    vibe: "Hidden micro-neighborhood with a tight-knit community feel",
  },
  {
    name: "Boerum Hill",
    slug: "boerum-hill",
    ...
    landmarks: ["Atlantic Avenue antique row", "State Street Houses", "Boerum Hill Historic District"],
    vibe: "Upscale brownstone living with boutique shopping and dining",
  },
  {
    name: "Borough Park",
    slug: "borough-park",
    ...
    landmarks: ["13th Avenue shopping district", "Maimonides Medical Center", "Borough Park Playground"],
    vibe: "Vibrant Orthodox Jewish community with busy commercial streets",
  },
  {
    name: "Brighton Beach",
    slug: "brighton-beach",
    ...
    landmarks: ["Brighton Beach Boardwalk", "Brighton Beach Avenue", "B&Q subway terminal"],
    vibe: "Eastern European oceanfront community with lively nightlife",
  },
  {
    ...
    vibe: "Prestigious historic brownstone neighborhood with iconic skyline views",
  },
  {
    name: "Brownsville",
    slug: "brownsville",
    ...
    landmarks: ["Betsy Head Park", "Brownsville Heritage House", "Pitkin Avenue commercial corridor"],
    vibe: "Resilient community with deep historical roots and renewed investment",
  },
  {
    name: "Bushwick",
    slug: "bushwick",
    ...
    landmarks: ["The Bushwick Collective murals", "Maria Hernandez Park", "Roberta's Pizza"],
    vibe: "Street art mecca with a thriving DIY creative scene",
  },
  {
    name: "Wyckoff Heights",
    slug: "wyckoff-heights",
    borough: "Brooklyn",
    boroughSlug: "brooklyn",
    description:
    ...
    landmarks: ["Wyckoff Heights Medical Center", "Irving Square Park", "Wyckoff Avenue corridor"],
    vibe: "Diverse residential area bridging Brooklyn and Queens",
  },
  {
    name: "Canarsie",
    slug: "canarsie",
    ...
    landmarks: ["Canarsie Pier", "Canarsie Park", "Fresh Creek Nature Preserve"],
    vibe: "Caribbean-influenced community with waterfront access and suburban calm",
  },
  {
    ...
    landmarks: ["Carroll Park", "Smith Street restaurant row", "Court Street shopping"],
    vibe: "Charming brownstone neighborhood with Italian roots and foodie culture",
  },
  {
    name: "Columbia Street Waterfront District",
    slug: "columbia-street-waterfront-district",
    borough: "Brooklyn",
    boroughSlug: "brooklyn",
    description:
    ...
    landmarks: ["Columbia Street", "Valentino Pier", "Red Hook grain terminal views"],
    vibe: "Compact waterfront strip with harbor views and artisan character",
  },
  {
    name: "Clinton Hill",
    slug: "clinton-hill",
    ...
    landmarks: ["Pratt Institute campus", "Clinton Avenue mansions", "Pratt Sculpture Park"],
    vibe: "Stately and intellectual with a creative arts campus energy",
  },
  {
    name: "Cobble Hill",
    slug: "cobble-hill",
    ...
    landmarks: ["Cobble Hill Park", "Cobble Hill Historic District", "Court Street restaurants"],
    vibe: "Refined and picturesque with top-tier brownstone charm",
  },
  {
    name: "Coney Island",
    slug: "coney-island",
    ...
    landmarks: ["Luna Park", "Coney Island Boardwalk", "New York Aquarium"],
    vibe: "Iconic beachfront amusement destination with year-round character",
  },
  {
    ...
    landmarks: ["Manhattan Beach Park", "Kingsborough Community College", "Oriental Boulevard"],
    vibe: "Affluent coastal enclave with a private, suburban feel",
  },
  {
    name: "Sea Gate",
    slug: "sea-gate",
    ...
    landmarks: ["Sea Gate Beach", "Norton Point", "Sea Gate lighthouse site"],
    vibe: "Private gated oceanfront community with exclusive beach access",
  },
  {
    name: "Crown Heights",
    slug: "crown-heights",
    ...
    landmarks: ["Brooklyn Museum", "Brooklyn Botanic Garden", "Eastern Parkway"],
    vibe: "Culturally diverse with Caribbean flair and world-class cultural institutions",
  },
  {
    name: "Weeksville",
    slug: "weeksville",
    ...
    vibe: "Historically significant neighborhood honoring Black heritage",
  },
  {
    name: "Cypress Hills",
    slug: "cypress-hills",
    ...
    landmarks: ["Cypress Hills Cemetery", "Highland Park", "Cypress Hills Playground"],
    vibe: "Diverse working-class community on Brooklyn's eastern border",
  },
  {
    name: "Ditmas Park",
    slug: "ditmas-park",
    ...
    landmarks: [
      ...
      "Cortelyou Road restaurants",
      "Victorian and Colonial Revival mansions",
    ],
    vibe: "Victorian suburban charm with diverse dining and leafy streets",
  },
  {
    ...
    landmarks: ["Brooklyn Academy of Music (BAM)", "Barclays Center", "City Point mall"],
    vibe: "High-energy commercial hub with rapid residential growth",
  },
  {
    name: "DUMBO",
    slug: "dumbo",
    ...
    landmarks: ["Brooklyn Bridge Park", "Washington Street photo spot", "St. Ann's Warehouse"],
    vibe: "Photogenic waterfront tech-and-arts enclave with iconic views",
  },
  {
    name: "Fulton Ferry",
    slug: "fulton-ferry",
    ...
    landmarks: ["Jane's Carousel", "Fulton Ferry Landing", "Empire Stores"],
    vibe: "Historic waterfront landing with world-class dining",
  },
  {
    name: "Dyker Heights",
    slug: "dyker-heights",
    ...
    landmarks: ["Dyker Heights Christmas lights", "Dyker Beach Golf Course", "Leif Ericson Park"],
    vibe: "Quiet residential with legendary holiday light displays",
  },
  {
    name: "East Flatbush",
    slug: "east-flatbush",
    ...
    landmarks: ["Kings County Hospital", "Flatbush Avenue corridor", "Paerdegat Park"],
    vibe: "Vibrant Caribbean community with outstanding island cuisine",
  },
  {
    name: "Remsen Village",
    slug: "remsen-village",
    ...
    landmarks: ["Remsen Avenue", "Holy Cross Cemetery", "Paerdegat Basin nearby"],
    vibe: "Quiet Caribbean-American residential pocket",
  },
  {
    name: "East New York",
    slug: "east-new-york",
    ...
    landmarks: ["Gateway Center mall", "Linden Park", "East New York Farms"],
    vibe: "Large, diverse neighborhood with growing community investment",
  },
  {
    name: "City Line",
    slug: "city-line",
    ...
    landmarks: ["Linden Boulevard corridor", "City Line Park", "Brooklyn-Queens border marker"],
    vibe: "Working-class border neighborhood bridging two boroughs",
  },
  {
    name: "New Lots",
    slug: "new-lots",
    ...
    landmarks: ["New Lots Avenue commercial strip", "New Lots Library", "Hegeman Avenue corridor"],
    vibe: "Historic eastern Brooklyn residential area with community roots",
  },
  {
    name: "Spring Creek",
    slug: "spring-creek",
    ...
    landmarks: ["Gateway Center", "Spring Creek Park", "Jamaica Bay shoreline"],
    vibe: "Developing waterfront area with retail and nature preserves",
  },
  {
    name: "Starrett City",
    slug: "starrett-city",
    ...
    landmarks: [
      "Spring Creek Towers complex",
      "Starrett City power plant",
      "Jamaica Bay views",
    ],
    vibe: "Self-contained residential campus on Jamaica Bay",
  },
  {
    ...
    landmarks: ["Morgantown loft district", "English Kills waterway", "Flushing Avenue studios"],
    vibe: "Industrial-creative zone with warehouse lofts and artist studios",
  },
  {
    name: "Flatbush",
    slug: "flatbush",
    ...
    landmarks: ["Flatbush Reformed Dutch Church", "Junction (Flatbush Junction)", "Kings Theatre"],
    vibe: "Historic and bustling with deep Caribbean and Dutch roots",
  },
  {
    name: "Flatlands",
    slug: "flatlands",
    ...
    landmarks: ["Hendrick I. Lott House", "Flatlands Dutch Reformed Church", "Mill Basin inlet"],
    vibe: "Suburban-feeling with colonial Dutch history",
  },
  {
    name: "Fort Greene",
    slug: "fort-greene",
    ...
    landmarks: ["Fort Greene Park", "Brooklyn Academy of Music (BAM)", "Prison Ship Martyrs' Monument"],
    vibe: "Culturally dynamic brownstone neighborhood with arts pedigree",
  },
  {
    ...
    landmarks: ["Gerritsen Creek", "Kiddie Beach", "Gerritsen Beach Volunteer Fire Department"],
    vibe: "Isolated small-town waterfront community with boat docks",
  },
  {
    name: "Gowanus",
    slug: "gowanus",
    ...
    landmarks: ["Gowanus Canal", "The Bell House", "Royal Palms Shuffleboard Club"],
    vibe: "Industrial-creative neighborhood in rapid transformation",
  },
  {
    name: "Gravesend",
    slug: "gravesend",
    ...
    landmarks: ["Lady Moody House site", "Gravesend Cemetery", "Avenue U shopping"],
    vibe: "Historically rich neighborhood with deep colonial roots",
  },
  {
    name: "Greenpoint",
    slug: "greenpoint",
    ...
    landmarks: [
      "Transmitter Park",
      "WNYC Transmitter Park waterfront",
      "McCarren Park",
    ],
    vibe: "Polish-rooted creative hub with stunning waterfront parks",
  },
  {
    ...
    landmarks: ["Green-Wood Cemetery", "Prospect Expressway overpass views", "Fourth Avenue corridor"],
    vibe: "Hilly residential area with cemetery-adjacent tranquility",
  },
  {
    name: "Homecrest",
    slug: "homecrest",
    ...
    landmarks: ["Homecrest Playground", "Coney Island Avenue shops", "Avenue U corridor"],
    vibe: "Quiet and diverse with accessible southern Brooklyn living",
  },
  {
    name: "Kensington",
    slug: "kensington",
    ...
    landmarks: ["Prospect Park south entrance", "Church Avenue corridor", "Kensington Stables"],
    vibe: "Ultra-diverse residential neighborhood at Prospect Park's doorstep",
  },
  {
    name: "Ocean Parkway",
    slug: "ocean-parkway",
    ...
    landmarks: [
      ...
      "Ocean Parkway boulevard",
      "Kensington–Ocean Parkway subway station",
    ],
    vibe: "Historic tree-lined boulevard with a gracious residential feel",
  },
  {
    name: "Parkville",
    slug: "parkville",
    ...
    landmarks: ["Parkville Avenue", "McDonald Avenue corridor", "Ocean Parkway nearby"],
    vibe: "Low-key residential with affordable central Brooklyn living",
  },
  {
    name: "Mapleton",
    slug: "mapleton",
    ...
    landmarks: ["Mapleton Park", "60th Street corridor", "Bensonhurst Park nearby"],
    vibe: "Peaceful tree-lined residential pocket in southern Brooklyn",
  },
  {
    name: "Marine Park",
    slug: "marine-park",
    ...
    landmarks: ["Marine Park (Salt Marsh Nature Center)", "Carll playground", "Avenue U commercial strip"],
    vibe: "Green and spacious with Brooklyn's largest park and salt marsh",
  },
  {
    name: "Midwood",
    slug: "midwood",
    ...
    landmarks: ["Brooklyn College", "Avenue M shopping district", "Kings Highway corridor"],
    vibe: "Academic and family-oriented with diverse cultural communities",
  },
  {
    name: "Mill Basin",
    slug: "mill-basin",
    ...
    landmarks: ["Mill Basin inlet", "Mill Basin Marina", "Flatbush Avenue shopping"],
    vibe: "Affluent waterfront enclave with private docks and suburban luxury",
  },
  {
    name: "Plumb Beach",
    slug: "plumb-beach",
    ...
    landmarks: ["Plumb Beach shoreline", "Belt Parkway bike path", "Jamaica Bay wildlife area"],
    vibe: "Windswept coastal strip popular with kiteboarders and nature lovers",
  },
  {
    ...
    landmarks: ["Brooklyn Museum", "Brooklyn Botanic Garden", "Barclays Center"],
    vibe: "Culturally packed neighborhood with world-class museums and dining",
  },
  {
    ...
    landmarks: [
      "Prospect Park southeast entrance",
      "Lefferts Historic House",
      "Flatbush Avenue dining strip",
    ],
    vibe: "Diverse and leafy with Prospect Park at your doorstep",
  },
  {
    ...
    landmarks: [
      ...
      "Victorian mansions on Buckingham Road",
    ],
    vibe: "Grand historic district with showstopping Victorian architecture",
  },
  {
    name: "Red Hook",
    slug: "red-hook",
    ...
    landmarks: ["Red Hook Ball Fields food vendors", "IKEA Brooklyn", "Louis Valentino Jr. Park and Pier"],
    vibe: "Isolated waterfront creative community with indie spirit",
  },
  {
    name: "Sheepshead Bay",
    slug: "sheepshead-bay",
    ...
    landmarks: ["Sheepshead Bay piers", "Emmons Avenue seafood row", "Holocaust Memorial Park"],
    vibe: "Waterfront seafood destination with fishing-village charm",
  },
  {
    name: "Sunset Park",
    slug: "sunset-park",
    ...
    landmarks: ["Sunset Park (the park)", "Industry City", "8th Avenue Chinatown"],
    vibe: "Diverse hillside community with spectacular sunset views and ethnic cuisine",
  },
  {
    name: "Vinegar Hill",
    slug: "vinegar-hill",
    ...
    landmarks: ["Vinegar Hill House restaurant", "Commandant's House", "cobblestone streets"],
    vibe: "Tiny, time-capsule neighborhood with cobblestone charm",
  },
  {
    name: "Williamsburg",
    slug: "williamsburg",
    ...
    vibe: "World-famous creative hub with waterfront parks and nightlife",
  },
  {
    ...
    landmarks: ["Williamsburg Bridge", "Division Avenue", "Peter Luger Steak House"],
    vibe: "Culturally layered neighborhood with Hasidic heritage and evolving dining",
  },
  {
    ...
    landmarks: ["Prospect Park Southwest entrance", "Green-Wood Cemetery border", "Bartel-Pritchard Square"],
    vibe: "Small-town feel nestled between two iconic green spaces",
  },
  {
    name: "Wingate",
    slug: "wingate",
    ...
    landmarks: ["Wingate Park", "Winthrop Street corridor", "Kings County Hospital nearby"],
    vibe: "Small Caribbean-influenced residential area with community park life",
  },
  {
    name: "Barren Island",
    slug: "barren-island",
    ...
    landmarks: ["Floyd Bennett Field", "Gateway National Recreation Area", "Jamaica Bay Wildlife Refuge"],
    vibe: "Historic ghost-island turned nature preserve in Jamaica Bay",
  },
  {
    name: "Beverley Square East",
    slug: "beverley-square-east",
    borough: "Brooklyn",
    boroughSlug: "brooklyn",
    description:
    ...
    landmarks: [
      "Beverley Square East historic homes",
      "Beverley Road",
      "Cortelyou Road shops nearby",
    ],
    vibe: "Intimate historic pocket with pristine early-1900s homes",
  },
  {
    name: "Beverley Square West",
    slug: "beverley-square-west",
    borough: "Brooklyn",
    boroughSlug: "brooklyn",
    description:
    ...
    landmarks: [
      "Beverley Square West historic homes",
      "Marlborough Road",
      "Beverley Road corridor",
    ],
    vibe: "Charming historic micro-neighborhood with strong community pride",
  },
  {
    name: "Fiske Terrace",
    slug: "fiske-terrace",
    ...
    landmarks: ["Fiske Terrace-Midwood Park Historic District", "Avenue H station", "East 19th Street homes"],
    vibe: "Landmarked suburban oasis with Arts and Crafts-era homes",
  },
  {
    name: "Highland Park",
    slug: "highland-park",
    ...
    landmarks: ["Highland Park", "Ridgewood Reservoir", "Vermont Place houses"],
    vibe: "Border neighborhood with a wild urban nature preserve",
  },
  {
    name: "Pacific Park",
    slug: "pacific-park",
    ...
    landmarks: ["Barclays Center", "Pacific Park towers", "Atlantic Terminal mall"],
    vibe: "Major mixed-use development reshaping central Brooklyn",
  },
  {
    name: "RAMBO",
    slug: "rambo",
    ...
    landmarks: ["Manhattan Bridge anchorage", "Front Street galleries", "Gold Street corridor"],
    vibe: "Tiny creative micro-neighborhood in the Manhattan Bridge shadow",
  },
];
