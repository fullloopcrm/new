...
export const bronxNeighborhoods: Neighborhood[] = [
  {
    name: "Bedford Park",
    slug: "bedford-park",
    borough: "Bronx",
    ...
    landmarks: ["Mosholu Parkway", "Lehman College", "Bedford Park Boulevard"],
    vibe: "Peaceful and academic with a suburban feel",
  },
  {
    name: "Belmont",
    slug: "belmont",
    ...
    vibe: "Old-world Italian charm with bustling food markets",
  },
  {
    name: "Fordham",
    slug: "fordham",
    ...
    vibe: "Energetic college-town atmosphere meets urban retail",
  },
  {
    ...
    landmarks: [
      "University Avenue",
      "Devoe Park",
      "Fordham Hill Oval Apartments",
    ],
    vibe: "Hilltop community with multicultural energy",
  },
  {
    name: "Jerome Park",
    slug: "jerome-park",
    ...
    vibe: "Quiet residential with historic roots",
  },
  {
    name: "Kingsbridge",
    slug: "kingsbridge",
    ...
    landmarks: [
      "Kingsbridge Armory",
      "Jerome Park Reservoir",
      "West 231st Street commercial strip",
    ],
    vibe: "Diverse and hardworking with deep community ties",
  },
  {
    ...
    vibe: "Elevated and serene with a neighborly atmosphere",
  },
  {
    name: "Van Cortlandt Village",
    slug: "van-cortlandt-village",
    borough: "Bronx",
    boroughSlug: "bronx",
    description:
    ...
    vibe: "Park-adjacent tranquility with cooperative spirit",
  },
  {
    name: "Norwood",
    slug: "norwood",
    ...
    vibe: "Steady and diverse with a healthcare-oriented community",
  },
  {
    name: "Riverdale",
    slug: "riverdale",
    ...
    vibe: "Upscale and leafy with stunning Hudson River views",
  },
  {
    name: "Fieldston",
    slug: "fieldston",
    ...
    vibe: "Exclusive and pastoral with historic grandeur",
  },
  {
    ...
    landmarks: [
      "Van Cortlandt Park (north entrance)",
      "Riverdale Avenue shops",
      "Seton Park",
    ],
    vibe: "Suburban calm at the city's northern edge",
  },
  {
    name: "Spuyten Duyvil",
    slug: "spuyten-duyvil",
    ...
    vibe: "Waterfront seclusion with dramatic river views",
  },
  {
    ...
    landmarks: [
      "Bronx Community College (former NYU campus)",
      "Hall of Fame for Great Americans",
      "Aqueduct Walk",
    ],
    vibe: "Elevated and historic with a strong student presence",
  },
  {
    name: "Woodlawn",
    slug: "woodlawn",
    ...
    landmarks: [
      "Woodlawn Cemetery",
      "Katonah Avenue",
      "Van Cortlandt Park (east side)",
    ],
    vibe: "Irish-American warmth with small-town charm",
  },
  {
    name: "Bathgate",
    slug: "bathgate",
    ...
    landmarks: [
      "Bathgate Avenue",
      "Claremont Park (nearby)",
      "Crotona Park (nearby)",
    ],
    vibe: "Rebuilding and resilient with grassroots energy",
  },
  {
    name: "Claremont",
    slug: "claremont",
    ...
    vibe: "Park-centered living with emerging creative energy",
  },
  {
    name: "Concourse",
    slug: "concourse",
    ...
    landmarks: [
      ...
      "Grand Concourse Art Deco District",
    ],
    vibe: "Grand and civic with Art Deco elegance",
  },
  {
    name: "East Tremont",
    slug: "east-tremont",
    ...
    vibe: "Family-oriented with green space at the doorstep",
  },
  {
    name: "Highbridge",
    slug: "highbridge",
    ...
    landmarks: [
      "High Bridge (oldest NYC bridge)",
      "Highbridge Park",
      "Yankee Stadium (nearby)",
    ],
    vibe: "Historic and elevated with river-facing pride",
  },
  {
    name: "Hunts Point",
    slug: "hunts-point",
    ...
    vibe: "Industrial grit meets environmental activism",
  },
  {
    name: "Longwood",
    slug: "longwood",
    ...
    vibe: "Historic preservation with South Bronx soul",
  },
  {
    name: "Foxhurst",
    slug: "foxhurst",
    ...
    vibe: "Close-knit and community-driven",
  },
  {
    name: "Melrose",
    slug: "melrose",
    ...
    landmarks: [
      "The Hub (Third Ave & 149th St)",
      "Melrose Houses",
      "Brook Avenue",
    ],
    vibe: "Bustling commercial energy with rapid renewal",
  },
  {
    name: "Morris Heights",
    slug: "morris-heights",
    ...
    vibe: "Hillside community with healthcare anchors",
  },
  {
    name: "Morrisania",
    slug: "morrisania",
    ...
    vibe: "Hip-hop heritage with deep cultural roots",
  },
  {
    ...
    landmarks: [
      "Crotona Park",
      "Indian Lake",
      "Charlotte Street (rebirth symbol)",
    ],
    vibe: "Resilient and park-centered with community pride",
  },
  {
    name: "Mott Haven",
    slug: "mott-haven",
    ...
    landmarks: [
      "Bruckner Bar & Gardens",
      "Mott Haven Historic District",
      "Mill Pond Park",
    ],
    vibe: "Artsy renaissance with brownstone charm",
  },
  {
    name: "Port Morris",
    slug: "port-morris",
    ...
    vibe: "Industrial-chic with craft beverage culture",
  },
  {
    name: "Tremont",
    slug: "tremont",
    ...
    vibe: "Bustling crossroads with multicultural flavor",
  },
  {
    name: "Mount Hope",
    slug: "mount-hope",
    ...
    vibe: "Hilly residential with neighborhood solidarity",
  },
  {
    name: "Mount Eden",
    slug: "mount-eden",
    ...
    vibe: "Game-day excitement meets everyday neighborhood life",
  },
  {
    name: "West Farms",
    slug: "west-farms",
    ...
    landmarks: [
      "Bronx River",
      "Bronx Zoo (western edge)",
      "180th Street junction",
    ],
    vibe: "Historic roots along the Bronx River",
  },
  {
    name: "Allerton",
    slug: "allerton",
    ...
    landmarks: [
      "Allerton Avenue",
      "Bronx House",
      "Allerton Coops (cooperative housing)",
    ],
    vibe: "Diverse commercial energy with cooperative roots",
  },
  {
    name: "Bronxdale",
    slug: "bronxdale",
    ...
    vibe: "Quiet residential enclave near green corridors",
  },
  {
    name: "City Island",
    slug: "city-island",
    ...
    vibe: "Quaint seaside village in the middle of New York City",
  },
  {
    name: "Co-op City",
    slug: "co-op-city",
    ...
    vibe: "Self-contained urban village with cooperative ideals",
  },
  {
    name: "Eastchester",
    slug: "eastchester",
    ...
    landmarks: [
      "Eastchester Road",
      "Dyre Avenue Line (5 train)",
      "Burke Avenue",
    ],
    vibe: "Suburban quietude at the Bronx-Westchester border",
  },
  {
    name: "Edenwald",
    slug: "edenwald",
    ...
    vibe: "Edge-of-city living with growing community investment",
  },
  {
    name: "Pelham Gardens",
    slug: "pelham-gardens",
    ...
    landmarks: [
      ...
      "Eastchester Road",
      "Albert Einstein College of Medicine (nearby)",
    ],
    vibe: "Garden-style suburban living within city limits",
  },
  {
    name: "Pelham Parkway",
    slug: "pelham-parkway",
    ...
    landmarks: [
      "Pelham Parkway Boulevard",
      "Albert Einstein College of Medicine",
      "Jacobi Medical Center",
    ],
    vibe: "Boulevard living with strong Eastern European heritage",
  },
  {
    name: "Wakefield",
    slug: "wakefield",
    ...
    landmarks: [
      "White Plains Road commercial strip",
      "Van Cortlandt Park (east)",
      "Nereid Avenue (last stop on 2 train)",
    ],
    vibe: "Northern gateway with Caribbean and African vitality",
  },
  {
    name: "Williamsbridge",
    slug: "williamsbridge",
    ...
    vibe: "Stable and residential with colonial-era roots",
  },
  {
    name: "Castle Hill",
    slug: "castle-hill",
    ...
    vibe: "Tight-knit Latino community with family values",
  },
  {
    name: "Clason Point",
    slug: "clason-point",
    ...
    landmarks: [
      "Clason Point Park",
      "Soundview Park (nearby)",
      "Harding Park (adjacent)",
    ],
    vibe: "Waterfront peninsula with hidden park gems",
  },
  {
    name: "Country Club",
    slug: "country-club",
    ...
    landmarks: [
      "Country Club Road",
      "Eastchester Bay waterfront",
      "Pelham Bay Park (nearby)",
    ],
    vibe: "Affluent enclave with waterfront serenity",
  },
  {
    name: "Morris Park",
    slug: "morris-park",
    ...
    vibe: "Italian-American pride with a healthcare campus",
  },
  {
    name: "Parkchester",
    slug: "parkchester",
    ...
    vibe: "Mid-century planned community with diverse character",
  },
  {
    name: "Pelham Bay",
    slug: "pelham-bay",
    ...
    landmarks: [
      "Pelham Bay Park",
      "Orchard Beach",
      "Pelham Bay station (6 train terminus)",
    ],
    vibe: "Parkside living with beach access",
  },
  {
    name: "Soundview",
    slug: "soundview",
    ...
    landmarks: [
      "Soundview Park",
      "Story Avenue",
      "Bronx River Greenway (terminus)",
    ],
    vibe: "Waterfront community with green investment",
  },
  {
    name: "Bronx River",
    slug: "bronx-river",
    ...
    vibe: "River-centered with grassroots ecological revival",
  },
  {
    name: "Schuylerville",
    slug: "schuylerville",
    ...
    landmarks: [
      ...
      "Westchester Creek",
      "East Tremont Avenue (commercial strip)",
    ],
    vibe: "Quiet residential blocks with Revolutionary War heritage",
  },
  {
    name: "Throggs Neck",
    slug: "throggs-neck",
    ...
    landmarks: [
      ...
      "Locust Point Yacht Club (nearby)",
    ],
    vibe: "Peninsular pride with blue-collar warmth",
  },
  {
    name: "Van Nest",
    slug: "van-nest",
    ...
    landmarks: [
      "Van Nest Avenue",
      "Morris Park Avenue (nearby)",
      "Bear Swamp Road historic site",
    ],
    vibe: "Village-like charm with European immigrant roots",
  },
  {
    ...
    landmarks: [
      "Westchester Square (the plaza)",
      "Owen Dolen Park",
      "Westchester Square–East Tremont Avenue station",
    ],
    vibe: "Historic town center with walkable commercial energy",
  },
  {
    name: "South Bronx",
    slug: "south-bronx",
    ...
    vibe: "Hip-hop birthplace with unstoppable creative energy",
  },
  {
    name: "Laconia",
    slug: "laconia",
    ...
    landmarks: [
      "Laconia Avenue",
      "Seton Falls Park (nearby)",
      "Grace Baptist Church",
    ],
    vibe: "Peaceful Caribbean-American enclave with suburban character",
  },
  {
    name: "Bronxwood",
    slug: "bronxwood",
    ...
    vibe: "Tree-lined and family-centered with neighborly bonds",
  },
  {
    name: "Harding Park",
    slug: "harding-park",
    ...
    landmarks: [
      "Harding Park bungalow colony",
      "East River waterfront",
      "Clason Point Park (adjacent)",
    ],
    vibe: "Bungalow colony charm on a hidden waterfront peninsula",
  },
  {
    name: "Edgewater Park",
    slug: "edgewater-park",
    ...
    landmarks: [
      "Edgewater Park private beach",
      "Long Island Sound shoreline",
      "Edgewater Park Community Association",
    ],
    vibe: "Private beach colony with small-town exclusivity",
  },
  {
    name: "Silver Beach",
    slug: "silver-beach",
    ...
    landmarks: [
      "Silver Beach Gardens",
      "Long Island Sound views",
      "Silver Beach Community Association",
    ],
    vibe: "Hidden seaside enclave with tight community bonds",
  },
  {
    name: "Locust Point",
    slug: "locust-point",
    ...
    landmarks: [
      ...
      "Throgs Neck Bridge views",
      "Hammond Cove",
    ],
    vibe: "Secluded waterfront living with yacht club culture",
  },
  {
    name: "Indian Village",
    slug: "indian-village",
    ...
    landmarks: [
      "Indian Village private beach",
      "Eastchester Bay shoreline",
      "Pelham Bay Park (nearby)",
    ],
    vibe: "Ultra-private waterfront bungalow enclave",
  },
  {
    name: "Olinville",
    slug: "olinville",
    ...
    vibe: "Quiet riverside residential with Caribbean-American roots",
  },
  {
    name: "Unionport",
    slug: "unionport",
    ...
    landmarks: [
      "Unionport Road",
      "Westchester Creek",
      "Zerega Avenue industrial area",
    ],
    vibe: "Former village with working-class resilience",
  },
  {
    name: "Fairmount",
    slug: "fairmount",
    ...
    vibe: "Elevated and unassuming with central convenience",
  },
  {
    name: "Bruckner",
    slug: "bruckner",
    ...
    landmarks: [
      "Bruckner Expressway",
      "Bruckner Boulevard",
      "Bronx Terminal Market (nearby)",
    ],
    vibe: "Highway-adjacent with emerging commercial potential",
  },
];
