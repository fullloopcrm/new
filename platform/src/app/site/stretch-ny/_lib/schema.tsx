...
export const organizationSchema = {
  ...
  name: SITE_NAME,
  alternateName: "Stretch New York City",
  legalName: "Stretch NYC",
  url: SITE_URL,
  logo: {
    "@type": "ImageObject",
  ...
  description:
    "Stretch NYC is New York City's premier mobile assisted stretch service. Our certified stretch therapists bring professional flexibility and rehabilitation therapy directly to your home, office, hotel, or any NYC location. Serving all five boroughs: Manhattan, Brooklyn, Queens, Bronx, and Staten Island. $99 per hour. 10% off weekly sessions.",
  slogan: "NYC's #1 Mobile Stretch Service — $99/Hour",
  foundingDate: "2021",
  foundingLocation: {
    "@type": "Place",
  ...
  address: {
    "@type": "PostalAddress",
    streetAddress: "150 W 47th Street",
  ...
  knowsAbout: [
    ...
    "NYC Tourist Recovery Stretching",
    "Chronic Pain Management through Stretching",
  ],
  sameAs: [
    "https://www.instagram.com/stretchnewyorkcity",
    "https://www.google.com/maps/place/Stretch+NYC",
  ],
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Stretch NYC Mobile Stretch Services",
    itemListElement: [
      {
        "@type": "Offer",
        ...
        itemOffered: {
          ...
          description: "Full-body comprehensive stretch service with mobility assessment, professional equipment, and personalized treatment plan delivered to your NYC location.",
        ...
        eligibleRegion: { "@type": "Place", name: "New York City" },
      },
      {
        "@type": "Offer",
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description: "On-site corporate wellness stretch service programs for NYC offices. Reduce workplace injuries, boost productivity, and improve employee morale.",
...
export const websiteSchema = {
  ...
  url: SITE_URL,
  name: SITE_NAME,
  alternateName: "Stretch NYC Mobile Stretch Service",
  description: "NYC Mobile Assisted Stretch Service — Professional stretch service delivered to your home, office, hotel, or any location across New York City. $99/hour. 10% off weekly.",
  publisher: {
    "@id": `${SITE_URL}/#organization`,
  },
  inLanguage: "en-US",
...
export const howToSchema = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: "How to Book a Mobile Stretch Service in NYC",
  description: "Book a professional mobile stretch service in New York City in 4 simple steps. Our certified stretch therapists come to your home, office, hotel, or any NYC location.",
  totalTime: "PT2M",
  estimatedCost: {
    "@type": "MonetaryAmount",
    currency: "USD",
  ...
  step: [
    {
      ...
      text: "Text or call 212-202-7080 with your preferred date, time, and location anywhere in NYC.",
    ...
    },
    {
      ...
      text: "We confirm your stretch service appointment and assign a certified stretch therapist in your NYC neighborhood.",
      url: `${SITE_URL}/#how-it-works`,
    },
    {
      "@type": "HowToStep",
...
export function serviceListSchema(serviceItems: { name: string; url: string; description: string }[]) {
  return {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "NYC Mobile Stretch Services",
    description: "All professional stretch service types offered by Stretch NYC across New York City.",
...
export function neighborhoodListSchema(boroughName: string, items: { name: string; url: string }[]) {
  return {
    ...
    description: `All ${boroughName} neighborhoods served by Stretch NYC mobile stretch service.`,
...
export function jobPostingSchema(locationName?: string, borough?: string) {
  return {
    ...
    qualifications: "Certified stretch therapist or equivalent experience. Must carry own padded yoga mat. Must be in NYC.",
...
export function serviceSchema(serviceName: string, serviceDesc: string, url: string, areaName?: string) {
  return {
    ...
    "@type": "Service",
    "@id": `${url}/#service`,
    name: areaName ? `${serviceName} Stretch Service in ${areaName}` : `${serviceName} Stretch Service in NYC`,
    ...
    audience: {
      "@type": "Audience",
      audienceType: "NYC residents, tourists, athletes, desk workers, seniors, corporate teams",
    },
  };
}
...
export function localBusinessSchema(areaName: string, borough: string) {
  return {
    ...
    description: `Professional mobile stretch service in ${areaName}, ${borough}, NYC. Certified therapists come to your home, office, or hotel. $99/hour. 10% off weekly. 7AM-10PM daily. Same-day appointments available.`,
    url: SITE_URL,
    telephone: "+1-212-202-7080",
    image: `${SITE_URL}/og-image.jpg`,
    priceRange: "$99/hour",
...
export function parkSchema(parkName: string, borough: string, description: string, url: string) {
  return {
    ...
    description: `${description} Professional mobile stretch service available at ${parkName}, ${borough}. Our certified stretch therapists meet you at this iconic NYC location with all equipment. $99/hour.`,
    url,
...
export const aboutPageSchema = {
  ...
  description: "Learn about Stretch NYC — NYC's #1 assisted stretch service. Our story, mission, team, and commitment to making professional stretch service accessible across all five NYC boroughs.",
  url: `${SITE_URL}/about`,
...
export const contactPageSchema = {
  ...
  description: "Contact Stretch NYC for assisted stretch service. Text or call 212-202-7080. $99/hr, same-day available across all NYC boroughs.",
...
export const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "NYC Assisted Stretch Service Session",
  description: "60-minute professional assisted stretch service delivered to your home, office, hotel, or any NYC location. Includes full-body mobility assessment, PNF stretching, myofascial release, and personalized treatment plan. All professional equipment provided.",
...
export const courseSchema = {
  ...
  description: "Free comprehensive stretching guide covering daily routines by age group, stretch techniques, nutrition for flexibility, recovery protocols, and when to use professional stretch service. By Stretch NYC.",
...
export function exerciseActionSchema(exerciseName: string, targetMuscle: string, url: string) {
  return {
    ...
    url,
    description: `Professional ${exerciseName} targeting the ${targetMuscle}. Part of Stretch NYC's assisted stretch service program.`,
  };
}
...
export function medicalConditionSchema(conditionName: string, description: string, url: string) {
  return {
    ...
    possibleTreatment: {
      ...
      description: `Professional stretch service for ${conditionName} management. Certified therapists use PNF stretching and myofascial release to address ${conditionName} at its root cause. $99/hr mobile service across NYC.`,
      drug: [],
    ...
    riskFactor: {
      ...
      name: "Sedentary lifestyle, desk work, NYC commuting",
    },
  };
}
...
export const profilePageSchema = {
  ...
  description: "Career opportunities at Stretch NYC. $50/hr part-time mobile stretch therapist positions across all NYC boroughs.",
  url: `${SITE_URL}/jobs`,
  mainEntity: { "@id": `${SITE_URL}/#organization` },
  isPartOf: { "@id": `${SITE_URL}/#website` },
};
...
export const discountAnnouncementSchema = {
  ...
  name: "Stretch NYC Discounts & Savings",
