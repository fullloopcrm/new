...
const PAGE_DESC = "Pre-workout dynamic stretching, post-workout recovery, sport-specific routines for runners, cyclists, and gym-goers. NYC athlete stretch service — $99/hr, all five boroughs.";
...
const faqs = [
  ...
  { question: "What is the best stretching routine for basketball players in NYC?", answer: "Basketball players need: dynamic hip openers (lateral lunges, hip circles) for cutting and jumping, ankle mobility drills for landing mechanics, hamstring and quad stretches for explosive jumping, shoulder mobility for shooting and passing, and thoracic rotation for court awareness. Pre-game dynamic warm-up should take 10 minutes. Post-game static stretching should take 15 minutes. NYC basketball players at courts across the city can book pre-game and post-game stretch service sessions." },
  { question: "How much does athlete stretch service cost in NYC?", answer: "Professional stretch service for athletes at Stretch NYC costs $99 per 60-minute session. Weekly athlete clients save 10% at $89 per session. Sessions include a sport-specific mobility assessment, targeted stretching using PNF, dynamic, and myofascial release techniques, and personalized recovery recommendations. Our therapists meet you at your gym, Central Park, Prospect Park, or any NYC location. Text or call 212-202-7080 to book." },
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-20">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            Pre-workout dynamic stretching, post-workout recovery protocols, and sport-specific routines for runners, cyclists, basketball players, and gym-goers across NYC. Used by the same techniques as professional sports teams. <strong className="text-white">$99/hr | 10% off weekly.</strong>
          </p>
