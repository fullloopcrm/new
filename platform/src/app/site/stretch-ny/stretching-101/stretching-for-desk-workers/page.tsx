...
const PAGE_DESC = "Tech neck fixes, hip flexor openers, 5-minute desk routines, and lunch break stretches for NYC office workers. Professional stretch service for desk workers — $99/hr across all five boroughs.";
...
const faqs = [
  ...
  { question: "Does our company need a corporate stretch service program?", answer: "If your employees sit at desks for 6+ hours daily, yes. Corporate stretch service programs reduce workplace injuries, decrease employee absenteeism, lower healthcare costs, boost productivity, and improve team morale. We provide on-site stretch service at NYC offices in Midtown, FiDi, DUMBO, Williamsburg, and all five boroughs. Programs include individual stretch sessions, group stretch breaks, and ergonomic assessments. Visit our corporate wellness page for details or text 212-202-7080." },
  ...
  { question: "How much does desk worker stretch service cost?", answer: "Professional stretch service for desk workers at Stretch NYC costs $99 per 60-minute session. Weekly clients save 10% at $89 per session. For corporate programs, we offer customized pricing for on-site office sessions. Our therapists come to your Midtown office, FiDi workspace, DUMBO studio, or any NYC location. Every session addresses the specific muscle imbalances created by desk work — shortened hip flexors, tight chest, restricted thoracic spine, and compressed lower back. Text or call 212-202-7080 to book." },
