...
const PAGE_DESC = "Complete daily stretching routines organized by age: 18-30, 30-45, 45-60, and 60+. Morning, midday, and evening stretch routines with step-by-step instructions. Stretch NYC — $99/hr professional stretch service.";
...
const faqs = [
  ...
  { question: "How much does a professional stretch service cost to complement my daily routine?", answer: "Professional stretch service at Stretch NYC costs $99 per 60-minute session. Weekly clients save 10% and pay just $89 per session. We recommend combining your daily self-stretching routine with one weekly professional session for optimal results. Our certified stretch therapists serve all five NYC boroughs and come to your home, office, hotel, or park. Text or call 212-202-7080 to book your first session." },
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <ul className="mt-3 space-y-2 text-sm text-slate-700">
                ...
                <li>&#8226; $99/hr or $89/hr weekly — all five NYC boroughs</li>
              </ul>
            </div>
          </div>
        </div>
