...
const PAGE_DESC = "Safe stretching routines for seniors 60+: chair stretches, standing exercises, fall prevention, arthritis-friendly techniques. Professional gentle stretch service in NYC — $99/hr.";
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-20">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            Complete stretching guide for adults 60+: chair stretching routines, standing exercises with support, balance exercises, fall prevention, and arthritis-friendly techniques. Professional gentle stretch service across all five NYC boroughs. <strong className="text-white">$99/hr | 10% off weekly.</strong>
          </p>
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <ul className="mt-3 space-y-2 text-sm text-slate-700">
                <li>&#8226; <strong>NYC Department for the Aging:</strong> Senior centers across all five boroughs offer free or low-cost group exercise classes</li>
