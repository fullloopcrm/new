      ...
      <div className="bg-slate-900">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-1.5">
          ...
          <div className="flex items-center gap-3 sm:hidden">
            <a href="sms:+12122027080" className="text-xs font-semibold text-teal-400 font-cta">
              Text 212.202.7080
            </a>
          ...
          <div className="hidden items-center gap-1.5 overflow-x-auto sm:flex">
            <span className="shrink-0 text-xs font-semibold text-slate-500 font-cta">Boroughs:</span>
            {topBoroughs.map((b) => (
          ...
          <div className="hidden items-center gap-3 shrink-0 sm:flex">
            <a href="sms:+12122027080" className="text-xs font-semibold text-teal-400 transition-colors hover:text-teal-300 font-cta">
              Text 212.202.7080
            </a>
          </div>
        </div>
