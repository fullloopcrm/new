...
export const metadata: Metadata = {
  ...
  description: "Join the Stretch NYC team. Hiring mobile stretch therapists across NYC. $50/hr part-time, flexible hours, fast payment. Apply today.",
...
const requirements = [
  ...
  "Able to transport equipment to client locations across NYC",
...
export default function CareersPage() {
  return (
    <>
      <JsonLd data={webPageSchema("Careers at Stretch NYC", "Join Stretch NYC as a certified stretch therapist. $50/hr, flexible schedule.", `${SITE_URL}/careers`)} />
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="rounded-xl border border-teal-400 bg-teal-50 p-8 shadow-lg">
            ...
            <p className="mt-4 text-base text-slate-600 leading-relaxed">
              Stretch NYC is looking for certified stretch therapists to join our growing team of mobile wellness professionals. You&apos;ll travel to clients across NYC — homes, offices, hotels, and outdoor locations — providing personalized assisted stretching sessions. This is a flexible, part-time position ideal for therapists who want to earn great pay on their own schedule.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="text-center text-3xl font-bold text-slate-900 font-heading">Why Work With Stretch NYC</h2>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-white/80">
            Send us your resume and a brief introduction. Tell us about your experience with assisted stretching and why you want to join Stretch NYC.
          </p>
