...
import { SITE_URL } from "@/app/site/stretch-ny/_lib/siteData";
import { JsonLd, webPageSchema, breadcrumbSchema } from "@/app/site/stretch-ny/_lib/schema";

const pageTitle = "Legal | Stretch NYC Mobile Stretch Service";
const pageDescription =
  "Legal information for Stretch NYC mobile stretch service. Terms, privacy policy, refund policy, and liability information.";
...
const legalPages = [
  {
    ...
    href: "/terms",
    description:
      "The terms governing your use of Stretch NYC services, including booking, payment, liability, and service agreements.",
  },
  {
