...
import { SITE_SMS_LINK, SITE_PHONE } from "@/app/site/stretch-ny/_lib/siteData";
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-24 sm:pt-44 min-h-screen">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-lg text-white/80">
          The page you&apos;re looking for doesn&apos;t exist or has moved. But our assisted stretch service is still here — $99/hr, mobile across all of NYC.
        </p>
