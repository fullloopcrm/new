...
import { parks, boroughs, getParkUrl, SITE_URL, SITE_SMS_LINK, SITE_PHONE } from "@/app/site/stretch-ny/_lib/siteData";
...
export const metadata: Metadata = {
  title: "Outdoor Stretch Service NYC | 50+ Parks & Locations",
  description: "Outdoor stretch service at 50+ NYC parks. Central Park, Brooklyn Bridge Park, High Line & more. $99/hr, 10% off weekly. Same-day available 7AM-10PM.",
...
export default function ParksPage() {
  return (
    <>
      <JsonLd data={webPageSchema("NYC Parks & Iconic Stretching Locations", "Get stretched at 50+ iconic NYC parks and public spaces.", `${SITE_URL}/parks`)} />
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-20">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-teal-200 font-cta">132 Parks &amp; Public Spaces | Outdoor Stretch Service | $99/hr</p>
          <h1 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl font-heading">
            NYC Parks & Iconic <span className="text-teal-200">Stretch Service Locations</span>
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/80">
            We bring professional stretch service to {parks.length}+ iconic NYC parks and public spaces. $99/hr. Perfect for tourists and locals who love outdoor stretching.
          </p>
        </div>
      </section>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-6xl px-6">
          {boroughs.map((b) => {
            const bParks = parks.filter((p) => p.boroughSlug === b.slug);
            if (bParks.length === 0) return null;
            return (
              <div key={b.slug} className="mb-12">
                <h2 className="text-2xl font-bold text-slate-900 font-heading">{b.name} Parks</h2>
                      ...
                      <div className="group rounded-xl border border-slate-200 bg-white p-5 transition-all hover:border-teal-400 hover:shadow-md h-full">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-xs text-slate-500">{p.borough} | Tourist Rating: {"★".repeat(p.touristRating)}</p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-2xl font-bold text-white font-heading">Visiting NYC? Get Stretched at an Iconic Location</h2>
          <p className="mt-4 text-lg text-white/80">After walking 20,000 steps exploring the city, meet us at any park or we&apos;ll come to your hotel. You choose!</p>
