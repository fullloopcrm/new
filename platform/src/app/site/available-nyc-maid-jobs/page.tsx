...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, howToBookSchema, breadcrumbSchema } from '@/lib/seo/schema'
...
const careerFAQs = [
  ...
  { question: 'How do I apply?', questionEs: '¿Cómo aplico?', answer: 'Apply online at thenycmaid.com/apply or text (212) 202-9030. We review applications within 24–48 hours and get you working fast.', answerEs: 'Aplica en thenycmaid.com/apply o envía un texto al (212) 202-9030. Revisamos en 24–48 horas.' },
]
...
const pageDescription = 'Hiring cleaners NYC, Long Island & NJ! Starting $30/hr + bonus programs. Zelle in <30 min. 100% tips. Open 24/7. English & Spanish | Contratando — desde $30/hr + bonos, propinas 100% tuyas. (212) 202-9030'
...
function jobPostingSchema(region: string, locations: string) {
  ...
  return {
    ...
    description: `Now hiring experienced house cleaners in ${locations}. Starting at $30/hr paid via Zelle within 30 minutes of every completed job. Bonus programs available for retention, client satisfaction, and five-star reviews. Flexible schedule. Open 24/7. You provide your own cleaning supplies and equipment. Background check required. Apply at thenycmaid.com/apply or text (212) 202-9030. Bilingual workplace (English/Spanish). 100% of tips are yours.`,
    identifier: {
      '@type': 'PropertyValue',
      name: 'The NYC Maid',
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            <a href="sms:2122029030" className="text-blue-200/70 font-medium text-lg py-4 hover:text-white transition-colors underline underline-offset-4">
