...
import { parklandEstatesMaidConfig as config } from '@/app/site/the-florida-maid/_lib/emd/parkland-estates-maid'
...
export default function ParklandEstatesMaidPage() {
