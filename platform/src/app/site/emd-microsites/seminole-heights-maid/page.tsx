...
import { seminoleHeightsMaidConfig as config } from '@/app/site/the-florida-maid/_lib/emd/seminole-heights-maid'
...
export default function SeminoleHeightsMaidPage() {
