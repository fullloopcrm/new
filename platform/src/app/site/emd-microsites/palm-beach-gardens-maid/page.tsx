...
import { palmBeachGardensMaidConfig as config } from '@/app/site/the-florida-maid/_lib/emd/palm-beach-gardens-maid'
...
export default function PalmBeachGardensMaidPage() {
