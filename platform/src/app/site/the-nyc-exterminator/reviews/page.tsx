...
import { PHONE, SITE_URL, SITE_NAME } from "@/app/site/the-nyc-exterminator/_lib/seo";
import { getBreadcrumbSchema } from "@/app/site/the-nyc-exterminator/_lib/seo";
...
export const metadata: Metadata = {
  title: "NYC Exterminator Reviews | Pest Control Customer Reviews",
  description:
    "Read reviews from NYC homeowners, renters, and businesses about our cockroach, bed bug, rat, mouse, and termite extermination results. Licensed exterminators across all 5 boroughs, NJ, Long Island & Westchester. Text us.",
  keywords:
    "NYC exterminator reviews, pest control reviews NYC, best exterminator NYC, bed bug treatment reviews, cockroach exterminator reviews, rat exterminator reviews, pest control testimonials",
  openGraph: {
    title: "NYC Exterminator Reviews | Pest Control Customer Reviews",
    description:
      "See what NYC says about our pest control. Text us.",
  ...
  return (
    <div>
      ...
      <section className="bg-[#0A0A0A] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold sm:text-4xl">
            Why NYC Trusts <span className="text-green-500">{SITE_NAME}</span>
          </h2>
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            Licensed exterminators serving all five boroughs and the surrounding metro area for{" "}
            <Link
              href="/cockroach-extermination"
              className="text-green-400 hover:text-green-300"
            >
