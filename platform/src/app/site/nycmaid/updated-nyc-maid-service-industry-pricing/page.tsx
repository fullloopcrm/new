...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, pricingOffersSchema, howToBookSchema, breadcrumbSchema, faqSchema } from '@/app/site/nycmaid/_lib/seo/schema'
...
const pricingFaqs = [
  ...
  { question: 'What payment methods do you accept?', answer: 'Cash, Venmo, Zelle (pay@thenycmaid.com), and credit card (via Stripe). Payment is collected 30 minutes before the cleaner finishes. No deposits, no pre-authorization holds.' },
  ...
  { question: 'Do you offer free estimates?', answer: 'Yes. Text (212) 202-8400 with your address, home size, and service type and we\'ll provide a custom quote within minutes. No obligation, no pressure.' },
    ...
    <>
          ...
          <div className="max-w-5xl mx-auto px-4 py-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:2122028400" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-[#A8F0DC] rounded-2xl p-7 text-center relative">
                ...
                <a href="sms:2122028400" className="block mt-6 bg-[#1E2A4A] text-white px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:2122028400" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text — same-day</a>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { n: '01', t: 'Text Us', d: 'Reach us at (212) 202-8400 with your address, home size, and what type of cleaning you need.' },
              ...
              { n: '03', t: 'Pay After', d: 'We clean, you inspect, you pay. No deposits, no upfront charges. Cash, Venmo, Zelle (pay@thenycmaid.com), or credit card.' },
            ].map(s => (
