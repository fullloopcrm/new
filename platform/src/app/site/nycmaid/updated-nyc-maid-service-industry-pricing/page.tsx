...
const pricingFaqs = [
  ...
  { question: 'Is there a minimum charge?', answer: 'Our minimum booking is 2 hours (first-time cleanings included). Bookings with 2 or more cleaners carry a 4-hour minimum and receive no discounts, regardless of notice. For most studio and 1-bedroom regular cleanings, 2 hours is sufficient. Deep cleans and larger apartments typically require 3–6+ hours.' },
