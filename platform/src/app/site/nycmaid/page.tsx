...
import { homepageContent } from '@/app/site/nycmaid/_lib/seo/content'
import { homepageSchemas, faqSchema, videoReviewsSchemas } from '@/app/site/nycmaid/_lib/seo/schema'
import { pickLifestylePhoto } from '@/app/site/nycmaid/_lib/seo/photos'
import JsonLd from '@/app/site/nycmaid/_components/JsonLd'
import ServiceGrid from '@/app/site/nycmaid/_components/ServiceGrid'
import TrustBadges from '@/app/site/nycmaid/_components/TrustBadges'
import CTABlock from '@/app/site/nycmaid/_components/CTABlock'
import FAQSection from '@/app/site/nycmaid/_components/FAQSection'
import Image from 'next/image'
import VideoReviews from '@/app/site/nycmaid/_components/VideoReviews'
...
const homepageFAQs = [
  ...
  { question: 'How do I contact you?', answer: 'Text (212) 202-8400, or email hi@thenycmaid.com. Texting is the fastest way to reach us.' },
]
    ...
    <>
      ...
      <section className="bg-white">
        <figure className="relative aspect-[21/9] w-full overflow-hidden max-h-[560px]">
          ...
          />
          <figcaption className="sr-only">{homepagePhoto.caption} — NYC Maid service homepage</figcaption>
        </figure>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <a href="sms:2122028400" className="inline-block bg-[#1E2A4A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                  Text 212.202.8400
                </a>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="sms:2122028400" className="inline-block bg-[#1E2A4A] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                Text 212.202.8400
              </a>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="p-4 sm:p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                {[
                  ...
                  { name: 'Marisa Akson', time: '3 weeks ago', text: 'I was in a stressful situation after another cleaning company canceled on me last minute, and NYC Maid was able to fit me in right away. The cleaner was thorough, friendly, and did an amazing job.', initial: 'M', color: 'bg-fuchsia-400' },
                  ...
                  { name: 'Alexandra Spieth', time: '20 weeks ago', text: 'Have used NYC Maid twice and have had a great experience both times. Maria was thorough, prompt, and awesome. Highly recommend!', initial: 'A', color: 'bg-purple-400' },
          ...
          <div className="text-center mt-10">
            <Link href="/reviews" className="text-[#1E2A4A] font-semibold hover:underline underline-offset-4">Read All Reviews &rarr;</Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#A8F0DC] py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="mt-8">
            <Link href="/reviews" className="text-[#1E2A4A] font-semibold text-sm tracking-wide hover:underline underline-offset-4">Read All NYC Maid Service Reviews &rarr;</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#1E2A4A] tracking-wide text-center mb-4">Hundreds of Neighborhoods Across NYC Metro Served by Professional Cleaners</h2>
          <p className="text-gray-500 text-center max-w-3xl mx-auto mb-14">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 text-center">
            ...
            <div>
              <Link href="/bronx-maid-service" className="block mb-4 group">
                <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide group-hover:text-[#1E2A4A]/70 transition-colors">Bronx</h3>
                <p className="text-xs text-gray-400 tracking-[0.15em] uppercase">New York</p>
              </Link>
              <ul className="space-y-2">
                {[
                ...
                <li><Link href="/bronx-maid-service" className="text-sm text-[#1E2A4A] font-semibold hover:underline underline-offset-4">All Bronx &rarr;</Link></li>
              </ul>
            </div>
            ...
            <div>
              <Link href="/staten-island-maid-service" className="block mb-4 group">
                <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide group-hover:text-[#1E2A4A]/70 transition-colors">Staten Island</h3>
                <p className="text-xs text-gray-400 tracking-[0.15em] uppercase">New York</p>
              </Link>
              <ul className="space-y-2">
                {[
                ...
                <li><Link href="/staten-island-maid-service" className="text-sm text-[#1E2A4A] font-semibold hover:underline underline-offset-4">All Staten Island &rarr;</Link></li>
              </ul>
            </div>
            ...
            <div>
              <Link href="/westchester-maid-service" className="block mb-4 group">
                <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide group-hover:text-[#1E2A4A]/70 transition-colors">Westchester</h3>
                <p className="text-xs text-gray-400 tracking-[0.15em] uppercase">New York</p>
              </Link>
              <ul className="space-y-2">
                {[
                ...
                <li><Link href="/westchester-maid-service" className="text-sm text-[#1E2A4A] font-semibold hover:underline underline-offset-4">All Westchester &rarr;</Link></li>
              </ul>
            </div>
          ...
          <div className="text-center mt-12">
            <Link href="/service-areas-served-by-the-nyc-maid" className="text-[#1E2A4A] font-semibold hover:underline underline-offset-4">Browse All Neighborhoods &rarr;</Link>
          </div>
        </div>
      </section>
