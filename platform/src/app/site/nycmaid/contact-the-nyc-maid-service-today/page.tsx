...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, howToBookSchema, breadcrumbSchema, faqSchema } from '@/app/site/nycmaid/_lib/seo/schema'
...
const title = 'Contact The NYC Maid | Text Sales (212) 202-8400 | Support (646) 490-0130'
const description = 'Contact The NYC Maid for a free cleaning quote. Text sales at (212) 202-8400, support at (646) 490-0130, or email hi@thenycmaid.com. Service from $59/hr across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. 5.0★ Rated.'
...
const contactFaqs = [
  { question: 'What\'s the fastest way to get a quote?', answer: 'Text sales at (212) 202-8400 with your address, home size (bedrooms/bathrooms), and what type of cleaning you need. For existing clients needing support, text (646) 490-0130. Most quotes are delivered within 15 minutes.' },
  ...
  { question: 'How quickly can you schedule a cleaning?', answer: 'Usually within 24–48 hours. For same-day service, text us before 10am for the best chance of afternoon availability. Same-day is $89/hr. A 2-hour minimum applies (first-time cleanings included). Bookings with 2 or more cleaners carry a 4-hour minimum and receive no discounts, regardless of notice.' },
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
            <a href="sms:2122028400" className="inline-block font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#A8F0DC] tracking-wide hover:text-white transition-colors">
              Sales: (212) 202-8400
            </a>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              ...
              <div className="bg-[#A8F0DC]/15 rounded-lg p-3 mb-8">
                ...
                <p className="text-gray-500 text-xs">Text sales (212) 202-8400 anytime. Support: (646) 490-0130.</p>
              </div>
