...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    category: 'Pricing',
    readTime: '5 min',
    metaDescription: 'NYC apartment cleaning costs $59–$89/hr in 2026 — recurring clients save 10–20% weekly, 5–10% biweekly/monthly depending on tier. Honest pricing breakdown by apartment size, service type & frequency. Text The NYC Maid (212) 202-8400.',
    sections: [
  ...
  },
  {
    ...
    category: 'Tips',
    readTime: '5 min',
    metaDescription: 'Remove bathroom mold in NYC apartments — causes, DIY fixes & when to text pros. Cleaning service from $59/hr. The NYC Maid (212) 202-8400.',
    sections: [
