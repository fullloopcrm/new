...
import { useFormTracking } from '@/app/site/nycmaid/_lib/useFormTracking'
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center max-w-sm">
            ...
            <a href="/get-paid-for-cleaning-referrals-every-time-they-are-serviced" className="inline-block mt-6 text-[#1E2A4A] text-sm font-semibold underline underline-offset-4 hover:text-[#243352]">
              Refer friends &amp; earn 10% on every cleaning they book &rarr;
            </a>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto p-4 pt-6">
        <form onSubmit={handleSubmit} onFocusCapture={trackStart} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          <div className="my-5 p-4 border-2 border-red-300 rounded-lg bg-red-50">
            <p className="text-sm font-bold text-red-900 mb-1 uppercase tracking-wide">No cancellations — read carefully</p>
            <ul className="text-[13px] leading-relaxed text-red-900 list-disc list-inside space-y-1">
              <li><strong>First-time bookings CANNOT be cancelled or rescheduled.</strong> We hold your slot and turn other clients away.</li>
