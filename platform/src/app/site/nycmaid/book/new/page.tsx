...
function trackBookingEvent(action: string, sessionId: string, extra: Record<string, unknown> = {}) {
  try {
    const body = JSON.stringify({
      domain: typeof window !== 'undefined' ? window.location.hostname : 'thenycmaid.com',
      page: '/book/new',
      action,
...
function BookFormContent() {
  ...
  // Emergency ($89/hr) is same-day only. Multi-cleaner bookings still carry
  // their own 4-hour minimum regardless of notice, just not the surcharge
  // (nycmaid ref 287c8cc4).
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-10 md:py-16 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <div className="inline-block bg-[#A8F0DC] text-[#1E2A4A] text-xs font-bold tracking-widest uppercase px-3 py-1 rounded-full mb-4">The NYC Maid Self-Booking System</div>
