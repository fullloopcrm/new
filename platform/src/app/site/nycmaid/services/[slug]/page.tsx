...
import { SERVICES, getServiceByUrlSlug } from '@/app/site/nycmaid/_lib/seo/services'
...
import { serviceContent, serviceFAQs, getServiceRichContent, commonServiceFAQs } from '@/app/site/nycmaid/_lib/seo/content'
import { servicePageSchemas, faqSchema } from '@/app/site/nycmaid/_lib/seo/schema'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Professional ${service.name.toLowerCase()} across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. ${service.features.slice(0, 2).join(', ')} & more. From ${service.priceRange.split('–')[0]}. 5.0★ Rated. (212) 202-8400`
    ...
    <>
      ...
      <section className="bg-white">
        <figure className="relative aspect-[21/9] w-full overflow-hidden max-h-[520px]">
          ...
          />
          <figcaption className="sr-only">{servicePhoto.caption} — {service.name} by The NYC Maid</figcaption>
        </figure>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-2 lg:sticky lg:top-28">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-3">
                  ...
                  <a href="sms:2122028400" className="bg-[#1E2A4A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                    Text 212.202.8400
                  </a>
                </div>
              </div>
