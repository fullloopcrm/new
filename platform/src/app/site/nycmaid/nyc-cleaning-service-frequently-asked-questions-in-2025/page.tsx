...
const pricingFAQs = [
  ...
  { question: 'Is there a minimum charge?', answer: 'Our minimum is 2 hours per visit (first-time cleanings included). Bookings with 2 or more cleaners carry a 4-hour minimum and receive no discounts, regardless of notice. Most apartments take 2–4 hours depending on size and condition.' },
...
const schedulingFAQs = [
  { question: 'How do I book a cleaning?', answer: 'Text (212) 202-8400. We typically schedule within 24–48 hours. Same-day availability for urgent requests.' },
...
const pageDescription = 'Answers to 24 common questions about The NYC Maid — pricing ($59–$89/hr) plus 20% off weekly recurring, what\'s included, scheduling, insurance, service areas, and more. Serving Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. (212) 202-8400'
