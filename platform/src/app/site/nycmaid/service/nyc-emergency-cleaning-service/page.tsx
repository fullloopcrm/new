...
const process = [
  { step: '1', title: 'Text Us', description: 'Text (212) 202-8400 and describe the situation. We\'ll ask what happened, when it happened, and the scope of damage. Be honest about severity — it helps us send the right team with the right equipment.' },
...
export const metadata: Metadata = {
  ...
  description: 'NYC emergency cleaning — water damage, fire, sewage, biohazard & mold. 24/7 rapid response with pro equipment. What to do, what not to do. Text (212) 202-8400.',
