...
export const metadata: Metadata = {
  ...
  description: 'Read 43+ verified 5-star reviews from real NYC cleaning clients. See why New Yorkers trust our background-checked, insured cleaners for apartments across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. From $59/hr, no contracts. (212) 202-8400',
