...
const categories = [
  ...
  { id: 'new-jersey', name: 'New Jersey-Specific', icon: '🏙️' },
...
const tips: Record<string, { title: string; tip: string }[]> = {
  ...
  bathroom: [
    ...
    { title: 'Ventilation is everything', tip: 'Run the bathroom fan for 30 minutes after every shower. If it doesn\'t work, tell your landlord — it\'s required by code in New Jersey.' },
  ],
  bedroom: [
  ...
  living: [
    ...
    { title: 'Window sill maintenance', tip: 'Wipe sills weekly in New Jersey. City dust and pollution settle there first, and it tracks into the room when you open the window.' },
  ...
  laundry: [
    ...
    { title: 'Shared laundry room etiquette', tip: 'In New Jersey buildings: set a timer, remove clothes promptly, wipe the lint trap, and don\'t leave detergent residue on machines. Your neighbors will appreciate it.' },
  ],
  'new-jersey': [
    { title: 'Cockroach prevention is cleaning', tip: 'In New Jersey, cockroaches are a fact of life — but a clean kitchen denies them food. Wipe counters nightly, seal food in containers, take trash out daily.' },
    ...
    { title: 'City dust requires more frequent dusting', tip: 'New Jersey apartments get dustier than suburban homes due to air pollution and constant construction. Dust weekly minimum, not monthly.' },
    ...
    { title: 'Building laundry lint hazard', tip: 'If your building has shared dryers, check the vent ducts. Clogged dryer vents are one of the top causes of apartment fires in New Jersey.' },
  ],
  green: [
  ...
  habits: [
    ...
    { title: 'Shoe-free home', tip: 'Take shoes off at the door. New Jersey sidewalks carry bacteria, rat poison residue, and general filth. Your floors stay cleaner for days longer.' },
...
const faqData = [
  { q: 'How often should I deep clean my apartment?', a: 'Every 4–6 weeks is ideal for most New Jersey apartments. If you have pets or cook frequently, monthly deep cleaning keeps things manageable. Regular weekly maintenance between deep cleans keeps your space consistently comfortable.' },
  ...
  { q: 'How do I keep my New Jersey apartment clean between professional cleanings?', a: 'Follow the daily habits section above — make the bed, wipe counters, deal with dishes immediately, and take shoes off at the door. These 5 habits keep your apartment presentable between professional visits.' },
...
export const metadata: Metadata = {
  title: 'The 100 Best Cleaning Tips for New Jersey Apartments | The New Jersey Maid',
  description: 'The definitive list — 100 expert cleaning tips for New Jersey apartments from professional cleaners. Kitchen, bathroom, floors, pets & more. From $59/hr. (973) 370-8800',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/new-jersey-maid-and-cleaning-tips-and-advice-by-the-new-jersey-maid' },
  openGraph: {
    title: '100 Best Cleaning Tips | The New Jersey Maid',
    description: 'The definitive cleaning tips guide for New Jersey apartments — 100 expert tips organized by room.',
    url: 'https://www.thenewjerseymaid.com/new-jersey-maid-and-cleaning-tips-and-advice-by-the-new-jersey-maid',
  },
}
...
export default function TipsPage() {
  ...
  const howToSchema = {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: '100 Cleaning Tips for New Jersey Apartments',
    description: 'The definitive guide to keeping your New Jersey apartment clean — 100 expert tips organized by room and category.',
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: '100 Cleaning Tips', url: 'https://www.thenewjerseymaid.com/new-jersey-maid-and-cleaning-tips-and-advice-by-the-new-jersey-maid' },
        ]),
        faqSchema,
        howToSchema,
      ]} />
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <p className="text-xs font-semibold text-[#A8F0DC] tracking-[0.25em] uppercase mb-4">From the Pros Who Clean New Jersey Every Day</p>
          <h1 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl lg:text-7xl text-white tracking-wide leading-[0.95] mb-4">The 100 Best Cleaning Tips for New Jersey Apartments</h1>
          <p className="text-white/60 text-lg max-w-3xl mx-auto">No fluff, no sponsored products — just the tips our professional cleaning team actually uses in real New Jersey apartments every single day.</p>
        </div>
      </section>

      <div className="max-w-5xl mx-auto px-4 py-12">
        <Breadcrumbs items={[{ name: '100 Cleaning Tips', href: '/new-jersey-maid-and-cleaning-tips-and-advice-by-the-new-jersey-maid' }]} />
        ...
        <div className="text-center">
          <p className="text-gray-600">
            Want more in-depth articles? Check out our <Link href="/new-jersey-maid-service-blog" className="text-[#1E2A4A] font-semibold hover:underline">blog</Link> for detailed cleaning guides.
          </p>
        </div>
      </div>
