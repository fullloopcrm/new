...
export const metadata: Metadata = {
  title: 'Do Not Share Policy | The New Jersey Maid',
  description: 'The New Jersey Maid does not sell, share, or distribute your personal information. Your data stays with us. New Jersey cleaning from $59/hr. (973) 370-8800',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/do-not-share-policy' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Do Not Share Policy', url: 'https://www.thenewjerseymaid.com/do-not-share-policy' },
      ])} />
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-xl p-5 mt-4 space-y-2">
              <p className="text-gray-600 text-sm">Email us at <a href="mailto:hi@thenewjerseymaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thenewjerseymaid.com</a> with the subject &ldquo;Do Not Share&rdquo;</p>
              <p className="text-gray-600 text-sm">Or text <a href="sms:9733708800" className="text-[#1E2A4A] underline underline-offset-2">(973) 370-8800</a></p>
            </div>
