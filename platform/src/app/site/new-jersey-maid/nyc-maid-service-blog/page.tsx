...
export const metadata: Metadata = {
  title: 'Blog | NYC Cleaning Tips & News | The New Jersey Maid',
  description: 'The New Jersey Maid blog — cleaning tips, guides & news for NYC residents. Apartment care, eco-friendly products & pro advice. Service from $59/hr. (973) 370-8800',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/nyc-maid-service-blog' },
  openGraph: {
    title: 'Blog | The New Jersey Maid',
    description: 'Expert cleaning tips and guides for NYC residents.',
    url: 'https://www.thenewjerseymaid.com/nyc-maid-service-blog',
  },
  twitter: {
