...
import { BLOG_POSTS, getBlogPost, getAllBlogSlugs } from '@/app/site/new-jersey-maid/_lib/seo/blog-data'
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const blogPhotoUrl = `https://www.thenewjerseymaid.com${blogPhoto.src}`
  ...
  const articleSchema = {
    ...
    author: { '@type': 'Organization', name: 'The New Jersey Maid', url: 'https://www.thenewjerseymaid.com' },
    publisher: {
      '@type': 'Organization',
