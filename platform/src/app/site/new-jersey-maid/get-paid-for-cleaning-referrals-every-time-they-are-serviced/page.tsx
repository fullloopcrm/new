...
import { breadcrumbSchema, localBusinessSchema, faqSchema } from '@/app/site/new-jersey-maid/_lib/seo/schema'
...
import ReferralFAQSection from '@/app/site/new-jersey-maid/_components/ReferralFAQSection'
import ReferralCTABlock from '@/app/site/new-jersey-maid/_components/ReferralCTABlock'
import ReferralPageBody from '@/app/site/new-jersey-maid/_components/ReferralPageBody'

export const metadata: Metadata = {
  title: 'Get Paid for Cleaning Referrals | Earn 10% Commission | The New Jersey Maid',
  description: 'Earn 10% commission every time your referral books a cleaning (from $59/hr). Recurring income, fast payouts via Stripe. (973) 370-8800',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
  openGraph: {
    title: 'Get Paid for Cleaning Referrals | The New Jersey Maid',
    description: 'Earn 10% commission every time someone you refer books a cleaning. Recurring income, fast payouts.',
    url: 'https://www.thenewjerseymaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Referral Program', url: 'https://www.thenewjerseymaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
        ]),
