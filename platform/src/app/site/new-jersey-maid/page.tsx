...
const homepageFAQs = [
  ...
  { question: 'Do you clean offices and commercial spaces?', answer: 'Yes. We offer office cleaning for small to mid-size commercial spaces across the New Jersey area. Contact us for a custom quote.' },
  ...
  // Areas & Coverage
  { question: 'What areas do you serve?', answer: 'We serve New Jersey and the surrounding area. Same rates everywhere — no travel fees.' },
  ...
  { question: 'How long have you been in business?', answer: 'The New Jersey Maid is proud to bring the same standard of professional, background-checked house cleaning to New Jersey.' },
    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            {/* Left — story */}
            <div>
              <p className="text-xs font-semibold text-gray-400 tracking-[0.25em] uppercase mb-3">New Jersey&apos;s Trusted Home Cleaning Company</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-16 items-start">
            ...
            <div className="bg-[#1E2A4A] rounded-2xl p-8 pt-10 relative flex flex-col lg:-my-4 shadow-xl">
              ...
              <ul className="space-y-2 mb-6">
                {[
                  'Most New Jersey renters — no storage needed for bulky supplies',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-5">New Jersey Cleaning Cost Tips — How to Get the Best Value</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-5">What Affects the Cost of House Cleaning in New Jersey?</h3>
              <ul className="space-y-4">
                {[
      ...
      <section className="py-16 bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#1E2A4A] tracking-wide mb-4">Proudly Serving New Jersey</h2>

          <p className="text-gray-500 max-w-2xl mx-auto">Same flat hourly rate, same background-checked cleaners, no travel fees — anywhere in our New Jersey service area. Text us your address and we&apos;ll confirm coverage.</p>
      ...
      {/* FAQ */}
      <FAQSection faqs={homepageFAQs} title="New Jersey House Cleaning Service — Frequently Asked Questions &amp; Answers" columns={2} />

      <CTABlock title="Book Your New Jersey Cleaning Service Today" subtitle="Text us — background-checked, insured cleaners serving New Jersey." />
    </>
  )
}
