...
import { homepageContent } from '@/app/site/new-jersey-maid/_lib/seo/content'
import { homepageSchemas, faqSchema, videoReviewsSchemas } from '@/app/site/new-jersey-maid/_lib/seo/schema'
import { pickLifestylePhoto } from '@/app/site/new-jersey-maid/_lib/seo/photos'
import JsonLd from '@/app/site/new-jersey-maid/_components/JsonLd'
import ServiceGrid from '@/app/site/new-jersey-maid/_components/ServiceGrid'
import TrustBadges from '@/app/site/new-jersey-maid/_components/TrustBadges'
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.thenewjerseymaid.com' },
  openGraph: {
    title: content.title,
    description: content.metaDescription,
...
const homepageFAQs = [
  ...
  { question: 'How long have you been in business?', answer: 'The New Jersey Maid has been serving the New York City metro area since 2018. We have cleaned thousands of homes and built a loyal client base through consistent quality.' },
  ...
  { question: 'How do I contact you?', answer: 'Text (973) 370-8800, or email hi@thenewjerseymaid.com. Texting is the fastest way to reach us.' },
]
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] pt-12 md:pt-16 pb-14 md:pb-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            ...
            <a href="sms:9733708800" className="inline-flex items-center gap-2 bg-white/10 border border-white/30 text-white px-8 py-4 rounded-lg font-bold text-base tracking-widest uppercase hover:bg-white/20 transition-colors">
              Text (973) 370-8800
            </a>
      ...
      <section className="bg-white">
        <figure className="relative aspect-[21/9] w-full overflow-hidden max-h-[560px]">
          <Image
            ...
            alt={`${homepagePhoto.alt} — The New Jersey Maid`}
            fill
            priority
            sizes="100vw"
            className="object-cover"
          />
          <figcaption className="sr-only">{homepagePhoto.caption} — New Jersey Maid service homepage</figcaption>
        </figure>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#1E2A4A] tracking-wide leading-tight mb-4">Welcome to The New Jersey Maid</h2>
            ...
            <div className="space-y-6">
              <div className="bg-[#F5FBF8] border border-[#A8F0DC]/30 rounded-2xl p-8">
                <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-5">The New Jersey Maid at a Glance</h3>
      ...
      <section className="py-20 bg-[#A8F0DC]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center">
            <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-2">How New Jersey Maid Pricing Compares to the Industry</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto mb-8">
              ...
              <div className="bg-[#F5FBF8] border border-[#A8F0DC]/30 rounded-xl p-4">
                <p className="text-xs text-[#A8F0DC] font-semibold tracking-wide uppercase mb-1">The New Jersey Maid</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#1E2A4A] tracking-wide leading-tight mb-6">Why Thousands of New Yorkers Trust The New Jersey Maid</h2>
            <div className="w-12 h-[2px] bg-[#A8F0DC] mb-6" />
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xs font-semibold text-gray-400 tracking-[0.25em] uppercase mb-3 text-center">What Makes The New Jersey Maid Different From Other NYC Cleaning Services</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mb-8">
            Refer friends, family, or neighbors to The New Jersey Maid and earn 10% recurring commission on every cleaning they book — not just the first. Paid via Stripe after each completed visit. No limit on referrals, no cap on earnings.
          </p>
