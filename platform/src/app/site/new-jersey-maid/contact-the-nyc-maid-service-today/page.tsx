...
const title = 'Contact The New Jersey Maid | Text Sales (973) 370-8800 | Support (646) 490-0130'
const description = 'Contact The New Jersey Maid for a free cleaning quote. Text sales at (973) 370-8800, support at (646) 490-0130, or email hi@thenewjerseymaid.com. Service from $59/hr across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. 5.0★ Rated.'
...
const contactFaqs = [
  { question: 'What\'s the fastest way to get a quote?', answer: 'Text sales at (973) 370-8800 with your address, home size (bedrooms/bathrooms), and what type of cleaning you need. For existing clients needing support, text (646) 490-0130. Most quotes are delivered within 15 minutes.' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              ...
              <div className="bg-[#A8F0DC]/15 rounded-lg p-3 mb-8">
                ...
                <p className="text-gray-500 text-xs">Text sales (973) 370-8800 anytime. Support: (646) 490-0130.</p>
              </div>
