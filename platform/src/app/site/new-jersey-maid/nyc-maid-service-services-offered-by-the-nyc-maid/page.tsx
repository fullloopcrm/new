...
import { breadcrumbSchema, localBusinessSchema, serviceItemListSchema } from '@/app/site/new-jersey-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: { absolute: 'NYC Cleaning Services — Deep Clean, Maid Service, Move-In/Out & More | The New Jersey Maid' },
  description: 'All cleaning services by The New Jersey Maid from $59/hr. Deep cleaning, weekly maid service, move-in/out, post-construction, Airbnb, same-day. Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ.',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/nyc-maid-service-services-offered-by-the-nyc-maid' },
  openGraph: {
    title: 'NYC Cleaning Services — Deep Clean, Maid Service & More | The New Jersey Maid',
    ...
    url: 'https://www.thenewjerseymaid.com/nyc-maid-service-services-offered-by-the-nyc-maid',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Services', url: 'https://www.thenewjerseymaid.com/nyc-maid-service-services-offered-by-the-nyc-maid' },
        ]),
      ]} />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-xs font-semibold text-gray-400 tracking-[0.2em] uppercase mb-3">Why New Yorkers Choose The New Jersey Maid</h2>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <a href="sms:9733708800" className="inline-block text-[#1E2A4A] font-semibold py-3.5 hover:underline underline-offset-4">
                Text us for questions
              </a>
            </div>
          </div>
