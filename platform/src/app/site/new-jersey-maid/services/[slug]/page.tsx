...
import { SERVICES, getServiceByUrlSlug } from '@/app/site/new-jersey-maid/_lib/seo/services'
...
import { serviceContent, serviceFAQs, getServiceRichContent, commonServiceFAQs } from '@/app/site/new-jersey-maid/_lib/seo/content'
import { servicePageSchemas, faqSchema } from '@/app/site/new-jersey-maid/_lib/seo/schema'
    ...
    <>
      ...
      <section className="bg-white">
        <figure className="relative aspect-[21/9] w-full overflow-hidden max-h-[520px]">
          ...
          />
          <figcaption className="sr-only">{servicePhoto.caption} — {service.name} by The New Jersey Maid</figcaption>
        </figure>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-2 lg:sticky lg:top-28">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-3">
                  ...
                  <a href="sms:9733708800" className="bg-[#1E2A4A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                    Text 973.370.8800
                  </a>
                </div>
              </div>
