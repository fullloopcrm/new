...
import { breadcrumbSchema } from '@/app/site/new-jersey-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: 'Terms & Conditions | The New Jersey Maid',
  description: 'Terms & conditions for The New Jersey Maid — cancellation policy, payment terms, scheduling & service agreement. Cleaning from $59/hr. (973) 370-8800',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/terms-conditions' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Terms & Conditions', url: 'https://www.thenewjerseymaid.com/terms-conditions' },
      ])} />
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-200/60 mt-3">Service agreement for The New Jersey Maid</p>
        </div>
      </section>
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              By booking a cleaning service with The New Jersey Maid, you agree to the following terms and conditions. We reserve the right to update these terms at any time. Continued use of our services constitutes acceptance of any changes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                'The New Jersey Maid carries full general liability insurance and bonding.',
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about these terms? Contact us at <a href="mailto:hi@thenewjerseymaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thenewjerseymaid.com</a> or text <a href="sms:9733708800" className="text-[#1E2A4A] underline underline-offset-2">(973) 370-8800</a>.
            </p>
            <p className="text-gray-500 text-sm mt-4">
