  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <Breadcrumbs items={[{ name: 'Services', href: '/new-jersey-maid-service-services-offered-by-the-new-jersey-maid' }]} />
      </div>
      ...
      <section className="py-20 bg-[#A8F0DC]">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <Link href="/updated-new-jersey-maid-service-industry-pricing" className="inline-block bg-[#1E2A4A] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
