...
import { localBusinessSchema, breadcrumbSchema } from '@/app/site/new-jersey-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: 'Leave a Review | The New Jersey Maid',
  description: 'Share your experience with The New Jersey Maid. Your honest feedback helps other New Yorkers find trusted, reliable cleaning services.',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/reviews/submit' },
  openGraph: {
    title: 'Leave a Review | The New Jersey Maid',
    description: 'Share your experience with The New Jersey Maid cleaning service.',
    url: 'https://www.thenewjerseymaid.com/reviews/submit',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Leave a Review', url: 'https://www.thenewjerseymaid.com/reviews/submit' },
        ]),
      ]} />
