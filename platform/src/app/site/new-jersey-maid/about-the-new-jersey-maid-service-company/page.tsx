...
import { getNeighborhoodsByArea, ALL_NEIGHBORHOODS } from '@/app/site/new-jersey-maid/_lib/seo/locations'
...
const url = 'https://www.thenewjerseymaid.com/about-the-new-jersey-maid-service-company'
const title = 'About The New Jersey Maid | Affordable, Reliable New Jersey Cleaning Since 2018'
const description = 'The New Jersey Maid is New Jersey\'s most trusted cleaning service — affordable rates from $59/hr, reliable background-checked cleaners, and consistent quality since 2018. Serving 150+ neighborhoods. 5.0★ Rated. (973) 370-8800'
  ...
  return (
    <>
      <JsonLd data={[
        organizationSchema(),
        webSiteSchema(),
        webPageSchema({ url, name: title, description, type: 'AboutPage', breadcrumb: [{ name: 'Home', url: 'https://www.thenewjerseymaid.com' }, { name: 'About', url }] }),
        localBusinessSchema(),
        howToBookSchema(),
        breadcrumbSchema([{ name: 'Home', url: 'https://www.thenewjerseymaid.com' }, { name: 'About', url }]),
        faqSchema(aboutFaqs),
      ]} />
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs items={[{ name: 'About', href: '/about-the-new-jersey-maid-service-company' }]} />
      </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Truly Affordable', detail: 'Our rates start at $59/hr — well below the New Jersey average for licensed, insured cleaning. No surge pricing, no hidden fees, no travel charges. New Jersey to Long Island, same rate.' },
      ...
      <section className="py-16 bg-gradient-to-b from-[#1E2A4A] to-[#243352]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-white tracking-wide text-center mb-4">The New Jersey Maid Difference</p>
      ...
      <section className="py-12 bg-[#A8F0DC]">
        <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-start gap-6">
          ...
          <div>
            ...
            <Link href="/available-new-jersey-maid-jobs" className="inline-block mt-3 text-[#1E2A4A] font-semibold text-sm underline underline-offset-4">See open positions &rarr;</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#1E2A4A] tracking-wide text-center mb-12">About The New Jersey Maid</p>
