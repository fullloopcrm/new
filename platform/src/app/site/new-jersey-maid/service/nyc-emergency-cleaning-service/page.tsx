...
export const metadata: Metadata = {
  title: 'Emergency Cleaning Service NYC — 24/7 Response | The New Jersey Maid',
  description: 'NYC emergency cleaning — water damage, fire, sewage, biohazard & mold. 24/7 rapid response with pro equipment. What to do, what not to do. Text (973) 370-8800.',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/service/nyc-emergency-cleaning-service' },
  openGraph: {
    title: 'Emergency Cleaning Service NYC | The New Jersey Maid',
    description: 'Rapid-response emergency cleaning across NYC. Water damage, fire, biohazard & more. Available 24/7.',
    url: 'https://www.thenewjerseymaid.com/service/nyc-emergency-cleaning-service',
  },
}
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Emergency Cleaning', url: 'https://www.thenewjerseymaid.com/service/nyc-emergency-cleaning-service' },
        ]),
        faqSchema,
        serviceSchema,
        howToSchema,
