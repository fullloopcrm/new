...
function ReferralSignupFormContent() {
  ...
  const copyLink = () => {
    navigator.clipboard.writeText(`https://www.thenewjerseymaid.com/book/new?ref=${refCode}`)
    alert('Link copied!')
  }
  ...
  if (success) {
    return (
      <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
        ...
        <p className="text-gray-600">Welcome to The New Jersey Maid referral program.</p>
        <p className="text-gray-400 italic mb-6">Bienvenido al programa de referidos de The New Jersey Maid.</p>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm font-mono text-gray-700 break-all mb-3">https://www.thenewjerseymaid.com/book/new?ref={refCode}</p>
          <button
            onClick={copyLink}
