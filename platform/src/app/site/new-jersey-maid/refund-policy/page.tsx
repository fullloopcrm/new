...
export const metadata: Metadata = {
  title: 'Refund Policy | The New Jersey Maid',
  description: 'The New Jersey Maid refund policy — no money upfront, pay only after cleaning is complete. No deposits. Service from $59/hr. (973) 370-8800',
  alternates: { canonical: 'https://www.thenewjerseymaid.com/refund-policy' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Refund Policy', url: 'https://www.thenewjerseymaid.com/refund-policy' },
      ])} />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions? Contact us at <a href="mailto:hi@thenewjerseymaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thenewjerseymaid.com</a> or text <a href="sms:9733708800" className="text-[#1E2A4A] underline underline-offset-2">(973) 370-8800</a>.
            </p>
            <p className="text-gray-500 text-sm mt-4">
