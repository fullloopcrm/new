...
const reviews = [
  ...
  },
  {
    ...
    snippet:
      "We interviewed six agencies before choosing Consortium NYC. Nobody else came close to their level of strategic thinking. They don't just execute — they think like business owners. Revenue is up 140% year over year and we've cut our ad spend by 30%.",
  ...
  },
  {
    ...
    badge: "Best of NYC",
    snippet:
      "After getting burned by two other agencies, we were skeptical. Consortium NYC proved us wrong in the first month. Transparent reporting, real results, and a team that actually picks up the phone. They treat our business like it's their own.",
