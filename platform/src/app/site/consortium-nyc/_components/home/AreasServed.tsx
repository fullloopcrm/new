...
import { areas } from "@/app/site/consortium-nyc/_lib/siteData";

const TriStateMap = dynamic(() => import("@/app/site/consortium-nyc/services-areas-we-offer-marketing-services-in/TriStateMap"), {
  ssr: false,
  loading: () => (
