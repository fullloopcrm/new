...
export default function ReferrerPortalPage() {
  useEffect(() => { document.title = 'Referral Program | Consortium NYC' }, [])
  ...
  const copyLink = () => { if (referrer) { navigator.clipboard.writeText('https://www.consortiumnyc.com/contact?ref=' + referrer.ref_code); alert('Copied!') } }
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-[#0f766e] text-white py-4 px-6">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          <div><h1 className="text-xl font-bold">Consortium NYC</h1><p className="text-gray-400 text-sm">Referral Portal</p></div>
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="flex gap-3">
            <input type="text" value={'https://www.consortiumnyc.com/contact?ref=' + referrer?.ref_code} readOnly className="flex-1 px-4 py-2 bg-gray-50 border rounded-lg text-gray-600 text-sm" />
        ...
        <div className="mt-8 text-center text-sm text-gray-500"><p>Questions? hello@consortiumnyc.com</p></div>
      </main>
    </div>
  )
}
