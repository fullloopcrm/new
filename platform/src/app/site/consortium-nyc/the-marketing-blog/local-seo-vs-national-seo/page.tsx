...
import BlogNav from "@/app/site/consortium-nyc/_components/blog/BlogNav";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [{ url: "https://www.consortiumnyc.com/og-consortium.jpg", width: 1200, height: 630, alt: title }],
  },
  twitter: {
    card: "summary_large_image",
    title,
    description,
    images: ["https://www.consortiumnyc.com/og-consortium.jpg"],
  },
};
