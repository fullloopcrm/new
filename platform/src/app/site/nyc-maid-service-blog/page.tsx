...
export const metadata: Metadata = {
  ...
  description: 'The NYC Maid blog — cleaning tips, guides & news for NYC residents. Apartment care, eco-friendly products & pro advice. Service from $59/hr. (212) 202-9030',
