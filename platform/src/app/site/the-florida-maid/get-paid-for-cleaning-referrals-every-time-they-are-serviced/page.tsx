...
import { breadcrumbSchema, localBusinessSchema, faqSchema } from '@/app/site/the-florida-maid/_lib/seo/schema'
...
import ReferralFAQSection from '@/app/site/the-florida-maid/_components/marketing/ReferralFAQSection'
import ReferralCTABlock from '@/app/site/the-florida-maid/_components/marketing/ReferralCTABlock'
import ReferralPageBody from '@/app/site/the-florida-maid/_components/marketing/ReferralPageBody'

export const metadata: Metadata = {
  title: 'Get Paid for Cleaning Referrals | Earn 10% Commission | The Florida Maid',
  description: 'Earn 10% commission every time your referral books a cleaning (from $49/hr). Recurring income, fast payouts via Zelle or Apple Cash. 25,000+ homes served. (954) 710-3636',
    ...
    <>
      <JsonLd data={[
        ...
        breadcrumbSchema([
          ...
          { name: 'Referral Program', url: 'https://www.thefloridamaid.com/get-paid-for-cleaning-referrals-every-time-they-are-serviced' },
        ]),
