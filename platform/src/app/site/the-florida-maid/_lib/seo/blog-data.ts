...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    category: 'Pricing',
    readTime: '5 min',
    metaDescription: 'Florida house cleaning costs $49–$89/hr in 2026. Honest pricing breakdown by home size, service type & frequency. Call The Florida Maid (954) 710-3636.',
    sections: [
      ...
      { heading: 'The Short Answer', paragraphs: ['Most professional cleaning in Florida runs between $49 and $89 per hour, depending on the service and who\'s doing it. A standard <a href="/services/house-cleaning-service-in-florida">house cleaning</a> for a 2-bedroom home typically takes 2–3 hours. So you\'re looking at roughly $89–$250 for a basic clean.', '<a href="/services/deep-cleaning-service-in-florida">Deep cleaning</a> costs more — usually 1.5x to 2x the standard rate — because it includes things like inside the oven, behind the fridge, scrubbing grout, and all those spots you pretend don\'t exist.'] },
