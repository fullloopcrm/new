...
export const SERVICES: Service[] = [
  {
    slug: 'deep-cleaning',
    urlSlug: 'deep-cleaning-service-in-florida',
    name: 'Deep Cleaning',
  ...
  },
  {
    ...
    urlSlug: 'house-cleaning-service-in-florida',
  ...
  },
  {
    ...
    urlSlug: 'weekly-maid-service-in-florida',
  ...
  },
  {
    ...
    urlSlug: 'bi-weekly-cleaning-service-in-florida',
    ...
    idealFor: ['Budget-conscious homeowners', 'Couples', 'Small homes and condos', 'Light-use homes'],
    priceRange: '$120–$260',
    duration: '2.5–4 hours',
  },
  {
    slug: 'monthly-cleaning',
    urlSlug: 'monthly-cleaning-service-in-florida',
  ...
  },
  {
    ...
    urlSlug: 'move-in-move-out-cleaning-service-in-florida',
    ...
    idealFor: ['Moving into a new home', 'Moving out (deposit recovery)', 'Lease turnovers', 'Real estate showings'],
    priceRange: '$260–$520',
    duration: '3–5 hours',
  },
  {
    slug: 'post-renovation-cleaning',
    urlSlug: 'post-construction-cleanup-service-in-florida',
    ...
    idealFor: ['After kitchen remodel', 'Bathroom renovation', 'Full home renovation', 'New construction move-in'],
    priceRange: '$325–$590',
    duration: '3–5 hours',
  },
  {
    slug: 'same-day-cleaning',
    urlSlug: 'same-day-cleaning-service-in-florida',
  ...
  },
  {
    ...
    urlSlug: 'airbnb-cleaning-in-florida',
  ...
  },
  {
    ...
    urlSlug: 'office-cleaning-service-in-florida',
