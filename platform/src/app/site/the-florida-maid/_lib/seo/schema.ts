...
const BUSINESS = {
  ...
  image: 'https://www.thefloridamaid.com/sites/the-florida-maid/icon-512.png',
  priceRange: '$$',
  ratingValue: '5.0',
  ratingCount: '25000',
  reviewCount: '25000',
...
export function siteNavigationSchema() {
  return {
    ...
    hasPart: [
      ...
      { '@type': 'WebPage', name: 'FAQ', url: `${BUSINESS.url}/florida-cleaning-service-frequently-asked-questions-in-2026`, position: 8 },
