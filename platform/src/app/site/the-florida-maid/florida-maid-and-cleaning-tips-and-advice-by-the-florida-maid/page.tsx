...
const categories = [
  ...
  { id: 'florida', name: 'Florida-Specific', icon: '🏙️' },
...
export const metadata: Metadata = {
  ...
  description: 'The definitive list — 100 expert cleaning tips for Florida homes from professional cleaners. Kitchen, bathroom, floors, pets & more. Over 25,000 homes served. From $49/hr. (954) 710-3636',
...
export default function TipsPage() {
  ...
  const howToSchema = {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: '100 Cleaning Tips for Florida Homes',
    description: 'The definitive guide to keeping your Florida home clean — 100 expert tips organized by room and category.',
