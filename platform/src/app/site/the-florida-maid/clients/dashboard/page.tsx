...
export default function ClientDashboardPage() {
  ...
  const formatPickedDate = (dateStr: string) => {
    ...
    return new Date(y, m - 1, d).toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' , timeZone: 'UTC' })
  }
              ...
              <>
                ...
                <div className="bg-[#A8F0DC]/20 border border-[#A8F0DC]/30 rounded-lg p-3 mb-4 text-sm">
                  ...
                  <div className="flex gap-3 mt-2">
                    <a href="tel:9547103636" className="flex-1 py-2 bg-[#1E2A4A] text-white rounded-lg text-center font-medium text-sm hover:bg-[#1E2A4A]/90">Call (954) 710-3636</a>
                    <a href="sms:9547103636" className="flex-1 py-2 bg-[#1E2A4A] text-white rounded-lg text-center font-medium text-sm hover:bg-[#1E2A4A]/90">Text (954) 710-3636</a>
                  </div>
                </div>
                ...
                {bookingDate && isSameDay(bookingDate) && (
                  <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4 mb-4">
                    ...
                    <div className="flex gap-3 mt-3">
                      <a href="tel:9547103636" className="flex-1 py-2 bg-yellow-600 text-white rounded-lg text-center font-medium text-sm">Call (954) 710-3636</a>
                      <a href="sms:9547103636" className="flex-1 py-2 bg-yellow-600 text-white rounded-lg text-center font-medium text-sm">Text (954) 710-3636</a>
                    </div>
                  </div>
                )}
                ...
                {isExpanded && (
                  <div className="px-4 pb-4 border-t border-gray-100">
                    ...
                    <div className="border-t border-gray-100 pt-3 mb-3">
                      ...
                      <BookingNotes bookingId={booking.id} mode="client" authorName={clientName} clientId={clientId} />
                    </div>
