...
export const metadata: Metadata = {
  ...
  description:
    'Join The Florida Maid — Florida\'s highest-paying cleaning jobs starting at $25/hr with same-day pay. Apply now for full-time or part-time house cleaning work in Florida. Solicite ahora — los trabajos de limpieza mejor pagados en Florida.',
  ...
  openGraph: {
    ...
    description:
      'Florida\'s best cleaning opportunities. $25/hr+, same-day pay, flexible hours. Apply in 2 minutes.',
