...
export const metadata: Metadata = {
  title: 'Do Not Share Policy | The Florida Maid',
  description: 'The Florida Maid does not sell, share, or distribute your personal information. Your data stays with us. Florida cleaning from $49/hr. (954) 710-3636',
  alternates: { canonical: 'https://www.thefloridamaid.com/do-not-share-policy' },
}
  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Do Not Share Policy', url: 'https://www.thefloridamaid.com/do-not-share-policy' },
      ])} />
      ...
      <section className="bg-gradient-to-b from-[#CC6222] to-[#CC6222] py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-white mt-3">We don&apos;t share it — because we never have</p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#CC6222] tracking-wide mb-4">Our Position Is Simple</h2>
            <div className="bg-[#F5FBF8] border border-[#34D399]/30 rounded-xl p-6">
              <p className="text-gray-600 leading-relaxed mb-3">
                <strong className="text-[#CC6222]">We do not sell, trade, rent, or share your personal information with anyone.</strong> Not with advertisers, not with data brokers, not with marketing companies, not with any third parties of any kind.
              </p>
          ...
          <div>
            <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#CC6222] tracking-wide mb-4">What We Do Collect</h2>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <span className="text-[#CC6222]/30 mt-0.5 flex-shrink-0">&#8226;</span>
          ...
          <div>
            <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#CC6222] tracking-wide mb-4">Your Rights Under CCPA &amp; Other Privacy Laws</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <div className="bg-gray-50 rounded-xl p-5 mt-4 space-y-2">
              <p className="text-gray-600 text-sm">Email us at <a href="mailto:hi@thefloridamaid.com" className="text-[#CC6222] underline underline-offset-2">hi@thefloridamaid.com</a> with the subject &ldquo;Do Not Share&rdquo;</p>
              <p className="text-gray-600 text-sm">Or text/call <a href="tel:9547103636" className="text-[#CC6222] underline underline-offset-2">(954) 710-3636</a></p>
            </div>
          ...
          <div>
            <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#CC6222] tracking-wide mb-4">Data Deletion</h2>
            <p className="text-gray-600 leading-relaxed">
