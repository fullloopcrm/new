...
import { ALL_NEIGHBORHOODS, getNeighborhoodsByArea, type Neighborhood } from '@/app/site/the-florida-maid/_lib/seo/locations'
  ...
  const jobSchema = {
    ...
    jobLocation: {
      ...
      address: {
        ...
        postalCode: n.zip_codes[0] || ('33101'),
        addressCountry: 'US',
      },
    ...
    responsibilities: `Perform professional residential cleaning in ${n.name} including regular home cleaning, deep cleaning, move-in/move-out cleaning, post-renovation cleanup, Airbnb turnovers, and office cleaning.`,
