...
import { SERVICES, getService } from '@/app/site/the-florida-maid/_lib/seo/services'
import { neighborhoodServiceContent, neighborhoodFAQs, serviceFAQs, commonServiceFAQs } from '@/app/site/the-florida-maid/_lib/seo/content'
import { neighborhoodServicePageSchemas, faqSchema } from '@/app/site/the-florida-maid/_lib/seo/schema'
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#CC6222] to-[#CC6222] pt-14 md:pt-20 pb-0">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-white text-lg max-w-3xl leading-relaxed mb-8">{content.intro}</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
            ...
            <div className="lg:col-span-3">
              ...
              <p className="font-[family-name:var(--font-bebas)] text-3xl text-[#CC6222] tracking-wide mb-6">{service.name} Checklist</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {service.features.map((f, i) => (
                  <div key={f} className="flex items-start gap-4 bg-gray-50 border border-gray-100 rounded-xl p-4">
                    <span className="font-[family-name:var(--font-bebas)] text-2xl text-[#CC6222]/30 leading-none mt-0.5">{String(i + 1).padStart(2, '0')}</span>
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="bg-gradient-to-br from-[#CC6222] to-[#CC6222] rounded-2xl p-7">
              ...
              <div className="bg-[#F5FBF8] border border-[#34D399]/30 rounded-2xl p-6 text-center">
                <div className="flex items-center justify-center gap-4 mb-3">
                  <div>
                    <p className="font-[family-name:var(--font-bebas)] text-3xl text-[#CC6222] tracking-wide leading-none">{service.priceRange}</p>
                    <p className="text-gray-400 text-xs mt-1">Typical cost</p>
                  </div>
                  <div className="w-px h-10 bg-[#34D399]/30" />
                  <div>
                    <p className="font-[family-name:var(--font-bebas)] text-3xl text-[#CC6222] tracking-wide leading-none">{service.duration}</p>
                    <p className="text-gray-400 text-xs mt-1">Duration</p>
                  </div>
                </div>
                <a href="sms:9547103636" className="inline-block bg-[#34D399] text-white px-6 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors w-full">
                  Get a Free Quote
                </a>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl text-[#CC6222] tracking-wide text-center mb-10">Who Books {service.name} in {neighborhood.name}?</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {service.idealFor.map(item => (
              <div key={item} className="bg-white border border-gray-200 rounded-xl p-5 text-center">
                <p className="text-sm font-medium text-[#CC6222]">{item}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#CC6222] tracking-wide text-center mb-4">Other Cleaning Services in {neighborhood.name}</p>
      ...
      <section className="py-20 bg-[#CC6222]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { n: '01', t: 'Text or Call', d: `Reach us at (954) 710-3636 with your ${neighborhood.name} address and tell us you need ${service.name.toLowerCase()}.` },
      ...
      {neighborhood.nearby.length > 0 && (
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#CC6222] tracking-wide text-center mb-4">{service.name} Near {neighborhood.name}</p>
