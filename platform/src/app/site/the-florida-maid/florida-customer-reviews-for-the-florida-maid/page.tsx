...
import { breadcrumbSchema, localBusinessSchema, reviewSchemas } from '@/app/site/the-florida-maid/_lib/seo/schema'
...
export const metadata: Metadata = {
  title: 'Florida Maid Service Reviews | 5.0★ Rated | 25,000+ Homes Served | The Florida Maid',
  description: '5.0★ rated across 25,000+ Florida homes. Background-checked cleaners, from $49/hr, $1M insured, no contracts. Miami, Tampa, Orlando, Fort Lauderdale & Jacksonville. (954) 710-3636',
  alternates: { canonical: 'https://www.thefloridamaid.com/florida-customer-reviews-for-the-florida-maid' },
  openGraph: {
    title: 'Florida Maid Service Reviews | 5.0★ Rated | The Florida Maid',
    description: '5.0★ rated across 25,000+ Florida homes. Professional maid service across Miami, Fort Lauderdale, West Palm Beach, Tampa & Orlando.',
...
export default function ReviewsPage() {
  return (
    <>
      ...
      <CTABlock title="Book Your Florida Cleaning Service Today" subtitle="Trusted by Floridians since 2018. Text or call to schedule your first cleaning." />
    </>
  )
}
