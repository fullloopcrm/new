...
export default function PushPrompt({ role, userId }: PushPromptProps) {
  ...
  const enablePush = async () => {
    ...
    try {
      ...
      const reg = await navigator.serviceWorker.register('/sites/the-florida-maid/sw.js')
  ...
  const disablePush = async () => {
    setPushLoading(true)
    try {
      const reg = await navigator.serviceWorker.getRegistration('/sites/the-florida-maid/sw.js')
      if (reg) {
