        ...
        <div className="bg-[#1E2A4A] text-gray-300 text-xs">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center lg:justify-between h-9">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <a href="/clients" target="_blank" rel="noopener noreferrer" className="text-[#A8F0DC] font-semibold tracking-widest uppercase text-[10px] hover:text-white transition-colors">Client Login</a>
              <span className="text-white/30">|</span>
          ...
          <div className="overflow-y-auto h-[calc(100%-72px)] px-5 py-6">
            <div className="space-y-1">
              ...
              <div className="border-t border-white/10 mt-4 pt-4 space-y-1">
                <Link href="/clients" onClick={closeMenu} className="block py-3 text-[#A8F0DC] font-medium">Client Login</Link>
