...
export const metadata: Metadata = {
  ...
  description: 'Earn 10% commission every time your referral books a cleaning (from $59/hr). Recurring income, fast payouts via Zelle or Apple Cash. (212) 202-9030',
