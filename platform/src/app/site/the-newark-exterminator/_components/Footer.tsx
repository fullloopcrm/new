...
import { PHONE, SITE_NAME, EMAIL, ADDRESS } from "@/app/site/the-newark-exterminator/_lib/seo";
import { getCategories, getRegions } from "@/app/site/the-newark-exterminator/_lib/data";
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <span className="text-xl font-bold text-white">
              The<span className="text-green-500">Newark</span>Exterminator
            </span>
            <p className="mt-3 text-sm leading-6 text-zinc-500">
              Professional pest control and extermination services across Newark,
        ...
        <div className="mt-8 border-t border-white/[0.06] pt-8 text-center text-sm text-zinc-600">
          <p>
            ...
            Licensed pest control serving Newark, NJ, Long Island &amp; Westchester.
          </p>
