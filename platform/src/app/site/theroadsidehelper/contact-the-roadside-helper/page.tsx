...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      formType: "general-inquiry" as const,
    ...
    <>
      <section className="relative overflow-hidden bg-slate-900 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-amber-300 font-cta">Get in Touch</p>
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl font-heading">
            Contact <span className="text-amber-300">The Roadside Helper</span> — 24/7 at (888) 944-3001
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            Questions, fleet inquiries, partnerships, feedback. For a roadside call right now, use the <Link href="/book-roadside-help-now" className="underline text-white hover:text-amber-200">booking page</Link> or call <a href={PHONE_HREF} className="underline text-amber-200">{PHONE}</a>.
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="mt-8 rounded-xl border-2 border-accent/30 bg-accent/5 p-5">
                  ...
                  <Link href="/book-roadside-help-now" className="mt-3 inline-block rounded-lg bg-accent px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-accent-dark font-cta">
                    Go to Booking Page →
                  </Link>
                </div>
              </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">Head to our booking page to schedule your roadside assistance pickup.</p>
