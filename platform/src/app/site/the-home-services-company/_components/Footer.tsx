    ...
    <footer className="bg-slate-900 text-white">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-xl font-bold tracking-widest font-heading mb-4">
              HOME<span className="text-teal-200">SERVICES</span>
            </h3>
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              40 home services under one roof. Starting at $99/hour, licensed and insured, same-day availability. One phone number for every home service need — across 990 cities in all 50 states.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/book" className="text-teal-400 hover:text-teal-300 font-semibold transition-colors font-cta">Book Now</Link></li>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>&copy; {new Date().getFullYear()} Home Services Co. All rights reserved.</p>
