...
function ReferralSignupContent() {
  useEffect(() => { document.title = 'Become a Referrer | Home Services Co' }, []);
  ...
  const copyLink = () => {
    navigator.clipboard.writeText(`https://www.thehomeservicescompany.com/book?ref=${refCode}`)
    alert('Link copied!')
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">Welcome to the Home Services Co referral program</p>
          ...
          <div className="bg-[#f0fdf4] rounded-lg p-4 mb-6">
            ...
            <p className="text-sm font-mono text-[#2d6a4f] break-all">https://www.thehomeservicescompany.com/book?ref={refCode}</p>
            <button
              onClick={copyLink}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <form onSubmit={handleSubmit} onFocusCapture={trackStart} className="space-y-4">
            ...
            <div style={{ margin: '20px 0', padding: '15px', border: '1px solid #ddd', borderRadius: '8px', background: '#fafafa' }}>
              <label style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', cursor: 'pointer', fontSize: '13px', lineHeight: '1.5', color: '#555' }}>
                ...
                <span>By checking this box, I consent to receive transactional text messages from <strong>Home Services Co</strong> for appointment confirmations, reminders, and customer support. Reply STOP to opt out. Reply HELP for help. Msg frequency may vary. Msg &amp; data rates may apply.</span>
              </label>
            </div>
      ...
      <div className="text-center py-8 text-sm text-gray-500">
        <p>Questions? Email us at hello@thehomeservicescompany.com</p>
      </div>
    </div>
  )
}
