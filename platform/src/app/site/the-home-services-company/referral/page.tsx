...
export default function ReferrerPortalPage() {
  useEffect(() => { document.title = 'Referral Program | Home Services Co' }, [])
  ...
  const copyLink = () => { if (referrer) { navigator.clipboard.writeText('https://www.thehomeservicescompany.com/book?ref=' + referrer.ref_code); alert('Copied!') } }
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-[#2d6a4f] text-white py-4 px-6">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          <div><h1 className="text-xl font-bold">Home Services Co</h1><p className="text-gray-400 text-sm">Referral Portal</p></div>
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="flex gap-3">
            <input type="text" value={'https://www.thehomeservicescompany.com/book?ref=' + referrer?.ref_code} readOnly className="flex-1 px-4 py-2 bg-gray-50 border rounded-lg text-gray-600 text-sm" />
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-[#f0fdf4] rounded-lg p-4 text-center"><p className="text-sm text-gray-500">This Week</p><p className="text-2xl font-bold text-[#2d6a4f]">{linkStats.thisWeek}</p></div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500"><p>Questions? hello@thehomeservicescompany.com</p></div>
      </main>
    </div>
  )
}
