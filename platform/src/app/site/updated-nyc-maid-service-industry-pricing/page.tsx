...
const description = 'Transparent hourly cleaning rates across NYC, Brooklyn, Queens, Long Island & NJ. $59/hr your supplies, $75/hr we bring everything, $100/hr same-day. No hidden fees. 5.0★ Rated. (212) 202-9030'
...
const pricingFaqs = [
  ...
  { question: 'What payment methods do you accept?', answer: 'Cash, Venmo, Zelle (hi@thenycmaid.com), and credit card (via Stripe). Payment is collected 30 minutes before the cleaner finishes. No deposits, no pre-authorization holds.' },
  ...
  { question: 'Do you offer free estimates?', answer: 'Yes. Text (212) 202-9030 with your address, home size, and service type and we\'ll provide a custom quote within minutes. No obligation, no pressure.' },
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] pt-14 md:pt-20 pb-0">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-10">
            <a href="tel:2122029030" className="inline-flex items-center gap-2 bg-[#A8F0DC] text-[#1E2A4A] px-8 py-4 rounded-lg font-bold text-base tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
              📞 Call for a Quote
            </a>
            <a href="sms:2122029030" className="inline-flex items-center gap-2 bg-white/10 border border-white/30 text-white px-8 py-4 rounded-lg font-bold text-base tracking-widest uppercase hover:bg-white/20 transition-colors">
              💬 Text (212) 202-9030
            </a>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 py-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:2122029030" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-[#A8F0DC] rounded-2xl p-7 text-center relative">
                ...
                <a href="sms:2122029030" className="block mt-6 bg-[#1E2A4A] text-white px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="tel:2122029030" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Call — emergency</a>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { n: '01', t: 'Text Us', d: 'Reach us at (212) 202-9030 with your address, home size, and what type of cleaning you need.' },
