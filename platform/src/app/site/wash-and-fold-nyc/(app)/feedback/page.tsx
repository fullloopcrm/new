            ...
            {!anonymous && phone.trim() && (
              <div className="mt-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                <label className="flex items-start gap-3 cursor-pointer text-[13px] leading-relaxed text-gray-600">
                  ...
                  />
                  <span>
                    By checking this box, I consent to receive transactional text messages from <strong>The NYC Wash and Fold Service Company</strong> for follow-up on this feedback. Reply STOP to opt out. Reply HELP for help. Msg frequency may vary. Msg &amp; data rates may apply.{' '}
