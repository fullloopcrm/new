...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (area) {
    ...
    const description = `Professional house cleaning in ${area.name} from $59/hr. Deep cleaning, weekly maid service, move-in/out & more. Licensed, insured, 5.0★ Rated. (212) 202-9030`
    return {
  ...
  if (neighborhood) {
    ...
    const description = `Professional cleaning in ${neighborhood.name}, ${neighborhoodArea.name}. Serving ${neighborhood.housing_types.slice(0, 2).join(', ')} near ${neighborhood.landmarks[0]}. From $59/hr. 5.0★ Rated. (212) 202-9030`
    return {
      title: { absolute: title },
      description,
      alternates: { canonical: url },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-2xl p-7 shadow-xl">
                  ...
                  <a href="sms:2122029030" className="block text-center bg-[#A8F0DC] text-[#1E2A4A] px-6 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
                    Text (212) 202-9030
                  </a>
                </div>
              </div>
        ...
        <section className="py-20 bg-[#1E2A4A]">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { n: '01', t: 'Text Us', d: `Reach us at (212) 202-9030 with your ${area.name} address, preferred date, and any special requests.` },
      ...
      <>
        ...
        <section className="bg-white border-b border-gray-100 pt-14 md:pt-20 pb-0">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <a href="sms:2122029030" className="text-[#1E2A4A] font-semibold py-4 hover:underline underline-offset-4">
        ...
        <section className="py-20 bg-[#1E2A4A]">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { n: '01', t: 'Text Us', d: `Reach us at (212) 202-9030 with your ${neighborhood.name} address, preferred date, and any special requests.` },
                { n: '02', t: 'We Confirm', d: 'We match you with a background-checked, insured cleaner and lock in your appointment — usually within the hour.' },
                { n: '03', t: 'Pay After', d: 'Your cleaner arrives on time, does the work, and you pay only after the cleaning is complete. No deposits ever.' },
              ].map(s => (
                <div key={s.n} className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
