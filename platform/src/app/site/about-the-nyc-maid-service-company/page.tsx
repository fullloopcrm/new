...
const description = 'The NYC Maid is NYC\'s most trusted cleaning service — affordable rates from $59/hr, reliable background-checked cleaners, and consistent quality since 2018. Serving 150+ neighborhoods. 5.0★ Rated. (212) 202-9030'
...
const aboutFaqs = [
  { question: 'How long has The NYC Maid been in business?', answer: 'Since 2018. We started serving Manhattan and have expanded to Brooklyn, Queens, Long Island, and New Jersey. We\'ve completed thousands of cleanings and maintain a 5.0-star rating with 50+ verified reviews.' },
