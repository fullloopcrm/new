...
const process = [
  { step: '1', title: 'Text Us', description: 'Text (212) 202-9030 and describe the situation. We\'ll ask what happened, when it happened, and the scope of damage. Be honest about severity — it helps us send the right team with the right equipment.' },
...
export const metadata: Metadata = {
  ...
  description: 'NYC emergency cleaning — water damage, fire, sewage, biohazard & mold. 24/7 rapid response with pro equipment. What to do, what not to do. Text (212) 202-9030.',
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="sms:2122029030" className="bg-red-600 text-white px-10 py-4 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-red-700 transition-colors">
              Text Now — (212) 202-9030
            </a>
            <a href="sms:2122029030" className="text-white font-semibold text-lg hover:underline underline-offset-4">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="bg-red-600 rounded-xl p-8 md:p-10 mb-20 text-center">
          ...
          <a href="sms:2122029030" className="inline-block bg-white text-red-600 px-10 py-4 rounded-lg font-bold text-lg hover:bg-red-50 transition-colors">
            Text (212) 202-9030
          </a>
        </div>
