...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Contact NYC Exterminator | Call, Text, or Book Pest Control Today",
    description:
      "Contact NYC Commercial Exterminator. Call or text 212-202-8545. $249/hr (fully inclusive — save money). The only NYC pest control service that bills fully inclusive hourly. Pay on completion.",
...
export default function ContactPage() {
  ...
  const contactFaqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How quickly does NYC Commercial Exterminator respond to contact requests?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Have the following ready: the type of pest you've seen (or describe what it looks like), your property type (restaurant, office, retail, warehouse, hotel, healthcare, property mgmt), your address, when you first noticed the problem, and how severe it appears. Photos are extremely helpful.",
        },
      },
      {
        "@type": "Question",
        name: "Does NYC Commercial Exterminator offer free pest control inspections?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "What areas does NYC Commercial Exterminator serve?",
        acceptedAnswer: {
          "@type": "Answer",
    ...
    <div className="text-white">
      ...
      <section className="bg-green-700 pb-20 pt-8">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-green-100">
            ...
            No call centers, no runaround. When you contact NYC Commercial Exterminator,
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-green-100">
            ...
            is no reason to wait another night with unwanted guests at your facility
            or business.
          </p>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-green-100">
            We serve restaurants, offices, retail, warehouses, hotels, healthcare facilities,
            multi-tenant commercial buildings, and every other type of commercial property in
            NYC, New Jersey, Long Island, and
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            the ways you can get in touch with NYC Commercial Exterminator, ranked by
            response speed.
          </p>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-300">
                  ...
                  for example, if you have just spotted a rat in your operation or
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            From the moment you reach out to NYC Commercial Exterminator, our process is
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-300">
                  ...
                  small office, a commercial kitchen, a multi-tenant building?
            ...
            <ul className="mt-4 space-y-3 text-zinc-300">
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  visible in occupied work areas, especially where staff, customers, or patients are present. Our{" "}
      ...
      <section className="bg-[#0A0A0A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            ...
            clients ask most often about contacting NYC Commercial Exterminator and
            scheduling service.
          </p>
          ...
          <div className="mt-12 space-y-8">
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                description of what it looks like), your property type (restaurant, office, retail,
                warehouse, hotel, healthcare facility), your address and neighborhood, when you
                first noticed the problem, how many rooms or areas are affected, and
                whether staff, customers, or patients are regularly present in the affected area. Photos are
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#141414] p-6">
              ...
              <p className="mt-3 text-zinc-300">
                ...
                we specialize in exactly that. Property managers and building owners should
                ...
                We work with commercial property management firms, office portfolios, and
                retail landlords across all five boroughs. Building-wide pest control contracts include
      ...
      <section className="bg-[#2A2A2A] py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-zinc-300">
            NYC Commercial Exterminator provides professional pest control and exterminator
