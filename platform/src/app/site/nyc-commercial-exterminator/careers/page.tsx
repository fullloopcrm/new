...
import { getAllNeighborhoods, getNeighborhoodsByRegion } from "@/app/site/nyc-commercial-exterminator/_lib/data";
import { PHONE, SITE_URL, SITE_NAME, EMAIL } from "@/app/site/nyc-commercial-exterminator/_lib/seo";
import { getBreadcrumbSchema } from "@/app/site/nyc-commercial-exterminator/_lib/seo";
import CareersCTA from "@/app/site/nyc-commercial-exterminator/_components/CareersCTA";
import JobApplicationForm from "@/app/site/nyc-commercial-exterminator/_components/JobApplicationForm";
...
const positions = [
  ...
  },
  {
    ...
    description:
      "Pest Control Technicians are the backbone of NYC Commercial Exterminator's field operations. In this role, you will perform commercial pest control treatments across NYC, Brooklyn, Queens, the Bronx, Staten Island, New Jersey, Long Island, and Westchester County. Your daily work includes conducting pest inspections, applying EPA-approved treatments for cockroaches, bed bugs, mice, rats, ants, termites, spiders, and other common NYC pests, documenting findings and treatment details, and communicating with customers about prevention strategies. You will be trained in the latest extermination techniques, Integrated Pest Management methods, and safety protocols to deliver lasting results for our commercial pest control customers. This is an outstanding opportunity for someone who wants to build a long-term career in the pest control and extermination industry with one of NYC's fastest-growing pest control companies.",
    requirements: [
      ...
      "Comfortable working in NYC commercial buildings, commercial kitchens, basements, crawl spaces, and rooftops",
  ...
  },
  {
    ...
    description:
      "Our Wildlife Control Specialists handle the unique challenges of urban wildlife management in New York City and the surrounding metro area. You will specialize in the humane removal, exclusion, and prevention of raccoons, squirrels, opossums, birds, bats, groundhogs, and other wildlife species that invade commercial properties throughout our service territory. This pest control career requires deep expertise in animal behavior, structural exclusion techniques, habitat modification, one-way door installation, and full compliance with NYS DEC wildlife regulations. You will also coordinate with our pest control technicians on projects that involve both wildlife and traditional pest issues, such as properties dealing with both raccoons and rodent infestations simultaneously. Wildlife Control Specialists at NYC Commercial Exterminator gain exposure to an extraordinary variety of wildlife scenarios unique to the New York City urban environment.",
    requirements: [
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-zinc-700 bg-zinc-800/50 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-400">
                ...
                Manhattan restaurant kitchens to Queens warehouses to Bronx multi-tenant
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            ...
            <p>
              ...
              span the full spectrum of commercial
              extermination, from single-unit cockroach treatments and studio
              hospitality bed bug heat remediation to building-wide pest
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-zinc-400">
              Fill out the form below to apply for a pest control position with NYC Commercial Exterminator.
