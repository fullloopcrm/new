...
import { getJobDates } from "@/app/site/nyc-commercial-exterminator/_lib/jobDates";
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-4xl">
            ...
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              ...
              for an exterminator to work in. The mix of mixed-use buildings,
              ...
              day. From restaurant cockroach infestations and commercial bed bug
              treatments in hotels to rodent exclusion work for{" "}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            <p>
              ...
              compelling mix of commercial pest control jobs.
            </p>
            <p>
              The pest control landscape in {neighborhood.name} includes common
              NYC pest issues like cockroach infestations in commercial buildings,
              bed bug treatments in multi-unit commercial properties, mouse and
              rat control for both commercial customers,
              ant and spider treatments for commercial properties, and wildlife
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: `Working as an exterminator in ${neighborhood.name} exposes you to commercial kitchens, office buildings, retail spaces, hotels, warehouses, and more. This variety builds a comprehensive pest control skill set that advances your career.`,
              },
              {
              ...
              },
              {
                ...
                desc: `Exterminators who excel in ${neighborhood.name} have clear advancement opportunities to lead exterminator, field supervisor, and management roles within NYC Commercial Exterminator's ${neighborhood.region} operation.`,
              },
              {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            <p>
              ...
              bug inspection at a {neighborhood.name} hotel,
              follow that with a cockroach gel bait treatment at an office
              suite, then head to a {neighborhood.name} restaurant for a
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 max-w-4xl space-y-4 text-lg leading-8 text-zinc-300">
            ...
            <p>
              ...
              develops and its commercial property inventory
