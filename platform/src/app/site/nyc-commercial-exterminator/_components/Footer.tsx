...
import { PHONE, SITE_NAME, EMAIL, ADDRESS } from "@/app/site/nyc-commercial-exterminator/_lib/seo";
import { getCategories, getRegions } from "@/app/site/nyc-commercial-exterminator/_lib/data";
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <span className="text-xl font-bold text-white">
              <span className="text-green-500">NYC</span>CommercialExterminator
            </span>
            <p className="mt-3 text-sm leading-6 text-zinc-500">
              NYC's commercial-only pest control & exterminator. Restaurants,
              offices, retail, warehouses, hotels, healthcare & property
              management. DOH-compliant treatment, all labor + products in
              the rate. Licensed & insured. Serving NYC, NJ, Long Island &amp;
              Westchester.
            </p>
        ...
        <div className="mt-10 border-t border-white/[0.06] pt-8 text-center text-sm text-zinc-600">
          <p>
            ...
            Licensed commercial pest control & extermination serving NYC, NJ, Long Island &amp; Westchester.
          </p>
