      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          ...
          <select id="propertyType" name="propertyType" required className={selectClass}>
            ...
            <option value="restaurant">Restaurant / Bar / Food Service</option>
            <option value="office">Office / Corporate / Coworking</option>
            <option value="retail">Retail / Storefront / Supermarket</option>
            <option value="warehouse">Warehouse / Industrial</option>
            <option value="hotel">Hotel / Hospitality</option>
            <option value="healthcare">Healthcare / Medical / Dental</option>
            <option value="property-mgmt">Property Mgmt / Multi-tenant Building</option>
            <option value="gym-salon">Gym / Salon / Studio</option>
