...
import { track as localTrack, getSessionId } from "@/app/site/nyc-commercial-exterminator/_lib/tracker";
...
export default function JobApplicationForm({
  ...
  const inputClass =
    "mt-1 block w-full rounded-lg border border-zinc-600 bg-zinc-800 px-3 py-2.5 text-sm text-white shadow-sm placeholder:text-zinc-400 focus:border-green-500 focus:ring-1 focus:ring-green-500";
  const selectClass =
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Your pest control experience, certifications, what kind of role you're looking for, and why you want to join NYC Commercial Exterminator..."
        />
      </div>
