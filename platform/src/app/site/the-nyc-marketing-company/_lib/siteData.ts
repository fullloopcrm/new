...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    metaDescription: "Data-driven SEO for NYC businesses across every borough, Long Island & Westchester. Technical SEO, local search, content strategy, link building — 25 years of results. Consortium NYC (Now The NYC Marketing Company). From $950/mo. No contracts. Call (212) 202-9220.",
    icon: "search",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Custom Next.js websites for NYC businesses — built for speed, SEO, and conversion. No WordPress, no templates, no lock-in. You own everything. Consortium NYC (Now The NYC Marketing Company). Starting at $4,600. Call (212) 202-9220.",
    icon: "layout",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Strategic brand identity for NYC businesses — logo design, visual identity systems, brand voice, style guides, and rebranding. Stand out in the most competitive market in the country. Consortium NYC (Now The NYC Marketing Company). From $2,500. Call (212) 202-9220.",
    icon: "palette",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Strategic content marketing for NYC businesses — blog writing, SEO content, content calendars, and thought leadership that drives organic traffic and builds authority. Consortium NYC (Now The NYC Marketing Company). Call (212) 202-9220.",
    icon: "pen",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Full-service social media marketing for NYC businesses — content creation, community management, paid social advertising, influencer partnerships, and real measurable results. Consortium NYC (Now The NYC Marketing Company). From $750/mo. Call (212) 202-9220.",
    icon: "share",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Precision-targeted Google Ads and digital advertising for NYC businesses. No wasted spend — every dollar tracked, optimized, and accountable to your bottom line. Consortium NYC (Now The NYC Marketing Company). From $500/mo + ad spend. Call (212) 202-9220.",
    icon: "megaphone",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Email marketing and automation for NYC businesses — welcome sequences, drip campaigns, segmentation, list management, and monthly campaigns that drive repeat revenue. Consortium NYC (Now The NYC Marketing Company). Call (212) 202-9220.",
    icon: "mail",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Online reputation management and PR for NYC businesses — review generation, media outreach, press releases, crisis communication, and brand sentiment monitoring. Consortium NYC (Now The NYC Marketing Company). Call (212) 202-9220.",
    icon: "shield",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Marketing analytics and technology consulting for NYC businesses — GA4 setup, conversion tracking, custom dashboards, CRM integration, lead attribution. Turn data into decisions. Consortium NYC (Now The NYC Marketing Company). Call (212) 202-9220.",
    icon: "chart",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Hands-on business strategy and growth consulting for NYC companies ready to scale — market research, competitive analysis, revenue roadmaps, SWOT, and expansion planning. Consortium NYC (Now The NYC Marketing Company). Call (212) 202-9220.",
    icon: "briefcase",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Fractional CMO and outsourced marketing management for NYC businesses — strategy, execution, vendor coordination, and monthly reporting. No $75K hire. Consortium NYC (Now The NYC Marketing Company). From $1,500/mo. Call (212) 202-9220.",
    icon: "user",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Custom AI automation for NYC businesses — SMS chatbots, 24/7 lead follow-up, appointment booking, review requests. Built on Telnyx, Supabase & Claude AI. Not a plugin. Consortium NYC (Now The NYC Marketing Company). From $1,000/mo. Call (212) 202-9220.",
    icon: "cpu",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Programmatic SEO for NYC businesses — location pages, service pages, EMD micro sites. 2,000 page 1 rankings in 2 months. See the proof in Google Search Console. Consortium NYC (Now The NYC Marketing Company). From $5,000. Call (212) 202-9220.",
    icon: "layers",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Custom CRM platforms built from scratch for NYC businesses — lead tracking, AI bots, scheduling, review management. No monthly SaaS fees. You own the code and data. Consortium NYC (Now The NYC Marketing Company). From $25K. Call (212) 202-9220.",
    icon: "database",
    features: [
  ...
  },
  {
    ...
    metaDescription: "Google Business Profile setup, verification submission, full optimization, and ongoing management for NYC businesses. Dominate the local map pack. Consortium NYC (Now The NYC Marketing Company). Setup from $500. Call (212) 202-9220.",
    icon: "map-pin",
    features: [
...
export const testimonials = [
  ...
  },
  {
    ...
    text: "Consortium NYC (Now The NYC Marketing Company) exceeded all our expectations! Their top-tier NYC web design and SEO services transformed our online presence completely.",
    rating: 5,
  },
  {
    name: "Gabriel Gonzalez",
    business: "Queens, NY",
    text: "Jeff at Consortium NYC (Now The NYC Marketing Company) is very communicative after we spoke about my new website. He took the time to understand my vision and delivered beyond what I expected.",
    rating: 5,
  },
  {
    name: "Michael",
    business: "Hoboken, NJ",
    text: "I cannot express enough gratitude for the incredible work Jeff and the entire Consortium NYC (Now The NYC Marketing Company) team have done. Their dedication and expertise are unmatched.",
    rating: 5,
  },
  {
    name: "William Snyder",
    business: "Long Island, NY",
    text: "Consortium NYC (Now The NYC Marketing Company) has consistently impressed clients with their exceptional web design and SEO services, leading to significant business growth and online presence.",
    rating: 5,
  },
  {
    name: "Rachel M.",
    business: "Westchester, NY",
    text: "We switched to Consortium NYC (Now The NYC Marketing Company) from another agency and the difference was night and day. Our rankings improved within weeks and the leads haven't stopped since.",
    rating: 5,
  },
  {
    name: "David Chen",
  ...
  },
  {
    ...
    business: "Bronx, NY",
    text: "Consortium NYC (Now The NYC Marketing Company) understood our business from day one. The branding and website they created perfectly captured who we are. Our customers love it.",
    rating: 5,
  },
  {
    name: "Mark Sullivan",
    business: "Nassau County, NY",
    text: "After years of wasting money on agencies that overpromised, Consortium NYC (Now The NYC Marketing Company) actually delivered. Transparent, responsive, and the SEO results speak for themselves.",
    rating: 5,
  },
  {
    name: "Lisa Park",
    business: "Jersey City, NJ",
    text: "The team at Consortium NYC (Now The NYC Marketing Company) is incredibly responsive. They treat our business like their own. Our web traffic has tripled and we're getting calls every single day now.",
    rating: 5,
  },
  {
    name: "James O'Brien",
...
export const faqs = {
  general: [
    {
      question:
        "What makes Consortium NYC (Now The NYC Marketing Company) different from other marketing companies?",
      answer:
  ...
  homepageAll: [
    // ── general (6) ──
    {
      question: "What makes Consortium NYC (Now The NYC Marketing Company) different from other marketing companies?",
    ...
    {
      question: "How do I get started with Consortium NYC (Now The NYC Marketing Company)?",
