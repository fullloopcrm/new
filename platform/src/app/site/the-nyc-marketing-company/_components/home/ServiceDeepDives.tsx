...
import { services } from "@/app/site/the-nyc-marketing-company/_lib/siteData";
...
> = {
  "search-engine-optimization-seo-nyc": {
    ...
    paragraphs: [
      ...
      <span key="seo3">SEO doesn&apos;t work in a vacuum. Every ranking we earn feeds your <L href="/nyc-marketing-company-services-list">website conversion rates</L>, strengthens your reputation, and fills your phone with calls from real customers. That&apos;s the <L href="/about-digital-marketing-agency-consortium-nyc">Consortium NYC (Now The NYC Marketing Company) difference</L> — SEO as part of an integrated system that turns searches into revenue. See our <L href="/nyc-marketing-company-portfolio">real results</L> or <L href="https://www.thenycmarketingcompany.com/contact">schedule a free strategy session</L>.</span>,
    ],
  },
  "web-design-nyc": {
