...
import { industries, services, serviceCategories, areas, h1Label } from "@/app/site/the-nyc-marketing-company/_lib/siteData";
import {
  JsonLd,
  serviceSchema,
  localBusinessSchema,
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${ind.name} | Consortium NYC (Now The NYC Marketing Company)`,
...
function getIndustryFaqs(badge: string) {
  ...
  return [
    ...
    { question: `Why should a ${lb} business choose Consortium NYC (Now The NYC Marketing Company)?`, answer: `We specialize exclusively in local business marketing. You work directly with senior strategists with 25+ years of experience — no junior account managers, no outsourcing. We've generated over $15.2M in attributable revenue for local businesses. No contracts, transparent pricing, and real results you can verify. Call ${PHONE}.` },
