...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/og-marketing.jpg", width: 1200, height: 630, alt: "The NYC Marketing Company Pricing" }],
  },
  twitter: {
...
const addOns = [
  ...
  },
  {
    ...
    price: "$2,500",
    description: "Logo, brand guide, visual identity",
  },
  {
    name: "Google Ads Management",
    price: "$500/mo + ad spend",
    description: "Instant leads while SEO builds",
  },
  {
    name: "Social Media",
    price: "$750/mo",
...
const faqs = [
  {
    ...
    answer:
      "No. We don't lock you into long-term contracts. Our SEO clients work with us month-to-month. We believe if we're delivering results, you'll want to stay. If not, you're free to leave anytime. Website projects are billed on a project basis with a 50% deposit upfront and 50% at launch.",
  },
  {
    question: "What's included in the monthly SEO?",
    answer:
      "Everything you need to rank and grow: keyword research, on-page optimization, Google Business Profile management, monthly content creation, link building, review management, and a detailed monthly report. You also get a dedicated account manager who knows your business inside and out.",
  },
  {
    question: "Can I cancel anytime?",
    answer:
      "Yes. We ask for 30 days notice so we can wrap things up properly, but there are no cancellation fees or penalties. We want to earn your business every single month.",
  },
  {
    question: "Do you offer payment plans?",
    answer:
      "Yes. For website projects, we offer a 50/50 split (half upfront, half at launch) as standard. For larger projects or bundles, we can work out a payment schedule that fits your cash flow. Just ask.",
  },
  {
    question: "What if I just need a website?",
    answer:
      "That's totally fine. Not every business needs ongoing SEO right away. We'll build you a beautiful, fast, SEO-ready website and hand it over. When you're ready to invest in monthly marketing, we'll be here.",
  },
];
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="rounded-2xl bg-white border border-slate-200 shadow-sm p-8 sm:p-10 flex flex-col">
              <p className="text-teal-600 text-sm font-semibold tracking-[0.15em] uppercase mb-2">
                One-Time Project
              </p>
          ...
          <div className="mt-12 rounded-2xl bg-white border border-teal-200 p-8 sm:p-10 text-center">
            <h3 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-3 font-heading">
              Bundle & Save
            </h3>
            <p className="text-slate-600 text-lg max-w-xl mx-auto mb-4">
              Get both for{" "}
              <span className="font-bold text-teal-600 font-mono">$5,200</span>{" "}
              startup +{" "}
              <span className="font-bold text-teal-600 font-mono">$950/month</span>.
            </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-slate-600 text-lg max-w-xl mx-auto">
              Scale up when you are ready. Mix and match to fit your goals.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {addOns.map((addon) => (
              <div
                key={addon.name}
                className="rounded-2xl bg-teal-50 border border-teal-100 p-6 text-center flex flex-col"
              >
                <h3 className="text-lg font-bold text-slate-900 mb-2 font-heading">
                  {addon.name}
                </h3>
                <p className="text-2xl font-extrabold text-teal-600 mb-3 font-mono">
                  {addon.price}
                </p>
      ...
      <section className="bg-white py-20 sm:py-28 px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-slate-600 text-lg max-w-xl mx-auto">
            Book a free 30-minute call. We will look at your current setup,
            understand your goals, and recommend the right plan — no pressure,
            no obligation.
          </p>
          <div className="mt-10">
            <Link
