...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/og-marketing.jpg", width: 1200, height: 630, alt: "The NYC Marketing Company" }],
  },
  twitter: {
...
const updates = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Selena is the first product from our new platform, <a href="https://homeservicecrm.ai/" target="_blank" rel="noopener noreferrer" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">Full Loop CRM</a>. More on that below.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          <a href="https://homeservicecrm.ai/" target="_blank" rel="noopener noreferrer" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">Full Loop CRM</a> is live. It&apos;s our own CRM platform built specifically for small businesses that are tired of paying $300/month for tools they use 10% of.
        </p>
        <p>
