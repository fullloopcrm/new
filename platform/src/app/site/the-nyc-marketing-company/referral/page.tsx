...
export default function ReferrerPortalPage() {
  useEffect(() => { document.title = 'Referral Program | The NYC Marketing Company' }, [])
  ...
  const copyLink = () => { if (referrer) { navigator.clipboard.writeText('https://www.thenycmarketingcompany.com/contact?ref=' + referrer.ref_code); alert('Copied!') } }
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-[#0f766e] text-white py-4 px-6">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          <div><h1 className="text-xl font-bold">The NYC Marketing Company</h1><p className="text-gray-400 text-sm">Referral Portal</p></div>
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="flex gap-3">
            <input type="text" value={'https://www.thenycmarketingcompany.com/contact?ref=' + referrer?.ref_code} readOnly className="flex-1 px-4 py-2 bg-gray-50 border rounded-lg text-gray-600 text-sm" />
            <button onClick={copyLink} className="px-4 py-2 bg-[#0f766e] text-white rounded-lg hover:bg-[#0f766e]/90">Copy</button>
          </div>
          <p className="text-sm text-gray-500 mt-2">Share this link. You earn 10% of every client!</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div className="mt-8 text-center text-sm text-gray-500"><p>Questions? hello@thenycmarketingcompany.com</p></div>
      </main>
    </div>
  )
}
