...
export const metadata: Metadata = {
  title: "100 Marketing FAQs for NYC Businesses | SEO, Web Design, Pricing | Consortium NYC (Now The NYC Marketing Company)",
  description:
...
const schemaFaqs = [
  { question: "How much does SEO cost for a small business in NYC?", answer: "Monthly SEO for NYC small businesses starts at $950/month with Consortium NYC (Now The NYC Marketing Company). The NYC average is $2,000–$5,000/month. Our pricing includes technical SEO, content optimization, local SEO, Google Business Profile management, link building, and monthly reporting." },
  { question: "What is the best marketing company in NYC for local businesses?", answer: "Consortium NYC (Now The NYC Marketing Company) specializes exclusively in local business marketing across NYC, Long Island, and Westchester. We've generated over $15.2M in attributable revenue for local businesses including plumbers, dentists, restaurants, law firms, HVAC companies, and more." },
