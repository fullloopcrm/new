...
const testimonials = [
  ...
  {
    text: "We went from hoping the phone would ring to having to hire two more plumbers to keep up. Consortium NYC (Now The NYC Marketing Company) changed everything for us.",
    name: "Mike T.",
