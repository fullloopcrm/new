...
import { services, areas, serviceCategories, getAllServiceSlugs, findServiceBySlug } from "@/app/site/the-nyc-marketing-company/_lib/siteData";
import {
  JsonLd,
  serviceSchema,
  localBusinessSchema,
...
export default async function ServiceAreaPage({
  ...
  return (
    <>
      ...
      <JsonLd data={webPageSchema(`${serviceName} in ${area.name} | Consortium NYC (Now The NYC Marketing Company)`, `${serviceName} for ${area.name} businesses.`, pageUrl, breadcrumbs)} />
