...
import { parkSlopeExterminatorConfig as config } from '@/app/site/the-nyc-exterminator/_lib/emd/park-slope-exterminator'
...
export default function ParkSlopeExterminatorPage() {
