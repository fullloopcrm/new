...
export const metadata: Metadata = {
  title: 'Your Business Service Reviews | 5-Star Verified Client Reviews',
  description: 'Read 43+ verified 5-star reviews from real NYC cleaning clients. See why New Yorkers trust our background-checked, insured cleaners for apartments across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ. From $59/hr, no contracts. (555) 555-5555',
  alternates: { canonical: 'https://www.example.com/reviews' },
  openGraph: {
    title: 'Your Business Service Reviews | 5-Star Verified Client Reviews',
    description: 'Read 50+ verified 5-star reviews from real NYC apartment cleaning, deep cleaning, and maid service clients across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ.',
