    ...
    return (
      <>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <ReviewsList businessName={config.identity.name} reviewUrl={config.reviewUrl} />
          <div className="text-center mt-12 mb-8">
            <p className="text-gray-500 mb-4">Had a great experience? We&apos;d love to hear from you.</p>
            <Link href={config.reviewUrl} className="inline-block bg-[var(--brand)] text-white px-8 py-3.5 rounded-full font-bold text-sm tracking-widest uppercase hover:bg-[var(--brand-alt)] transition-colors">
              Write a Review
            </Link>
          </div>
        </div>

        <CTABlock title="Book Your NYC Cleaning Service Today" subtitle="Trusted by New Yorkers since 2018. Text us to schedule your first cleaning." phone={config.contact.phone} phoneDigits={config.contact.phoneDigits} reviewUrl={config.reviewUrl} />
      </>
    )
  }
