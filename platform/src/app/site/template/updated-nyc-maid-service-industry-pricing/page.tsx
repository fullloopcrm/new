          ...
          <div className="max-w-5xl mx-auto px-4 py-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:5555555555" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-[#A8F0DC] rounded-2xl p-7 text-center relative">
                ...
                <a href="sms:5555555555" className="block mt-6 bg-[#1E2A4A] text-white px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">Text for this tier</a>
              </div>
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <a href="sms:5555555555" className="block mt-6 bg-[#A8F0DC] text-[#1E2A4A] px-4 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">Text — same-day</a>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex justify-center mt-10">
            <a href="sms:5555555555" className="bg-[#1E2A4A] text-white px-10 py-4 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
              Text (555) 555-5555
            </a>
          </div>
        </div>
