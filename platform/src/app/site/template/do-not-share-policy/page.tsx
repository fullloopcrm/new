  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Do Not Share Policy', url: 'https://www.example.com/do-not-share-policy' },
      ])} />
        ...
        <div className="mt-8 space-y-10">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <span className="text-[rgb(var(--brand-rgb)/0.3)] mt-0.5 flex-shrink-0">&#8226;</span>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-xl p-5 mt-4 space-y-2">
              <p className="text-gray-600 text-sm">Email us at <a href="mailto:hi@example.com" className="text-[var(--brand)] underline underline-offset-2">hi@example.com</a> with the subject &ldquo;Do Not Share&rdquo;</p>
              <p className="text-gray-600 text-sm">Or text <a href="sms:5555555556" className="text-[var(--brand)] underline underline-offset-2">(555) 555-5556</a></p>
            </div>
