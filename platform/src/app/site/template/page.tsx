  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <h2 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#1E2A4A] tracking-wide leading-tight mb-4">Welcome to Your Business</h2>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <a href={`sms:${siteConfig.contact.phoneDigits}`} className="inline-block bg-[#1E2A4A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                  Text 555.555.5555
                </a>
            ...
            <div className="space-y-6">
              <div className="bg-[#F5FBF8] border border-[#A8F0DC]/30 rounded-2xl p-8">
                <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-5">Your Business at a Glance</h3>
      ...
      <section className="py-20 bg-[#A8F0DC]">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xs font-semibold text-[#1E2A4A]/50 tracking-[0.25em] uppercase mb-3 text-center">Your Business Service Pricing Explained — Hourly Rates, Average Costs &amp; What to Expect</p>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center">
            <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[#1E2A4A] tracking-wide mb-2">How Your Business Pricing Compares to the Industry</h3>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href={`sms:${siteConfig.contact.phoneDigits}`} className="inline-block bg-[#1E2A4A] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                Text 555.555.5555
              </a>
      ...
      <section className="bg-[#A8F0DC] py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="mt-8">
            <Link href="/reviews" className="text-[#1E2A4A] font-semibold text-sm tracking-wide hover:underline underline-offset-4">Read All Your Business Service Reviews &rarr;</Link>
          </div>
        </div>
      </section>
