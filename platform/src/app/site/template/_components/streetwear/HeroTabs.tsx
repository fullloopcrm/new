...
// photo; tabs without one (e.g. About) fall back to the plain black hero.
// The background div is `absolute inset-0` — it paints the nearest
// positioned ancestor, the hero <section> itself, not just this component's
// own box, since no element in between sets its own position.
