...
function BookFormContent({ services, businessName, isNycmaid }: { services: ServiceOption[]; businessName: string; isNycmaid: boolean }) {
  ...
  const isSameDay = form.service_type === emergencyValue || form.date === todayET
        ...
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 text-center">
          ...
          {waitlisted ? (
            <>
              ...
              <h1 className="font-[family-name:var(--font-bebas)] text-3xl text-[var(--brand)] tracking-wide mb-2">You&rsquo;re on the Waitlist.</h1>
          ...
          {pin && (
            <div className="bg-[rgb(var(--accent-rgb)/0.3)] border border-[var(--accent)] rounded-lg p-4 mb-6">
              ...
              <p className="text-xs text-[rgb(var(--brand-rgb)/0.6)] mt-2">Save this — log in at <Link href="/portal/login" className="underline">your account</Link></p>
            </div>
          )}
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-6 md:p-8 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 border rounded-lg text-sm text-[var(--brand)] ${fieldErrors.date ? 'border-red-400 ring-1 ring-red-300' : 'border-gray-200'}`}
              />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 border rounded-lg text-sm text-[var(--brand)] ${fieldErrors.name ? 'border-red-400 ring-1 ring-red-300' : 'border-gray-200'}`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 border rounded-lg text-sm text-[var(--brand)] ${fieldErrors.phone ? 'border-red-400 ring-1 ring-red-300' : 'border-gray-200'}`}
              />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 border rounded-lg text-sm text-[var(--brand)] ${fieldErrors.email ? 'border-red-400 ring-1 ring-red-300' : 'border-gray-200'}`}
            />
          ...
          <div>
            ...
            <AddressAutocomplete
              ...
              className={`w-full px-3 py-2.5 border rounded-lg text-sm text-[var(--brand)] ${fieldErrors.address ? 'border-red-400 ring-1 ring-red-300' : 'border-gray-200'}`}
            />
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2.5 border rounded-lg text-sm text-[var(--brand)] ${fieldErrors.lead_source ? 'border-red-400 ring-1 ring-red-300' : 'border-gray-200'}`}
            >
    ...
    {showRecap && (
      <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center px-4 py-8 overflow-y-auto" role="dialog" aria-modal="true">
        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6 my-auto">
          <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[var(--brand)] tracking-wide mb-1">{isFullyBooked ? 'Join the waitlist' : 'Confirm your booking'}</h2>
