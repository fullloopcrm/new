...
export const metadata: Metadata = {
  title: { absolute: 'NYC Cleaning Services — Deep Clean, Maid Service, Move-In/Out & More | Your Business' },
  description: 'All cleaning services by Your Business from $59/hr. Deep cleaning, weekly maid service, move-in/out, post-construction, Airbnb, same-day. Manhattan, Brooklyn, Queens, the Bronx, Staten Island, Long Island, Westchester & NJ.',
  alternates: { canonical: 'https://www.example.com/nyc-maid-service-services-offered-by-the-nyc-maid' },
  openGraph: {
    title: 'NYC Cleaning Services — Deep Clean, Maid Service & More | Your Business',
    ...
    url: 'https://www.example.com/nyc-maid-service-services-offered-by-the-nyc-maid',
  },
}
    ...
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {SERVICES.map(service => (
              <Link
                ...
                className="group border border-gray-200 rounded-2xl p-8 hover:border-[var(--accent)] hover:shadow-lg transition-all bg-white"
              >
                <div className="flex items-start justify-between mb-4">
                  <h3 className="font-[family-name:var(--font-bebas)] text-2xl text-[var(--brand)] tracking-wide group-hover:text-[rgb(var(--brand-rgb)/0.7)] transition-colors">{service.name}</h3>
                  <span className="text-[var(--brand)] font-bold text-sm whitespace-nowrap ml-4">From {service.priceRange.split('–')[0]}</span>
                </div>
      ...
      <section className="py-20 bg-[var(--accent)]">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-xs font-semibold text-[rgb(var(--brand-rgb)/0.5)] tracking-[0.25em] uppercase mb-3">Simple, Transparent Hourly Pricing for All Services</h2>
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[var(--brand)] tracking-wide mb-6">One Rate — Every Service, Every Neighborhood</p>
          <p className="text-[rgb(var(--brand-rgb)/0.7)] max-w-2xl mx-auto mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-3xl mx-auto mb-10">
            <div className="bg-white rounded-2xl p-6">
              ...
              <p className="text-[var(--brand)] text-[10px] font-semibold tracking-wide mt-2">10% off weekly &middot; 5% off biweekly/monthly</p>
            </div>
            <div className="bg-[var(--brand)] rounded-2xl p-6 shadow-lg">
              <p className="text-xs font-semibold text-[rgb(var(--accent-rgb)/0.7)] tracking-[0.15em] uppercase mb-2">We Bring Everything</p>
              ...
              <p className="text-[var(--accent)] text-[10px] font-semibold tracking-wide mt-2">20% off weekly &middot; 10% off biweekly/monthly</p>
            </div>
            <div className="bg-white rounded-2xl p-6">
          ...
          <Link href="/updated-nyc-maid-service-industry-pricing" className="inline-block bg-[var(--brand)] text-white px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[rgb(var(--brand-rgb)/0.9)] transition-colors">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-xs font-semibold text-gray-400 tracking-[0.2em] uppercase mb-3">Why New Yorkers Choose Your Business</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              { title: 'Flat Hourly Rate', desc: 'Same rate regardless of service type or neighborhood. $59/hr with your supplies (recurring: 10% off weekly, 5% off biweekly/monthly), $69/hr when we bring everything (recurring: 20% off weekly, 10% off biweekly/monthly), $89/hr same-day emergency.' },
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mb-8">
            Every service listed above is available in all of our coverage areas. Same rates, same quality — whether you&apos;re in the <Link href="/upper-east-side-maid-service" className="text-[var(--brand)] underline underline-offset-2">Upper East Side</Link>, <Link href="/williamsburg-maid-service" className="text-[var(--brand)] underline underline-offset-2">Williamsburg</Link>, <Link href="/astoria-maid-service" className="text-[var(--brand)] underline underline-offset-2">Astoria</Link>, <Link href="/great-neck-maid-service" className="text-[var(--brand)] underline underline-offset-2">Great Neck</Link>, or <Link href="/hoboken-maid-service" className="text-[var(--brand)] underline underline-offset-2">Hoboken</Link>.
          </p>
