        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <a href="sms:5555555555" className="inline-block bg-[#A8F0DC] text-[#1E2A4A] px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
                Text (555) 555-5555
              </a>
              <a href="sms:5555555555" className="inline-block text-[#1E2A4A] font-semibold py-3.5 hover:underline underline-offset-4">
                or Text (555) 555-5555
              </a>
            </div>
          </div>
