/**
 * Long-form SEO body content for the VA home page — the "complete guide" section
 * rendered below the conversion content to give the homepage real editorial depth
 * (the 10k-word target). Data-only, industry-generic; rendered by
 * VirtualAssistantLanding. Kept as prose sections (not one giant string) so the
 * page can render semantic headings and stay readable.
 */
...
export const HOME_GUIDE: GuideSection[] = [
  {
    heading: 'The Complete Guide to Hiring a Virtual Assistant',
    paragraphs: [
  ...
  {
    heading: 'What Is a Virtual Assistant, Really?',
    paragraphs: [
  ...
  {
    heading: 'What Can a Virtual Assistant Do for Your Business?',
    paragraphs: [
  ...
  {
    heading: 'Why English-Speaking, Philippines-Based Assistants',
    paragraphs: [
  ...
  {
    heading: 'American-Owned and Managed: Why It Matters',
    paragraphs: [
  ...
  {
    heading: 'How It Works: Knowledge Panel, Quo Tracking, and Your CRM',
    paragraphs: [
  ...
  {
    heading: 'Who Hires Virtual Assistants?',
    paragraphs: [
  ...
  {
    heading: 'Virtual Assistant vs. AI Voice Bots vs. Answering Services',
    paragraphs: [
