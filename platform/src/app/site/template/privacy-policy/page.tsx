  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Privacy Policy', url: 'https://www.example.com/privacy-policy' },
      ])} />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about this privacy policy? Contact us at <a href="mailto:hi@example.com" className="text-[var(--brand)] underline underline-offset-2">hi@example.com</a> or text <a href="sms:5555555556" className="text-[var(--brand)] underline underline-offset-2">(555) 555-5556</a>.
            </p>
