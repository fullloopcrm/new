  ...
  return (
    <>
      <JsonLd data={breadcrumbSchema([
        ...
        { name: 'Terms & Conditions', url: 'https://www.example.com/terms-conditions' },
      ])} />
      ...
      <section className="bg-gradient-to-b from-[var(--brand)] to-[var(--brand-alt)] py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-200/60 mt-3">Service agreement for Your Business</p>
        </div>
      </section>
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              By booking a cleaning service with Your Business, you agree to the following terms and conditions. We reserve the right to update these terms at any time. Continued use of our services constitutes acceptance of any changes.
            </p>
          </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="text-[var(--accent)] mt-0.5 flex-shrink-0 font-bold text-sm">7 days</span>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                'Your Business carries full general liability insurance and bonding.',
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about these terms? Contact us at <a href="mailto:hi@example.com" className="text-[var(--brand)] underline underline-offset-2">hi@example.com</a> or text <a href="sms:5555555556" className="text-[var(--brand)] underline underline-offset-2">(555) 555-5556</a>.
            </p>
            <p className="text-gray-500 text-sm mt-4">
