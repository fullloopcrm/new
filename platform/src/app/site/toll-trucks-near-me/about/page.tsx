...
export const metadata: Metadata = {
  title: "About Toll Trucks Near Me — The Only Tow Operator That Pays You Back",
  description: "Toll Trucks Near Me started with a radical idea: customers deserve a cut when their items have resale value. Starting at $95 hookup, flat upfront pricing, flat upfront pricing. 900+ cities, 50 states, 34 services.",
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl font-heading">
            About Toll Trucks Near Me<br /><span className="gradient-text">Tow Truck Dispatch</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            The tow truck service industry has a dirty secret. Every company charges you for the service and keeps 35%+ of your items to resell for profit. We built the only company that shares resale value with customers.
          </p>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-slate-600">
            We spent years inside the tow truck service industry before launching Toll Trucks Near Me. What we saw convinced us the entire model was broken. Learn more about our <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">transparent pricing</Link>, our <Link href="/services" className="text-teal-700 font-semibold hover:underline">{SERVICES.length} services</Link>, and how we operate across <Link href="/locations" className="text-teal-700 font-semibold hover:underline">{CITY_COUNT} cities</Link>.
          </p>
          <div className="mx-auto mt-8 max-w-3xl space-y-5 text-center text-base leading-relaxed text-slate-700">
            <p>Here&apos;s what the tow truck service industry doesn&apos;t want you to know: every major company — from the franchises to the local operators — charges you full price to haul your stuff away, then turns around and resells 35% or more of it for pure profit. That vintage dresser, the working appliances, the power tools in the garage — they make money on your items and never share a dime with you. It&apos;s been this way for decades and nobody has challenged it.</p>
            ...
            <p>We started asking a simple question: what if we quoted the final price on the phone and simply stuck to it? The industry said it couldn&apos;t work. Too hard to predict. Too many variables at the scene. We built it anyway — first in one city, then five, then twenty. Customers didn&apos;t just appreciate the honest quote. They were stunned to discover what professional dispatch could actually feel like.</p>
            <p>That radical idea became Toll Trucks Near Me. Today we operate in {CITY_COUNT} cities across all {STATE_COUNT} states with 50 offices and growing. We&apos;ve proven what the industry said was impossible: you can run a profitable tow truck company, charge a fair flat rate with <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">flat upfront pricing</Link>, and still share resale value with your customers. We do it every single day.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-slate-600">
            Everything we do is guided by five core principles. From <Link href="/services/long-distance-towing" className="text-teal-700 font-semibold hover:underline">estate cleanouts</Link> to <Link href="/services/flatbed-towing" className="text-teal-700 font-semibold hover:underline">furniture removal</Link>, these values show up in every <Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">job we book</Link>.
          </p>
          <div className="mx-auto mt-8 max-w-3xl space-y-5 text-center text-base leading-relaxed text-slate-700">
            <p><strong>Mission:</strong> To build the most honest tow truck company in America — one that charges a fair rate, includes dump fees, and shares resale value with the people whose items we haul. We believe your stuff has value and you deserve a cut.</p>
            <p><strong>Transparency:</strong> No hidden fees. No surprise surcharges. No volume-based guessing games. Starting at $95 hookup with a 1 hour minimum and flat upfront pricing. You watch the clock. You see every appraisal. You approve every credit. Our <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">pricing page</Link> tells you exactly what you&apos;ll pay — and we stick to it.</p>
            <p><strong>Fairness:</strong> The flat upfront pricing exists because we refuse to profit from your items without sharing the upside. Other companies keep 100% of resale revenue. We split it 50/50 because that&apos;s what&apos;s right. If your credits exceed your bill, we pay you the difference — same day, on the spot.</p>
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-teal-400 hover:shadow-md text-center">
              <p className="text-3xl font-bold text-teal-700 font-heading">$95 hookup</p>
              <h3 className="mt-2 text-lg font-bold text-slate-900 font-heading">Simple Hourly Rate</h3>
              <p className="mt-2 text-sm text-slate-600">Starting at $95 hookup with a 1 hour minimum. No volume estimates, no truck-fraction pricing, no hidden fees. Flat upfront pricing — an industry first.</p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-teal-400 hover:shadow-md text-center">
              <p className="text-3xl font-bold text-teal-700 font-heading">50%</p>
              <h3 className="mt-2 text-lg font-bold text-slate-900 font-heading">Upfront Quote</h3>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-teal-400 hover:shadow-md text-center">
              ...
              <p className="mt-2 text-sm text-slate-600">If your upfront quotes add up to more than the cost of the job, we cut you a check or send a digital payment. Same day, on the spot.</p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-6 transition-all hover:border-teal-400 hover:shadow-md text-center">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-20">
        <div className="absolute inset-0 grid-bg opacity-30" />
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-white sm:text-4xl font-heading">Ready to See What Your Vehicle Is Worth?</h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/80">
            Starting at $95 hookup. Flat upfront pricing. flat upfront pricing. The only tow truck company that pays you back.
          </p>
          <CtaButtons variant="dark" />
        </div>
      </section>
