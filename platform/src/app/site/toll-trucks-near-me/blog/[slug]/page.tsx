  ...
  return (
    <>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="mt-12 rounded-xl border-2 border-teal-400 bg-teal-50 p-6 text-center">
            <p className="text-lg font-bold text-slate-900 font-heading">Ready to see what your vehicle is worth?</p>
            <p className="mt-2 text-sm text-slate-600">Starting at $95 hookup. Flat upfront pricing with no surcharge games. flat upfront pricing.</p>
            <div className="mt-4 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <Link href="/book-tow-truck-now" className="inline-block rounded-lg bg-teal-700 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-teal-800 font-cta">Book Now</Link>
      ...
      {others.length > 0 && (
        <section className="bg-section-white py-16">
          <div className="mx-auto max-w-5xl px-6">
            <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">Explore More Tow Truck Dispatch Topics</p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        <div className="absolute inset-0 grid-bg opacity-30" />
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-200 font-cta">Book Your Tow Truck Dispatch Today</p>
          <h2 className="mt-3 text-center text-3xl font-bold text-white sm:text-4xl font-heading">Done Reading? Let&apos;s Get Your Vehicle Handled.</h2>
