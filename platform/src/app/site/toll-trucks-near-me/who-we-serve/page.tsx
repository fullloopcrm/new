...
import { CITY_COUNT, STATE_COUNT } from "@/app/site/toll-trucks-near-me/_data/content";
...
export const metadata: Metadata = {
  title: "Who We Serve — Tow Truck Dispatch for Homeowners, Businesses, Property Managers & More",
  description: `We serve 13 customer types across ${CITY_COUNT}+ cities. Homeowners, renters, property managers, realtors, businesses, estate managers, contractors, and more. Starting at $95 hookup.`,
    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl font-heading">
            Who We Serve — <span className="gradient-text">Tow Truck Dispatch for Everyone</span>
          </h1>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">Tow Truck Services Tailored to Your Situation</p>
