...
import { STATES, TOTAL_CITIES } from "@/app/site/toll-trucks-near-me/_data/cities";
import { OFFICES } from "@/app/site/toll-trucks-near-me/_data/offices";

export const metadata: Metadata = {
  title: `Tow Truck Dispatch Locations — 50 Offices, ${TOTAL_CITIES}+ Cities, All 50 States`,
  description: `Toll Trucks Near Me has 50 offices across all 50 states serving ${TOTAL_CITIES}+ cities. Find your nearest office with address and directions.`,
    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl font-heading">
            Toll Trucks Near Me <span className="gradient-text">Locations</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            One office in every state. {TOTAL_CITIES}+ cities served nationwide. starting at $95 hookup, flat upfront pricing, flat upfront pricing on valuable items.
          </p>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">Tow Truck Dispatch Offices in All 50 States</p>
          <h2 className="text-center text-3xl font-bold text-slate-900 font-heading">
            All 50 Toll Trucks Near Me Offices
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-slate-600">Every state has a local office with crews who know your area. Browse our <Link href="/services" className="text-teal-700 font-semibold hover:underline">full service menu</Link>, review our <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">transparent hourly pricing</Link>, or <Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">book your tow truck service online</Link>. Click any state below for full city listings.</p>
                      ...
                      <div className="flex-1">
                        <Link href={`/locations/${office.stateSlug}`} className="group">
                          <h3 className="text-xl font-bold text-slate-900 font-heading group-hover:text-teal-700 transition-colors">
                            Toll Trucks Near Me {office.state}
                          </h3>
                        </Link>
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          ...
                          <Link href="/book-tow-truck-now" className="inline-block rounded-md bg-accent px-4 py-2 text-xs font-bold text-white transition-colors hover:bg-accent-dark font-cta">Book Now</Link>
                        </div>
                      </div>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">Find Tow Truck Service in Your City</p>
          <h2 className="text-center text-3xl font-bold text-slate-900 font-heading">
            Browse Cities by State
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-slate-600">Select your state to see every city we serve with <Link href="/services" className="text-teal-700 font-semibold hover:underline">full-service tow truck service</Link>. Each location offers the same <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">starting at $95 hookup pricing with upfront quotes</Link>, and you can <Link href="/contact-toll-trucks" className="text-teal-700 font-semibold hover:underline">contact us</Link> if you do not see your area listed.</p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        <div className="absolute inset-0 grid-bg opacity-30" />
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-200 font-cta">Tow Truck Service Expanding Nationwide</p>
          <h2 className="text-center text-3xl font-bold text-white sm:text-4xl font-heading">Don&apos;t See Your City?</h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-white/70">We are expanding every week and chances are we already have a crew in your area. <Link href="/contact-toll-trucks" className="text-teal-200 font-semibold hover:underline">Send us a message</Link>, check our <Link href="/faq" className="text-teal-200 font-semibold hover:underline">FAQ for coverage questions</Link>, or explore <Link href="/franchise" className="text-teal-200 font-semibold hover:underline">franchise opportunities</Link> to bring Toll Trucks Near Me to your market.</p>
          <div className="mt-8">
