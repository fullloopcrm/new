...
export const metadata: Metadata = {
  title: "Tow Truck Dispatch FAQ — 50 Questions Answered About Pricing, Credits, Services & More",
  description: "50 frequently asked questions about tow truck service. Pricing, flat upfront pricing, scheduling, what we take, what we don't, insurance, and how we compare to random-number tow operators and others.",
  alternates: { canonical: "/faq" },
};

const LEFT_FAQS = [
  { q: "How much does tow truck service cost?", a: <>Our rates start at $95 hookup for a 1-person crew, $150 hookup for a 2-person crew, and $200/person/hr for emergency same-day. Flat upfront pricing with no surcharge games. 1 hour minimum. See our full <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">pricing breakdown</Link>.</> },
  { q: "What is the flat upfront pricing?", a: <>As we load your items, we appraise anything with resale value and credit you 50% (when applicable) toward your bill. A $400 couch = $200 credit. If credits exceed the bill, <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">we pay you the difference</Link>.</> },
  { q: "Can I really get paid for tow truck service?", a: <>Yes. If your item credits add up to more than the hours worked, we hand you a check on the spot. This happens regularly on <Link href="/services/long-distance-towing" className="text-teal-700 font-semibold hover:underline">estate cleanouts</Link> and <Link href="/services/fleet-vehicle-towing" className="text-teal-700 font-semibold hover:underline">office cleanouts</Link>.</> },
  { q: "Do you offer same-day tow truck service?", a: <>Yes. Call before noon and we can typically have a crew at your door within 2-4 hours. Need it faster? Our <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">emergency same-day rate</Link> guarantees arrival within 2 hours.</> },
  ...
  { q: "Are dump fees really included?", a: <>Yes — an industry first. Transfer station costs, landfill fees, recycling fees — all baked into the flat rate. No surprise charges at the end. See <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">what&apos;s included</Link>.</> },
  { q: "How does furniture removal work?", a: <>We come to your home, load the furniture, and haul it away. Quality furniture gets appraised — Pottery Barn, West Elm, Restoration Hardware pieces hold serious value. See our <Link href="/services/flatbed-towing" className="text-teal-700 font-semibold hover:underline">furniture removal service</Link>.</> },
  { q: "Do you remove appliances?", a: <>Yes. Refrigerators, washers, dryers, ovens, dishwashers — we disconnect (when applicable) and haul. Working appliances earn you significant <Link href="/services/flatbed-towing" className="text-teal-700 font-semibold hover:underline">upfront quotes</Link>.</> },
  { q: "What about electronics and e-waste?", a: <>We remove TVs, computers, monitors, printers, and all electronics. Working items earn you credit. Non-working items get <Link href="/services/luxury-exotic-towing" className="text-teal-700 font-semibold hover:underline">recycled through certified e-waste facilities</Link>.</> },
  { q: "Can you remove a piano?", a: <>Yes. Uprights, grands, baby grands — our crew handles the weight and the stairs. Working pianos in good condition earn credit. See <Link href="/services/motorcycle-towing" className="text-teal-700 font-semibold hover:underline">piano removal details</Link>.</> },
  { q: "Do you do hot tub removal?", a: <>Yes. We demo the shell, disconnect plumbing/electrical, load everything, and haul it away. All included in the flat rate. See <Link href="/services/heavy-duty-towing" className="text-teal-700 font-semibold hover:underline">hot tub removal</Link>.</> },
  { q: "What about construction debris?", a: <>Drywall, lumber, concrete, tile, roofing — we load and haul it all. No weight limits, no overage fees. Better than a dumpster rental. See <Link href="/services/heavy-duty-towing" className="text-teal-700 font-semibold hover:underline">construction debris removal</Link>.</> },
  { q: "Do you remove sheds and decks?", a: <>Yes. Full demolition and haul-away for <Link href="/services/equipment-transport" className="text-teal-700 font-semibold hover:underline">sheds</Link>, <Link href="/services/deck-removal" className="text-teal-700 font-semibold hover:underline">decks</Link>, <Link href="/services/fence-removal" className="text-teal-700 font-semibold hover:underline">fences</Link>, and <Link href="/services/trampoline-removal" className="text-teal-700 font-semibold hover:underline">trampolines</Link>. Same flat rate covers demo + hauling.</> },
  { q: "How do estate cleanouts work?", a: <>We clear the entire property room by room. Every item with resale value gets appraised and credited. Estates have the highest credit density — families frequently get a check instead of a bill. See <Link href="/services/long-distance-towing" className="text-teal-700 font-semibold hover:underline">estate cleanout details</Link>.</> },
  ...
  { q: "Can you clear a storage unit?", a: <>Yes. We coordinate with your facility for access and clear the entire unit. Stop paying monthly rent on stuff you don&apos;t need. See <Link href="/services/long-distance-towing" className="text-teal-700 font-semibold hover:underline">storage unit cleanouts</Link>.</> },
  ...
  { q: "Do you charge extra for stairs?", a: <>No. Third-floor walkup, basement, attic with a pull-down ladder — same flat rate. No stair fees, no heavy item surcharges, no distance fees. See <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">our no-hidden-fees policy</Link>.</> },
  ...
  { q: "Do you charge more on weekends?", a: <>No. Same rate 7 days a week, 365 days a year. Saturdays, Sundays, holidays — no surcharges, no overtime. <Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">Book any day</Link>.</> },
  { q: "How do I book tow truck service?", a: <><Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">Book online</Link>, <a href={SMS_HREF} className="text-teal-700 font-semibold hover:underline">text us</a>, or <a href={PHONE_HREF} className="text-teal-700 font-semibold hover:underline">call {PHONE}</a>. Takes about 2 minutes. We confirm the rate, estimate time, and schedule your crew.</> },
  { q: "How far in advance do I need to book?", a: <>Same-day is available. We also take bookings up to 4 weeks out. 24-48 hours ahead guarantees your preferred time slot. <Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">Book now</Link>.</> },
  { q: "Do I need to be home?", a: <>For items with resale value — yes, so you can approve appraisals and credits. For pure non-running with no valuable items, we can work without you present as long as we have access. <Link href="/contact-toll-trucks" className="text-teal-700 font-semibold hover:underline">Contact us</Link> to discuss.</> },
];

const RIGHT_FAQS = [
  { q: "How is your pricing different from random-number tow operators?", a: <>They charge $200-$800 per truckload based on volume and keep 100% of resale profit. We charge by the hour and credit you 50% (when applicable) of resale value. The math always favors you. See our <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">side-by-side comparison</Link>.</> },
  { q: "What items earn the most upfront quote?", a: <>Quality furniture (Pottery Barn, Restoration Hardware), working appliances (Samsung, LG), power tools (DeWalt, Milwaukee), exercise equipment (Peloton), and musical instruments. See the full <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">item value guide</Link>.</> },
  ...
  { q: "What if none of my items have resale value?", a: <>You pay the flat rate with flat upfront pricing with no surcharge games. Even with zero credits, our flat rate is competitive with or cheaper than flat-rate pricing for the same volume. See <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">pricing examples</Link>.</> },
  ...
  { q: "Do you offer commercial tow truck service?", a: <>Yes — offices, warehouses, retail stores, hotels, schools, churches, and property management. Commercial furniture has the highest resale value. See all <Link href="/commercial" className="text-teal-700 font-semibold hover:underline">commercial services</Link>.</> },
  { q: "Can you clear an entire office?", a: <>Yes. From a 5-person startup to a 500-seat corporate floor. Herman Miller chairs, Steelcase desks, monitors — the credits on office jobs regularly cover the entire bill. See <Link href="/services/fleet-vehicle-towing" className="text-teal-700 font-semibold hover:underline">office cleanout details</Link>.</> },
  ...
  { q: "Can you remove carpet and flooring?", a: <>Yes. We rip up and haul away carpet, tile, hardwood, laminate, and vinyl. Hardwood in good condition earns upfront quote. See <Link href="/services/carpet-flooring-removal" className="text-teal-700 font-semibold hover:underline">carpet &amp; flooring removal</Link>.</> },
  ...
  { q: "What about yard waste?", a: <>Branches, soil, mulch, sod, landscaping timbers, storm debris — we load and haul it all. See <Link href="/services/equipment-transport" className="text-teal-700 font-semibold hover:underline">yard waste removal</Link>.</> },
  ...
  { q: "Can you remove a pool table?", a: <>Yes. We disassemble slate tops, rails, and frame. Quality pool tables earn upfront quote. See <Link href="/services/pool-table-removal" className="text-teal-700 font-semibold hover:underline">pool table removal</Link>.</> },
  ...
  { q: "Do you provide certificates of insurance?", a: <>Yes. COIs available on request for commercial customers, property managers, and realtors. We carry comprehensive general liability and workers&apos; comp. <Link href="/contact-toll-trucks" className="text-teal-700 font-semibold hover:underline">Request a COI</Link>.</> },
  { q: "What payment methods do you accept?", a: <>Credit cards, debit cards, checks, Venmo, Zelle, and CashApp. For payouts (credits exceeding your bill), we process by check or digital transfer on the spot. <Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">Book now</Link>.</> },
  ...
  { q: "Do you offer franchise opportunities?", a: <>Yes. The only tow truck service franchise with a dual revenue model — hourly fees plus resale income. See <Link href="/franchise" className="text-teal-700 font-semibold hover:underline">franchise details</Link>.</> },
  { q: "How do I contact you for non-booking questions?", a: <>Use our <Link href="/contact-toll-trucks" className="text-teal-700 font-semibold hover:underline">contact form</Link> for general inquiries, partnerships, media, or feedback. For booking, use the <Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">booking page</Link>.</> },
  { q: "Why don't other companies do this?", a: <>Most tow operators charge you to haul your items and then resell the valuable ones for 100% profit. They have no incentive to share. We built a different model — see <Link href="/about" className="text-teal-700 font-semibold hover:underline">our story</Link>.</> },
  { q: "How many services do you offer?", a: <>34 specialized tow truck services — residential cleanouts, single item pickup, structure demolition, construction debris, and commercial services. Browse all <Link href="/services" className="text-teal-700 font-semibold hover:underline">34 services</Link>.</> },
];
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-teal-200 font-cta">50 Tow Truck Dispatch Questions Answered</p>
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl font-heading">
            Tow Truck Dispatch FAQ — <span className="gradient-text">Everything You Need to Know</span>
          </h1>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-6xl px-6">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">Tow Truck Dispatch Pricing, Upfront Quotes, and How the Math Works</p>
          <h2 className="mt-3 text-center text-3xl font-bold text-slate-900 font-heading">50 Frequently Asked Questions About Tow Truck Dispatch</h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-slate-600">
            Everything from <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">how pricing works</Link> to <Link href="/services" className="text-teal-700 font-semibold hover:underline">what services we offer</Link> to <Link href="/locations" className="text-teal-700 font-semibold hover:underline">where we operate</Link>. Still have questions? <Link href="/contact-toll-trucks" className="text-teal-700 font-semibold hover:underline">Contact us</Link> or <Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">book your pickup</Link>.
          </p>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">How the Only Tow Truck Dispatch Company That Pays You Actually Works</p>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-slate-600">
            Learn how our <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">hourly pricing</Link> and flat upfront pricing model creates a better deal for customers, a sustainable business for us, and a <Link href="/about" className="text-teal-700 font-semibold hover:underline">better outcome for the environment</Link>. Browse all <Link href="/services" className="text-teal-700 font-semibold hover:underline">34 services</Link> or <Link href="/book-tow-truck-now" className="text-teal-700 font-semibold hover:underline">book your pickup</Link>.
          </p>
          <div className="mx-auto mt-8 max-w-3xl space-y-5 text-base leading-relaxed text-slate-700">
            <p>Traditional tow operators charge you a flat fee based on truck volume, haul everything away, and resell your valuable items for their own profit. They make money twice — once from you and once from your stuff. You pay full price and get nothing back.</p>
            <p>We charge a transparent flat rate with flat upfront pricing with no surcharge games. As we load your items, we appraise anything with resale value and credit you 50% (when applicable) of fair market value toward your bill. If your credits exceed the bill, we pay you the difference.</p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        <div className="absolute inset-0 grid-bg opacity-30" />
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-200 font-cta">Ready to See What Your Vehicle Is Worth?</p>
