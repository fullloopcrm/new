/**
 * Rich sitemap for tolltrucksnearme.com (slug toll-trucks-near-me).
 *
 ...
 * /site/toll-trucks-near-me/sitemap.xml; middleware rewrites the apex
...
const BASE = 'https://www.tolltrucksnearme.com'

const STATIC_PATHS: TowStaticPath[] = [
  { path: '/', priority: 1.0, changeFrequency: 'daily' },
  { path: '/about', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/apply-for-tow-driver-job', priority: 0.7, changeFrequency: 'weekly' },
  { path: '/blog', priority: 0.6, changeFrequency: 'weekly' },
  { path: '/book-tow-truck-now', priority: 0.9, changeFrequency: 'weekly' },
  { path: '/careers', priority: 0.7, changeFrequency: 'weekly' },
  { path: '/commercial', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/contact-toll-trucks', priority: 0.6, changeFrequency: 'monthly' },
