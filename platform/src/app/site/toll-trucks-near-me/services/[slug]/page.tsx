...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!service) return {};
  return {
    title: `${service.title} — Nationwide Tow Truck Dispatch`,
    description: `${service.description} Simple flat rate, flat upfront pricing, flat upfront pricing. ${CITY_COUNT} cities, all ${STATE_COUNT} states.`,
    ...
    <>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-700">
            <p>{service.title} is one of our most requested services nationwide, and it&apos;s a perfect example of why the Toll Trucks Near Me model works better than traditional tow truck service. When you call a flat-rate company for {service.title.toLowerCase()}, they estimate the truck volume, charge you $200-$800+ depending on the load size, and haul everything away. Any items with resale value get resold for their own profit. You paid the removal fee and lost the resale value — a double hit to your wallet.</p>
            <p>With our {service.title.toLowerCase()} service, the economics are completely different. You pay a transparent flat rate — $95 hookup for a 1-person crew, $150 hookup for a 2-person crew, or $200/person/hr for emergency same-day. Dump fees, transfer station costs, and all disposal charges are included with no surcharge games. As our crew loads your items, they identify everything with resale value and appraise it at current fair market rates. You receive 50% of each item&apos;s appraised value (when applicable) as an immediate credit on your bill. If the total credits exceed the total bill, we pay you the difference.</p>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-700">
            ...
            <p>Other credit-earning categories include exercise equipment (treadmills, Peloton bikes, weight sets), musical instruments (pianos, guitars, drums, amplifiers), outdoor recreation gear (bikes, kayaks, grills, patio sets), antiques and vintage items, and designer or brand-name household goods. Our crew evaluates every item during {service.title.toLowerCase()} — you might be surprised how much credit your roadside issue earns you.</p>
            <p>Items that generally don&apos;t earn credit include broken or heavily damaged items, stained mattresses, construction debris, yard waste, and general household trash. These are still removed as part of your flat rate with flat upfront pricing — they just don&apos;t generate upfront quote. Our crew clearly communicates which items qualify and which don&apos;t, so there are no surprises on your final bill.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-700">
            ...
            <p>The hidden cost of DIY that most people don&apos;t consider: you get zero upfront quote. Every valuable item goes straight to the dump. That working refrigerator worth $300, the solid wood desk worth $150, the power tools worth $200 — all gone, with zero return. With our service, those same items generate $325 in credits that reduce your bill. When you factor in upfront quotes, professional {service.title.toLowerCase()} is almost always cheaper than DIY.</p>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-700">
            <p>Every {service.title.toLowerCase()} job we complete diverts a significant percentage of items from landfills. Traditional tow truck companies send 70-80% of everything they collect straight to the dump — including items with years of useful life remaining. Because our business model creates a financial incentive to resell rather than dump, we approach every job with a sorting-first mindset. Items with resale value get routed to our resale network. Usable items below our resale threshold get donated to local charities and nonprofits. Recyclable materials — metals, electronics, cardboard, certain plastics — go to certified recycling facilities. Only items with truly zero remaining value in any category reach the landfill.</p>
            ...
            <p>When you choose Toll Trucks Near Me for your {service.title.toLowerCase()} needs, you&apos;re making the most environmentally responsible choice available. You save money through upfront quotes, you get paid for valuable items, and you know that the maximum possible percentage of your items will be reused, recycled, or donated rather than buried in a landfill. It&apos;s better for your wallet, better for your community, and better for the planet.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-slate-600">
            Simple hourly pricing. Book your pickup. Flat upfront pricing with no surcharge games.
          </p>
          <div className="mt-8 max-w-sm mx-auto">
            <div className="rounded-xl border-2 border-teal-400 bg-white p-6 text-center shadow-md">
              ...
              <p className="mt-3 text-sm text-slate-500">Flat upfront pricing with no surcharge games &bull; flat upfront pricing</p>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            One call. Simple flat rate. Flat upfront pricing with no surcharge games. Items with value earn you 50% credit. Same-day available in {CITY_COUNT} cities.
          </p>
          <CtaButtons variant="dark" />
        </div>
      </section>
