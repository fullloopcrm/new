...
export const metadata: Metadata = {
  title: "Franchise Opportunity — Toll Trucks Near Me",
  description: "Own a Toll Trucks Near Me franchise. The only tow truck service model with built-in resale revenue. Low startup costs, nationwide brand, proven system.",
    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl font-heading">Own a <span className="gradient-text">Toll Trucks Near Me</span> Tow Truck Dispatch Franchise</h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">The only tow truck service franchise with a built-in dual revenue model — hourly service fees plus resale income. Currently in {CITY_COUNT} cities, expanding nationwide.</p>
        </div>
      </section>

      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">Tow Truck Dispatch Franchise With Built-In Resale Revenue</p>
          <h2 className="text-center text-3xl font-bold text-slate-900 font-heading">Why This Franchise Is Different</h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-slate-600">Our dual revenue model combines <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">hourly service fees</Link> with 50% resale income (when applicable) on valuable items. Explore the full range of <Link href="/services" className="text-teal-700 font-semibold hover:underline">tow truck services</Link> franchise owners deliver, see how our <Link href="/locations" className="text-teal-700 font-semibold hover:underline">nationwide office network</Link> supports every market, and learn more <Link href="/about" className="text-teal-700 font-semibold hover:underline">about our mission</Link>.</p>
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-700">
            <p>Traditional tow truck service franchises make money one way: charging customers to haul stuff. Toll Trucks Near Me franchise owners make money two ways: the hourly service fee AND the 50% retained resale value (when applicable) on items worth something. This dual revenue stream means higher per-job revenue, better margins, and a built-in competitive moat that no other franchise can replicate.</p>
      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">Tow Truck Dispatch Franchise Benefits and Support</p>
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: "National Brand", desc: "Leverage the Toll Trucks Near Me brand, website, SEO, and marketing infrastructure from day one." },
              ...
              { title: "Territory Protection", desc: "Exclusive territory rights. No other Toll Trucks Near Me franchise operates in your market." },
            ].map((item) => (
