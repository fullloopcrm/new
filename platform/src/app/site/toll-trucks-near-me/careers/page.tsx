...
import { PHONE, PHONE_HREF, SMS_HREF, EMAIL, CITY_COUNT, STATE_COUNT } from "@/app/site/toll-trucks-near-me/_data/content";

export const metadata: Metadata = {
  title: "Careers at Toll Trucks Near Me — We're Hiring Nationwide",
  description: "Join the only tow truck company that pays customers. We're hiring crew members, drivers, and team leads in 900+ cities across all 50 states.",
    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl font-heading">Careers at <span className="gradient-text">Toll Trucks Near Me</span> Tow Truck Dispatch</h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">We&apos;re hiring in {CITY_COUNT} cities across all {STATE_COUNT} states. Join the only tow truck company that actually values what customers have.</p>
        </div>
      </section>

      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-center text-sm font-semibold uppercase tracking-widest text-teal-600 font-cta">Tow Truck Dispatch Crew Member Jobs Near Me</p>
          <h2 className="text-center text-3xl font-bold text-slate-900 font-heading">Tow Truck Dispatch Crew Member</h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-slate-600">Our crew members handle everything from <Link href="/services" className="text-teal-600 underline">full-service tow truck service</Link> pickups to on-site item appraisals, working directly with customers at every stop. You&apos;ll train on valuation, safe handling, and our unique pay-back model that sets us apart from every other hauling company. Explore our <Link href="/locations" className="text-teal-600 underline">nationwide service areas</Link> to see where crews are hiring, or <Link href="/book-tow-truck-now" className="text-teal-600 underline">book a pickup</Link> to experience the process from the customer side.</p>
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-700">
            <p>As a Toll Trucks Near Me crew member, you&apos;re not just towing vehicles — you&apos;re running a mobile appraisal and removal operation. You&apos;ll work directly with customers, load and transport items, evaluate items for resale value, and deliver an experience that makes people say &quot;I can&apos;t believe a tow truck company just paid me.&quot;</p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        <div className="absolute inset-0 grid-bg opacity-30" />
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <p className="text-sm font-semibold uppercase tracking-widest text-teal-200 font-cta">Apply for Tow Truck Dispatch Jobs Today</p>
