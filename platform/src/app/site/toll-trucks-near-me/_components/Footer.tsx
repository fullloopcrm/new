...
import { PHONE, PHONE_HREF, SMS_HREF, EMAIL, HOURS } from "@/app/site/toll-trucks-near-me/_data/content";
    ...
    <footer className="bg-slate-900 text-white">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-xl font-bold tracking-widest font-heading mb-4">
              TOLLTRUCKS<span className="text-amber-300">NEAR ME</span>
            </h3>
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              24/7 tow truck dispatch nationwide. Flat upfront pricing — no surprise surcharges. 30-minute arrival option. Licensed & insured. Destination-of-your-choice delivery.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/book-tow-truck-now" className="text-teal-400 hover:text-teal-300 font-semibold transition-colors font-cta">Book Now</Link></li>
              <li><Link href="/contact-toll-trucks" className="text-slate-400 hover:text-white transition-colors">Contact Us</Link></li>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>&copy; {new Date().getFullYear()} Toll Trucks Near Me. All rights reserved.</p>
