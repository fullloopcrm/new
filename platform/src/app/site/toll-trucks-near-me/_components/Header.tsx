...
import { PHONE, PHONE_HREF, SMS_HREF, TOP_CITIES } from "@/app/site/toll-trucks-near-me/_data/content";
    ...
    <div className="fixed top-0 left-0 right-0 z-40">
      ...
      <nav className="transition-all duration-300" style={{ backgroundColor: "#2d6a4f" }}>
        <div className="flex items-center justify-between px-3 sm:px-4 py-4">
          <Link href="/" className="flex items-center gap-1 shrink-0">
            <span className="text-xl font-bold tracking-widest text-white font-heading">TOLLTRUCKS</span>
            <span className="text-xl font-bold tracking-widest text-amber-300 font-heading">NEAR ME</span>
          </Link>
          ...
          <div className="hidden items-center justify-center gap-6 lg:flex flex-1">
            ...
            <Link href="/contact-toll-trucks" className="text-[15px] font-medium tracking-wide text-white/90 transition-colors hover:text-white font-cta whitespace-nowrap">Contact</Link>
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-slate-900 border-t border-slate-700/60 px-4 py-6 space-y-4">
          ...
          <Link href="/contact-toll-trucks" onClick={() => setMobileOpen(false)} className="block text-lg font-semibold text-white hover:text-teal-400 transition-colors font-cta">Contact</Link>
          ...
          <div className="mt-4 space-y-3">
            ...
            <Link href="/book-tow-truck-now" onClick={() => setMobileOpen(false)} className="block">
