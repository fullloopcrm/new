...
const navMain: Array<{
  ...
  { num: '03', label: 'Sales', href: '/dashboard/sales', countKey: 'leads', fold: 'sales', perm: 'leads.view', subs: [
    ...
    { letter: 'C', label: 'Sales Dashboard', href: '/dashboard/sales/dashboard' },
  ]},
...
const foldMap: Record<string, string[]> = {
  loop: ['/dashboard'],
  sales: ['/dashboard/sales', '/dashboard/catalog', '/dashboard/leads', '/dashboard/schedules', '/dashboard/sales/budget', '/dashboard/sales/dashboard'],
