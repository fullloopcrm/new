...
const navMain: Array<{
  ...
  { num: '04', label: 'Production', href: '/dashboard/jobs', fold: 'production', perm: 'bookings.view', subs: [
    ...
    { letter: 'E', label: 'Inventory', href: '/dashboard/inventory' },
  ]},
  ...
  { num: '07', label: 'Marketing', href: '/dashboard/campaigns', fold: 'marketing', perm: 'campaigns.view', subs: [
    ...
    { letter: 'I', label: 'Map', href: '/dashboard/map' },
    { letter: 'J', label: 'SEO', href: '/dashboard/seo' },
  ]},
...
const foldMap: Record<string, string[]> = {
  ...
  production: ['/dashboard/jobs', '/dashboard/jobs/crews', '/dashboard/calendar', '/dashboard/bookings', '/dashboard/treatments', '/dashboard/inventory'],
