...
// Section nav pattern documented in platform/docs/design/tokens.md.
...
const navMain: Array<{
  ...
  { num: '04', label: 'Production', href: '/dashboard/jobs', fold: 'production', perm: 'bookings.view', subs: [
    ...
    { letter: 'B', label: 'Reoccurring', href: '/dashboard/recurring' },
    ...
    { letter: 'F', label: 'Find a Team Member', href: '/dashboard/find-cleaner' },
    { letter: 'G', label: 'Announcements', href: '/dashboard/announcements' },
  ]},
...
const foldMap: Record<string, string[]> = {
  ...
  production: ['/dashboard/jobs', '/dashboard/jobs/crews', '/dashboard/jobs/vendors', '/dashboard/jobs/inventory', '/dashboard/jobs/equipment', '/dashboard/calendar', '/dashboard/bookings', '/dashboard/recurring', '/dashboard/find-cleaner', '/dashboard/announcements'],
...
const TITLE_OVERRIDES: Record<string, string> = {
  ...
  '/dashboard/recurring': 'Reoccurring',
  ...
  return (
    ...
    >
      ...
      {/* Notifications panel — opens from the right, 1/4 of the page.
          Transparent click-catcher (no screen dimming) closes on outside click. */}
      {notifPanelOpen && (
