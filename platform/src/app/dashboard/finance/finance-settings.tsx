...
export default function FinanceSettings() {
  ...
  return (
    ...
    >
      {() => {
        const defaultRangeTarget = useSettingsTarget<HTMLDivElement>('default_range')
        return (
        <div className="space-y-6">
          <div ref={defaultRangeTarget.ref} className="space-y-3 transition-shadow" style={defaultRangeTarget.isTarget ? { boxShadow: '0 0 0 2px #3B82F6', borderRadius: 8, padding: 8, margin: -8 } : undefined}>
