...
const ISSUE_GROUP: Record<string, IssueGroup> = {
  ...
  unscheduled_sale: 'fix', terminated_assigned: 'fix',
  home_by_risk: 'review',
...
const ISSUE_ACTION: Record<string, string> = {
  ...
  day_off: 'Reassign', terminated_assigned: 'Reassign', over_max_jobs: 'Rebalance', tight_buffer: 'Adjust', home_by_risk: 'Adjust',
