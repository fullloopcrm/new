            ...
            <div key={row.id} style={{ border: '1px solid var(--sl-line,#e6e6e0)', borderRadius: 10, marginBottom: 10, overflow: 'hidden' }}>
              ...
              >
                ...
                {!b ? (
                  ...
                  <>
                    <span style={{ fontSize: 12, color: 'var(--sl-muted)', minWidth: 90, textAlign: 'right' }}>
                      Budgeted<br /><strong style={{ color: 'var(--sl-ink)', fontSize: 14 }}>{money(budgetedTotal)}</strong>
                    </span>
                    <span style={{ fontSize: 12, color: 'var(--sl-muted)', minWidth: 90, textAlign: 'right' }}>
                      Actual<br /><strong style={{ color: 'var(--sl-ink)', fontSize: 14 }}>{money(actualTotal)}</strong>
                    </span>
                    <span style={{ fontSize: 12, color: 'var(--sl-muted)', minWidth: 100, textAlign: 'right' }}>
                      Variance<br />
                      <strong style={{ fontSize: 14, color: varianceCents < 0 ? '#c0392b' : 'var(--sl-good,#1f4d2c)' }}>{money(varianceCents)}</strong>
                    </span>
                    <span style={{ fontSize: 12, color: 'var(--sl-muted)', minWidth: 90, textAlign: 'right' }}>
                      Margin<br />
