export default function DocsPage() {
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-gray-500 text-sm mb-8">Everything you need to run your business on Full Loop CRM.</p>

      <div className="space-y-8">
        {/* Getting Started */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Getting Started</h3>
        ...
        {/* Bookings */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Bookings</h3>
        ...
        {/* Clients */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Clients</h3>
          <div className="space-y-3 text-sm text-gray-300 leading-relaxed">
        ...
        {/* Team */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Team Members</h3>
          <div className="space-y-3 text-sm text-gray-300 leading-relaxed">
        ...
        {/* Finance */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Finance</h3>
          <div className="space-y-3 text-sm text-gray-300 leading-relaxed">
        ...
        {/* Leads */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Leads &amp; Analytics</h3>
          <div className="space-y-3 text-sm text-gray-300 leading-relaxed">
        ...
        {/* Communications */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Communications</h3>
          <div className="space-y-3 text-sm text-gray-300 leading-relaxed">
        ...
        {/* Settings */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Settings</h3>
          <div className="space-y-3 text-sm text-gray-300 leading-relaxed">
        ...
        {/* Support */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-gray-800">Need Help?</h3>
          <div className="space-y-3 text-sm text-gray-300 leading-relaxed">
