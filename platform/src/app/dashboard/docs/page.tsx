  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="space-y-8">
        {/* Getting Started */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Getting Started</h3>
        ...
        {/* Bookings */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Bookings</h3>
        ...
        {/* Clients */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Clients</h3>
          <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
        ...
        {/* Team */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Team Members</h3>
          <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
        ...
        {/* Finance */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Finance</h3>
          <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
        ...
        {/* Leads */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Leads &amp; Analytics</h3>
          <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
        ...
        {/* Communications */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Communications</h3>
          <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
        ...
        {/* Settings */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Settings</h3>
          <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
        ...
        {/* Support */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3 pb-2 border-b border-slate-700">Need Help?</h3>
          <div className="space-y-3 text-sm text-slate-300 leading-relaxed">
