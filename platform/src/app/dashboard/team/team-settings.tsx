...
import { usePageSettings, PageSettingsPanel, useSettingsTarget } from '@/components/page-settings'
...
export default function TeamSettings() {
  ...
  return (
    ...
    >
      {() => {
        const defaultPayRateTarget = useSettingsTarget<HTMLLabelElement>('default_pay_rate')
        return (
        <div className="space-y-6">
          ...
          <div className="space-y-3 border-t border-gray-800 pt-4">
            ...
            <label ref={defaultPayRateTarget.ref} className="block transition-shadow" style={defaultPayRateTarget.isTarget ? { boxShadow: '0 0 0 2px #3B82F6', borderRadius: 8, padding: 8, margin: -8 } : undefined}>
