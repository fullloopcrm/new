...
export default function CatalogSettings() {
  ...
  return (
    ...
    >
      {() => {
        const defaultTabTarget = useSettingsTarget<HTMLDivElement>('default_tab')
        return (
        <div className="space-y-6">
          <div ref={defaultTabTarget.ref} className="space-y-3 transition-shadow" style={defaultTabTarget.isTarget ? { boxShadow: '0 0 0 2px #3B82F6', borderRadius: 8, padding: 8, margin: -8 } : undefined}>
