...
export default function FeedbackPage() {
  ...
  if (!mounted) return <p className="text-center pt-16 text-gray-400">Loading...</p>
  ...
  return (
    <div className="pt-8">
      <h1 className="text-xl font-bold text-gray-900 mb-2">Leave Feedback</h1>
      <p className="text-sm text-gray-500 mb-6">Your feedback is anonymous and helps us improve.</p>
      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        <div>
          <label className="text-sm text-gray-500 block mb-2">Comments (optional)</label>
          <textarea
            value={comment}
