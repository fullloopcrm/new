...
const breadcrumbs = [
  ...
  { name: "CRM 101", url: "https://homeservicesbusinesscrm.com/full-loop-crm-101-educational-tips" },
];
...
const crm101Faqs = [
  ...
  },
  {
    ...
    answer:
      "Only if it replaces multiple tools and generates enough revenue to justify itself. If a CRM generates 20 new leads per month and you close half at $300 each, that's $3,000 in new revenue — before counting the time you save. Full Loop replaces 9+ separate tools, plus an answering service, plus a bookkeeper, plus a payroll seat. If your CRM is just a glorified calendar, it's not worth $50/month.",
  },
  {
...
const categoryCTAs: Record<string, { text: string; href: string; label: string }> = {
  ...
  money: { text: "See how pricing and payments work inside Full Loop", href: "/contact", label: "View Pricing Plans" },
  ...
  truth: { text: "No pressure — just explore what we built and decide for yourself", href: "/contact", label: "Inquire" },
};
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://homeservicesbusinesscrm.com/full-loop-crm-101-educational-tips" },
  openGraph: {
    ...
    url: "https://homeservicesbusinesscrm.com/full-loop-crm-101-educational-tips",
    type: "article",
    siteName: "Full Loop CRM",
    images: [
      {
        url: "https://homeservicesbusinesscrm.com/opengraph-image",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://homeservicesbusinesscrm.com/opengraph-image"],
  },
  other: {
    ...
    <>
      <JsonLd
        data={webPageSchema(
          ...
          "101 blunt, honest tips for home service businesses comparing CRMs. Learn what a CRM actually does, which platforms work for your business size, and how to stop wasting money on the wrong tools.",
          "https://homeservicesbusinesscrm.com/full-loop-crm-101-educational-tips",
          breadcrumbs
        )}
      />
      ...
      <JsonLd
        data={itemListSchema(
          ...
          tips.map((t) => ({
            ...
            url: `https://homeservicesbusinesscrm.com/full-loop-crm-101-educational-tips#${t.cat}`,
          }))
        )}
      />
