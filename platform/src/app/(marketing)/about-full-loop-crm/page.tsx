...
const breadcrumbs = [
  ...
  { name: "About", url: "https://homeservicecrm.ai/about-full-loop-crm" },
];
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://homeservicecrm.ai/about-full-loop-crm" },
  openGraph: {
    title: "About Full Loop CRM | Built by Home Service Operators",
    description:
      "Full Loop CRM was built by a home service business owner with 20+ years in the field. One platform, full cycle.",
    url: "https://homeservicecrm.ai/about-full-loop-crm",
    type: "website",
  },
  twitter: {
    ...
    <>
      <JsonLd
        data={webPageSchema(
          ...
          "https://homeservicecrm.ai/about-full-loop-crm",
          breadcrumbs
        )}
      />
      <JsonLd data={breadcrumbSchema(breadcrumbs)} />
      <JsonLd data={localBusinessSchema("https://homeservicecrm.ai/about-full-loop-crm", "United States", "Country")} />
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-6 text-slate-700 text-lg leading-relaxed">
            ...
            <p>
              ...
              SEO. Converts those leads with an AI receptionist who
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "The AI answers calls, texts, and web chats — qualifying leads and booking jobs autonomously.",
              },
              {
                num: "03",
