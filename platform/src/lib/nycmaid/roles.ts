...
// Pages each role can access — SINGLE SOURCE OF TRUTH.
// Imported by src/middleware.ts and src/components/AdminSidebar.tsx.
// Adding/removing a page here updates middleware enforcement AND sidebar
// visibility in one place.
export const PAGE_ACCESS: Record<AdminRole, string[]> = {
  owner: ['*'], // everything
  admin: [
    'dashboard', 'comhub', 'bookings', 'calendar', 'clients', 'team', 'finance',
    'feedback', 'reviews', 'sales', 'notifications',
  ],
  manager: [
    'dashboard', 'comhub', 'bookings', 'calendar', 'clients', 'team', 'finance',
    'yinez', 'selena', 'leads', 'sales', 'feedback', 'settings',
  ],
  viewer: [
...
const API_ACCESS: Record<AdminRole, string[]> = {
  ...
  admin: [
    ...
    '/api/admin/feedback', '/api/admin/reviews',
  ],
  manager: [
    '/api/dashboard', '/api/bookings', '/api/clients', '/api/cleaners',
    '/api/cleaner-applications', '/api/management-applications',
    '/api/admin/yinez', '/api/admin/recurring', '/api/notifications',
    '/api/admin/leads', '/api/admin/feedback', '/api/finance',
    '/api/admin/comhub', '/api/settings',
  ],
  viewer: [
