...
Insured up to $1M.
2-hour minimum on all bookings (first-time cleanings included). 2+ cleaners = 4-hour minimum and NO discounts, regardless of notice. The $89/hr emergency rate is SAME-DAY ONLY — a multi-cleaner booking with short notice still bills at the regular $59/$69 rate (just with the 4-hour minimum and no discount), it does NOT trigger the $89/hr emergency rate unless it's also same-day.
