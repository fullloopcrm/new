        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[72px]">
            ...
            <div className="hidden lg:flex items-center gap-2">
              <a href="tel:2122029030" className="inline-block bg-[#1E2A4A] text-white px-5 py-2.5 rounded-md font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors whitespace-nowrap">
                Call
              </a>
              <a href="sms:2122029030" className="inline-block bg-[#A8F0DC] text-[#1E2A4A] px-5 py-2.5 rounded-md font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors whitespace-nowrap">
                Text (212) 202-9030
              </a>
            </div>
            ...
            <div className="lg:hidden flex items-center gap-2">
              <a href="tel:2122029030" className="bg-[#1E2A4A] text-white px-3 py-2 rounded-md font-bold text-xs tracking-widest uppercase">
                Call
              </a>
              <a href="sms:2122029030" className="bg-[#A8F0DC] text-[#1E2A4A] px-3 py-2 rounded-md font-bold text-xs tracking-widest uppercase">
                Text
              </a>
          ...
          <div className="overflow-y-auto h-[calc(100%-72px)] px-5 py-6">
            <div className="space-y-1">
              ...
              <div className="border-t border-white/10 mt-4 pt-6 space-y-3 text-center">
                <a href="tel:2122029030" className="block bg-[#1E2A4A] text-white py-3 rounded-lg font-bold text-sm tracking-widest uppercase border border-white/20">Call Sales: (212) 202-9030</a>
