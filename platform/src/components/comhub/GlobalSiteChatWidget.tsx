...
// Sitewide floating chat launcher — the tenant-agnostic counterpart to each
// tenant's own hero-embedded chat. Mounted once in the root /site layout so
// every tenant gets it automatically; branding is resolved at runtime from
// /api/tenant/public instead of being hardcoded per tenant.
export default function GlobalSiteChatWidget() {
