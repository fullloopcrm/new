    ...
    <Band id="proves" tone="canvas">
      <Column className="py-20 sm:py-28">
        ...
        <Quote attribution="The one-sentence version">
          A real, competitive New York City service business — 850+ clients, six figures, 4.9★, zero ad spend — run almost entirely by software, proven in production, and put on the public record so you don&apos;t have to take our word for any of it.
        </Quote>
