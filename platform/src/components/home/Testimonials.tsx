      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-4 font-heading">
            ...
            <span className="text-teal-400">About Full Loop CRM</span>
          </h2>
          ...
          <div className="flex flex-col items-center gap-3 mt-8">
            ...
            <div className="flex items-center gap-2 mt-2 px-4 py-2 rounded-full bg-white/10 border border-white/20">
              ...
              <span className="text-teal-400 text-sm font-semibold">10 Reviews</span>
            </div>
          </div>
        </motion.div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-xs leading-tight">{t.business}</p>
