  ...
  return (
    <section className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <p className="text-[#1C1C1C] text-sm font-semibold tracking-[0.2em] uppercase mb-4 font-cta">
            One Trade Per City &mdash; Forever
          </p>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#1C1C1C] mb-6 font-heading">
            Is Your City Still Open?
          </h2>

          <p className="text-[#1C1C1C] text-lg sm:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            ...
            <a
              ...
              className="inline-block px-10 py-5 text-lg font-bold text-[#1C1C1C] rounded-xl bg-[#1F4D2C] hover:bg-teal-800 border border-white/20 transition-colors shadow-lg font-cta w-full sm:w-auto"
            >
              Call (212) 202-9220
            </a>
            <a
